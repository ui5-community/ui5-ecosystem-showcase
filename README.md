...
├── dev-approuter                   // dev time wrapper for the SAP Approuter that can serve UI5 and CAP modules added as dependencies
...
| [dev-approuter](packages/dev-approuter/README.md) | dev time wrapper for the SAP Approuter that can serve UI5 and CAP modules added as dependencies | [![npm version](https://badge.fury.io/js/dev-approuter.svg)](https://badge.fury.io/js/dev-approuter) |
