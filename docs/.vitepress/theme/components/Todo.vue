	...
	<div class="app ui5-content-density-compact">
		<section class="app-content">
			...
			<div class="list-todos-wrapper">
				<TodoList :todos="todos" @selection-change="handleDone" @item-deleted="handleRemove" @item-edit="handleEdit"> </TodoList>

				<ui5-panel header-text="Completed tasks">
					<TodoList :todos="doneTodos" @selection-change="handleUndone" @item-deleted="handleRemove" @item-edit="handleEdit"> </TodoList>
				</ui5-panel>
			</div>
		</section>
		<ui5-dialog header-text="Edit Todo item" ref="editDialog">
			<div class="dialog-content">
				<div class="edit-wrapper">
					...
					<ui5-textarea class="title-textarea" show-exceeded-text maxlength="24" :value="todoBeingEdittedText" ref="titleEditInput"> </ui5-textarea>
				</div>
			...
			<div class="dialog-footer" data-ui5-slot="footer">
				<ui5-button class="cancel-btn" design="Transparent" @click="cancelEdits">Cancel</ui5-button>
