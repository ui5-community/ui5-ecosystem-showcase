sap.ui.define((function () { 'use strict';
  ...
  */ const requestAnimFrame = function() {
  ...
  const defaultExports = Object.isFrozen(Chart) ? Object.assign({}, Chart?.default || Chart || { __emptyModule: true }) : Chart;
  Object.keys(namedExports || {}).filter((key) => !defaultExports[key]).forEach((key) => defaultExports[key] = namedExports[key]);
  Object.defineProperty(defaultExports, "__" + "esModule", { value: true });
  var auto = Object.isFrozen(Chart) ? Object.freeze(defaultExports) : defaultExports;
