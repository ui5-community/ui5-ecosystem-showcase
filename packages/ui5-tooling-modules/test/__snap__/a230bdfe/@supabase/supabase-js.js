...
sap.ui.define(['exports', 'ui5/ecosystem/demo/app/resources/index2'], (function (exports, index) { 'use strict';
	...
	exports.PostgrestError = index.PostgrestError;
	...
	exports.isAuthImplicitGrantRedirectError = index.isAuthImplicitGrantRedirectError;
  ...
  addEventListener("message", (e) => {
    ...
    class RealtimeClient {
        ...
        connect() {
            ...
            new Promise(function (resolve, reject) { require(['ui5/ecosystem/demo/app/resources/_dynamics/browser'], resolve, reject); }).then(function (n) { return n.browser; }).then(({ default: WS }) => {
