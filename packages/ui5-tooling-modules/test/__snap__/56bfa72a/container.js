...
=======
  var c$e={},e$h=c$e.hasOwnProperty,a$d=c$e.toString,o$h=e$h.toString,l$e=o$h.call(Object),i$h=function(r){var t,n;return !r||a$d.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$e):true)};

  var c$d=Object.create(null),u$c=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?undefined:c$d;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$h(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$h(n)?n:{},r[a]=u$c(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$g=function(n,t){return u$c(true,false,...arguments)};

  const e$f=new Map,s$l=(t,r)=>{e$f.set(t,r);},n$k=t=>e$f.get(t);

  const _$3={themes:{default:"sap_horizon"},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$e=_$3.themes.default,a$c=_$3.languages.default,r$g=_$3.locales.default,n$j=_$3.locales.all;

  const o$g=typeof document>"u",n$i={search(){return o$g?"":window.location.search}},s$k=()=>o$g?"":window.location.href,u$b=()=>n$i.search();

  const o$f=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},s$j=e=>{const t=o$f("sap-allowedThemeOrigins");return t&&t.split(",").some(n=>n==="*"||e===n.trim())},a$b=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$7=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$k()).toString();else {const n=new URL(e),r=n.origin;r&&s$j(r)?t=n.toString():t=a$b(n.toString(),s$k());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};

  var u$a=(l=>(l.Full="full",l.Basic="basic",l.Minimal="minimal",l.None="none",l))(u$a||{});

  let i$g = class i{constructor(){this._eventRegistry=new Map;}attachEvent(t,r){const n=this._eventRegistry,e=n.get(t);if(!Array.isArray(e)){n.set(t,[r]);return}e.includes(r)||e.push(r);}detachEvent(t,r){const n=this._eventRegistry,e=n.get(t);if(!e)return;const s=e.indexOf(r);s!==-1&&e.splice(s,1),e.length===0&&n.delete(t);}fireEvent(t,r){const e=this._eventRegistry.get(t);return e?e.map(s=>s.call(this,r)):[]}fireEventAsync(t,r){return Promise.all(this.fireEvent(t,r))}isHandlerAttached(t,r){const e=this._eventRegistry.get(t);return e?e.includes(r):false}hasListeners(t){return !!this._eventRegistry.get(t)}};

  const e$d=new i$g,t$j="configurationReset",i$f=n=>{e$d.attachEvent(t$j,n);};

  let p$6=false,t$i={animationMode:u$a.Full,theme:e$e,themeRoot:undefined,rtl:undefined,language:undefined,timezone:undefined,calendarType:undefined,secondaryCalendarType:undefined,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const T$3=()=>(o$e(),t$i.theme),S$5=()=>(o$e(),t$i.themeRoot),L$2=()=>(o$e(),t$i.language),F=()=>(o$e(),t$i.fetchDefaultLanguage),U$2=()=>(o$e(),t$i.noConflict),b$5=()=>(o$e(),t$i.defaultFontLoading),M$2=()=>(o$e(),t$i.formatSettings),i$e=new Map;i$e.set("true",true),i$e.set("false",false);const z$1=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$i=e$g(t$i,e));}},E$2=()=>{const n=new URLSearchParams(u$b());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||u$9(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&u$9(a,e,"sap-ui");});},P$4=n=>{const e=n.split("@")[1];return g$7(e)},w$6=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,u$9=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$e.has(e)&&(e=i$e.get(r)),s==="theme"?(t$i.theme=w$6(s,e),e&&e.includes("@")&&(t$i.themeRoot=P$4(e))):t$i[s]=e;},j=()=>{const n=n$k("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$i=e$g(t$i,e);},o$e=()=>{typeof document>"u"||p$6||(g$6(),p$6=true);},g$6=n=>{z$1(),E$2(),j();};

  i$f(()=>{});

  var s$i=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$i||{});

  i$f(()=>{});

  let t$h;let a$a = class a{static getLegacyDateCalendarCustomizing(){return t$h===undefined&&(t$h=M$2()),t$h.legacyDateCalendarCustomizing||[]}};s$l("LegacyDateFormats",a$a);

  i$f(()=>{});const i$d=n$k("LegacyDateFormats");i$d?a$a.getLegacyDateCalendarCustomizing:()=>[];
  ...
  const u$8=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$c=()=>typeof document>"u"?null:o$d('meta[name="ui5-shared-resources"]',document.head,u$8),m$9=(t,o)=>{const r=t.split(".");let e=l$c();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$c={version:"2.7.0",major:2,minor:7,patch:0,suffix:"",isNext:false,buildTime:1738589223};

  let o$c,t$g={include:[/^ui5-/],exclude:[]};const s$h=new Map,c$c=()=>o$c,m$8=()=>t$g,i$c=e=>{if(!s$h.has(e)){const r=t$g.include.some(n=>e.match(n))&&!t$g.exclude.some(n=>e.match(n));s$h.set(e,r);}return s$h.get(e)},p$5=e=>{if(i$c(e))return c$c()};

  let i$b,s$g="";const u$7=new Map,r$f=m$9("Runtimes",[]),x$1=()=>{if(i$b===undefined){i$b=r$f.length;const e=e$c;r$f.push({...e,get scopingSuffix(){return c$c()},get registeredTags(){return $$1()},get scopingRules(){return m$8()},alias:s$g,description:`Runtime ${i$b} - ver ${e.version}${""}`});}},I$4=()=>i$b,b$4=(e,m)=>{const o=`${e},${m}`;if(u$7.has(o))return u$7.get(o);const t=r$f[e],n=r$f[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(undefined,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$7.set(o,l),l},$$2=()=>r$f;

  const m$7=m$9("Tags",new Map),d$9=new Set;let s$f=new Map,c$b;const g$5=-1,h$5=e=>{d$9.add(e),m$7.set(e,I$4());},w$5=e=>d$9.has(e),$$1=()=>[...d$9.values()],y$5=e=>{let n=m$7.get(e);n===undefined&&(n=g$5),s$f.has(n)||s$f.set(n,new Set),s$f.get(n).add(e),c$b||(c$b=setTimeout(()=>{R$3(),s$f=new Map,c$b=undefined;},1e3));},R$3=()=>{const e=$$2(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(i=>`
${i.description}`).join("")}`),[...s$f.keys()].forEach(i=>{let o,r;i===g$5?(o=1,r={description:"Older unknown runtime"}):(o=b$4(n,i),r=e[i]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${s$f.get(i).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...s$f.get(i)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$f=new Set,n$h=e=>{t$f.add(e);},r$e=e=>t$f.has(e);

  const s$e=new Set,d$8=new i$g,n$g=new l$d;let t$e,a$9,m$6,i$a;const l$b=async e=>{n$g.add(e),await P$3();},c$a=e=>{d$8.fireEvent("beforeComponentRender",e),s$e.add(e),e._render();},h$4=e=>{n$g.remove(e),s$e.delete(e);},P$3=async()=>{i$a||(i$a=new Promise(e=>{window.requestAnimationFrame(()=>{n$g.process(c$a),i$a=null,e(),m$6||(m$6=setTimeout(()=>{m$6=undefined,n$g.isEmpty()&&U$1();},200));});})),await i$a;},y$4=()=>t$e||(t$e=new Promise(e=>{a$9=e,window.requestAnimationFrame(()=>{n$g.isEmpty()&&(t$e=undefined,e());});}),t$e),I$3=()=>{const e=$$1().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$6=async()=>{await I$3(),await y$4();},U$1=()=>{n$g.isEmpty()&&a$9&&(a$9(),a$9=undefined,t$e=undefined);},C$3=async e=>{s$e.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$e(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$b(r);}),await f$6();};

  const g$4=typeof document>"u",i$9=(e,t)=>t?`${e}|${t}`:e,l$a=e=>e===undefined?true:b$4(I$4(),parseInt(e))===1,c$9=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$9(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$3=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$9(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$a(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$4?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$9(e,t)),f$5=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$9(e,t));},R$2=(e,t,r="",s)=>{S$4(t,r)?y$3(e,t,r,s):c$9(e,t,r,s);},m$5=(e,t)=>e===undefined?t:t===undefined?e:`${e} ${t}`;

  const t$d=new i$g,r$d="themeRegistered",n$f=e=>{t$d.attachEvent(r$d,e);};

  const l$9=new Map,h$3=new Map,u$6=new Map,T$2=new Set,i$8=new Set,m$4=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$9.get(g);if(s!==undefined)return s;if(!i$8.has(r)){const $=[...i$8.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$e}. Registered themes are: ${$}`),a$8(e,e$e)}const[n,d]=await Promise.all([a$8(e,r),t?a$8(e,t,true):undefined]),o=m$5(n,d);return o&&l$9.set(g,o),o},a$8=async(e,r,t=false)=>{const s=(t?u$6:h$3).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$4=()=>T$2,P$2=e=>i$8.has(e);

  const r$c=new Set,s$d=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$b=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$c.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$c.add("decode"));return}try{return JSON.parse(a)}catch{r$c.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$c.add("parse"));}}},d$7=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$c.has("object")||(console.warn("Malformed theme metadata Object",e),r$c.add("object"));return}return {themeName:t,baseThemeName:a}},m$3=()=>{const e=s$d();if(!e||e==="none")return;const t=o$b(e);if(t)return d$7(t)};

  const t$c=new i$g,d$6="themeLoaded",r$b=e=>t$c.fireEvent(d$6,e);
  ...
  let t$b;i$f(()=>{t$b=undefined;});const n$e=()=>(t$b===undefined&&(t$b=S$5()),t$b),u$5=e=>`${n$e()}Base/baseLib/${e}/css_variables.css`,i$7=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$5(u$5(e),{"sap-ui-webcomponents-theme":e});};

  const s$c="@ui5/webcomponents-theming",S$3=()=>w$4().has(s$c),P$1=async e=>{if(!S$3())return;const t=await m$4(s$c,e);t&&R$2(t,"data-ui5-theme-properties",s$c,e);},E$1=()=>{f$5("data-ui5-theme-properties",s$c);},U=async(e,t)=>{const o=[...w$4()].map(async a=>{if(a===s$c)return;const i=await m$4(a,e,t);i&&R$2(i,`data-ui5-component-properties-${I$4()}`,a);});return Promise.all(o)},w$3=async e=>{const t=m$3();if(t)return t;const r=n$k("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$e())return await i$7(e),m$3()},I$2=async e=>{const t=await w$3(e);!t||e!==t.themeName?await P$1(e):E$1();const r=P$2(e)?e:t&&t.baseThemeName;await U(r||e$e,t&&t.themeName===e?e:undefined),r$b(e);};
  ...
  var n$d = "@font-face{font-family:'72override';unicode-range:U+0102-0103,U+01A0-01A1,U+01AF-01B0,U+1EA0-1EB7,U+1EB8-1EC7,U+1EC8-1ECB,U+1ECC-1EE3,U+1EE4-1EF1,U+1EF4-1EF7;src:local('Arial'),local('Helvetica'),local('sans-serif')}";

  let o$a;i$f(()=>{o$a=undefined;});const a$6=()=>(o$a===undefined&&(o$a=b$5()),o$a);

  const i$6=()=>{const t=n$k("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$4(),c$8();},p$4=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$6()||t||S$4("data-ui5-font-face")||c$9(a$7,"data-ui5-font-face");},c$8=()=>{S$4("data-ui5-font-face-override")||c$9(n$d,"data-ui5-font-face-override");};
  ...
  const e$b=()=>{S$4("data-ui5-system-css-vars")||c$9(a$5,"data-ui5-system-css-vars");};

  const t$a=typeof document>"u",e$a={get userAgent(){return t$a?"":navigator.userAgent},get chrome(){return t$a?false:/(Chrome|CriOS)/.test(e$a.userAgent)},get safari(){return t$a?false:!e$a.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$a.userAgent)},get iOS(){return t$a?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$a.userAgent.match(/Mac/)&&"ontouchend"in document)}};const h$2=()=>e$a.safari,w$2=()=>e$a.iOS;

  let t$9=false;const i$5=()=>{h$2()&&w$2()&&!t$9&&(document.body.addEventListener("touchstart",()=>{}),t$9=true);};

  let o$9=false,r$a;const p$3=new i$g,l$8=async()=>{if(r$a!==undefined)return r$a;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$f(b$3);const t=n$k("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$k("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$4(),await I$2(r$9()),t&&t.attachListeners(),i$6(),e$b(),i$5(),n(),o$9=true,p$3.fireEvent("boot");};return r$a=new Promise(e),r$a},b$3=e=>{o$9&&e===r$9()&&I$2(r$9());};

  let t$8;i$f(()=>{t$8=undefined;});const r$9=()=>(t$8===undefined&&(t$8=T$3()),t$8);
  ...
  var t$6=(s=>(s["SAP-icons"]="SAP-icons-v4",s.horizon="SAP-icons-v5",s["SAP-icons-TNT"]="tnt",s.BusinessSuiteInAppSymbols="business-suite",s))(t$6||{});

  const e$9=new i$g,n$c="languageChange",t$5=a=>{e$9.attachEvent(n$c,a);};

  let e$8,n$b;i$f(()=>{e$8=undefined,n$b=undefined;});const d$3=()=>(e$8===undefined&&(e$8=L$2()),e$8),c$7=()=>(n$b===undefined&&(n$b=F()),n$b);

  const c$6=["value-changed","click"];let e$7;i$f(()=>{e$7=undefined;});const s$a=t=>c$6.includes(t),l$7=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$7===undefined&&(e$7=U$2()),e$7),a$4=t=>{const n=o$8();return s$a(t)?false:n===true?true:!l$7(t)};
  ...
  const t$4=new WeakMap,n$7=(e,o,r)=>{const s=new MutationObserver(o);t$4.set(e,s),s.observe(e,r);},b$1=e=>{const o=t$4.get(e);o&&(o.disconnect(),t$4.delete(e));};
  ...
  const n$6=(t,r)=>{if(t.length!==r.length)return  false;for(let e=0;e<t.length;e++)if(t[e]!==r[e])return  false;return  true};

  const n$5=(e,t)=>e.call(t);

  const o$4=t=>{s$4(t)&&e$3(t);},e$3=t=>{if(t._internals?.form){if(n$4(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},n$4=async t=>{if(t._internals?.form)if(t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},s$4=t=>"formFormattedValue"in t&&"name"in t;

  const t$3=typeof document>"u",o$3=()=>{if(t$3)return a$c;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$c};
  ...
  const r$2=new Map,n$2=t=>(r$2.has(t)||r$2.set(t,new r$3(t)),r$2.get(t)),c$3=t=>{try{if(t&&typeof t=="string")return n$2(t)}catch{}return new r$3(r$g)},s$3=t=>{const e=d$3();return e?n$2(e):c$3(o$3())};

  const _$2=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$2=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$4={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$1=i=>{let e;if(!i)return r$g;if(typeof i=="string"&&(e=_$2.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():undefined;const s=e[2]?e[2].toLowerCase():undefined,r=e[4]?e[4].slice(1):undefined,o=e[6];return t=f$4[t]||t,o&&(e=c$2.exec(o))||r&&(e=c$2.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$g};

  const e$2=r=>{if(!r)return r$g;if(r==="zh_HK")return "zh_TW";const n=r.lastIndexOf("_");return n>=0?r.slice(0,n):r!==r$g?r$g:""};

  const d$2=new Set,m$2=new Set,g$2=new Map,l$3=new Map,u$4=new Map,f$3=(n,t)=>{g$2.set(n,t);},A$1=n=>g$2.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$4.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$4.get(e);return r&&!l$3.get(e)&&l$3.set(e,r(t)),l$3.get(e)},M$1=n=>{d$2.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$2.add(n));},L$1=(n,t)=>t!==a$c&&!h$1(n,t),w$1=async n=>{const t=s$3().getLanguage(),e=s$3().getRegion(),r=s$3().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$1(n,s))for(s=p$1(s);L$1(n,s);)s=e$2(s);const I=c$7();if(s===a$c&&!I){f$3(n,null);return}if(!h$1(n,s)){M$1(n);return}try{const o=await B$1(n,s);f$3(n,o);}catch(o){const a=o;m$2.has(a.message)||(m$2.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$2.keys()];return Promise.all(t.map(w$1))});
  ...
  m$9("SVGIcons.registry",new Map);m$9("SVGIcons.promises",new Map);
  ...
  let t$1 = class t{static{this.html=n;}static{this.svg=u;}static{this.unsafeStatic=o$1;}};s$l("LitStatic",t$1);
