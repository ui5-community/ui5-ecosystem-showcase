sap.ui.define(['require', 'exports'], (function (require, exports) { 'use strict';
  ...
  var c$e={},e$h=c$e.hasOwnProperty,a$f=c$e.toString,o$i=e$h.toString,l$h=o$i.call(Object),i$i=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$i.call(n)===l$h):true)};
  ...
  const _$4={themes:{default:"sap_horizon"},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$e=_$4.themes.default,a$e=_$4.languages.default,r$i=_$4.locales.default,l$g=_$4.locales.all;

  const o$h=typeof document>"u",n$j={search(){return o$h?"":window.location.search}},s$m=()=>o$h?"":window.location.href,u$c=()=>n$j.search();

  const o$g=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},s$l=e=>{const t=o$g("sap-allowedThemeOrigins");return t&&t.split(",").some(n=>n==="*"||e===n.trim())},a$d=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$9=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$m()).toString();else {const n=new URL(e),r=n.origin;r&&s$l(r)?t=n.toString():t=a$d(n.toString(),s$m());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  const e$d=new i$h,t$l="configurationReset",i$g=n=>{e$d.attachEvent(t$l,n);};

  let p$7=false,t$k={animationMode:u$b.Full,theme:e$e,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const T$4=()=>(o$f(),t$k.theme),S$5=()=>(o$f(),t$k.themeRoot),L$3=()=>(o$f(),t$k.language),F$1=()=>(o$f(),t$k.fetchDefaultLanguage),U$3=()=>(o$f(),t$k.noConflict),b$7=()=>(o$f(),t$k.defaultFontLoading),M$3=()=>(o$f(),t$k.formatSettings),i$f=new Map;i$f.set("true",true),i$f.set("false",false);const z$2=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$k=e$g(t$k,e));}},E$3=()=>{const n=new URLSearchParams(u$c());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||u$a(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&u$a(a,e,"sap-ui");});},P$5=n=>{const e=n.split("@")[1];return g$9(e)},w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,u$a=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$f.has(e)&&(e=i$f.get(r)),s==="theme"?(t$k.theme=w$7(s,e),e&&e.includes("@")&&(t$k.themeRoot=P$5(e))):t$k[s]=e;},j$1=()=>{const n=n$k("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$k=e$g(t$k,e);},o$f=()=>{typeof document>"u"||p$7||(g$8(),p$7=true);},g$8=n=>{z$2(),E$3(),j$1();};
  ...
  let t$j;let a$c = class a{static getLegacyDateCalendarCustomizing(){return t$j===void 0&&(t$j=M$3()),t$j.legacyDateCalendarCustomizing||[]}};s$n("LegacyDateFormats",a$c);
  ...
  const u$9=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$e=()=>typeof document>"u"?null:o$e('meta[name="ui5-shared-resources"]',document.head,u$9),m$a=(t,o)=>{const r=t.split(".");let e=l$e();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$c={version:"2.12.0",major:2,minor:12,patch:0,suffix:"",isNext:false,buildTime:1751620086};

  let s$j,t$i={include:[/^ui5-/],exclude:[]};const o$d=new Map,c$c=()=>s$j,p$6=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$i=e,o$d.clear();},m$9=()=>t$i,i$d=e=>{if(!o$d.has(e)){const n=t$i.include.some(r=>e.match(r))&&!t$i.exclude.some(r=>e.match(r));o$d.set(e,n);}return o$d.get(e)},g$7=e=>{if(i$d(e))return c$c()};

  let i$c,s$i="";const u$8=new Map,r$h=m$a("Runtimes",[]),x$2=()=>{if(i$c===void 0){i$c=r$h.length;const e=e$c;r$h.push({...e,get scopingSuffix(){return c$c()},get registeredTags(){return T$3()},get scopingRules(){return m$9()},alias:s$i,description:`Runtime ${i$c} - ver ${e.version}${""}`});}},I$5=()=>i$c,b$6=(e,m)=>{const o=`${e},${m}`;if(u$8.has(o))return u$8.get(o);const t=r$h[e],n=r$h[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$8.set(o,l),l},$$3=()=>r$h;

  const g$6=m$a("Tags",new Map),d$9=new Set;let s$h=new Map,c$b;const m$8=-1,h$7=e=>{d$9.add(e),g$6.set(e,I$5());},w$6=e=>d$9.has(e),T$3=()=>[...d$9.values()],$$2=e=>{let n=g$6.get(e);n===void 0&&(n=m$8),s$h.has(n)||s$h.set(n,new Set),s$h.get(n).add(e),c$b||(c$b=setTimeout(()=>{y$6(),s$h=new Map,c$b=void 0;},1e3));},y$6=()=>{const e=$$3(),n=I$5(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(i=>`
${i.description}`).join("")}`),[...s$h.keys()].forEach(i=>{let o,r;i===m$8?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,i),r=e[i]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${s$h.get(i).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...s$h.get(i)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$h=new Set,n$i=e=>{t$h.add(e);},r$g=e=>t$h.has(e);

  const s$g=new Set,d$8=new i$h,n$h=new l$f;let t$g,a$b,m$7,i$b;const l$d=async e=>{n$h.add(e),await P$4();},c$a=e=>{d$8.fireEvent("beforeComponentRender",e),s$g.add(e),e._render();},h$6=e=>{n$h.remove(e),s$g.delete(e);},P$4=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$h.process(c$a),i$b=null,e(),m$7||(m$7=setTimeout(()=>{m$7=void 0,n$h.isEmpty()&&U$2();},200));});})),await i$b;},y$5=()=>t$g||(t$g=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$h.isEmpty()&&(t$g=void 0,e());});}),t$g),I$4=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$7=async()=>{await I$4(),await y$5();},U$2=()=>{n$h.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$g=void 0);},C$4=async e=>{s$g.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$g(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$d(r);}),await f$7();};

  const g$5=typeof document>"u",i$a=(e,t)=>t?`${e}|${t}`:e,l$c=e=>e===void 0?true:b$6(I$5(),parseInt(e))===1,c$9=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$a(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$a(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$c(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$5?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$a(e,t)),f$6=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$a(e,t));},R$4=(e,t,r="",s)=>{S$4(t,r)?y$4(e,t,r,s):c$9(e,t,r,s);},m$6=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$f=new i$h,r$f="themeRegistered",n$g=e=>{t$f.attachEvent(r$f,e);};

  const l$b=new Map,h$5=new Map,u$7=new Map,T$2=new Set,i$9=new Set,m$5=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$b.get(g);if(s!==void 0)return s;if(!i$9.has(r)){const $=[...i$9.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$e}. Registered themes are: ${$}`),a$a(e,e$e)}const[n,d]=await Promise.all([a$a(e,r),t?a$a(e,t,true):void 0]),o=m$6(n,d);return o&&l$b.set(g,o),o},a$a=async(e,r,t=false)=>{const s=(t?u$7:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$3=e=>i$9.has(e);

  const r$e=new Set,s$f=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$c=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$e.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$e.add("decode"));return}try{return JSON.parse(a)}catch{r$e.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$e.add("parse"));}}},d$7=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$e.has("object")||(console.warn("Malformed theme metadata Object",e),r$e.add("object"));return}return {themeName:t,baseThemeName:a}},m$4=()=>{const e=s$f();if(!e||e==="none")return;const t=o$c(e);if(t)return d$7(t)};

  const t$e=new i$h,d$6="themeLoaded",r$d=e=>t$e.fireEvent(d$6,e);
  ...
  let o$b;i$g(()=>{o$b=void 0;});const a$8=()=>(o$b===void 0&&(o$b=b$7()),o$b);

  const i$7=()=>{const t=n$k("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$8();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$8()||t||S$4("data-ui5-font-face")||c$9(a$9,"data-ui5-font-face");},c$8=()=>{S$4("data-ui5-font-face-override")||c$9(n$e,"data-ui5-font-face-override");};
  ...
  const e$b=()=>{S$4("data-ui5-system-css-vars")||c$9(a$7,"data-ui5-system-css-vars");};
  ...
  let o$a=false,r$c;const p$4=new i$h,l$a=async()=>{if(r$c!==void 0)return r$c;const e=async n=>{if(x$2(),typeof document>"u"){n();return}n$g(b$5);const t=n$k("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$k("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$4(),await I$3(r$b()),t&&t.attachListeners(),i$7(),e$b(),i$6(),n(),o$a=true,p$4.fireEvent("boot");};return r$c=new Promise(e),r$c},b$5=e=>{o$a&&e===r$b()&&I$3(r$b());};
  ...
  const e$9=new i$h,n$d="languageChange",t$7=a=>{e$9.attachEvent(n$d,a);};

  let e$8,t$6;i$g(()=>{e$8=void 0,t$6=void 0;});let a$6=false;const s$c=()=>a$6,l$9=()=>(e$8===void 0&&(e$8=L$3()),e$8),h$3=()=>(t$6===void 0&&(t$6=F$1()),t$6);

  const c$7=["value-changed","click"];let e$7;i$g(()=>{e$7=void 0;});const s$b=t=>c$7.includes(t),l$8=t=>{const n=o$9();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$9=()=>(e$7===void 0&&(e$7=U$3()),e$7),a$5=t=>{const n=o$9();return s$b(t)?false:n===true?true:!l$8(t)};
  ...
  const s$a=new Map,o$8=new Map,n$c=new Map,c$6=e=>{if(!s$a.has(e)){const a=b$4(e.split("-"));s$a.set(e,a);}return s$a.get(e)},l$6=e=>{if(!o$8.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$8.set(e,a);}return o$8.get(e)},b$4=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$3=e=>{const a=n$c.get(e);if(a)return a;const t=c$6(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$c.set(e,r),r};

  const o$7=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$b=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$9=t=>t.reduce((e,r)=>e.concat(n$b(r)),[]);
  ...
  const r$9=()=>m$a("CustomStyle.eventProvider",new i$h),n$a="CustomCSSChange",i$5=t=>{r$9().attachEvent(n$a,t);},c$5=()=>m$a("CustomStyle.customCSSFor",{});i$5(t=>{C$4({tag:t});});const l$5=t=>{const e=c$5();return e[t]?e[t].join(""):""};

  const e$6=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$5=new Map;i$5(t=>{e$5.delete(`${t}_normal`);});const y$3=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$k("OpenUI5Enablement");if(!e$5.has(n)){let l="";s&&(l=e$6(s.getBusyIndicatorStyles()));const a=l$5(o)||"",m=`${e$6(t.styles)} ${a} ${l}`;e$5.set(n,m);}return e$5.get(n)};

  const e$4=new Map;i$5(t=>{e$4.delete(`${t}_normal`);});const s$8=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$4.has(n)){const a=y$3(t),o=new CSSStyleSheet;o.replaceSync(a),e$4.set(n,[o]);}return e$4.get(n)};
  ...
  const r$8=[],o$6=t=>r$8.some(s=>t.startsWith(s));

  const t$5=new WeakMap,n$9=(e,o,r)=>{const s=new MutationObserver(o);t$5.set(e,s),s.observe(e,r);},b$3=e=>{const o=t$5.get(e);o&&(o.disconnect(),t$5.delete(e));};

  const r$7=t=>t.matches(":dir(rtl)")?"rtl":"ltr";

  const s$6=["disabled","title","hidden","role","draggable"],r$6=e=>s$6.includes(e)||e.startsWith("aria")?true:![HTMLElement,Element,Node].some(t=>t.prototype.hasOwnProperty(e));
  ...
  const o$5=t=>{s$5(t)&&e$3(t);},e$3=t=>{if(t._internals?.form){if(n$6(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},n$6=async t=>{if(t._internals?.form)if(t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},s$5=t=>"formFormattedValue"in t&&"name"in t;

  const t$4=typeof document>"u",o$4=()=>{if(t$4)return a$e;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$e};
  ...
  const r$4=new Map,n$4=t=>(r$4.has(t)||r$4.set(t,new r$5(t)),r$4.get(t)),c$4=t=>{try{if(t&&typeof t=="string")return n$4(t)}catch{}return new r$5(r$i)},s$4=t=>{const e=l$9();return e?n$4(e):c$4(o$4())};

  const _$3=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$3=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$5={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$2=i=>{let e;if(!i)return r$i;if(typeof i=="string"&&(e=_$3.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$5[t]||t,o&&(e=c$3.exec(o))||r&&(e=c$3.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$i};

  const r$3={zh_HK:"zh_TW",in:"id"},n$3=t=>{if(!t)return r$i;if(r$3[t])return r$3[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$i?r$i:""};

  const d$3=new Set,m$3=new Set,g$3=new Map,l$4=new Map,u$5=new Map,f$4=(n,t)=>{g$3.set(n,t);},A$2=n=>g$3.get(n),h$2=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$2=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$4.get(e)&&l$4.set(e,r(t)),l$4.get(e)},M$2=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$2=(n,t)=>t!==a$e&&!h$2(n,t),w$2=async n=>{const t=s$4().getLanguage(),e=s$4().getRegion(),r=s$4().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$2(s);L$2(n,s);)s=n$3(s);const I=h$3();if(s===a$e&&!I){f$4(n,null);return}if(!h$2(n,s)){M$2(n);return}try{const o=await B$2(n,s);f$4(n,o);}catch(o){const a=o;m$3.has(a.message)||(m$3.add(a.message),console.error(a.message));}};t$7(n=>{const t=[...g$3.keys()];return Promise.all(t.map(w$2))});
  ...
  const scopingRules = m$9();
  scopingRules.include.push(/^luigi-container$/);
  scopingRules.include.push(/^luigi-compound-container$/);
  p$6(scopingRules);
