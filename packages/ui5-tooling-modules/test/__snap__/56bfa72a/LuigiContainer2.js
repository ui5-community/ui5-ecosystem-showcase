sap.ui.define(['require', 'exports'], (function (require, exports) { 'use strict';
  ...
  var c$f={},e$h=c$f.hasOwnProperty,a$f=c$f.toString,o$h=e$h.toString,l$g=o$h.call(Object),i$j=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$g):true)};

  var c$e=Object.create(null),u$d=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$e;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$j(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$j(n)?n:{},r[a]=u$d(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$g=function(n,t){return u$d(true,false,...arguments)};

  const e$f=new Map,s$n=(t,r)=>{e$f.set(t,r);},n$l=t=>e$f.get(t);

  const _$3={themes:{default:"sap_horizon"},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$e=_$3.themes.default,a$e=_$3.languages.default,r$l=_$3.locales.default,l$f=_$3.locales.all;

  const o$g=typeof document>"u",n$k={search(){return o$g?"":window.location.search}},s$m=()=>o$g?"":window.location.href,u$c=()=>n$k.search();

  const s$l=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$f=e=>{const t=s$l("sap-allowed-theme-origins")??s$l("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$d=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$a=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$m()).toString();else {const n=new URL(e),r=n.origin;r&&o$f(r)?t=n.toString():t=a$d(n.toString(),s$m());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  const e$d=new i$i,t$n="configurationReset",i$h=n=>{e$d.attachEvent(t$n,n);};

  let p$5=false,t$m={animationMode:u$b.Full,theme:e$e,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const T$4=()=>(o$e(),t$m.theme),S$6=()=>{if(o$e(),t$m.themeRoot!==void 0){if(!g$a(t$m.themeRoot)){console.warn(`The ${t$m.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$m.themeRoot}},L$6=()=>(o$e(),t$m.language),R$3=()=>(o$e(),t$m.fetchDefaultLanguage),F$1=()=>(o$e(),t$m.noConflict),U$3=()=>(o$e(),t$m.defaultFontLoading),M$4=()=>(o$e(),t$m.formatSettings),i$g=new Map;i$g.set("true",true),i$g.set("false",false);const w$8=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$m=e$g(t$m,e));}},z$2=()=>{const n=new URLSearchParams(u$c());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$9(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$9(r,e,"sap-ui");});},E$4=n=>{const e=n.split("@")[1];return g$a(e)},P$3=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$9=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$g.has(e)&&(e=i$g.get(a)),s==="theme"?(t$m.theme=P$3(s,e),e&&e.includes("@")&&(t$m.themeRoot=E$4(e))):t$m[s]=e;},j$1=()=>{const n=n$l("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$m=e$g(t$m,e);},o$e=()=>{typeof document>"u"||p$5||(l$e(),p$5=true);},l$e=n=>{w$8(),z$2(),j$1();};
  ...
  let t$l;let a$c = class a{static getLegacyDateCalendarCustomizing(){return t$l===void 0&&(t$l=M$4()),t$l.legacyDateCalendarCustomizing||[]}};s$n("LegacyDateFormats",a$c);

  i$h(()=>{});const i$f=n$l("LegacyDateFormats");i$f?a$c.getLegacyDateCalendarCustomizing:()=>[];
  ...
  const o$d=(t,n=document.body,r)=>{let e=document.querySelector(t);return e||(e=r?r():document.createElement(t),n.insertBefore(e,n.firstChild))};

  const u$a=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$c=()=>typeof document>"u"?null:o$d('meta[name="ui5-shared-resources"]',document.head,u$a),m$b=(t,o)=>{const r=t.split(".");let e=l$c();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$c={version:"2.20.0",major:2,minor:20,patch:0,suffix:"",isNext:false,buildTime:1772704608};

  let s$j,t$k={include:[/^ui5-/],exclude:[]};const o$c=new Map,c$d=()=>s$j,m$a=()=>t$k,i$e=e=>{if(!o$c.has(e)){const n=t$k.include.some(r=>e.match(r))&&!t$k.exclude.some(r=>e.match(r));o$c.set(e,n);}return o$c.get(e)},d$a=e=>{if(i$e(e))return c$d()};

  let i$d,s$i="";const u$9=new Map,r$k=m$b("Runtimes",[]),x$2=()=>{if(i$d===void 0){i$d=r$k.length;const e=e$c;r$k.push({...e,get scopingSuffix(){return c$d()},get registeredTags(){return T$3()},get scopingRules(){return m$a()},alias:s$i,description:`Runtime ${i$d} - ver ${e.version}${""}`});}},I$4=()=>i$d,b$6=(e,m)=>{const o=`${e},${m}`;if(u$9.has(o))return u$9.get(o);const t=r$k[e],n=r$k[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$9.set(o,l),l},$$3=()=>r$k;

  const g$8=m$b("Tags",new Map),d$9=new Set;let i$c=new Map,c$c;const m$9=-1,h$7=e=>{d$9.add(e),g$8.set(e,I$4());},w$7=e=>d$9.has(e),T$3=()=>[...d$9.values()],$$2=e=>{let n=g$8.get(e);n===void 0&&(n=m$9),i$c.has(n)||i$c.set(n,new Set),i$c.get(n).add(e),c$c||(c$c=setTimeout(()=>{y$7(),i$c=new Map,c$c=void 0;},1e3));},y$7=()=>{const e=$$3(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$c.keys()].forEach(s=>{let o,r;s===m$9?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${i$c.get(s).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...i$c.get(s)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$j=new Set,n$j=e=>{t$j.add(e);},r$j=e=>t$j.has(e);

  const s$h=new Set,d$8=new i$i,n$i=new l$d;let t$i,a$b,m$8,i$b;const l$b=async e=>{n$i.add(e),await P$2();},c$b=e=>{d$8.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$6=e=>{n$i.remove(e),s$h.delete(e);},P$2=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$i.process(c$b),i$b=null,e(),m$8||(m$8=setTimeout(()=>{m$8=void 0,n$i.isEmpty()&&U$2();},200));});})),await i$b;},y$6=()=>t$i||(t$i=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$i.isEmpty()&&(t$i=void 0,e());});}),t$i),I$3=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$9=async()=>{await I$3(),await y$6();},U$2=()=>{n$i.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$i=void 0);},C$3=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$j(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$b(r);}),await f$9();};

  const g$7=typeof document>"u",i$a=(e,t)=>t?`${e}|${t}`:e,l$a=e=>e===void 0?true:b$6(I$4(),parseInt(e))>=1,c$a=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$a(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$5=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$a(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$a(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$5=(e,t="")=>g$7?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$a(e,t)),f$8=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$a(e,t));},R$2=(e,t,r="",s)=>{S$5(t,r)?y$5(e,t,r,s):c$a(e,t,r,s);},m$7=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$h=new i$i,r$i="themeRegistered",n$h=e=>{t$h.attachEvent(r$i,e);};

  const l$9=new Map,T$2=new Map,h$5=new Map,u$8=new Map,a$a=new Set,L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$9.get(s);if(o!==void 0)return o;if(!a$a.has(r)){const p=[...a$a.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$e}. Registered themes are: ${p}`),c$9(e,e$e)}const[n,g]=await Promise.all([c$9(e,r),t?c$9(e,t,true):void 0]),i=m$7(n,g);return i&&l$9.set(s,i),i},c$9=async(e,r,t=false)=>{const o=(t?h$5:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$6=()=>u$8,w$6=e=>a$a.has(e);

  const r$h=new Set,s$g=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$b=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$h.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$h.add("decode"));return}try{return JSON.parse(a)}catch{r$h.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$h.add("parse"));}}},d$7=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$h.has("object")||(console.warn("Malformed theme metadata Object",e),r$h.add("object"));return}return {themeName:t,baseThemeName:a}},m$5=()=>{const e=s$g();if(!e||e==="none")return;const t=o$b(e);if(t)return d$7(t)};

  const t$g=new i$i,d$6="themeLoaded",r$g=e=>t$g.fireEvent(d$6,e);
  ...
  let t$f;i$h(()=>{t$f=void 0;});const n$g=()=>(t$f===void 0&&(t$f=S$6()),t$f),u$7=e=>`${n$g()}Base/baseLib/${e}/css_variables.css`,i$9=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$5(u$7(e),{"sap-ui-webcomponents-theme":e});};

  const t$e=new Map;let e$b;const n$f=()=>(e$b||(e$b=new CSSStyleSheet),e$b),r$f=(o,s)=>{t$e.set(o,s);const S=Array.from(t$e.values()).join(`
`);n$f().replaceSync(S);};

  let _lib="ui5",_package="webcomponents-theming";const a$9="@"+_lib+"/"+_package,E$3=()=>m$6().has(a$9),U$1=async e=>{if(!E$3())return;const t=await L$5(a$9,e);t&&R$2(t,"data-ui5-theme-properties",a$9,e);},w$5=()=>{f$8("data-ui5-theme-properties",a$9);},I$2=async(e,t)=>{const o=[...m$6().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$9)return;const i=await L$5(s,e,t);i&&(n==="root"?R$2(i,`data-ui5-component-properties-${I$4()}`,s):n==="host"&&r$f(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$5();if(t)return t;const r=n$l("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$g())return await i$9(e),m$5()},b$5=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U$1(e):w$5();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$6(e)?e:o||e$e;await I$2(s,r),w$3(o),r$g(e);};

  const d$4=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$e = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$a;i$h(()=>{o$a=void 0;});const a$8=()=>(o$a===void 0&&(o$a=U$3()),o$a);

  const a$7=()=>{const t=n$l("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$7();},f$7=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$8()||t||S$5("data-ui5-font-face")||c$a(n$e,"data-ui5-font-face");};

  var s$f = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

  const r$e=()=>{R$2(s$f,"data-ui5-system-css-vars");};

  var t$d = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

  const s$e=()=>{S$5("data-ui5-scrollbar-styles")||c$a(t$d,"data-ui5-scrollbar-styles");};

  const t$c=typeof document>"u",e$a={get userAgent(){return t$c?"":navigator.userAgent},get chrome(){return t$c?false:/(Chrome|CriOS)/.test(e$a.userAgent)},get safari(){return t$c?false:!e$a.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$a.userAgent)},get iOS(){return t$c?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$a.userAgent.match(/Mac/)&&"ontouchend"in document)}};const h$4=()=>e$a.safari,w$4=()=>e$a.iOS;

  let t$b=false;const i$8=()=>{h$4()&&w$4()&&!t$b&&(document.body.addEventListener("touchstart",()=>{}),t$b=true);};

  let r$d=false,i$7,p$4=false;const m$4=new i$i,f$6=async()=>{const t=n$l("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$l("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$8=()=>{if(p$4)return;const t=n$l("OpenUI5Support");t&&(p$4=t.attachListeners());},u$6=async()=>{if(i$7!==void 0)return i$7;const t=async e=>{if(x$2(),typeof document>"u"){e();return}n$h(b$4),await f$6(),await d$4(),await b$5(r$c()),c$8(),a$7(),r$e(),s$e(),i$8(),e(),r$d=true,m$4.fireEvent("boot");};return i$7=new Promise(t),i$7},b$4=t=>{if(!r$d)return;const e=r$c(),o=E$2();(t===e||t===o)&&b$5(e);};

  let t$a,n$d;i$h(()=>{t$a=void 0;});const r$c=()=>(t$a===void 0&&(t$a=T$4()),t$a),E$2=()=>n$d,w$3=e=>{n$d=e;};
  ...
  const r$8=new Map;let u$4 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$5=n=>{if(r$8.has(n))return r$8.get(n);const e=new u$4(n);return r$8.set(n,e),e},f$3=async n=>(await w$2(n),a$5(n));

  const c$5=["value-changed","click"];let e$7;i$h(()=>{e$7=void 0;});const s$a=t=>c$5.includes(t),l$6=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$7===void 0&&(e$7=F$1()),e$7),a$4=t=>{const n=o$8();return s$a(t)?false:n===true?true:!l$6(t)};
  ...
  const s$9=new Map,o$7=new Map,n$8=new Map,c$4=e=>{if(!s$9.has(e)){const a=b$3(e.split("-"));s$9.set(e,a);}return s$9.get(e)},l$4=e=>{if(!o$7.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$7.set(e,a);}return o$7.get(e)},b$3=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$2=e=>{const a=n$8.get(e);if(a)return a;const t=c$4(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$8.set(e,r),r};

  const o$6=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$7=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$8=t=>t.reduce((e,r)=>e.concat(n$7(r)),[]);
  ...
  const r$6=()=>m$b("CustomStyle.eventProvider",new i$i),n$6="CustomCSSChange",i$5=t=>{r$6().attachEvent(n$6,t);},c$3=()=>m$b("CustomStyle.customCSSFor",{});i$5(t=>{C$3({tag:t});});const l$3=t=>{const e=c$3();return e[t]?e[t].join(""):""};

  const e$6=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$5=new Map;i$5(t=>{e$5.delete(`${t}_normal`);});const y$4=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$l("OpenUI5Enablement");if(!e$5.has(n)){let l="";s&&(l=e$6(s.getBusyIndicatorStyles()));const a=l$3(o)||"",m=`${e$6(t.styles)} ${a} ${l}`;e$5.set(n,m);}return e$5.get(n)};

  const e$4=new Map;i$5(t=>{e$4.delete(`${t}_normal`);});const s$7=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$4.has(n)){const a=y$4(t),o=new CSSStyleSheet;o.replaceSync(a),e$4.set(n,[o]);}return e$4.get(n)};

  const s$6=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$f(),...s$7(e)],e.renderer(o,t);};

  const r$5=[],o$5=t=>r$5.some(s=>t.startsWith(s));

  const t$4=new WeakMap,n$5=(e,o,r)=>{const s=new MutationObserver(o);t$4.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$4.get(e);o&&(o.disconnect(),t$4.delete(e));};
