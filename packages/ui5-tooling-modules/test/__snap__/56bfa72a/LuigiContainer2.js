sap.ui.define(['require', 'exports'], (function (require, exports) { 'use strict';
  ...
  let t$i;let a$b = class a{static getLegacyDateCalendarCustomizing(){return t$i===void 0&&(t$i=M$3()),t$i.legacyDateCalendarCustomizing||[]}};s$m("LegacyDateFormats",a$b);
  ...
  const e$d={version:"2.8.0",major:2,minor:8,patch:0,suffix:"",isNext:false,buildTime:1741075456};

  let s$i,t$h={include:[/^ui5-/],exclude:[]};const o$d=new Map,c$d=()=>s$i,m$9=()=>t$h,i$d=e=>{if(!o$d.has(e)){const n=t$h.include.some(r=>e.match(r))&&!t$h.exclude.some(r=>e.match(r));o$d.set(e,n);}return o$d.get(e)},g$7=e=>{if(i$d(e))return c$d()};

  let i$c,s$h="";const u$8=new Map,r$g=m$a("Runtimes",[]),x$2=()=>{if(i$c===void 0){i$c=r$g.length;const e=e$d;r$g.push({...e,get scopingSuffix(){return c$d()},get registeredTags(){return T$3()},get scopingRules(){return m$9()},alias:s$h,description:`Runtime ${i$c} - ver ${e.version}${""}`});}},I$5=()=>i$c,b$6=(e,m)=>{const o=`${e},${m}`;if(u$8.has(o))return u$8.get(o);const t=r$g[e],n=r$g[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$8.set(o,l),l},$$3=()=>r$g;

  const g$6=m$a("Tags",new Map),d$a=new Set;let s$g=new Map,c$c;const m$8=-1,h$6=e=>{d$a.add(e),g$6.set(e,I$5());},w$6=e=>d$a.has(e),T$3=()=>[...d$a.values()],$$2=e=>{let n=g$6.get(e);n===void 0&&(n=m$8),s$g.has(n)||s$g.set(n,new Set),s$g.get(n).add(e),c$c||(c$c=setTimeout(()=>{y$6(),s$g=new Map,c$c=void 0;},1e3));},y$6=()=>{const e=$$3(),n=I$5(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(i=>`
${i.description}`).join("")}`),[...s$g.keys()].forEach(i=>{let o,r;i===m$8?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,i),r=e[i]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$f=new Set,d$9=new i$h,n$h=new l$e;let t$f,a$a,m$7,i$b;const l$c=async e=>{n$h.add(e),await P$4();},c$b=e=>{d$9.fireEvent("beforeComponentRender",e),s$f.add(e),e._render();},h$5=e=>{n$h.remove(e),s$f.delete(e);},P$4=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$h.process(c$b),i$b=null,e(),m$7||(m$7=setTimeout(()=>{m$7=void 0,n$h.isEmpty()&&U$2();},200));});})),await i$b;},y$5=()=>t$f||(t$f=new Promise(e=>{a$a=e,window.requestAnimationFrame(()=>{n$h.isEmpty()&&(t$f=void 0,e());});}),t$f),I$4=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$7=async()=>{await I$4(),await y$5();},U$2=()=>{n$h.isEmpty()&&a$a&&(a$a(),a$a=void 0,t$f=void 0);},C$4=async e=>{s$f.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$f(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$7();};

  const g$5=typeof document>"u",i$a=(e,t)=>t?`${e}|${t}`:e,l$b=e=>e===void 0?true:b$6(I$5(),parseInt(e))===1,c$a=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$a(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$a(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$b(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$5?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$a(e,t)),f$6=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$a(e,t));},R$4=(e,t,r="",s)=>{S$4(t,r)?y$4(e,t,r,s):c$a(e,t,r,s);},m$6=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$e=new i$h,r$e="themeRegistered",n$g=e=>{t$e.attachEvent(r$e,e);};

  const l$a=new Map,h$4=new Map,u$7=new Map,T$2=new Set,i$9=new Set,m$5=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$a.get(g);if(s!==void 0)return s;if(!i$9.has(r)){const $=[...i$9.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$9(e,e$f)}const[n,d]=await Promise.all([a$9(e,r),t?a$9(e,t,true):void 0]),o=m$6(n,d);return o&&l$a.set(g,o),o},a$9=async(e,r,t=false)=>{const s=(t?u$7:h$4).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$3=e=>i$9.has(e);
  ...
  let t$c;i$g(()=>{t$c=void 0;});const n$f=()=>(t$c===void 0&&(t$c=S$5()),t$c),u$6=e=>`${n$f()}Base/baseLib/${e}/css_variables.css`,i$8=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$6(u$6(e),{"sap-ui-webcomponents-theme":e});};

  const s$d="@ui5/webcomponents-theming",S$3=()=>w$5().has(s$d),P$2=async e=>{if(!S$3())return;const t=await m$5(s$d,e);t&&R$4(t,"data-ui5-theme-properties",s$d,e);},E$2=()=>{f$6("data-ui5-theme-properties",s$d);},U$1=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$d)return;const i=await m$5(a,e,t);i&&R$4(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$4();if(t)return t;const r=n$l("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$f())return await i$8(e),m$4()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$2(e):E$2();const r=P$3(e)?e:t&&t.baseThemeName;await U$1(r||e$f,t&&t.themeName===e?e:void 0),r$c(e);};
  ...
  let o$b;i$g(()=>{o$b=void 0;});const a$7=()=>(o$b===void 0&&(o$b=b$7()),o$b);

  const i$7=()=>{const t=n$l("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$9();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$7()||t||S$4("data-ui5-font-face")||c$a(a$8,"data-ui5-font-face");},c$9=()=>{S$4("data-ui5-font-face-override")||c$a(n$e,"data-ui5-font-face-override");};
  ...
  const e$c=()=>{S$4("data-ui5-system-css-vars")||c$a(a$6,"data-ui5-system-css-vars");};
  ...
  let o$a=false,r$b;const p$4=new i$h,l$9=async()=>{if(r$b!==void 0)return r$b;const e=async n=>{if(x$2(),typeof document>"u"){n();return}n$g(b$5);const t=n$l("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$l("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$5(),await I$3(r$a()),t&&t.attachListeners(),i$7(),e$c(),i$6(),n(),o$a=true,p$4.fireEvent("boot");};return r$b=new Promise(e),r$b},b$5=e=>{o$a&&e===r$a()&&I$3(r$a());};

  let t$9;i$g(()=>{t$9=void 0;});const r$a=()=>(t$9===void 0&&(t$9=T$4()),t$9);
  ...
  let e$9,n$c;i$g(()=>{e$9=void 0,n$c=void 0;});const d$4=()=>(e$9===void 0&&(e$9=L$3()),e$9),c$8=()=>(n$c===void 0&&(n$c=F$1()),n$c);

  const c$7=["value-changed","click"];let e$8;i$g(()=>{e$8=void 0;});const s$b=t=>c$7.includes(t),l$8=t=>{const n=o$9();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$9=()=>(e$8===void 0&&(e$8=U$3()),e$8),a$5=t=>{const n=o$9();return s$b(t)?false:n===true?true:!l$8(t)};
  ...
  const s$a=new Map,o$8=new Map,n$b=new Map,c$6=e=>{if(!s$a.has(e)){const a=b$4(e.split("-"));s$a.set(e,a);}return s$a.get(e)},l$6=e=>{if(!o$8.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$8.set(e,a);}return o$8.get(e)},b$4=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$3=e=>{const a=n$b.get(e);if(a)return a;const t=c$6(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$b.set(e,r),r};
  ...
  const t$5=new WeakMap,n$8=(e,o,r)=>{const s=new MutationObserver(o);t$5.set(e,s),s.observe(e,r);},b$3=e=>{const o=t$5.get(e);o&&(o.disconnect(),t$5.delete(e));};
  ...
  const _$3=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$3=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$5={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$2=i=>{let e;if(!i)return r$h;if(typeof i=="string"&&(e=_$3.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$5[t]||t,o&&(e=c$3.exec(o))||r&&(e=c$3.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$h};
