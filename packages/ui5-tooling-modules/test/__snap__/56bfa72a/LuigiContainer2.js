sap.ui.define(['require', 'exports'], (function (require, exports) { 'use strict';
  ...
  var c$f={},e$i=c$f.hasOwnProperty,a$e=c$f.toString,o$i=e$i.toString,l$f=o$i.call(Object),i$i=function(r){var t,n;return !r||a$e.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$i.call(n)===l$f):true)};
  ...
  const e$h=function(n,t){return u$d(true,false,...arguments)};

  const e$g=new Map,s$m=(t,r)=>{e$g.set(t,r);},n$l=t=>e$g.get(t);

  const _$4={themes:{default:"sap_horizon"},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$f=_$4.themes.default,a$d=_$4.languages.default,r$h=_$4.locales.default,n$k=_$4.locales.all;

  const o$h=typeof document>"u",n$j={search(){return o$h?"":window.location.search}},s$l=()=>o$h?"":window.location.href,u$c=()=>n$j.search();

  const o$g=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},s$k=e=>{const t=o$g("sap-allowedThemeOrigins");return t&&t.split(",").some(n=>n==="*"||e===n.trim())},a$c=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$8=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$l()).toString();else {const n=new URL(e),r=n.origin;r&&s$k(r)?t=n.toString():t=a$c(n.toString(),s$l());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  const e$e=new i$h,t$k="configurationReset",i$g=n=>{e$e.attachEvent(t$k,n);};

  let p$7=false,t$j={animationMode:u$b.Full,theme:e$f,themeRoot:undefined,rtl:undefined,language:undefined,timezone:undefined,calendarType:undefined,secondaryCalendarType:undefined,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const T$4=()=>(o$f(),t$j.theme),S$6=()=>(o$f(),t$j.themeRoot),L$3=()=>(o$f(),t$j.language),F$1=()=>(o$f(),t$j.fetchDefaultLanguage),U$3=()=>(o$f(),t$j.noConflict),b$6=()=>(o$f(),t$j.defaultFontLoading),M$3=()=>(o$f(),t$j.formatSettings),i$f=new Map;i$f.set("true",true),i$f.set("false",false);const z$2=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$j=e$h(t$j,e));}},E$3=()=>{const n=new URLSearchParams(u$c());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||u$a(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&u$a(a,e,"sap-ui");});},P$5=n=>{const e=n.split("@")[1];return g$8(e)},w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,u$a=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$f.has(e)&&(e=i$f.get(r)),s==="theme"?(t$j.theme=w$7(s,e),e&&e.includes("@")&&(t$j.themeRoot=P$5(e))):t$j[s]=e;},j$1=()=>{const n=n$l("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$j=e$h(t$j,e);},o$f=()=>{typeof document>"u"||p$7||(g$7(),p$7=true);},g$7=n=>{z$2(),E$3(),j$1();};

  i$g(()=>{});

  var s$j=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$j||{});

  i$g(()=>{});

  let t$i;let a$b = class a{static getLegacyDateCalendarCustomizing(){return t$i===undefined&&(t$i=M$3()),t$i.legacyDateCalendarCustomizing||[]}};s$m("LegacyDateFormats",a$b);

  i$g(()=>{});const i$e=n$l("LegacyDateFormats");i$e?a$b.getLegacyDateCalendarCustomizing:()=>[];
  ...
  const u$9=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$d=()=>typeof document>"u"?null:o$e('meta[name="ui5-shared-resources"]',document.head,u$9),m$a=(t,o)=>{const r=t.split(".");let e=l$d();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$d={version:"2.7.0",major:2,minor:7,patch:0,suffix:"",isNext:false,buildTime:1738589223};

  let o$d,t$h={include:[/^ui5-/],exclude:[]};const s$i=new Map,c$d=()=>o$d,m$9=()=>t$h,i$d=e=>{if(!s$i.has(e)){const r=t$h.include.some(n=>e.match(n))&&!t$h.exclude.some(n=>e.match(n));s$i.set(e,r);}return s$i.get(e)},p$6=e=>{if(i$d(e))return c$d()};

  let i$c,s$h="";const u$8=new Map,r$g=m$a("Runtimes",[]),x$2=()=>{if(i$c===undefined){i$c=r$g.length;const e=e$d;r$g.push({...e,get scopingSuffix(){return c$d()},get registeredTags(){return $$2()},get scopingRules(){return m$9()},alias:s$h,description:`Runtime ${i$c} - ver ${e.version}${""}`});}},I$5=()=>i$c,b$5=(e,m)=>{const o=`${e},${m}`;if(u$8.has(o))return u$8.get(o);const t=r$g[e],n=r$g[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(undefined,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$8.set(o,l),l},$$3=()=>r$g;

  const m$8=m$a("Tags",new Map),d$a=new Set;let s$g=new Map,c$c;const g$6=-1,h$6=e=>{d$a.add(e),m$8.set(e,I$5());},w$6=e=>d$a.has(e),$$2=()=>[...d$a.values()],y$6=e=>{let n=m$8.get(e);n===undefined&&(n=g$6),s$g.has(n)||s$g.set(n,new Set),s$g.get(n).add(e),c$c||(c$c=setTimeout(()=>{R$4(),s$g=new Map,c$c=undefined;},1e3));},R$4=()=>{const e=$$3(),n=I$5(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(i=>`
${i.description}`).join("")}`),[...s$g.keys()].forEach(i=>{let o,r;i===g$6?(o=1,r={description:"Older unknown runtime"}):(o=b$5(n,i),r=e[i]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${s$g.get(i).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...s$g.get(i)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$g=new Set,n$i=e=>{t$g.add(e);},r$f=e=>t$g.has(e);

  const s$f=new Set,d$9=new i$h,n$h=new l$e;let t$f,a$a,m$7,i$b;const l$c=async e=>{n$h.add(e),await P$4();},c$b=e=>{d$9.fireEvent("beforeComponentRender",e),s$f.add(e),e._render();},h$5=e=>{n$h.remove(e),s$f.delete(e);},P$4=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$h.process(c$b),i$b=null,e(),m$7||(m$7=setTimeout(()=>{m$7=undefined,n$h.isEmpty()&&U$2();},200));});})),await i$b;},y$5=()=>t$f||(t$f=new Promise(e=>{a$a=e,window.requestAnimationFrame(()=>{n$h.isEmpty()&&(t$f=undefined,e());});}),t$f),I$4=()=>{const e=$$2().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$7=async()=>{await I$4(),await y$5();},U$2=()=>{n$h.isEmpty()&&a$a&&(a$a(),a$a=undefined,t$f=undefined);},C$4=async e=>{s$f.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$f(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$7();};

  const g$5=typeof document>"u",i$a=(e,t)=>t?`${e}|${t}`:e,l$b=e=>e===undefined?true:b$5(I$5(),parseInt(e))===1,c$a=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$a(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$a(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$b(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$5=(e,t="")=>g$5?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$a(e,t)),f$6=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$a(e,t));},R$3=(e,t,r="",s)=>{S$5(t,r)?y$4(e,t,r,s):c$a(e,t,r,s);},m$6=(e,t)=>e===undefined?t:t===undefined?e:`${e} ${t}`;

  const t$e=new i$h,r$e="themeRegistered",n$g=e=>{t$e.attachEvent(r$e,e);};

  const l$a=new Map,h$4=new Map,u$7=new Map,T$3=new Set,i$9=new Set,m$5=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$a.get(g);if(s!==undefined)return s;if(!i$9.has(r)){const $=[...i$9.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$9(e,e$f)}const[n,d]=await Promise.all([a$9(e,r),t?a$9(e,t,true):undefined]),o=m$6(n,d);return o&&l$a.set(g,o),o},a$9=async(e,r,t=false)=>{const s=(t?u$7:h$4).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$3,P$3=e=>i$9.has(e);

  const r$d=new Set,s$e=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$c=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$d.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$d.add("decode"));return}try{return JSON.parse(a)}catch{r$d.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$d.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$d.has("object")||(console.warn("Malformed theme metadata Object",e),r$d.add("object"));return}return {themeName:t,baseThemeName:a}},m$4=()=>{const e=s$e();if(!e||e==="none")return;const t=o$c(e);if(t)return d$8(t)};

  const t$d=new i$h,d$7="themeLoaded",r$c=e=>t$d.fireEvent(d$7,e);
  ...
  let t$c;i$g(()=>{t$c=undefined;});const n$f=()=>(t$c===undefined&&(t$c=S$6()),t$c),u$6=e=>`${n$f()}Base/baseLib/${e}/css_variables.css`,i$8=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$6(u$6(e),{"sap-ui-webcomponents-theme":e});};

  const s$d="@ui5/webcomponents-theming",S$4=()=>w$5().has(s$d),P$2=async e=>{if(!S$4())return;const t=await m$5(s$d,e);t&&R$3(t,"data-ui5-theme-properties",s$d,e);},E$2=()=>{f$6("data-ui5-theme-properties",s$d);},U$1=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$d)return;const i=await m$5(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$4();if(t)return t;const r=n$l("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$f())return await i$8(e),m$4()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$2(e):E$2();const r=P$3(e)?e:t&&t.baseThemeName;await U$1(r||e$f,t&&t.themeName===e?e:undefined),r$c(e);};
  ...
  var n$e = "@font-face{font-family:'72override';unicode-range:U+0102-0103,U+01A0-01A1,U+01AF-01B0,U+1EA0-1EB7,U+1EB8-1EC7,U+1EC8-1ECB,U+1ECC-1EE3,U+1EE4-1EF1,U+1EF4-1EF7;src:local('Arial'),local('Helvetica'),local('sans-serif')}";

  let o$b;i$g(()=>{o$b=undefined;});const a$7=()=>(o$b===undefined&&(o$b=b$6()),o$b);

  const i$7=()=>{const t=n$l("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$9();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$7()||t||S$5("data-ui5-font-face")||c$a(a$8,"data-ui5-font-face");},c$9=()=>{S$5("data-ui5-font-face-override")||c$a(n$e,"data-ui5-font-face-override");};
  ...
  const e$c=()=>{S$5("data-ui5-system-css-vars")||c$a(a$6,"data-ui5-system-css-vars");};

  const t$b=typeof document>"u",e$b={get userAgent(){return t$b?"":navigator.userAgent},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$b.userAgent)},get safari(){return t$b?false:!e$b.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$b.userAgent)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$b.userAgent.match(/Mac/)&&"ontouchend"in document)}};const h$3=()=>e$b.safari,w$3=()=>e$b.iOS;

  let t$a=false;const i$6=()=>{h$3()&&w$3()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

  let o$a=false,r$b;const p$4=new i$h,l$9=async()=>{if(r$b!==undefined)return r$b;const e=async n=>{if(x$2(),typeof document>"u"){n();return}n$g(b$4);const t=n$l("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$l("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$5(),await I$3(r$a()),t&&t.attachListeners(),i$7(),e$c(),i$6(),n(),o$a=true,p$4.fireEvent("boot");};return r$b=new Promise(e),r$b},b$4=e=>{o$a&&e===r$a()&&I$3(r$a());};

  let t$9;i$g(()=>{t$9=undefined;});const r$a=()=>(t$9===undefined&&(t$9=T$4()),t$9);

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$c=new Map;s$c.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$c.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$c.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});

  var t$7=(s=>(s["SAP-icons"]="SAP-icons-v4",s.horizon="SAP-icons-v5",s["SAP-icons-TNT"]="tnt",s.BusinessSuiteInAppSymbols="business-suite",s))(t$7||{});

  const e$a=new i$h,n$d="languageChange",t$6=a=>{e$a.attachEvent(n$d,a);};

  let e$9,n$c;i$g(()=>{e$9=undefined,n$c=undefined;});const d$4=()=>(e$9===undefined&&(e$9=L$3()),e$9),c$8=()=>(n$c===undefined&&(n$c=F$1()),n$c);

  const c$7=["value-changed","click"];let e$8;i$g(()=>{e$8=undefined;});const s$b=t=>c$7.includes(t),l$8=t=>{const n=o$9();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$9=()=>(e$8===undefined&&(e$8=U$3()),e$8),a$5=t=>{const n=o$9();return s$b(t)?false:n===true?true:!l$8(t)};
  ...
  const o$5=t=>{s$5(t)&&e$4(t);},e$4=t=>{if(t._internals?.form){if(n$5(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},n$5=async t=>{if(t._internals?.form)if(t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},s$5=t=>"formFormattedValue"in t&&"name"in t;

  const t$4=typeof document>"u",o$4=()=>{if(t$4)return a$d;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$d};
  ...
  const r$3=new Map,n$3=t=>(r$3.has(t)||r$3.set(t,new r$4(t)),r$3.get(t)),c$4=t=>{try{if(t&&typeof t=="string")return n$3(t)}catch{}return new r$4(r$h)},s$4=t=>{const e=d$4();return e?n$3(e):c$4(o$4())};

  const _$3=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$3=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$5={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$2=i=>{let e;if(!i)return r$h;if(typeof i=="string"&&(e=_$3.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():undefined;const s=e[2]?e[2].toLowerCase():undefined,r=e[4]?e[4].slice(1):undefined,o=e[6];return t=f$5[t]||t,o&&(e=c$3.exec(o))||r&&(e=c$3.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$h};

  const e$3=r=>{if(!r)return r$h;if(r==="zh_HK")return "zh_TW";const n=r.lastIndexOf("_");return n>=0?r.slice(0,n):r!==r$h?r$h:""};

  const d$3=new Set,m$3=new Set,g$3=new Map,l$4=new Map,u$5=new Map,f$4=(n,t)=>{g$3.set(n,t);},A$2=n=>g$3.get(n),h$2=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$2=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$4.get(e)&&l$4.set(e,r(t)),l$4.get(e)},M$2=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$2=(n,t)=>t!==a$d&&!h$2(n,t),w$2=async n=>{const t=s$4().getLanguage(),e=s$4().getRegion(),r=s$4().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$2(s);L$2(n,s);)s=e$3(s);const I=c$8();if(s===a$d&&!I){f$4(n,null);return}if(!h$2(n,s)){M$2(n);return}try{const o=await B$2(n,s);f$4(n,o);}catch(o){const a=o;m$3.has(a.message)||(m$3.add(a.message),console.error(a.message));}};t$6(n=>{const t=[...g$3.keys()];return Promise.all(t.map(w$2))});
   ...
   */
  var t$3;const i$2=window,s$2=i$2.trustedTypes,e$2=s$2?s$2.createPolicy("lit-html",{createHTML:t=>t}):undefined,o$3="$lit$",n$2=`lit$${(Math.random()+"").slice(9)}$`,l$2="?"+n$2,h$1=`<${l$2}>`,r$1=document,u$2=()=>r$1.createComment(""),d$1=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$2=Array.isArray,v$1=t=>c$2(t)||"function"==typeof(null==t?undefined:t[Symbol.iterator]),a$3="[ \t\n\f\r]",f$1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$1=/-->/g,m$1=/>/g,p$1=RegExp(`>|${a$3}(?:([^\\s"'>=/]+)(${a$3}*=${a$3}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$1=/'/g,$$1=/"/g,y$1=/^(?:script|style|textarea|title)$/i,w$1=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$1=w$1(1),b$1=w$1(2),T$1=Symbol.for("lit-noChange"),A$1=Symbol.for("lit-nothing"),E$1=new WeakMap,C$1=r$1.createTreeWalker(r$1,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return undefined!==e$2?e$2.createHTML(i):i}const V$1=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$1;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$1?"!--"===c[1]?u=_$1:undefined!==c[1]?u=m$1:undefined!==c[2]?(y$1.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$1):undefined!==c[3]&&(u=p$1):u===p$1?">"===c[0]?(u=null!=l?l:f$1,v=-1):undefined===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=undefined===c[3]?p$1:'"'===c[3]?$$1:g$1):u===$$1||u===g$1?u=p$1:u===_$1||u===m$1?u=f$1:(u=p$1,l=undefined);const w=u===p$1&&t[i+1].startsWith("/>")?" ":"";r+=u===f$1?s+h$1:v>=0?(e.push(d),s.slice(0,v)+o$3+s.slice(v)+n$2+w):s+n$2+(-2===v?(e.push(undefined),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V$1(t,i);if(this.el=N.createElement(a,e),C$1.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$1.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$3)||i.startsWith(n$2)){const s=f[d++];if(t.push(i),undefined!==s){const t=h.getAttribute(s.toLowerCase()+o$3).split(n$2),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H$1:"?"===i[1]?L$1:"@"===i[1]?z$1:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$1.test(h.tagName)){const t=h.textContent.split(n$2),i=t.length-1;if(i>0){h.textContent=s$2?s$2.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$2()),C$1.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$2());}}}else if(8===h.nodeType)if(h.data===l$2)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$2,t+1));)v.push({type:7,index:r}),t+=n$2.length-1;}r++;}}static createElement(t,i){const s=r$1.createElement("template");return s.innerHTML=t,s}};function S$2(t,i,s=t,e){var o,n,l,h;if(i===T$1)return i;let r=undefined!==e?null===(o=s._$Co)||undefined===o?undefined:o[e]:s._$Cl;const u=d$1(i)?undefined:i._$litDirective$;return (null==r?undefined:r.constructor)!==u&&(null===(n=null==r?undefined:r._$AO)||undefined===n||n.call(r,false),undefined===u?r=undefined:(r=new u(t),r._$AT(t,s,e)),undefined!==e?(null!==(l=(h=s)._$Co)&&undefined!==l?l:h._$Co=[])[e]=r:s._$Cl=r),undefined!==r&&(i=S$2(t,r._$AS(t,i.values),r,e)),i}let M$1 = class M{constructor(t,i){this._$AV=[],this._$AN=undefined,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?undefined:t.creationScope)&&undefined!==i?i:r$1).importNode(s,true);C$1.currentNode=o;let n=C$1.nextNode(),l=0,h=0,u=e[0];for(;undefined!==u;){if(l===u.index){let i;2===u.type?i=new R$1(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z$1(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?undefined:u.index)&&(n=C$1.nextNode(),l++);}return C$1.currentNode=r$1,o}v(t){let i=0;for(const s of this._$AV) undefined!==s&&(undefined!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$1 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$1,this._$AN=undefined,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?undefined:e.isConnected)||undefined===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||undefined===t?undefined:t._$AU)&&undefined!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return undefined!==i&&11===(null==t?undefined:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$2(this,t,i),d$1(t)?t===A$1||null==t||""===t?(this._$AH!==A$1&&this._$AR(),this._$AH=A$1):t!==this._$AH&&t!==T$1&&this._(t):undefined!==t._$litType$?this.g(t):undefined!==t.nodeType?this.$(t):v$1(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$1&&d$1(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$1.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(undefined===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||undefined===i?undefined:i._$AD)===o)this._$AH.v(s);else {const t=new M$1(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E$1.get(t.strings);return undefined===i&&E$1.set(t.strings,i=new N$1(t)),i}T(t){c$2(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$2()),this.k(u$2()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||undefined===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;undefined===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||undefined===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$1,this._$AN=undefined,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$1;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(undefined===o)t=S$2(this,t,i,0),n=!d$1(t)||t!==this._$AH&&t!==T$1,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$2(this,e[s+l],i,l),h===T$1&&(h=this._$AH[l]),n||(n=!d$1(h)||h!==this._$AH[l]),h===A$1?t=A$1:t!==A$1&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$1?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};let H$1 = class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$1?undefined:t;}};const I$1=s$2?s$2.emptyScript:"";let L$1 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$1?this.element.setAttribute(this.name,I$1):this.element.removeAttribute(this.name);}};let z$1 = class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$2(this,t,i,0))&&undefined!==s?s:A$1)===T$1)return;const e=this._$AH,o=t===A$1&&e!==A$1||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$1&&(e===A$1||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||undefined===i?undefined:i.host)&&undefined!==s?s:this.element,t):this._$AH.handleEvent(t);}};let Z$1 = class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=undefined,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$2(this,t);}};const B$1=i$2.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$1),(null!==(t$3=i$2.litHtmlVersions)&&undefined!==t$3?t$3:i$2.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$1=Symbol.for(""),l$1=t=>{if((null==t?undefined:t.r)===e$1)return null==t?undefined:t._$litStatic$},o$2=t=>({_$litStatic$:t,r:e$1}),s$1=new Map,a$2=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&undefined!==(a=e[$],i=l$1(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");undefined===(r=s$1.get(t))&&(n.raw=n,s$1.set(t,r=n)),e=u;}return t(r,...e)},n$1=a$2(x$1),u$1=a$2(b$1);

  let t$2 = class t{static{this.html=n$1;}static{this.svg=u$1;}static{this.unsafeStatic=o$2;}};s$m("LitStatic",t$2);
