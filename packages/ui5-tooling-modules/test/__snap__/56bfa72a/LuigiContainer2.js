sap.ui.define(['module', 'require', 'exports'], (function (module, require, exports) { 'use strict';
  ...
  const e$a={version:"2.21.1",major:2,minor:21,patch:1,suffix:"",isNext:false,buildTime:1776341110};
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const a$c=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},g$8=(e,t=false)=>{const n=a$c("sap-allowed-theme-origins")??a$c("sap-allowedThemeOrigins");return n?t?true:n.split(",").some(r=>r==="*"||e===r.trim()):false},l$8=e=>{let t,n=false;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$l()).toString(),n=!0;else {const r=new URL(e),i=r.origin,o=new URL(s$l()).origin;if(n=i===o,i&&g$8(i,n))t=r.toString();else return}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{return}};
...
`);n$g().replaceSync(S);};
  ...
  var n$f = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.34.1/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
