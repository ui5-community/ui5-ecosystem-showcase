sap.ui.define(['require', 'exports'], (function (require, exports) { 'use strict';
  ...
  var c$d={},e$h=c$d.hasOwnProperty,a$f=c$d.toString,o$i=e$h.toString,l$h=o$i.call(Object),i$i=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$i.call(n)===l$h):true)};

  var c$c=Object.create(null),u$c=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$c;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$i(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$i(n)?n:{},r[a]=u$c(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};
  ...
  const o$h=typeof document>"u",n$j={search(){return o$h?"":window.location.search}},s$m=()=>o$h?"":window.location.href,u$b=()=>n$j.search();
  ...
  let p$5=false,t$l={animationMode:u$a.Full,theme:e$e,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const T$4=()=>(o$f(),t$l.theme),S$5=()=>{if(o$f(),t$l.themeRoot!==void 0){if(!g$9(t$l.themeRoot)){console.warn(`The ${t$l.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$l.themeRoot}},L$3=()=>(o$f(),t$l.language),R$5=()=>(o$f(),t$l.fetchDefaultLanguage),F$2=()=>(o$f(),t$l.noConflict),U$3=()=>(o$f(),t$l.defaultFontLoading),M$3=()=>(o$f(),t$l.formatSettings),i$f=new Map;i$f.set("true",true),i$f.set("false",false);const w$7=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$l=e$g(t$l,e));}},z$2=()=>{const n=new URLSearchParams(u$b());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$8(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$8(r,e,"sap-ui");});},E$3=n=>{const e=n.split("@")[1];return g$9(e)},P$5=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$8=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$f.has(e)&&(e=i$f.get(a)),s==="theme"?(t$l.theme=P$5(s,e),e&&e.includes("@")&&(t$l.themeRoot=E$3(e))):t$l[s]=e;},j$1=()=>{const n=n$k("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$l=e$g(t$l,e);},o$f=()=>{typeof document>"u"||p$5||(l$f(),p$5=true);},l$f=n=>{w$7(),z$2(),j$1();};
  ...
  const e$c={version:"2.15.1",major:2,minor:15,patch:1,suffix:"",isNext:false,buildTime:1761052348};

  let s$j,t$j={include:[/^ui5-/],exclude:[]};const o$d=new Map,c$b=()=>s$j,m$9=()=>t$j,i$d=e=>{if(!o$d.has(e)){const n=t$j.include.some(r=>e.match(r))&&!t$j.exclude.some(r=>e.match(r));o$d.set(e,n);}return o$d.get(e)},g$7=e=>{if(i$d(e))return c$b()};

  let i$c,s$i="";const u$8=new Map,r$h=m$a("Runtimes",[]),x$2=()=>{if(i$c===void 0){i$c=r$h.length;const e=e$c;r$h.push({...e,get scopingSuffix(){return c$b()},get registeredTags(){return T$3()},get scopingRules(){return m$9()},alias:s$i,description:`Runtime ${i$c} - ver ${e.version}${""}`});}},I$4=()=>i$c,b$6=(e,m)=>{const o=`${e},${m}`;if(u$8.has(o))return u$8.get(o);const t=r$h[e],n=r$h[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$8.set(o,l),l},$$3=()=>r$h;

  const g$6=m$a("Tags",new Map),d$9=new Set;let i$b=new Map,c$a;const m$8=-1,h$7=e=>{d$9.add(e),g$6.set(e,I$4());},w$6=e=>d$9.has(e),T$3=()=>[...d$9.values()],$$2=e=>{let n=g$6.get(e);n===void 0&&(n=m$8),i$b.has(n)||i$b.set(n,new Set),i$b.get(n).add(e),c$a||(c$a=setTimeout(()=>{y$6(),i$b=new Map,c$a=void 0;},1e3));},y$6=()=>{const e=$$3(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$h=new Set,d$8=new i$h,n$h=new l$e;let t$h,a$b,m$7,i$a;const l$c=async e=>{n$h.add(e),await P$4();},c$9=e=>{d$8.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$6=e=>{n$h.remove(e),s$h.delete(e);},P$4=async()=>{i$a||(i$a=new Promise(e=>{window.requestAnimationFrame(()=>{n$h.process(c$9),i$a=null,e(),m$7||(m$7=setTimeout(()=>{m$7=void 0,n$h.isEmpty()&&U$2();},200));});})),await i$a;},y$5=()=>t$h||(t$h=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$h.isEmpty()&&(t$h=void 0,e());});}),t$h),I$3=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$8=async()=>{await I$3(),await y$5();},U$2=()=>{n$h.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$h=void 0);},C$4=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$g(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$8();};

  const g$5=typeof document>"u",i$9=(e,t)=>t?`${e}|${t}`:e,l$b=e=>e===void 0?true:b$6(I$4(),parseInt(e))===1,c$8=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$9(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$9(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$b(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$5?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$9(e,t)),f$7=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$9(e,t));},R$4=(e,t,r="",s)=>{S$4(t,r)?y$4(e,t,r,s):c$8(e,t,r,s);},m$6=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$g=new i$h,r$f="themeRegistered",n$g=e=>{t$g.attachEvent(r$f,e);};

  const l$a=new Map,h$5=new Map,u$7=new Map,T$2=new Set,i$8=new Set,m$5=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$a.get(g);if(s!==void 0)return s;if(!i$8.has(r)){const $=[...i$8.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$e}. Registered themes are: ${$}`),a$a(e,e$e)}const[n,d]=await Promise.all([a$a(e,r),t?a$a(e,t,true):void 0]),o=m$6(n,d);return o&&l$a.set(g,o),o},a$a=async(e,r,t=false)=>{const s=(t?u$7:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$3=e=>i$8.has(e);
  ...
  let t$e;i$g(()=>{t$e=void 0;});const n$f=()=>(t$e===void 0&&(t$e=S$5()),t$e),u$6=e=>`${n$f()}Base/baseLib/${e}/css_variables.css`,i$7=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$5(u$6(e),{"sap-ui-webcomponents-theme":e});};

  let _lib="ui5",_package="webcomponents-theming";const s$f="@"+_lib+"/"+_package,S$3=()=>w$5().has(s$f),P$2=async e=>{if(!S$3())return;const t=await m$5(s$f,e);t&&R$4(t,"data-ui5-theme-properties",s$f,e);},E$2=()=>{f$7("data-ui5-theme-properties",s$f);},U$1=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$f)return;const i=await m$5(a,e,t);i&&R$4(i,`data-ui5-component-properties-${I$4()}`,a);});return Promise.all(o)},k$2=async e=>{const t=m$4();if(t)return t;const r=n$k("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$f())return await i$7(e),m$4()},w$4=async e=>{const t=await k$2(e);!t||e!==t.themeName?await P$2(e):E$2();const r=P$3(e)?e:t&&t.baseThemeName;await U$1(r||e$e,t&&t.themeName===e?e:void 0),r$d(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  const a$8=()=>{const t=n$k("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$6();},f$6=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$9()||t||S$4("data-ui5-font-face")||c$8(n$e,"data-ui5-font-face");};
  ...
  const e$b=()=>{S$4("data-ui5-system-css-vars")||c$8(a$7,"data-ui5-system-css-vars");};

  var t$d = "html:not(:has(.ui5-content-native-scrollbars)){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

  const s$e=()=>{S$4("data-ui5-scrollbar-styles")||c$8(t$d,"data-ui5-scrollbar-styles");};
  ...
  let o$a=false,r$c;const p$4=new i$h,b$5=async()=>{if(r$c!==void 0)return r$c;const t=async n=>{if(x$2(),typeof document>"u"){n();return}n$g(F$1);const e=n$k("OpenUI5Support"),f=e?e.isOpenUI5Detected():false,s=n$k("F6Navigation");e&&await e.init(),s&&!f&&s.init(),await d$4(),await w$4(r$b()),e&&e.attachListeners(),a$8(),e$b(),s$e(),i$6(),n(),o$a=true,p$4.fireEvent("boot");};return r$c=new Promise(t),r$c},F$1=t=>{o$a&&t===r$b()&&w$4(r$b());};
  ...
  let e$8,t$5;i$g(()=>{e$8=void 0,t$5=void 0;});let a$6=false;const s$c=()=>a$6,l$9=()=>(e$8===void 0&&(e$8=L$3()),e$8),h$3=()=>(t$5===void 0&&(t$5=R$5()),t$5);
  ...
  const r$9=new Map,n$b=t=>(r$9.has(t)||r$9.set(t,new r$a(t)),r$9.get(t)),c$7=t=>{try{if(t&&typeof t=="string")return n$b(t)}catch{}return new r$a(r$i)},s$b=t=>{const e=l$9();return e?n$b(e):c$7(o$9())};

  const _$3=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$6=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$5={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$3=i=>{let e;if(!i)return r$i;if(typeof i=="string"&&(e=_$3.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$5[t]||t,o&&(e=c$6.exec(o))||r&&(e=c$6.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$i};
  ...
  const d$3=new Set,m$3=new Set,g$4=new Map,l$8=new Map,u$5=new Map,f$4=(n,t)=>{g$4.set(n,t);},A$2=n=>g$4.get(n),h$2=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$2=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$8.get(e)&&l$8.set(e,r(t)),l$8.get(e)},M$2=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$2=(n,t)=>t!==a$e&&!h$2(n,t),w$2=async n=>{const t=s$b().getLanguage(),e=s$b().getRegion(),r=s$b().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$3(s);L$2(n,s);)s=n$a(s);const I=h$3();if(s===a$e&&!I){f$4(n,null);return}if(!h$2(n,s)){M$2(n);return}try{const o=await B$2(n,s);f$4(n,o);}catch(o){const a=o;m$3.has(a.message)||(m$3.add(a.message),console.error(a.message));}};t$6(n=>{const t=[...g$4.keys()];return Promise.all(t.map(w$2))});
  ...
  const r$7=new Map;let u$4 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$5(l,i)}};const a$5=n=>{if(r$7.has(n))return r$7.get(n);const e=new u$4(n);return r$7.set(n,e),e},f$3=async n=>(await w$2(n),a$5(n));

  const c$5=["value-changed","click"];let e$7;i$g(()=>{e$7=void 0;});const s$a=t=>c$5.includes(t),l$7=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$7===void 0&&(e$7=F$2()),e$7),a$4=t=>{const n=o$8();return s$a(t)?false:n===true?true:!l$7(t)};
