sap.ui.define(['module', 'require', 'exports'], (function (module, require, exports) { 'use strict';

  var c$g={},e$f=c$g.hasOwnProperty,a$h=c$g.toString,o$h=e$f.toString,l$e=o$h.call(Object),i$i=function(r){var t,n;return !r||a$h.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$f.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$e):true)};

  var c$f=Object.create(null),u$d=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$f;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$i(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$i(n)?n:{},r[a]=u$d(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$e=function(n,t){return u$d(true,false,...arguments)};

  const e$d=new Map,s$m=(t,r)=>{e$d.set(t,r);},n$n=t=>e$d.get(t);

  const _$3={themes:{default:"sap_horizon"},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$c=_$3.themes.default,a$g=_$3.languages.default,r$m=_$3.locales.default,n$m=_$3.locales.all;
  ...
  const e$b=new i$h,t$o="configurationReset",i$g=n=>{e$b.attachEvent(t$o,n);};

  const o$g=typeof document>"u",n$l={search(){return o$g?"":window.location.search}},s$l=()=>o$g?"":window.location.href,u$b=()=>n$l.search();

  let u$a=false,t$n={animationMode:u$c.Full,theme:e$c,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$5=()=>(o$f(),t$n.theme),T$4=()=>(o$f(),t$n.themeRoot),S$6=()=>(o$f(),t$n.language),L$7=()=>(o$f(),t$n.fetchDefaultLanguage),F$1=()=>(o$f(),t$n.noConflict),U$3=()=>(o$f(),t$n.defaultFontLoading),R$3=()=>(o$f(),t$n.formatSettings),i$f=new Map;i$f.set("true",true),i$f.set("false",false);const M$4=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$n=e$e(t$n,e));}},z$2=()=>{const n=new URLSearchParams(u$b());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||p$5(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&p$5(a,e,"sap-ui");});},E$3=n=>n.split("@")[1],P$3=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,p$5=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$f.has(e)&&(e=i$f.get(r)),s==="theme"?(t$n.theme=P$3(s,e),e&&e.includes("@")&&(t$n.themeRoot=E$3(e))):t$n[s]=e;},w$7=()=>{const n=n$n("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$n=e$e(t$n,e);},o$f=()=>{typeof document>"u"||u$a||(g$b(),u$a=true);},g$b=n=>{M$4(),z$2(),w$7();};
  ...
  let t$m;let a$f = class a{static getLegacyDateCalendarCustomizing(){return t$m===void 0&&(t$m=R$3()),t$m.legacyDateCalendarCustomizing||[]}};s$m("LegacyDateFormats",a$f);

  i$g(()=>{});const i$e=n$n("LegacyDateFormats");i$e?a$f.getLegacyDateCalendarCustomizing:()=>[];
  ...
  const u$9=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$c=()=>typeof document>"u"?null:o$e('meta[name="ui5-shared-resources"]',document.head,u$9),m$b=(t,o)=>{const r=t.split(".");let e=l$c();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$a={version:"2.22.0",major:2,minor:22,patch:0,suffix:"",isNext:false,buildTime:1778494735};

  let s$j,t$l={include:[/./],exclude:[]};const o$d=new Map,c$e=()=>s$j,m$a=()=>t$l,i$d=e=>{if(!o$d.has(e)){const n=t$l.include.some(r=>e.match(r))&&!t$l.exclude.some(r=>e.match(r));o$d.set(e,n);}return o$d.get(e)},d$a=e=>{if(i$d(e))return c$e()};

  let i$c,s$i="";const u$8=new Map,n$k=m$b("Runtimes",[]),x$2=()=>{if(i$c===void 0){i$c=n$k.length;const t=e$a;n$k.push({...t,get scopingSuffix(){return c$e()},get registeredTags(){return T$3()},get scopingRules(){return m$a()},alias:s$i,description:`Runtime ${i$c} - ver ${t.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("LuigiContainer2"), document.baseURI).href});}},I$4=()=>i$c,b$6=(t,m)=>{const o=`${t},${m}`;if(u$8.has(o))return u$8.get(o);const e=n$k[t],r=n$k[m];if(!e||!r)throw new Error("Invalid runtime index supplied");if(e.isNext||r.isNext)return e.buildTime-r.buildTime;const c=e.major-r.major;if(c)return c;const a=e.minor-r.minor;if(a)return a;const f=e.patch-r.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,r.suffix);return u$8.set(o,l),l},$$3=()=>n$k;

  const g$a=m$b("Tags",new Map),d$9=new Set;let i$b=new Map,c$d;const m$9=-1,h$6=e=>{d$9.add(e),g$a.set(e,I$4());},w$6=e=>d$9.has(e),T$3=()=>[...d$9.values()],$$2=e=>{let n=g$a.get(e);n===void 0&&(n=m$9),i$b.has(n)||i$b.set(n,new Set),i$b.get(n).add(e),c$d||(c$d=setTimeout(()=>{y$7(),i$b=new Map,c$d=void 0;},1e3));},y$7=()=>{const e=$$3(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$b.keys()].forEach(s=>{let o,r;s===m$9?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$k=new Set,n$j=e=>{t$k.add(e);},r$l=e=>t$k.has(e);

  const s$h=new Set,d$8=new i$h,n$i=new l$d;let t$j,a$e,m$8,i$a;const l$b=async e=>{n$i.add(e),await P$2();},c$c=e=>{d$8.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$5=e=>{n$i.remove(e),s$h.delete(e);},P$2=async()=>{i$a||(i$a=new Promise(e=>{window.requestAnimationFrame(()=>{n$i.process(c$c),i$a=null,e(),m$8||(m$8=setTimeout(()=>{m$8=void 0,n$i.isEmpty()&&U$2();},200));});})),await i$a;},y$6=()=>t$j||(t$j=new Promise(e=>{a$e=e,window.requestAnimationFrame(()=>{n$i.isEmpty()&&(t$j=void 0,e());});}),t$j),I$3=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$b=async()=>{await I$3(),await y$6();},U$2=()=>{n$i.isEmpty()&&a$e&&(a$e(),a$e=void 0,t$j=void 0);},C$4=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$l(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$b(r);}),await f$b();};

  const g$9=typeof document>"u",i$9=(e,t)=>t?`${e}|${t}`:e,l$a=e=>e===void 0?true:b$6(I$4(),parseInt(e))>=1,c$b=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$9(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$5=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$9(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$a(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$5=(e,t="")=>g$9?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$9(e,t)),f$a=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$9(e,t));},R$2=(e,t,r="",s)=>{S$5(t,r)?y$5(e,t,r,s):c$b(e,t,r,s);},m$7=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$i=new i$h,r$k="themeRegistered",n$h=e=>{t$i.attachEvent(r$k,e);};

  const l$9=new Map,T$2=new Map,h$4=new Map,u$7=new Map,a$d=new Set,L$6=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$9.get(s);if(o!==void 0)return o;if(!a$d.has(r)){const p=[...a$d.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$c}. Registered themes are: ${p}`),c$a(e,e$c)}const[n,g]=await Promise.all([c$a(e,r),t?c$a(e,t,true):void 0]),i=m$7(n,g);return i&&l$9.set(s,i),i},c$a=async(e,r,t=false)=>{const o=(t?h$4:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$6=()=>u$7,w$5=e=>a$d.has(e);

  const r$j=new Set,s$g=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$c=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$j.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$j.add("decode"));return}try{return JSON.parse(a)}catch{r$j.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$j.add("parse"));}}},d$7=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$j.has("object")||(console.warn("Malformed theme metadata Object",e),r$j.add("object"));return}return {themeName:t,baseThemeName:a}},m$5=()=>{const e=s$g();if(!e||e==="none")return;const t=o$c(e);if(t)return d$7(t)};

  const t$h=new i$h,d$6="themeLoaded",r$i=e=>t$h.fireEvent(d$6,e);
  ...
  const a$c=t=>{const e=document.querySelector(`META[name="${t}"]`);return e&&e.getAttribute("content")},g$8=(t,e=false)=>{const n=a$c("sap-allowed-theme-origins")??a$c("sap-allowedThemeOrigins");return n?e?true:n.split(",").some(r=>r==="*"||t===r.trim()):false},l$8=t=>{let e,n=false;try{if(t.startsWith(".")||t.startsWith("/")&&!t.startsWith("//"))e=new URL(t,s$l()).toString(),n=!0;else {const r=t.startsWith("//")?new URL(t,s$l()):new URL(t),i=r.origin,o=new URL(s$l()).origin;if(n=i===o,i&&g$8(i,n))e=r.toString();else return}return e.endsWith("/")||(e=`${e}/`),`${e}UI5/`}catch{return}};

  let t$g;i$g(()=>{t$g=void 0;});const r$h=()=>(t$g===void 0&&(t$g=T$4()),t$g),f$9=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$f=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$h();if(!n)return;const i=l$8(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$5(f$9(e,i),{"sap-ui-webcomponents-theme":e});};

  const t$f=new Map;let e$9;const n$g=()=>(e$9||(e$9=new CSSStyleSheet),e$9),r$g=(o,s)=>{t$f.set(o,s);const S=Array.from(t$f.values()).join(`
`);n$g().replaceSync(S);};

  let _lib="ui5",_package="webcomponents-theming";const a$b="@"+_lib+"/"+_package,E$2=()=>m$6().has(a$b),U$1=async e=>{if(!E$2())return;const t=await L$6(a$b,e);t&&R$2(t,"data-ui5-theme-properties",a$b,e);},w$4=()=>{f$a("data-ui5-theme-properties",a$b);},I$2=async(e,t)=>{const o=[...m$6().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$b)return;const i=await L$6(s,e,t);i&&(n==="root"?R$2(i,`data-ui5-component-properties-${I$4()}`,s):n==="host"&&r$g(s,i));});return Promise.all(o)},O$4=async e=>{const t=m$5();if(t)return t;const r=n$n("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$h())return await s$f(e),m$5()},b$5=async e=>{const t=await O$4(e);!t||e!==t.themeName?await U$1(e):w$4();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$5(e)?e:o||e$c;await I$2(s,r),B$3(o),r$i(e);};

  const d$4=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$f = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$b;i$g(()=>{o$b=void 0;});const a$a=()=>(o$b===void 0&&(o$b=U$3()),o$b);

  const a$9=()=>{const t=n$n("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$8();},f$8=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$a()||t||S$5("data-ui5-font-face")||c$b(n$f,"data-ui5-font-face");};

  var s$e = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

  const r$f=()=>{R$2(s$e,"data-ui5-system-css-vars");};

  var t$e = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

  const s$d=()=>{S$5("data-ui5-scrollbar-styles")||c$b(t$e,"data-ui5-scrollbar-styles");};

  const t$d=typeof document>"u",e$8={get userAgent(){return t$d?"":navigator.userAgent},get chrome(){return t$d?false:/(Chrome|CriOS)/.test(e$8.userAgent)},get safari(){return t$d?false:!e$8.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$8.userAgent)},get iOS(){return t$d?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$8.userAgent.match(/Mac/)&&"ontouchend"in document)}};const h$3=()=>e$8.safari,w$3=()=>e$8.iOS;

  let t$c=false;const i$8=()=>{h$3()&&w$3()&&!t$c&&(document.body.addEventListener("touchstart",()=>{}),t$c=true);};

  let r$e=false,i$7,p$4=false;const m$4=new i$h,O$3=()=>r$e,f$7=async()=>{const t=n$n("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$n("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$9=()=>{if(p$4)return;const t=n$n("OpenUI5Support");t&&(p$4=t.attachListeners());},u$6=async()=>{if(i$7!==void 0)return i$7;const t=async e=>{if(x$2(),typeof document>"u"){e();return}n$h(b$4),await f$7(),await d$4(),await b$5(r$c()),c$9(),a$9(),r$f(),s$d(),i$8(),e(),r$e=true,m$4.fireEvent("boot");};return i$7=new Promise(t),i$7},b$4=t=>{if(!r$e)return;const e=r$c(),o=A$3();(t===e||t===o)&&b$5(e);};

  const g$7=()=>m$b("ConfigChange.eventProvider",new i$h),r$d=()=>m$b("ConfigChange.values",{}),a$8="configChange",t$b=new Set,C$3=(n,e)=>{g$7().attachEvent(a$8,i=>{i.name===n&&!t$b.has(n)&&e(i.value);});},f$6=n=>r$d()[n];

  let t$a,o$a;i$g(()=>{t$a=void 0;}),C$3("theme",e=>{t$a=e,O$3()&&b$5(t$a).then(()=>C$4({themeAware:true}));});const r$c=()=>(t$a===void 0&&(t$a=f$6("theme")??C$5()),t$a),A$3=()=>o$a,B$3=e=>{o$a=e;};

  var t$9=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$9||{});const s$c=new Map;s$c.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$c.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$c.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});
  ...
  const t$7=typeof document>"u",o$9=()=>{if(t$7)return a$g;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$g};

  const e$7=new i$h,n$e="languageChange",t$6=a=>{e$7.attachEvent(n$e,a);},o$8=a=>e$7.fireEventAsync(n$e,a);

  let n$d,t$5;i$g(()=>{n$d=void 0,t$5=void 0;});let a$7=false;C$3("language",e=>{n$d=e,a$7=true,o$8(e).then(()=>{a$7=false,O$3()&&C$4({languageAware:true});});});const c$8=()=>a$7,L$5=()=>(n$d===void 0&&(n$d=f$6("language")??S$6()),n$d),D$2=()=>(t$5===void 0&&(t$5=L$7()),t$5);

  const n$c=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$b = class r{constructor(s){const t=n$c.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$g,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

  const r$a=new Map,n$b=t=>(r$a.has(t)||r$a.set(t,new r$b(t)),r$a.get(t)),c$7=t=>{try{if(t&&typeof t=="string")return n$b(t)}catch{}return new r$b(r$m)},s$b=t=>{const e=L$5();return e?n$b(e):c$7(o$9())};

  const _$2=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$6=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$5={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$3=i=>{let e;if(!i)return r$m;if(typeof i=="string"&&(e=_$2.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$5[t]||t,o&&(e=c$6.exec(o))||r&&(e=c$6.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$m};

  const r$9={zh_HK:"zh_TW",in:"id"},n$a=t=>{if(!t)return r$m;if(r$9[t])return r$9[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$m?r$m:""};

  const d$3=new Set,m$3=new Set,g$6=new Map,l$7=new Map,u$5=new Map,f$4=(n,t)=>{g$6.set(n,t);},A$2=n=>g$6.get(n),h$2=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$2=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$7.get(e)&&l$7.set(e,r(t)),l$7.get(e)},M$3=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$4=(n,t)=>t!==a$g&&!h$2(n,t),w$2=async n=>{const t=s$b().getLanguage(),e=s$b().getRegion(),r=s$b().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$4(n,s))for(s=p$3(s);L$4(n,s);)s=n$a(s);const I=D$2();if(s===a$g&&!I){f$4(n,null);return}if(!h$2(n,s)){M$3(n);return}try{const o=await B$2(n,s);f$4(n,o);}catch(o){const a=o;m$3.has(a.message)||(m$3.add(a.message),console.error(a.message));}};t$6(n=>{const t=[...g$6.keys()];return Promise.all(t.map(w$2))});
  ...
  const r$8=new Map;let u$4 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$6=n=>{if(r$8.has(n))return r$8.get(n);const e=new u$4(n);return r$8.set(n,e),e},f$3=async n=>(await w$2(n),a$6(n));

  const c$5=["value-changed","click"];let e$6;i$g(()=>{e$6=void 0;});const s$a=t=>c$5.includes(t),l$6=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$6===void 0&&(e$6=F$1()),e$6),a$5=t=>{const n=o$7();return s$a(t)?false:n===true?true:!l$6(t)};
  ...
  const s$6=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$g(),...s$7(e)],e.renderer(o,t);};

  const r$5=[],o$4=t=>r$5.some(s=>t.startsWith(s));

  const t$4=new WeakMap,n$6=(e,o,r)=>{const s=new MutationObserver(o);t$4.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$4.get(e);o&&(o.disconnect(),t$4.delete(e));};
  ...
  m$b("SVGIcons.registry",new Map);m$b("SVGIcons.promises",new Map);
