sap.ui.define(['require', 'exports'], (function (require, exports) { 'use strict';
  ...
  let s$j,t$i={include:[/^ui5-/],exclude:[]};const o$d=new Map,c$c=()=>s$j,m$9=()=>t$i,i$d=e=>{if(!o$d.has(e)){const n=t$i.include.some(r=>e.match(r))&&!t$i.exclude.some(r=>e.match(r));o$d.set(e,n);}return o$d.get(e)},g$7=e=>{if(i$d(e))return c$c()};
