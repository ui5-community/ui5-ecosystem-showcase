sap.ui.define((function () { 'use strict';
    ...
    var jquery_signalR$1 = {};

    /* jquery.signalR.core.js */

    var hasRequiredJquery_signalR;

    function requireJquery_signalR () {
    	if (hasRequiredJquery_signalR) return jquery_signalR$1;
    	hasRequiredJquery_signalR = 1;
    	/*global window:false */
    	/*!
    	...
    	return jquery_signalR$1;
    }

    var jquery_signalRExports = requireJquery_signalR();

    var namedExports = /*#__PURE__*/_mergeNamespaces({
        __proto__: null,
        default: jquery_signalRExports
    }, [jquery_signalRExports]);

    const defaultExports = Object.isFrozen(jquery_signalRExports) ? Object.assign({}, jquery_signalRExports?.default || jquery_signalRExports || { __emptyModule: true }) : jquery_signalRExports;
    Object.keys(namedExports || {}).filter((key) => !defaultExports[key]).forEach((key) => defaultExports[key] = namedExports[key]);
    Object.defineProperty(defaultExports, "__" + "esModule", { value: true });
    var jquery_signalR = Object.isFrozen(jquery_signalRExports) ? Object.freeze(defaultExports) : defaultExports;

    return jquery_signalR;
