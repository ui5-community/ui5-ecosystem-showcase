sap.ui.define((function () { 'use strict';
    ...
    const A_RTL_LOCALES = designTimePropertyAsArray("$cldr-rtl-locales:ar,fa,he$") || [];
    /**
...
` };
    ...
    function block1(context, tags, suffix) { return suffix ? effectiveHtml `<div class="ui5-checkbox-display-only-icon-inner"><${scopeTag("ui5-icon", tags, suffix)} aria-hidden="true" name=${l(this.displayOnlyIcon)} class="ui5-checkbox-display-only-icon"></${scopeTag("ui5-icon", tags, suffix)}></div>` : effectiveHtml `<div class="ui5-checkbox-display-only-icon-inner"><ui5-icon aria-hidden="true" name=${l(this.displayOnlyIcon)} class="ui5-checkbox-display-only-icon"></ui5-icon></div>`; }
    ...
    function block3(context, tags, suffix) { return suffix ? effectiveHtml `<${scopeTag("ui5-icon", tags, suffix)} aria-hidden="true" name="accept" class="ui5-checkbox-icon"></${scopeTag("ui5-icon", tags, suffix)}>` : effectiveHtml `<ui5-icon aria-hidden="true" name="accept" class="ui5-checkbox-icon"></ui5-icon>`; }
