sap.ui.define(['module', 'exports'], (function (module, exports) { 'use strict';
  ...
  const e$k=t=>{const p=t.openEnd;t.openEnd=function(){return this._mAttributes?.popover&&delete this._mAttributes.popover,p.apply(this)};},n$x=t=>{"prototype"in t&&"openEnd"in t.prototype?e$k(t.prototype):"openEnd"in t&&e$k(t);};

  const o$l=(t,n=document.body,r)=>{let e=document.querySelector(t);return e||(e=r?r():document.createElement(t),n.insertBefore(e,n.firstChild))};

  const u$k=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$m=()=>typeof document>"u"?null:o$l('meta[name="ui5-shared-resources"]',document.head,u$k),m$j=(t,o)=>{const r=t.split(".");let e=l$m();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const g$f=m$j("Tags",new Map),d$g=new Set;let i$l=new Map,c$n;const m$i=-1,h$7=e=>{d$g.add(e),g$f.set(e,h$6());},w$8=e=>d$g.has(e),R$5=()=>d$g.size>0,T$5=()=>[...d$g.values()],$$2=e=>{let n=g$f.get(e);n===void 0&&(n=m$i),i$l.has(n)||i$l.set(n,new Set),i$l.get(n).add(e),c$n||(c$n=setTimeout(()=>{y$c(),i$l=new Map,c$n=void 0;},1e3));},y$c=()=>{const e=b$d(),n=h$6(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$l.keys()].forEach(s=>{let o,r;s===m$i?(o=1,r={description:"Older unknown runtime"}):(o=I$4(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${i$l.get(s).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...i$l.get(s)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const e$j={version:"2.23.1",major:2,minor:23,patch:1,suffix:"",isNext:false,buildTime:1781204653};

  let s$t,t$t={include:[/./],exclude:[]};const o$k=new Map,p$7=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$5()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$t=e;},c$m=()=>s$t,g$e=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$t=e,o$k.clear();},m$h=()=>t$t,i$k=e=>{if(!o$k.has(e)){const n=t$t.include.some(r=>e.match(r))&&!t$t.exclude.some(r=>e.match(r));o$k.set(e,n);}return o$k.get(e)},d$f=e=>{if(i$k(e))return c$m()};

  let s$s,u$j="";const c$l=new Map,o$j=m$j("Runtimes",[]),d$e=()=>{if(s$s===void 0){s$s=o$j.length;const e=e$j;o$j.push({...e,get scopingSuffix(){return c$m()},get registeredTags(){return T$5()},get scopingRules(){return m$h()},alias:u$j,description:`Runtime ${s$s} - ver ${e.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("webcomponents"), document.baseURI).href});}},h$6=()=>s$s,a$o=(e,t)=>{if(e.isNext||t.isNext)return e.buildTime-t.buildTime;const r=e.major-t.major;if(r)return r;const n=e.minor-t.minor;if(n)return n;const i=e.patch-t.patch;return i||new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,t.suffix)},I$4=(e,t)=>{const r=`${e},${t}`;if(c$l.has(r))return c$l.get(r);const n=o$j[e],i=o$j[t];if(!n||!i)throw new Error("Invalid runtime index supplied");const m=a$o(n,i);return c$l.set(r,m),m},b$d=()=>o$j;

  const g$d=typeof document>"u",i$j=(e,t)=>t?`${e}|${t}`:e,l$l=e=>e===void 0?true:I$4(h$6(),parseInt(e))>=1,c$k=(e,t,r="",s)=>{const d=h$6(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$j(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$b=(e,t,r="",s)=>{const d=h$6(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$j(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$l(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$5=(e,t="")=>g$d?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$j(e,t)),f$h=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$j(e,t));},R$4=(e,t,r="",s)=>{S$5(t,r)?y$b(e,t,r,s):c$k(e,t,r,s);},m$g=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  var e$i = "[data-sap-ui-popup][popover]{border:none;overflow:visible;margin:0}.sapUiBLy[popover]{width:100%;height:100%}";

  const o$i=()=>{S$5("data-ui5-popup-styles")||c$k(e$i,"data-ui5-popup-styles");};

  const t$s=m$j("PatchedFunctions",{}),a$n=o=>{const e=t$s[o];return !e||!e.version?true:a$o(e$j,e.version)>0},p$6=m$j("AllOpenedPopupsRegistry",{openedRegistry:[]}),y$a=o=>{p$6.openedRegistry.push(o);},d$d=o=>{const e=p$6.openedRegistry.findIndex(n=>n.instance===o);e===p$6.openedRegistry.length-1&&O$3(),e>-1&&p$6.openedRegistry.splice(e,1);},g$c=()=>p$6.openedRegistry.length===0?null:p$6.openedRegistry[p$6.openedRegistry.length-1].instance,P$5=o=>{for(let e=p$6.openedRegistry.length-1;e>=0;e--){const n=p$6.openedRegistry[e];if(n.type==="WebComponent")return  true;if(n.instance===o)break}return  false},c$j=o=>{const e=o.getContent();return e instanceof HTMLElement?e:e?.getDomRef()||null},v$3=o=>{if(!["OPENING","OPEN"].includes(o.getOpenState())||!l$k())return;const n=c$j(o);if(!n)return;const s=document.getElementById("sap-ui-blocklayer-popup");o.getModal()&&s&&(s.setAttribute("popover","manual"),s.hidePopover(),s.showPopover()),n.setAttribute("popover","manual"),n.hidePopover(),n.showPopover();},I$3=o=>{const e=c$j(o);if(e&&(e.hasAttribute("popover")&&(e.hidePopover(),e.removeAttribute("popover")),g$c()===o&&o.getModal())){const n=document.getElementById("sap-ui-blocklayer-popup");n&&n.hasAttribute("popover")&&n.hidePopover();}},O$3=()=>{if(!l$k())return;const o=p$6.openedRegistry[p$6.openedRegistry.length-2];if(!o||o.type!=="OpenUI5"||!o.instance.getModal())return;const e=c$j(o.instance),n=document.getElementById("sap-ui-blocklayer-popup");e?.hidePopover(),n?.showPopover(),e?.showPopover();},l$k=(o=document)=>o.querySelector(":popover-open")?true:Array.from(o.querySelectorAll("*")).some(e=>{const n=e.shadowRoot;return n&&l$k(n)}),m$f=o=>{const e="Dialog.prototype.onsapescape";a$n(e)&&(t$s[e]={version:e$j,originalFn:t$s[e]?.originalFn??o.prototype.onsapescape});const n=t$s[e].originalFn;o.prototype.onsapescape=function(...r){P$5(this.oPopup)||n.apply(this,r);};},R$3=o=>{const e="Popup.prototype.open";a$n(e)&&(t$s[e]={version:e$j,originalFn:t$s[e]?.originalFn??o.prototype.open});const n=t$s[e].originalFn;o.prototype.open=function(...r){n.apply(this,r),v$3(this),y$a({type:"OpenUI5",instance:this});};},F$1=o=>{const e="Popup.prototype._closed";a$n(e)&&(t$s[e]={version:e$j,originalFn:t$s[e]?.originalFn??o.prototype._closed});const n=t$s[e].originalFn;o.prototype._closed=function(...r){I$3(this),n.apply(this,r),d$d(this);};},U$4=o=>{const e="Popup.prototype.onFocusEvent";a$n(e)&&(t$s[e]={version:e$j,originalFn:t$s[e]?.originalFn??o.prototype.onFocusEvent});const n=t$s[e].originalFn;o.prototype.onFocusEvent=function(...r){P$5(this)||n.apply(this,r);};},C$8=()=>{const o=new CSSStyleSheet;o.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,o];},b$c=(o,e)=>{o$i(),R$3(o),F$1(o),C$8(),U$4(o),m$f(e);};

  const e$h=new Map,s$r=(t,r)=>{e$h.set(t,r);},n$w=t=>e$h.get(t);

  var c$i={},e$g=c$i.hasOwnProperty,a$m=c$i.toString,o$h=e$g.toString,l$j=o$h.call(Object),i$i=function(r){var t,n;return !r||a$m.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$g.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$j):true)};

  var c$h=Object.create(null),u$i=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$h;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$i(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$i(n)?n:{},r[a]=u$i(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$f=function(n,t){return u$i(true,false,...arguments)};

  const _$3={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_auto","sap_horizon_dark","sap_horizon_hc_auto","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$e=_$3.themes.default,s$q=_$3.themes.all,a$l=_$3.languages.default,r$p=_$3.locales.default,n$v=_$3.locales.all;

  var u$h=(l=>(l.Full="full",l.Basic="basic",l.Minimal="minimal",l.None="none",l))(u$h||{});
  ...
  const e$d=new i$h,t$r="configurationReset",i$g=n=>{e$d.attachEvent(t$r,n);};

  const o$g=typeof document>"u",n$u={search(){return o$g?"":window.location.search}},s$p=()=>o$g?"":window.location.href,u$g=()=>n$u.search();

  let g$b=false,t$q={animationMode:u$h.Full,theme:e$e,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true,ignoreUrlParams:false};const y$9=()=>(o$f(),t$q.animationMode),C$7=()=>(o$f(),t$q.theme),T$4=()=>(o$f(),t$q.themeRoot),S$4=()=>(o$f(),t$q.language),U$3=()=>(o$f(),t$q.fetchDefaultLanguage),L$6=()=>(o$f(),t$q.noConflict),F=()=>(o$f(),t$q.defaultFontLoading),b$b=()=>(o$f(),t$q.enableDefaultTooltips),I$2=()=>(o$f(),t$q.ignoreUrlParams),D$4=()=>(o$f(),t$q.calendarType),R$2=()=>(o$f(),t$q.formatSettings),i$f=new Map;i$f.set("true",true),i$f.set("false",false);const M$4=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$q=e$f(t$q,e));}},z$1=()=>{const n=new URLSearchParams(u$g());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||l$i(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&l$i(r,e,"sap-ui");});},E$2=n=>n.split("@")[1],w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,l$i=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$f.has(e)&&(e=i$f.get(a)),s==="theme"?(t$q.theme=w$7(s,e),e&&e.includes("@")&&(t$q.themeRoot=E$2(e))):t$q[s]=e;},j$1=()=>{const n=n$w("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$q=e$f(t$q,e);},o$f=()=>{typeof document>"u"||g$b||(u$f(),g$b=true);},u$f=n=>{M$4(),t$q.ignoreUrlParams||z$1(),j$1();};

  let l$h = class l{constructor(){this.list=[],this.lookup=new Set;}add(t){this.lookup.has(t)||(this.list.push(t),this.lookup.add(t));}remove(t){this.lookup.has(t)&&(this.list=this.list.filter(e=>e!==t),this.lookup.delete(t));}shift(){const t=this.list.shift();if(t)return this.lookup.delete(t),t}isEmpty(){return this.list.length===0}isAdded(t){return this.lookup.has(t)}process(t){let e;const s=new Map;for(e=this.shift();e;){const i=s.get(e)||0;if(i>10)throw new Error("Web component processed too many times this task, max allowed is: 10");t(e),s.set(e,i+1),e=this.shift();}}};

  const t$p=new Set,n$t=e=>{t$p.add(e);},r$o=e=>t$p.has(e);

  const i$e=new Set,m$e=new i$h,n$s=new l$h;let t$o,a$k,d$c,s$o;const l$g=async e=>{n$s.add(e),await U$2();},c$g=e=>{i$e.add(e);},f$g=e=>{i$e.delete(e);},u$e=e=>{m$e.fireEvent("beforeComponentRender",e),c$g(e),e._render();},P$4=e=>{n$s.remove(e),f$g(e);},U$2=async()=>{s$o||(s$o=new Promise(e=>{window.requestAnimationFrame(()=>{n$s.process(u$e),s$o=null,e(),d$c||(d$c=setTimeout(()=>{d$c=void 0,n$s.isEmpty()&&T$3();},200));});})),await s$o;},y$8=()=>t$o||(t$o=new Promise(e=>{a$k=e,window.requestAnimationFrame(()=>{n$s.isEmpty()&&(t$o=void 0,e());});}),t$o),C$6=()=>{const e=T$5().map(r=>customElements.whenDefined(r));return Promise.all(e)},w$6=async()=>{await C$6(),await y$8();},T$3=()=>{n$s.isEmpty()&&a$k&&(a$k(),a$k=void 0,t$o=void 0);},b$a=async e=>{i$e.forEach(r=>{const o=r.constructor,E=o.getMetadata().getTag(),p=r$o(o),g=o.getMetadata().isLanguageAware(),v=o.getMetadata().isThemeAware();(!e||e.tag===E||e.rtlAware&&p||e.languageAware&&g||e.themeAware&&v)&&l$g(r);}),await w$6();};

  const t$n=new i$h,r$n="themeRegistered",n$r=e=>{t$n.attachEvent(r$n,e);},s$n=e=>t$n.fireEvent(r$n,e);

  const l$f=new Map,T$2=new Map,h$5=new Map,u$d=new Map,a$j=new Set,f$f=(e,r,t,s="root")=>{T$2.set(`${e}/${r}`,t),u$d.set(e,{cssVariablesTarget:s}),a$j.add(r),s$n(r);},L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$f.get(s);if(o!==void 0)return o;if(!a$j.has(r)){const p=[...a$j.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$e}. Registered themes are: ${p}`),c$f(e,e$e)}const[n,g]=await Promise.all([c$f(e,r),t?c$f(e,t,true):void 0]),i=m$g(n,g);return i&&l$f.set(s,i),i},c$f=async(e,r,t=false)=>{const o=(t?h$5:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$d=()=>u$d,w$5=e=>a$j.has(e);

  const r$m=new Set,s$m=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$e=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$m.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$m.add("decode"));return}try{return JSON.parse(a)}catch{r$m.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$m.add("parse"));}}},d$b=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$m.has("object")||(console.warn("Malformed theme metadata Object",e),r$m.add("object"));return}return {themeName:t,baseThemeName:a}},m$c=()=>{const e=s$m();if(!e||e==="none")return;const t=o$e(e);if(t)return d$b(t)};

  const t$m=new i$h,d$a="themeLoaded",o$d=e=>{t$m.attachEvent(d$a,e);},n$q=e=>{t$m.detachEvent(d$a,e);},r$l=e=>t$m.fireEvent(d$a,e);
  ...
  const a$i=t=>{const e=document.querySelector(`META[name="${t}"]`);return e&&e.getAttribute("content")},g$a=(t,e=false)=>{const n=a$i("sap-allowed-theme-origins")??a$i("sap-allowedThemeOrigins");return n?e?true:n.split(",").some(r=>r==="*"||t===r.trim()):false},l$e=t=>{let e,n=false;try{if(t.startsWith(".")||t.startsWith("/")&&!t.startsWith("//"))e=new URL(t,s$p()).toString(),n=!0;else {const r=t.startsWith("//")?new URL(t,s$p()):new URL(t),i=r.origin,o=new URL(s$p()).origin;if(n=i===o,i&&g$a(i,n))e=r.toString();else return}return e.endsWith("/")||(e=`${e}/`),`${e}UI5/`}catch{return}};

  let t$l;i$g(()=>{t$l=void 0;});const r$k=()=>(t$l===void 0&&(t$l=T$4()),t$l),f$e=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$l=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$k();if(!n)return;const i=l$e(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$9(f$e(e,i),{"sap-ui-webcomponents-theme":e});};

  const t$k=new Map;let e$c;const n$p=()=>(e$c||(e$c=new CSSStyleSheet),e$c),r$j=(o,s)=>{t$k.set(o,s);const S=Array.from(t$k.values()).join(`
`);n$p().replaceSync(S);};

  let _lib="ui5",_package="webcomponents-theming";const a$h="@"+_lib+"/"+_package,E$1=()=>m$d().has(a$h),U$1=async e=>{if(!E$1())return;const t=await L$5(a$h,e);t&&R$4(t,"data-ui5-theme-properties",a$h,e);},w$4=()=>{f$h("data-ui5-theme-properties",a$h);},I$1=async(e,t)=>{const o=[...m$d().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$h)return;const i=await L$5(s,e,t);i&&(n==="root"?R$4(i,`data-ui5-component-properties-${h$6()}`,s):n==="host"&&r$j(s,i));});return Promise.all(o)},O$2=async e=>{const t=m$c();if(t)return t;const r=n$w("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$k())return await s$l(e),m$c()},b$9=async e=>{const t=await O$2(e);!t||e!==t.themeName?await U$1(e):w$4();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$5(e)?e:o||e$e;await I$1(s,r),B$2(o),r$l(e);};

  const d$8=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$o = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$c;i$g(()=>{o$c=void 0;});const a$g=()=>(o$c===void 0&&(o$c=F()),o$c);

  const a$f=()=>{const t=n$w("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$d();},f$d=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$g()||t||S$5("data-ui5-font-face")||c$k(n$o,"data-ui5-font-face");};

  var s$k = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

  const r$i=()=>{R$4(s$k,"data-ui5-system-css-vars");};

  var t$j = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

  const s$j=()=>{S$5("data-ui5-scrollbar-styles")||c$k(t$j,"data-ui5-scrollbar-styles");};

  const t$i=typeof document>"u",e$b={get userAgent(){return t$i?"":navigator.userAgent},get touch(){return t$i?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$i?false:/(Chrome|CriOS)/.test(e$b.userAgent)},get firefox(){return t$i?false:/Firefox/.test(e$b.userAgent)},get safari(){return t$i?false:!e$b.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$b.userAgent)},get webkit(){return t$i?false:/webkit/.test(e$b.userAgent)},get windows(){return t$i?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$i?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$i?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$b.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$i?false:!e$b.windows&&/Android/.test(e$b.userAgent)},get androidPhone(){return t$i?false:e$b.android&&/(?=android)(?=.*mobile)/i.test(e$b.userAgent)},get ipad(){return t$i?false:/ipad/i.test(e$b.userAgent)||/Macintosh/i.test(e$b.userAgent)&&"ontouchend"in document},_isPhone(){return u$c(),e$b.touch&&!r$h}};let o$b,i$d,r$h;const s$i=()=>{if(t$i||!e$b.windows)return  false;if(o$b===void 0){const n=e$b.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$e=()=>{if(t$i||!e$b.webkit)return  false;if(i$d===void 0){const n=e$b.userAgent.match(/(webkit)[ /]([\w.]+)/);i$d=n?parseFloat(n[1]):0;}return i$d>=537.1},u$c=()=>{if(t$i)return  false;if(r$h===void 0){if(e$b.ipad){r$h=true;return}if(e$b.touch){if(s$i()){r$h=true;return}if(e$b.chrome&&e$b.android){r$h=!/Mobile Safari\/[.0-9]+/.test(e$b.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$b.android&&c$e()&&(n=1),r$h=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$h=e$b.userAgent.indexOf("Touch")!==-1||e$b.android&&!e$b.androidPhone;}},l$d=()=>e$b.touch,h$4=()=>e$b.safari,g$9=()=>e$b.chrome,b$8=()=>e$b.firefox,a$e=()=>(u$c(),(e$b.touch||s$i())&&r$h),d$7=()=>e$b._isPhone(),f$c=()=>t$i?false:!a$e()&&!d$7()||s$i(),m$b=()=>a$e()&&f$c(),w$3=()=>e$b.iOS,P$3=()=>e$b.android||e$b.androidPhone;

  let t$h=false;const i$c=()=>{h$4()&&w$3()&&!t$h&&(document.body.addEventListener("touchstart",()=>{}),t$h=true);};

  let r$g=false,i$b,p$5=false;const m$a=new i$h,w$2=()=>r$g,O$1=t=>{if(!r$g){m$a.attachEvent("boot",t);return}t();},f$b=async()=>{const t=n$w("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$w("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$d=()=>{if(p$5)return;const t=n$w("OpenUI5Support");t&&(p$5=t.attachListeners());},u$b=async()=>{if(i$b!==void 0)return i$b;const t=async e=>{if(d$e(),typeof document>"u"){e();return}n$r(b$7),await f$b(),await d$8(),await b$9(r$e()),c$d(),a$f(),r$i(),s$j(),i$c(),e(),r$g=true,m$a.fireEvent("boot");};return i$b=new Promise(t),i$b},P$2=async()=>{await u$b(),await f$b(),c$d(),await b$9(r$e());},b$7=t=>{if(!r$g)return;const e=r$e(),o=A$3();(t===e||t===o)&&b$9(e);};

  const g$8=()=>m$j("ConfigChange.eventProvider",new i$h),r$f=()=>m$j("ConfigChange.values",{}),a$d="configChange",t$g=new Set,d$6=(n,e)=>{r$f()[n]=e,t$g.add(n);try{g$8().fireEvent(a$d,{name:n,value:e});}finally{t$g.delete(n);}},C$5=(n,e)=>{g$8().attachEvent(a$d,i=>{i.name===n&&!t$g.has(n)&&e(i.value);});},f$a=n=>r$f()[n];

  let t$f,o$a;i$g(()=>{t$f=void 0;}),C$5("theme",e=>{t$f=e,w$2()&&b$9(t$f).then(()=>b$a({themeAware:true}));});const r$e=()=>(t$f===void 0&&(t$f=f$a("theme")??C$7()),t$f),l$c=async e=>{t$f!==e&&(t$f=e,d$6("theme",e),w$2()&&(await b$9(t$f),await b$a({themeAware:true})));},y$7=()=>e$e,m$9=()=>{const e=r$e();return C$4(e)?!e.startsWith("sap_horizon"):!m$c()?.baseThemeName?.startsWith("sap_horizon")},C$4=e=>s$q.includes(e),A$3=()=>o$a,B$2=e=>{o$a=e;};

  const h$3=100;let t$e = class t{static{this.enablePolling=false;}static isAtLeastVersion(e){if(!window.sap.ui.version)return  true;const i=window.sap.ui.version.split(".");return !i||i.length<2?false:parseInt(i[0])>1||parseInt(i[1])>=e}static isOpenUI5Detected(){return typeof window.sap?.ui?.require=="function"}static{this.OpenUI5DelayedInit=async()=>{t.init(),await P$2();};}static awaitForOpenUI5(){if(t.enablePolling){const e=setInterval(()=>{t.isOpenUI5Detected()&&(clearInterval(e),t.OpenUI5DelayedInit());},h$3);}else document.addEventListener("sap-ui-core-ready",()=>{t.OpenUI5DelayedInit();});}static init(){return t.isOpenUI5Detected()?(t.initPromise||(t.initPromise=new Promise(e=>{window.sap.ui.require(["sap/ui/core/Core"],async a=>{const i=()=>{let n=["sap/ui/core/Popup","sap/m/Dialog","sap/ui/core/Patcher","sap/ui/core/LocaleData"];t.isAtLeastVersion(116)&&(n=[...n,"sap/base/i18n/Formatting","sap/base/i18n/Localization","sap/ui/core/ControlBehavior","sap/ui/core/Theming","sap/ui/core/date/CalendarUtils"]),window.sap.ui.require(n,(o,r,s)=>{n$x(s),b$c(o,r),e();});};t.isAtLeastVersion(116)?(await a.ready(),i()):a.attachInit(i);});})),t.initPromise):t.awaitForOpenUI5()}static getConfigurationSettingsObject(){if(!t.isOpenUI5Detected())return {};if(t.isAtLeastVersion(116)){const n=window.sap.ui.require("sap/ui/core/ControlBehavior"),o=window.sap.ui.require("sap/base/i18n/Localization"),r=window.sap.ui.require("sap/ui/core/Theming"),s=window.sap.ui.require("sap/base/i18n/Formatting"),c=window.sap.ui.require("sap/ui/core/date/CalendarUtils");return {animationMode:n.getAnimationMode(),language:o.getLanguage(),theme:r.getTheme(),themeRoot:r.getThemeRoot(),rtl:o.getRTL(),timezone:o.getTimezone(),calendarType:s.getCalendarType(),formatSettings:{firstDayOfWeek:c.getWeekConfigurationValues().firstDayOfWeek,legacyDateCalendarCustomizing:s.getCustomIslamicCalendarData?.()??s.getLegacyDateCalendarCustomizing?.()}}}const a=window.sap.ui.require("sap/ui/core/Core").getConfiguration(),i=window.sap.ui.require("sap/ui/core/LocaleData");return {animationMode:a.getAnimationMode(),language:a.getLanguage(),theme:a.getTheme(),themeRoot:typeof a.getThemeRoot=="function"?a.getThemeRoot():void 0,rtl:a.getRTL(),timezone:typeof a.getTimezone=="function"?a.getTimezone():void 0,calendarType:a.getCalendarType(),formatSettings:{firstDayOfWeek:i?i.getInstance(a.getLocale()).getFirstDayOfWeek():void 0,legacyDateCalendarCustomizing:a.getFormatSettings().getLegacyDateCalendarCustomizing()}}}static getLocaleDataObject(){if(!t.isOpenUI5Detected())return;const e=window.sap.ui.require("sap/ui/core/LocaleData");if(t.isAtLeastVersion(116)){const n=window.sap.ui.require("sap/base/i18n/Localization");return e.getInstance(n.getLanguageTag())._get()}const i=window.sap.ui.require("sap/ui/core/Core").getConfiguration();return e.getInstance(i.getLocale())._get()}static _listenForThemeChange(){if(t.isAtLeastVersion(116)){const e=window.sap.ui.require("sap/ui/core/Theming");e.attachApplied(()=>{l$c(e.getTheme());});}else {const e=window.sap.ui.require("sap/ui/core/Core"),a=e.getConfiguration();e.attachThemeChanged(()=>{l$c(a.getTheme());});}}static attachListeners(){return t.isOpenUI5Detected()?(t._listenForThemeChange(),true):false}static cssVariablesLoaded(){if(!t.isOpenUI5Detected())return;const e=[...document.head.children].find(a=>a.id==="sap-ui-theme-sap.ui.core");return e?t.isAtLeastVersion(127)?!!e.href.match(/\/css(-|_)variables\.css/)||!!e.href.match(/\/library\.css/):!!e.href.match(/\/css(-|_)variables\.css/):false}static addOpenedPopup(e){y$a(e);}static removeOpenedPopup(e){d$d(e);}static getTopmostPopup(){return g$c()}};s$r("OpenUI5Support",t$e);
   ...
   */
  var t$d;const i$a=window,s$h=i$a.trustedTypes,e$a=s$h?s$h.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$9="$lit$",n$n=`lit$${(Math.random()+"").slice(9)}$`,l$b="?"+n$n,h$2=`<${l$b}>`,r$d=document,u$a=()=>r$d.createComment(""),d$5=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$c=Array.isArray,v$2=t=>c$c(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$c="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$2=/-->/g,m$8=/>/g,p$4=RegExp(`>|${a$c}(?:([^\\s"'>=/]+)(${a$c}*=${a$c}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$7=/'/g,$$1=/"/g,y$6=/^(?:script|style|textarea|title)$/i,w$1=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$2=w$1(1),b$6=w$1(2),T$1=Symbol.for("lit-noChange"),A$2=Symbol.for("lit-nothing"),E=new WeakMap,C$3=r$d.createTreeWalker(r$d,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$a?e$a.createHTML(i):i}const V=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$2:void 0!==c[1]?u=m$8:void 0!==c[2]?(y$6.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$4):void 0!==c[3]&&(u=p$4):u===p$4?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$4:'"'===c[3]?$$1:g$7):u===$$1||u===g$7?u=p$4:u===_$2||u===m$8?u=f$9:(u=p$4,l=void 0);const w=u===p$4&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$2:v>=0?(e.push(d),s.slice(0,v)+o$9+s.slice(v)+n$n+w):s+n$n+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V(t,i);if(this.el=N.createElement(a,e),C$3.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$3.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$9)||i.startsWith(n$n)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$9).split(n$n),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H:"?"===i[1]?L$4:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$6.test(h.tagName)){const t=h.textContent.split(n$n),i=t.length-1;if(i>0){h.textContent=s$h?s$h.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$a()),C$3.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$a());}}}else if(8===h.nodeType)if(h.data===l$b)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$n,t+1));)v.push({type:7,index:r}),t+=n$n.length-1;}r++;}}static createElement(t,i){const s=r$d.createElement("template");return s.innerHTML=t,s}};function S$3(t,i,s=t,e){var o,n,l,h;if(i===T$1)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$5(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$3(t,r._$AS(t,i.values),r,e)),i}let M$3 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$d).importNode(s,true);C$3.currentNode=o;let n=C$3.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$1(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$3.nextNode(),l++);}return C$3.currentNode=r$d,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$1 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$2,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$3(this,t,i),d$5(t)?t===A$2||null==t||""===t?(this._$AH!==A$2&&this._$AR(),this._$AH=A$2):t!==this._$AH&&t!==T$1&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$2(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$2&&d$5(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$d.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$3(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$1(t)),i}T(t){c$c(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$a()),this.k(u$a()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$2,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$2;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$3(this,t,i,0),n=!d$5(t)||t!==this._$AH&&t!==T$1,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$3(this,e[s+l],i,l),h===T$1&&(h=this._$AH[l]),n||(n=!d$5(h)||h!==this._$AH[l]),h===A$2?t=A$2:t!==A$2&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$2?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$2?void 0:t;}}const I=s$h?s$h.emptyScript:"";let L$4 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$2?this.element.setAttribute(this.name,I):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$3(this,t,i,0))&&void 0!==s?s:A$2)===T$1)return;const e=this._$AH,o=t===A$2&&e!==A$2||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$2&&(e===A$2||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$3(this,t);}}const B$1=i$a.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$1),(null!==(t$d=i$a.litHtmlVersions)&&void 0!==t$d?t$d:i$a.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$9=Symbol.for(""),l$a=t=>{if((null==t?void 0:t.r)===e$9)return null==t?void 0:t._$litStatic$},o$8=t=>({_$litStatic$:t,r:e$9}),s$g=new Map,a$b=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$a(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$g.get(t))&&(n.raw=n,s$g.set(t,r=n)),e=u;}return t(r,...e)},n$m=a$b(x$2),u$9=a$b(b$6);

  let t$c = class t{static{this.html=n$m;}static{this.svg=u$9;}static{this.unsafeStatic=o$8;}};s$r("LitStatic",t$c);

  const t$b=new WeakMap;let a$a = class a{static get tasks(){return t$b}static enqueue(s,e){t$b.has(s)||t$b.set(s,[]),t$b.get(s).push(e);}static run(s,e){return t$b.has(s)||t$b.set(s,[]),e().then(()=>{const T=t$b.get(s);if(T.length>0)return a.run(s,T.shift());t$b.delete(s);})}static push(s,e){t$b.get(s)?a.enqueue(s,e):a.run(s,e);}};

  const f$8=e=>{let n=null,a=false,i,o,r;const m=new Promise((t,c)=>{r=u=>{n=n||u;const d=u-n,l=e.duration-d;if(d<=e.duration){const s=1-l/e.duration;e.advance(s),a||(i=requestAnimationFrame(r));}else e.advance(1),t();},o=()=>{a=true,cancelAnimationFrame(i),c(new Error("animation stopped"));};}).catch(t=>t);return a$a.push(e.element,()=>(typeof e.beforeStart=="function"&&e.beforeStart(),requestAnimationFrame(r),new Promise(t=>{m.then(()=>t());}))),{promise:()=>m,stop:()=>o}},v$1=400;

  const n$l=(r,c,a)=>{let o,l;return f$8({beforeStart:()=>{o=r.scrollLeft,l=r.scrollTop;},duration:v$1,element:r,advance:t=>{r.scrollLeft=o+t*c,r.scrollTop=l+t*a;}})};

  const b$5=t=>{let o,a,d,r,s,p,g,y,n,l,h,T;const B=f$8({beforeStart:()=>{t.style.display="block",o=getComputedStyle(t),a=parseFloat(o.paddingTop),d=parseFloat(o.paddingBottom),r=parseFloat(o.marginTop),s=parseFloat(o.marginBottom),p=parseFloat(o.height),g=t.style.overflow,y=t.style.paddingTop,n=t.style.paddingBottom,l=t.style.marginTop,h=t.style.marginBottom,T=t.style.height,t.style.overflow="hidden",t.style.paddingTop="0",t.style.paddingBottom="0",t.style.marginTop="0",t.style.marginBottom="0",t.style.height="0";},duration:v$1,element:t,advance:i=>{t.style.display="block",t.style.paddingTop=`${a*i}px`,t.style.paddingBottom=`${d*i}px`,t.style.marginTop=`${r*i}px`,t.style.marginBottom=`${s*i}px`,t.style.height=`${p*i}px`;}});return B.promise().then(()=>{t.style.overflow=g,t.style.paddingTop=y,t.style.paddingBottom=n,t.style.marginTop=l,t.style.marginBottom=h,t.style.height=T;}),B};

  const u$8=o=>{let i,a,r,d,n,s,p,g,e,l,y,m;const h=f$8({beforeStart:()=>{const t=o;i=getComputedStyle(t),a=parseFloat(i.paddingTop),r=parseFloat(i.paddingBottom),d=parseFloat(i.marginTop),n=parseFloat(i.marginBottom),s=parseFloat(i.height),p=t.style.overflow,g=t.style.paddingTop,e=t.style.paddingBottom,l=t.style.marginTop,y=t.style.marginBottom,m=t.style.height,t.style.overflow="hidden";},duration:v$1,element:o,advance:t=>{o.style.paddingTop=`${a-a*t}px`,o.style.paddingBottom=`${r-r*t}px`,o.style.marginTop=`${d-d*t}px`,o.style.marginBottom=`${n-n*t}px`,o.style.height=`${s-s*t}px`;}});return h.promise().then(t=>{t instanceof Error||(o.style.overflow=p,o.style.paddingTop=g,o.style.paddingBottom=e,o.style.marginTop=l,o.style.marginBottom=y,o.style.height=m,o.style.display="none");}),h};

  let n$k;i$g(()=>{n$k=void 0;});const d$4=()=>(n$k===void 0&&(n$k=y$9()),n$k),m$7=o=>{Object.values(u$h).includes(o)&&(n$k=o);};

  var s$f=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$f||{});

  let n$j;i$g(()=>{n$j=void 0;});const i$9=()=>(n$j===void 0&&(n$j=D$4()),n$j&&n$j in s$f?n$j:s$f.Gregorian);

  let t$a;let a$9 = class a{static getLegacyDateCalendarCustomizing(){return t$a===void 0&&(t$a=R$2()),t$a.legacyDateCalendarCustomizing||[]}};s$r("LegacyDateFormats",a$9);

  let e$8;i$g(()=>{e$8=void 0;});const n$i=()=>(e$8===void 0&&(e$8=R$2()),e$8.firstDayOfWeek),i$8=n$w("LegacyDateFormats"),m$6=i$8?a$9.getLegacyDateCalendarCustomizing:()=>[];

  const t$9=new Map,e$7=(n,o)=>{t$9.set(n,o);},c$b=n=>t$9.get(n);

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$e=new Map;s$e.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$e.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$e.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$a=(n,e)=>{if(s$e.has(n)){s$e.set(n,{...e,...s$e.get(n)});return}s$e.set(n,e);},r$c=n=>{const e=m$9()?"legacy":"sap_horizon";return s$e.has(n)?s$e.get(n)[e]:n};

  var t$7=(s=>(s["SAP-icons"]="SAP-icons-v4",s.horizon="SAP-icons-v5",s["SAP-icons-TNT"]="tnt",s.BusinessSuiteInAppSymbols="business-suite",s))(t$7||{});const n$h=e=>t$7[e]?t$7[e]:e;

  const i$7=o=>{const t=c$b(r$e());return !o&&t?n$h(t):o?r$c(o):r$c("SAP-icons")};

  var m$5 = ":host{justify-content:center;align-items:center;display:flex;color:var(--sapList_TextColor);background-color:var(--sapList_Background);font-family:var(--sapFontFamily);height:var(--sapElement_LineHeight);border-bottom:var(--sapList_BorderWidth) solid var(--sapList_BorderColor);opacity:.8;position:absolute;padding:0 1rem;top:-1000px;left:-1000px}";

  const t$6=typeof document>"u",o$7=()=>{if(t$6)return a$l;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$l};

  const e$6=new i$h,n$g="languageChange",t$5=a=>{e$6.attachEvent(n$g,a);},r$b=a=>{e$6.detachEvent(n$g,a);},o$6=a=>e$6.fireEventAsync(n$g,a);

  let n$f,t$4;i$g(()=>{n$f=void 0,t$4=void 0;});let a$8=false;C$5("language",e=>{n$f=e,a$8=true,o$6(e).then(()=>{a$8=false,w$2()&&b$a({languageAware:true});});});const c$9=()=>a$8,L$3=()=>(n$f===void 0&&(n$f=f$a("language")??S$4()),n$f),h$1=async e=>{n$f!==e&&(a$8=true,n$f=e,d$6("language",e),await o$6(e),a$8=false,w$2()&&await b$a({languageAware:true}));},C$2=()=>a$l,p$3=e=>{t$4=e;},D$3=()=>(t$4===void 0&&(t$4=U$3()),t$4);

  const n$e=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$a = class r{constructor(s){const t=n$e.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$l,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

  const r$9=new Map,n$d=t=>(r$9.has(t)||r$9.set(t,new r$a(t)),r$9.get(t)),c$8=t=>{try{if(t&&typeof t=="string")return n$d(t)}catch{}return new r$a(r$p)},s$d=t=>{const e=L$3();return e?n$d(e):c$8(o$7())};

  const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$7=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$2=i=>{let e;if(!i)return r$p;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$7.exec(o))||r&&(e=c$7.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$p};

  const r$8={zh_HK:"zh_TW",in:"id"},n$c=t=>{if(!t)return r$p;if(r$8[t])return r$8[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$p?r$p:""};

  const d$3=new Set,m$4=new Set,g$6=new Map,l$9=new Map,u$7=new Map,$=(n,t,e)=>{const r=`${n}/${t}`;u$7.set(r,e);},f$6=(n,t)=>{g$6.set(n,t);},A$1=n=>g$6.get(n),h=(n,t)=>{const e=`${n}/${t}`;return u$7.has(e)},B=(n,t)=>{const e=`${n}/${t}`,r=u$7.get(e);return r&&!l$9.get(e)&&l$9.set(e,r(t)),l$9.get(e)},M$2=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$2=(n,t)=>t!==a$l&&!h(n,t),w=async n=>{const t=s$d().getLanguage(),e=s$d().getRegion(),r=s$d().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$2(s);L$2(n,s);)s=n$c(s);const I=D$3();if(s===a$l&&!I){f$6(n,null);return}if(!h(n,s)){M$2(n);return}try{const o=await B(n,s);f$6(n,o);}catch(o){const a=o;m$4.has(a.message)||(m$4.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$6.keys()];return Promise.all(t.map(w))});
  ...
  const r$7=new Map;let s$c;let u$6 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$7=n=>{if(r$7.has(n))return r$7.get(n);const e=new u$6(n);return r$7.set(n,e),e},f$5=async n=>s$c?s$c(n):(await w(n),a$7(n)),y$5=n=>{s$c=n;};

  const e$5={key:"DRAG_DROP_MULTIPLE_TEXT",defaultText:"{0} items"};

  const l$8=2;const u$5=async e=>{const t=document.createElement("div"),n=await f$5("@ui5/webcomponents-base"),r=t.attachShadow({mode:"open"}),o=new CSSStyleSheet;return o.replaceSync(m$5),r.adoptedStyleSheets=[o],r.textContent=n.getText(e$5,e),t},s$b=async(e,t)=>{if(e<l$8){console.warn(`Cannot start multiple drag with count ${e}. Minimum is ${l$8}.`);return}if(!t.dataTransfer)return;const n=await u$5(e);document.body.appendChild(n),t.dataTransfer.setDragImage(n,0,0),requestAnimationFrame(()=>{n.remove();});};

  const c$6=["value-changed","click"];let e$4;i$g(()=>{e$4=void 0;});const s$a=t=>c$6.includes(t),l$7=t=>{const n=o$5();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$5=()=>(e$4===void 0&&(e$4=L$6()),e$4),f$4=t=>{e$4=t;},a$6=t=>{const n=o$5();return s$a(t)?false:n===true?true:!l$7(t)};

  let r$6;const a$5=()=>(r$6===void 0&&(r$6=I$2()),r$6),n$b=e=>{r$6=e;};
  ...
  const y$4={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,ARROW_LEFT:37,ARROW_UP:38,ARROW_RIGHT:39,ARROW_DOWN:40},b$3=o=>(o.key?o.key==="Enter":o.keyCode===y$4.ENTER)&&!a$4(o),A=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$4.SPACE)&&!a$4(o),K=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$4.SPACE)&&e$3(o,false,false,true),D$2=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$4.ARROW_LEFT)&&!a$4(o),R=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$4.ARROW_RIGHT)&&!a$4(o),P=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$4.ARROW_UP)&&!a$4(o),_=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$4.ARROW_DOWN)&&!a$4(o),M$1=o=>(o.key?o.key==="Home":o.keyCode===y$4.HOME)&&!a$4(o),n$a=o=>(o.key?o.key==="End":o.keyCode===y$4.END)&&!a$4(o),m$2=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$4.ESCAPE)&&!a$4(o),x$1=o=>(o.key?o.key==="Tab":o.keyCode===y$4.TAB)&&!a$4(o),j=o=>(o.key?o.key==="PageUp":o.keyCode===y$4.PAGE_UP)&&!a$4(o),q=o=>(o.key?o.key==="PageDown":o.keyCode===y$4.PAGE_DOWN)&&!a$4(o),Ko=o=>o.key==="Shift"||o.keyCode===y$4.SHIFT,a$4=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey),e$3=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k(o)===r;
  ...
  var l$6=(c=>(c.Static="Static",c.Cyclic="Cyclic",c))(l$6||{});

  const s$8=new Map,o$4=new Map,n$9=new Map,c$5=e=>{if(!s$8.has(e)){const a=b$2(e.split("-"));s$8.set(e,a);}return s$8.get(e)},l$5=e=>{if(!o$4.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$4.set(e,a);}return o$4.get(e)},p$1=e=>l$5(e),b$2=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$9.get(e);if(a)return a;const t=c$5(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$9.set(e,r),r};

  const o$3=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$8=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$7=t=>t.reduce((e,r)=>e.concat(n$8(r)),[]);

  let u$4 = class u{constructor(t){this.metadata=t;}getInitialState(){if(Object.prototype.hasOwnProperty.call(this,"_initialState"))return this._initialState;const t={};if(this.slotsAreManaged()){const o=this.getSlots();for(const[e,s]of Object.entries(o)){const n=s.propertyName||e;t[n]=[],t[c$5(n)]=t[n];}}return this._initialState=t,t}static validateSlotValue(t,a){return g$4(t,a)}getPureTag(){return this.metadata.tag||""}getTag(){const t=this.metadata.tag;if(!t)return "";const a=d$f(t);return a?`${t}-${a}`:t}hasAttribute(t){return !this.getProperties()[t].noAttribute}getPropertiesList(){return Object.keys(this.getProperties())}getAttributesList(){return this.getPropertiesList().filter(this.hasAttribute.bind(this)).map(l$5)}canSlotText(){return this.getSlots().default?.type===Node}hasSlots(){return !!Object.entries(this.getSlots()).length}hasIndividualSlots(){return this.slotsAreManaged()&&Object.values(this.getSlots()).some(t=>t.individualSlots)}slotsAreManaged(){return !!this.metadata.managedSlots}supportsF6FastNavigation(){return !!this.metadata.fastNavigation}getProperties(){return this.metadata.properties||(this.metadata.properties={}),this.metadata.properties}getEvents(){return this.metadata.events||(this.metadata.events={}),this.metadata.events}getSlots(){return this.metadata.slots||(this.metadata.slots={}),this.metadata.slots}isLanguageAware(){return !!this.metadata.languageAware}isThemeAware(){return !!this.metadata.themeAware}needsCLDR(){return !!this.metadata.cldr}getShadowRootOptions(){return this.metadata.shadowRootOptions||{}}isFormAssociated(){return !!this.metadata.formAssociated}shouldInvalidateOnChildChange(t,a,o){const e=this.getSlots()[t].invalidateOnChildChange;if(e===void 0)return  false;if(typeof e=="boolean")return e;if(typeof e=="object"){if(a==="property"){if(e.properties===void 0)return  false;if(typeof e.properties=="boolean")return e.properties;if(Array.isArray(e.properties))return e.properties.includes(o);throw new Error("Wrong format for invalidateOnChildChange.properties: boolean or array is expected")}if(a==="slot"){if(e.slots===void 0)return  false;if(typeof e.slots=="boolean")return e.slots;if(Array.isArray(e.slots))return e.slots.includes(o);throw new Error("Wrong format for invalidateOnChildChange.slots: boolean or array is expected")}}throw new Error("Wrong format for invalidateOnChildChange: boolean or object is expected")}getI18n(){return this.metadata.i18n||(this.metadata.i18n={}),this.metadata.i18n}};const g$4=(r,t)=>(r&&n$8(r).forEach(a=>{if(!(a instanceof t.type))throw new Error(`The element is not of type ${t.type.toString()}`)}),r);

  const r$4=()=>m$j("CustomStyle.eventProvider",new i$h),n$7="CustomCSSChange",i$5=t=>{r$4().attachEvent(n$7,t);},u$3=t=>r$4().fireEvent(n$7,t),c$4=()=>m$j("CustomStyle.customCSSFor",{});let s$6;i$5(t=>{s$6||b$a({tag:t});});const g$3=(t,e)=>{const o=c$4();o[t]||(o[t]=[]),o[t].push(e),s$6=true;try{u$3(t);}finally{s$6=false;}return b$a({tag:t})},l$4=t=>{const e=c$4();return e[t]?e[t].join(""):""};

  const e$2=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$1=new Map;i$5(t=>{e$1.delete(`${t}_normal`);});const y$3=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$w("OpenUI5Enablement");if(!e$1.has(n)){let l="";s&&(l=e$2(s.getBusyIndicatorStyles()));const a=l$4(o)||"",m=`${e$2(t.styles)} ${a} ${l}`;e$1.set(n,m);}return e$1.get(n)};

  const e=new Map;i$5(t=>{e.delete(`${t}_normal`);});const s$5=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e.has(n)){const a=y$3(t),o=new CSSStyleSheet;o.replaceSync(a),e.set(n,[o]);}return e.get(n)};

  const s$4=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$p(),...s$5(e)],e.renderer(o,t);};

  const r$3=[],o$2=t=>r$3.some(s=>t.startsWith(s));

  const t$2=new WeakMap,n$6=(e,o,r)=>{const s=new MutationObserver(o);t$2.set(e,s),s.observe(e,r);},b$1=e=>{const o=t$2.get(e);o&&(o.disconnect(),t$2.delete(e));};

  const r$2=t=>t.matches(":dir(rtl)")?"rtl":"ltr";

  const s$3=["disabled","title","hidden","role","draggable"],r$1=e=>s$3.includes(e)||e.startsWith("aria")?true:![HTMLElement,Element,Node].some(t=>t.prototype.hasOwnProperty(e));
  ...
  const T="legacy",s=new Map,c$1=m$j("SVGIcons.registry",new Map),i$1=m$j("SVGIcons.promises",new Map),l="ICON_NOT_FOUND",C=(e,t)=>{s.set(e,t);},N=async e=>{if(!i$1.has(e)){if(!s.has(e))throw new Error(`No loader registered for the ${e} icons collection. Probably you forgot to import the "AllIcons.js" module for the respective package.`);const t=s.get(e);i$1.set(e,t(e));}return i$1.get(e)},f=e=>{Object.keys(e.data).forEach(t=>{const o=e.data[t];y(t,{pathData:o.path||o.paths,ltr:o.ltr,viewBox:o.viewBox,accData:o.acc,collection:e.collection,packageName:e.packageName});});},y=(e,t)=>{const o=`${t.collection}/${e}`,a={collection:t.collection,packageName:t.packageName,pathData:t.pathData,viewBox:t.viewBox,ltr:t.ltr,accData:t.accData,customTemplate:t.customTemplate};c$1.set(o,a);},u=e=>{e.startsWith("sap-icon://")&&(e=e.replace("sap-icon://",""));let t;return [e,t]=e.split("/").reverse(),e=e.replace("icon-",""),t&&(t=n$h(t)),{name:e,collection:t}},D=e=>{const{name:t,collection:o}=u(e);return g(o,t)},n=async e=>{const{name:t,collection:o}=u(e);let a=l;try{a=await N(i$7(o));}catch(r){console.error(r.message);}if(a===l)return a;const p=g(o,t);return p||(Array.isArray(a)?a.forEach(r=>{f(r),c$a(o,{[r.themeFamily||T]:r.collection});}):f(a),g(o,t))},g=(e,t)=>{const o=`${i$7(e)}/${t}`;return c$1.get(o)},x=async e=>{if(!e)return;let t=D(e);if(t||(t=await n(e)),t&&t!==l&&t.accData)return t.packageName?(await f$5(t.packageName)).getText(t.accData):t.accData?.defaultText||""};
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    attachThemeLoaded: o$d,
    cancelRender: P$4,
    customElement: m$3,
    default: S$1,
    detachDirectionChange: c$2,
    detachLanguageChange: r$b,
    detachThemeLoaded: n$q,
    event: b$4,
    getAnimationMode: d$4,
    getCalendarType: i$9,
    getCustomElementsScopingRules: m$h,
    getCustomElementsScopingSuffix: c$m,
    getDefaultIconCollection: c$b,
    getDefaultLanguage: C$2,
    getDefaultTheme: y$7,
    getEffectiveDir: r$2,
    getEffectiveIconCollection: i$7,
    getEffectiveScopingSuffixForTag: d$f,
    getFetchDefaultLanguage: D$3,
    getFirstDayOfWeek: n$i,
    getI18nBundle: f$5,
    ...
    isTablet: a$e,
    property: s$9,
    registerCustomI18nBundleGetter: y$5,
    registerI18nLoader: $,
    registerIconLoader: C,
    registerLocaleDataLoader: m,
    registerThemePropertiesLoader: f$f,
    renderDeferred: l$g,
    renderFinished: w$6,
    renderImmediately: u$e,
    sanitizeHTML: fnSanitizeHTML,
    scroll: n$l,
    setAnimationMode: m$7,
    setCustomElementsScopingRules: g$e,
    setCustomElementsScopingSuffix: p$7,
    setDefaultIconCollection: e$7,
    setFetchDefaultLanguage: p$3,
    setIgnoreUrlParams: n$b,
    setLanguage: h$1,
    setNoConflict: f$4,
    setTheme: l$c,
    slideDown: b$5,
