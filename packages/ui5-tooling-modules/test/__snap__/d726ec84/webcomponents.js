sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  const p$9=t=>{const e=t.prototype.openEnd;t.prototype.openEnd=function(){return this._mAttributes.popover&&delete this._mAttributes.popover,e.apply(this)};};

  const o$m=(t,n=document.body,r)=>{let e=document.querySelector(t);return e||(e=r?r():document.createElement(t),n.insertBefore(e,n.firstChild))};

  const u$i=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$o=()=>typeof document>"u"?null:o$m('meta[name="ui5-shared-resources"]',document.head,u$i),m$i=(t,o)=>{const r=t.split(".");let e=l$o();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const g$d=m$i("Tags",new Map),d$b=new Set;let i$n=new Map,c$j;const m$h=-1,h$8=e=>{d$b.add(e),g$d.set(e,I$4());},w$7=e=>d$b.has(e),R$6=()=>d$b.size>0,T$3=()=>[...d$b.values()],$$3=e=>{let n=g$d.get(e);n===void 0&&(n=m$h),i$n.has(n)||i$n.set(n,new Set),i$n.get(n).add(e),c$j||(c$j=setTimeout(()=>{y$8(),i$n=new Map,c$j=void 0;},1e3));},y$8=()=>{const e=$$2(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$n.keys()].forEach(s=>{let o,r;s===m$h?(o=1,r={description:"Older unknown runtime"}):(o=b$b(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const e$k={version:"2.15.1",major:2,minor:15,patch:1,suffix:"",isNext:false,buildTime:1761052348};

  let s$u,t$p={include:[/^ui5-/],exclude:[]};const o$l=new Map,l$n=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$6()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$u=e;},c$i=()=>s$u,p$8=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$p=e,o$l.clear();},m$g=()=>t$p,i$m=e=>{if(!o$l.has(e)){const n=t$p.include.some(r=>e.match(r))&&!t$p.exclude.some(r=>e.match(r));o$l.set(e,n);}return o$l.get(e)},g$c=e=>{if(i$m(e))return c$i()};

  let i$l,s$t="";const u$h=new Map,r$k=m$i("Runtimes",[]),x$2=()=>{if(i$l===void 0){i$l=r$k.length;const e=e$k;r$k.push({...e,get scopingSuffix(){return c$i()},get registeredTags(){return T$3()},get scopingRules(){return m$g()},alias:s$t,description:`Runtime ${i$l} - ver ${e.version}${""}`});}},I$4=()=>i$l,b$b=(e,m)=>{const o=`${e},${m}`;if(u$h.has(o))return u$h.get(o);const t=r$k[e],n=r$k[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$h.set(o,l),l},$$2=()=>r$k;

  const g$b=typeof document>"u",i$k=(e,t)=>t?`${e}|${t}`:e,l$m=e=>e===void 0?true:b$b(I$4(),parseInt(e))===1,c$h=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$k(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$7=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$k(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$m(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$b?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$k(e,t)),f$e=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$k(e,t));},R$5=(e,t,r="",s)=>{S$4(t,r)?y$7(e,t,r,s):c$h(e,t,r,s);},m$f=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  var e$j = "[data-sap-ui-popup][popover]{border:none;overflow:visible;margin:0}";

  const o$k=()=>{S$4("data-ui5-popup-styles")||c$h(e$j,"data-ui5-popup-styles");};

  const n$v=m$i("AllOpenedPopupsRegistry",{openedRegistry:[]}),l$l=e=>{n$v.openedRegistry.push(e);},u$g=e=>{const t=n$v.openedRegistry.findIndex(o=>o.instance===e);t>-1&&n$v.openedRegistry.splice(t,1);},g$a=()=>n$v.openedRegistry[n$v.openedRegistry.length-1].instance,f$d=e=>{for(let t=n$v.openedRegistry.length-1;t>=0;t--){const o=n$v.openedRegistry[t];if(o.type!=="OpenUI5")return  false;if(o.instance===e)break}return  true},h$7=e=>{e.setAttribute("popover","manual"),e.showPopover();},v$4=e=>{e.hasAttribute("popover")&&(e.hidePopover(),e.removeAttribute("popover"));},a$l=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(t=>{const o=t.shadowRoot;return o&&a$l(o)}),O$2=e=>{const t=e.prototype.open;e.prototype.open=function(...p){t.apply(this,p);const s=a$l();if(["OPENING","OPEN"].includes(this.getOpenState())&&s){const r=this.getContent();if(r){const i=r instanceof HTMLElement?r:r?.getDomRef();i&&h$7(i);}}l$l({type:"OpenUI5",instance:this});};},m$e=e=>{const t=e.prototype._closed;e.prototype._closed=function(...p){const s=this.getContent(),c=s instanceof HTMLElement?s:s?.getDomRef();t.apply(this,p),c&&v$4(c),u$g(this);};},I$3=e=>{const t=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(p){f$d(this)&&t.call(this,p);};},P$8=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},E$3=e=>{o$k(),O$2(e),m$e(e),P$8(),I$3(e);};

  const e$i=new Map,s$s=(t,r)=>{e$i.set(t,r);},n$u=t=>e$i.get(t);

  var c$g={},e$h=c$g.hasOwnProperty,a$k=c$g.toString,o$j=e$h.toString,l$k=o$j.call(Object),i$j=function(r){var t,n;return !r||a$k.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$j.call(n)===l$k):true)};

  var c$f=Object.create(null),u$f=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$f;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$j(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$j(n)?n:{},r[a]=u$f(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$g=function(n,t){return u$f(true,false,...arguments)};

  const _$4={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$f=_$4.themes.default,s$r=_$4.themes.all,a$j=_$4.languages.default,r$j=_$4.locales.default,l$j=_$4.locales.all;

  const o$i=typeof document>"u",n$t={search(){return o$i?"":window.location.search}},s$q=()=>o$i?"":window.location.href,u$e=()=>n$t.search();

  const s$p=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$h=e=>{const t=s$p("sap-allowed-theme-origins")??s$p("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$i=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$9=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$q()).toString();else {const n=new URL(e),r=n.origin;r&&o$h(r)?t=n.toString():t=a$i(n.toString(),s$q());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  const e$e=new i$i,t$o="configurationReset",i$h=n=>{e$e.attachEvent(t$o,n);};

  let p$7=false,t$n={animationMode:u$d.Full,theme:e$f,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$5=()=>(o$g(),t$n.animationMode),T$2=()=>(o$g(),t$n.theme),S$3=()=>{if(o$g(),t$n.themeRoot!==void 0){if(!g$9(t$n.themeRoot)){console.warn(`The ${t$n.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$n.themeRoot}},L$3=()=>(o$g(),t$n.language),R$4=()=>(o$g(),t$n.fetchDefaultLanguage),F$1=()=>(o$g(),t$n.noConflict),U$2=()=>(o$g(),t$n.defaultFontLoading),b$a=()=>(o$g(),t$n.enableDefaultTooltips),D$3=()=>(o$g(),t$n.calendarType),M$3=()=>(o$g(),t$n.formatSettings),i$g=new Map;i$g.set("true",true),i$g.set("false",false);const w$6=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$n=e$g(t$n,e));}},z$1=()=>{const n=new URLSearchParams(u$e());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$8(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$8(r,e,"sap-ui");});},E$2=n=>{const e=n.split("@")[1];return g$9(e)},P$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$8=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$g.has(e)&&(e=i$g.get(a)),s==="theme"?(t$n.theme=P$7(s,e),e&&e.includes("@")&&(t$n.themeRoot=E$2(e))):t$n[s]=e;},j$1=()=>{const n=n$u("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$n=e$g(t$n,e);},o$g=()=>{typeof document>"u"||p$7||(l$i(),p$7=true);},l$i=n=>{w$6(),z$1(),j$1();};
  ...
  const t$m=new Set,n$s=e=>{t$m.add(e);},r$i=e=>t$m.has(e);

  const s$o=new Set,d$a=new i$i,n$r=new l$h;let t$l,a$h,m$d,i$f;const l$g=async e=>{n$r.add(e),await P$6();},c$e=e=>{d$a.fireEvent("beforeComponentRender",e),s$o.add(e),e._render();},h$6=e=>{n$r.remove(e),s$o.delete(e);},P$6=async()=>{i$f||(i$f=new Promise(e=>{window.requestAnimationFrame(()=>{n$r.process(c$e),i$f=null,e(),m$d||(m$d=setTimeout(()=>{m$d=void 0,n$r.isEmpty()&&U$1();},200));});})),await i$f;},y$6=()=>t$l||(t$l=new Promise(e=>{a$h=e,window.requestAnimationFrame(()=>{n$r.isEmpty()&&(t$l=void 0,e());});}),t$l),I$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$c=async()=>{await I$2(),await y$6();},U$1=()=>{n$r.isEmpty()&&a$h&&(a$h(),a$h=void 0,t$l=void 0);},C$4=async e=>{s$o.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$g(r);}),await f$c();};

  const t$k=new i$i,r$h="themeRegistered",n$q=e=>{t$k.attachEvent(r$h,e);},s$n=e=>t$k.fireEvent(r$h,e);

  const l$f=new Map,h$5=new Map,u$c=new Map,T$1=new Set,i$e=new Set,p$6=(e,r,t)=>{h$5.set(`${e}/${r}`,t),T$1.add(e),i$e.add(r),s$n(r);},m$c=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$f.get(g);if(s!==void 0)return s;if(!i$e.has(r)){const $=[...i$e.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$g(e,e$f)}const[n,d]=await Promise.all([a$g(e,r),t?a$g(e,t,true):void 0]),o=m$f(n,d);return o&&l$f.set(g,o),o},a$g=async(e,r,t=false)=>{const s=(t?u$c:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$1,P$5=e=>i$e.has(e);

  const r$g=new Set,s$m=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$f=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$9=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$b=()=>{const e=s$m();if(!e||e==="none")return;const t=o$f(e);if(t)return d$9(t)};

  const t$j=new i$i,d$8="themeLoaded",o$e=e=>{t$j.attachEvent(d$8,e);},n$p=e=>{t$j.detachEvent(d$8,e);},r$f=e=>t$j.fireEvent(d$8,e);
  ...
  let t$i;i$h(()=>{t$i=void 0;});const n$o=()=>(t$i===void 0&&(t$i=S$3()),t$i),u$b=e=>`${n$o()}Base/baseLib/${e}/css_variables.css`,i$d=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$7(u$b(e),{"sap-ui-webcomponents-theme":e});};

  let _lib="ui5",_package="webcomponents-theming";const s$l="@"+_lib+"/"+_package,S$2=()=>w$5().has(s$l),P$4=async e=>{if(!S$2())return;const t=await m$c(s$l,e);t&&R$5(t,"data-ui5-theme-properties",s$l,e);},E$1=()=>{f$e("data-ui5-theme-properties",s$l);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$l)return;const i=await m$c(a,e,t);i&&R$5(i,`data-ui5-component-properties-${I$4()}`,a);});return Promise.all(o)},k$2=async e=>{const t=m$b();if(t)return t;const r=n$u("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$o())return await i$d(e),m$b()},w$4=async e=>{const t=await k$2(e);!t||e!==t.themeName?await P$4(e):E$1();const r=P$5(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};

  const d$6=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$n = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$d;i$h(()=>{o$d=void 0;});const a$f=()=>(o$d===void 0&&(o$d=U$2()),o$d);

  const a$e=()=>{const t=n$u("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$b();},f$b=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$f()||t||S$4("data-ui5-font-face")||c$h(n$n,"data-ui5-font-face");};

  var a$d = ":root{--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5_content_density:compact}";

  const e$d=()=>{S$4("data-ui5-system-css-vars")||c$h(a$d,"data-ui5-system-css-vars");};
   ...
   */
  var t$d;const i$a=window,s$i=i$a.trustedTypes,e$b=s$i?s$i.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$a="$lit$",n$l=`lit$${(Math.random()+"").slice(9)}$`,l$c="?"+n$l,h$2=`<${l$c}>`,r$b=document,u$8=()=>r$b.createComment(""),d$4=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$c=Array.isArray,v$3=t=>c$c(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$a="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$3=/-->/g,m$9=/>/g,p$4=RegExp(`>|${a$a}(?:([^\\s"'>=/]+)(${a$a}*=${a$a}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$5=/'/g,$$1=/"/g,y$5=/^(?:script|style|textarea|title)$/i,w$2=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$1=w$2(1),b$7=w$2(2),T=Symbol.for("lit-noChange"),A$3=Symbol.for("lit-nothing"),E=new WeakMap,C$3=r$b.createTreeWalker(r$b,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$b?e$b.createHTML(i):i}const V=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$3:void 0!==c[1]?u=m$9:void 0!==c[2]?(y$5.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$4):void 0!==c[3]&&(u=p$4):u===p$4?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$4:'"'===c[3]?$$1:g$5):u===$$1||u===g$5?u=p$4:u===_$3||u===m$9?u=f$9:(u=p$4,l=void 0);const w=u===p$4&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$2:v>=0?(e.push(d),s.slice(0,v)+o$a+s.slice(v)+n$l+w):s+n$l+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V(t,i);if(this.el=N.createElement(a,e),C$3.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$3.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$a)||i.startsWith(n$l)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$a).split(n$l),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H:"?"===i[1]?L$2:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$5.test(h.tagName)){const t=h.textContent.split(n$l),i=t.length-1;if(i>0){h.textContent=s$i?s$i.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$8()),C$3.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$8());}}}else if(8===h.nodeType)if(h.data===l$c)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$l,t+1));)v.push({type:7,index:r}),t+=n$l.length-1;}r++;}}static createElement(t,i){const s=r$b.createElement("template");return s.innerHTML=t,s}};function S$1(t,i,s=t,e){var o,n,l,h;if(i===T)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$4(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$1(t,r._$AS(t,i.values),r,e)),i}let M$2 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$b).importNode(s,true);C$3.currentNode=o;let n=C$3.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$3(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$3.nextNode(),l++);}return C$3.currentNode=r$b,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$3 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$3,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$1(this,t,i),d$4(t)?t===A$3||null==t||""===t?(this._$AH!==A$3&&this._$AR(),this._$AH=A$3):t!==this._$AH&&t!==T&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$3(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$3&&d$4(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$b.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$2(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$1(t)),i}T(t){c$c(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$8()),this.k(u$8()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$3,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$3;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$1(this,t,i,0),n=!d$4(t)||t!==this._$AH&&t!==T,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$1(this,e[s+l],i,l),h===T&&(h=this._$AH[l]),n||(n=!d$4(h)||h!==this._$AH[l]),h===A$3?t=A$3:t!==A$3&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$3?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$3?void 0:t;}}const I$1=s$i?s$i.emptyScript:"";let L$2 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$3?this.element.setAttribute(this.name,I$1):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$1(this,t,i,0))&&void 0!==s?s:A$3)===T)return;const e=this._$AH,o=t===A$3&&e!==A$3||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$3&&(e===A$3||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$1(this,t);}}const B$1=i$a.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$3),(null!==(t$d=i$a.litHtmlVersions)&&void 0!==t$d?t$d:i$a.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$a=Symbol.for(""),l$b=t=>{if((null==t?void 0:t.r)===e$a)return null==t?void 0:t._$litStatic$},o$9=t=>({_$litStatic$:t,r:e$a}),s$h=new Map,a$9=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$b(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$h.get(t))&&(n.raw=n,s$h.set(t,r=n)),e=u;}return t(r,...e)},n$k=a$9(x$1),u$7=a$9(b$7);

  let t$c = class t{static{this.html=n$k;}static{this.svg=u$7;}static{this.unsafeStatic=o$9;}};s$s("LitStatic",t$c);

  const t$b=new WeakMap;let a$8 = class a{static get tasks(){return t$b}static enqueue(s,e){t$b.has(s)||t$b.set(s,[]),t$b.get(s).push(e);}static run(s,e){return t$b.has(s)||t$b.set(s,[]),e().then(()=>{const T=t$b.get(s);if(T.length>0)return a.run(s,T.shift());t$b.delete(s);})}static push(s,e){t$b.get(s)?a.enqueue(s,e):a.run(s,e);}};

  const f$8=e=>{let n=null,a=false,i,o,r;const m=new Promise((t,c)=>{r=u=>{n=n||u;const d=u-n,l=e.duration-d;if(d<=e.duration){const s=1-l/e.duration;e.advance(s),a||(i=requestAnimationFrame(r));}else e.advance(1),t();},o=()=>{a=true,cancelAnimationFrame(i),c(new Error("animation stopped"));};}).catch(t=>t);return a$8.push(e.element,()=>(typeof e.beforeStart=="function"&&e.beforeStart(),requestAnimationFrame(r),new Promise(t=>{m.then(()=>t());}))),{promise:()=>m,stop:()=>o}},v$2=400;

  const n$j=(r,c,a)=>{let o,l;return f$8({beforeStart:()=>{o=r.scrollLeft,l=r.scrollTop;},duration:v$2,element:r,advance:t=>{r.scrollLeft=o+t*c,r.scrollTop=l+t*a;}})};

  const b$6=t=>{let o,a,d,r,s,p,g,y,n,l,h,T;const B=f$8({beforeStart:()=>{t.style.display="block",o=getComputedStyle(t),a=parseFloat(o.paddingTop),d=parseFloat(o.paddingBottom),r=parseFloat(o.marginTop),s=parseFloat(o.marginBottom),p=parseFloat(o.height),g=t.style.overflow,y=t.style.paddingTop,n=t.style.paddingBottom,l=t.style.marginTop,h=t.style.marginBottom,T=t.style.height,t.style.overflow="hidden",t.style.paddingTop="0",t.style.paddingBottom="0",t.style.marginTop="0",t.style.marginBottom="0",t.style.height="0";},duration:v$2,element:t,advance:i=>{t.style.display="block",t.style.paddingTop=`${a*i}px`,t.style.paddingBottom=`${d*i}px`,t.style.marginTop=`${r*i}px`,t.style.marginBottom=`${s*i}px`,t.style.height=`${p*i}px`;}});return B.promise().then(()=>{t.style.overflow=g,t.style.paddingTop=y,t.style.paddingBottom=n,t.style.marginTop=l,t.style.marginBottom=h,t.style.height=T;}),B};

  const u$6=o=>{let i,a,r,d,n,s,p,g,e,l,y,m;const h=f$8({beforeStart:()=>{const t=o;i=getComputedStyle(t),a=parseFloat(i.paddingTop),r=parseFloat(i.paddingBottom),d=parseFloat(i.marginTop),n=parseFloat(i.marginBottom),s=parseFloat(i.height),p=t.style.overflow,g=t.style.paddingTop,e=t.style.paddingBottom,l=t.style.marginTop,y=t.style.marginBottom,m=t.style.height,t.style.overflow="hidden";},duration:v$2,element:o,advance:t=>{o.style.paddingTop=`${a-a*t}px`,o.style.paddingBottom=`${r-r*t}px`,o.style.marginTop=`${d-d*t}px`,o.style.marginBottom=`${n-n*t}px`,o.style.height=`${s-s*t}px`;}});return h.promise().then(t=>{t instanceof Error||(o.style.overflow=p,o.style.paddingTop=g,o.style.paddingBottom=e,o.style.marginTop=l,o.style.marginBottom=y,o.style.height=m,o.style.display="none");}),h};

  let n$i;i$h(()=>{n$i=void 0;});const d$3=()=>(n$i===void 0&&(n$i=C$5()),n$i),m$8=o=>{Object.values(u$d).includes(o)&&(n$i=o);};

  var s$g=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$g||{});

  let n$h;i$h(()=>{n$h=void 0;});const i$9=()=>(n$h===void 0&&(n$h=D$3()),n$h&&n$h in s$g?n$h:s$g.Gregorian);

  let t$a;let a$7 = class a{static getLegacyDateCalendarCustomizing(){return t$a===void 0&&(t$a=M$3()),t$a.legacyDateCalendarCustomizing||[]}};s$s("LegacyDateFormats",a$7);

  let e$9;i$h(()=>{e$9=void 0;});const n$g=()=>(e$9===void 0&&(e$9=M$3()),e$9.firstDayOfWeek),i$8=n$u("LegacyDateFormats"),m$7=i$8?a$7.getLegacyDateCalendarCustomizing:()=>[];

  const t$9=new Map,e$8=(n,o)=>{t$9.set(n,o);},c$b=n=>t$9.get(n);

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$f=new Map;s$f.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$f.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$f.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$a=(n,e)=>{if(s$f.has(n)){s$f.set(n,{...e,...s$f.get(n)});return}s$f.set(n,e);},r$a=n=>{const e=n$m()?"legacy":"sap_horizon";return s$f.has(n)?s$f.get(n)[e]:n};

  var t$7=(s=>(s["SAP-icons"]="SAP-icons-v4",s.horizon="SAP-icons-v5",s["SAP-icons-TNT"]="tnt",s.BusinessSuiteInAppSymbols="business-suite",s))(t$7||{});const n$f=e=>t$7[e]?t$7[e]:e;

  const i$7=o=>{const t=c$b(r$c());return !o&&t?n$f(t):o?r$a(o):r$a("SAP-icons")};

  var s$e = ":host{justify-content:center;align-items:center;display:flex;color:var(--sapList_TextColor);background-color:var(--sapList_Background);font-family:var(--sapFontFamily);height:var(--sapElement_LineHeight);border-bottom:var(--sapList_BorderWidth) solid var(--sapList_BorderColor);opacity:.8;position:absolute;padding:0 1rem;top:-1000px;left:-1000px}";

  const t$6=typeof document>"u",o$8=()=>{if(t$6)return a$j;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$j};

  const e$7=new i$i,n$e="languageChange",t$5=a=>{e$7.attachEvent(n$e,a);},r$9=a=>{e$7.detachEvent(n$e,a);},o$7=a=>e$7.fireEventAsync(n$e,a);

  let e$6,t$4;i$h(()=>{e$6=void 0,t$4=void 0;});let a$6=false;const s$d=()=>a$6,l$a=()=>(e$6===void 0&&(e$6=L$3()),e$6),L$1=async n=>{e$6!==n&&(a$6=true,e$6=n,await o$7(n),a$6=false,h$3()&&await C$4({languageAware:true}));},c$9=()=>a$j,m$6=n=>{t$4=n;},h$1=()=>(t$4===void 0&&(t$4=R$4()),t$4);

  const n$d=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$8 = class r{constructor(s){const t=n$d.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$j,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

  const r$7=new Map,n$c=t=>(r$7.has(t)||r$7.set(t,new r$8(t)),r$7.get(t)),c$8=t=>{try{if(t&&typeof t=="string")return n$c(t)}catch{}return new r$8(r$j)},s$c=t=>{const e=l$a();return e?n$c(e):c$8(o$8())};

  const _$2=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$7=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$3=i=>{let e;if(!i)return r$j;if(typeof i=="string"&&(e=_$2.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$7.exec(o))||r&&(e=c$7.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$j};

  const r$6={zh_HK:"zh_TW",in:"id"},n$b=t=>{if(!t)return r$j;if(r$6[t])return r$6[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$j?r$j:""};

  const d$2=new Set,m$5=new Set,g$4=new Map,l$9=new Map,u$5=new Map,$=(n,t,e)=>{const r=`${n}/${t}`;u$5.set(r,e);},f$6=(n,t)=>{g$4.set(n,t);},A$2=n=>g$4.get(n),h=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$9.get(e)&&l$9.set(e,r(t)),l$9.get(e)},M$1=n=>{d$2.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$2.add(n));},L=(n,t)=>t!==a$j&&!h(n,t),w$1=async n=>{const t=s$c().getLanguage(),e=s$c().getRegion(),r=s$c().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L(n,s))for(s=p$3(s);L(n,s);)s=n$b(s);const I=h$1();if(s===a$j&&!I){f$6(n,null);return}if(!h(n,s)){M$1(n);return}try{const o=await B(n,s);f$6(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$4.keys()];return Promise.all(t.map(w$1))});
  ...
  const r$5=new Map;let s$b;let u$4 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$5=n=>{if(r$5.has(n))return r$5.get(n);const e=new u$4(n);return r$5.set(n,e),e},f$5=async n=>s$b?s$b(n):(await w$1(n),a$5(n)),y$4=n=>{s$b=n;};

  const e$5={key:"DRAG_DROP_MULTIPLE_TEXT",defaultText:"{0} items"};

  const l$8=2;const u$3=async e=>{const t=document.createElement("div"),n=await f$5("@ui5/webcomponents-base"),r=t.attachShadow({mode:"open"}),o=new CSSStyleSheet;return o.replaceSync(s$e),r.adoptedStyleSheets=[o],r.textContent=n.getText(e$5,e),t},m$4=async(e,t)=>{if(e<l$8){console.warn(`Cannot start multiple drag with count ${e}. Minimum is ${l$8}.`);return}if(!t.dataTransfer)return;const n=await u$3(e);document.body.appendChild(n),t.dataTransfer.setDragImage(n,0,0),requestAnimationFrame(()=>{n.remove();});};

  const c$6=["value-changed","click"];let e$4;i$h(()=>{e$4=void 0;});const s$a=t=>c$6.includes(t),l$7=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$4===void 0&&(e$4=F$1()),e$4),f$4=t=>{e$4=t;},a$4=t=>{const n=o$6();return s$a(t)?false:n===true?true:!l$7(t)};
  ...
  const y$3={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,ARROW_LEFT:37,ARROW_UP:38,ARROW_RIGHT:39,ARROW_DOWN:40},b$4=o=>(o.key?o.key==="Enter":o.keyCode===y$3.ENTER)&&!a$3(o),A$1=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$3.SPACE)&&!a$3(o),D$2=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$3.ARROW_LEFT)&&!a$3(o),R$2=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$3.ARROW_RIGHT)&&!a$3(o),P=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$3.ARROW_UP)&&!a$3(o),_$1=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$3.ARROW_DOWN)&&!a$3(o),M=o=>(o.key?o.key==="Home":o.keyCode===y$3.HOME)&&!a$3(o),n$a=o=>(o.key?o.key==="End":o.keyCode===y$3.END)&&!a$3(o),m$2=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$3.ESCAPE)&&!a$3(o),x=o=>(o.key?o.key==="Tab":o.keyCode===y$3.TAB)&&!a$3(o),j=o=>(o.key?o.key==="PageUp":o.keyCode===y$3.PAGE_UP)&&!a$3(o),q=o=>(o.key?o.key==="PageDown":o.keyCode===y$3.PAGE_DOWN)&&!a$3(o),Ko=o=>o.key==="Shift"||o.keyCode===y$3.SHIFT,a$3=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey);
  ...
  const s$8=new Map,o$5=new Map,n$9=new Map,c$5=e=>{if(!s$8.has(e)){const a=b$3(e.split("-"));s$8.set(e,a);}return s$8.get(e)},l$5=e=>{if(!o$5.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$5.set(e,a);}return o$5.get(e)},p$2=e=>l$5(e),b$3=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$2=e=>{const a=n$9.get(e);if(a)return a;const t=c$5(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$9.set(e,r),r};

  const o$4=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$8=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$7=t=>t.reduce((e,r)=>e.concat(n$8(r)),[]);

  let p$1 = class p{constructor(t){this.metadata=t;}getInitialState(){if(Object.prototype.hasOwnProperty.call(this,"_initialState"))return this._initialState;const t={};if(this.slotsAreManaged()){const o=this.getSlots();for(const[e,s]of Object.entries(o)){const n=s.propertyName||e;t[n]=[],t[c$5(n)]=t[n];}}return this._initialState=t,t}static validateSlotValue(t,a){return g$2(t,a)}getPureTag(){return this.metadata.tag||""}getTag(){const t=this.metadata.tag;if(!t)return "";const a=g$c(t);return a?`${t}-${a}`:t}hasAttribute(t){const a=this.getProperties()[t];return a.type!==Object&&a.type!==Array&&!a.noAttribute}getPropertiesList(){return Object.keys(this.getProperties())}getAttributesList(){return this.getPropertiesList().filter(this.hasAttribute.bind(this)).map(l$5)}canSlotText(){return this.getSlots().default?.type===Node}hasSlots(){return !!Object.entries(this.getSlots()).length}hasIndividualSlots(){return this.slotsAreManaged()&&Object.values(this.getSlots()).some(t=>t.individualSlots)}slotsAreManaged(){return !!this.metadata.managedSlots}supportsF6FastNavigation(){return !!this.metadata.fastNavigation}getProperties(){return this.metadata.properties||(this.metadata.properties={}),this.metadata.properties}getEvents(){return this.metadata.events||(this.metadata.events={}),this.metadata.events}getSlots(){return this.metadata.slots||(this.metadata.slots={}),this.metadata.slots}isLanguageAware(){return !!this.metadata.languageAware}isThemeAware(){return !!this.metadata.themeAware}needsCLDR(){return !!this.metadata.cldr}getShadowRootOptions(){return this.metadata.shadowRootOptions||{}}isFormAssociated(){return !!this.metadata.formAssociated}shouldInvalidateOnChildChange(t,a,o){const e=this.getSlots()[t].invalidateOnChildChange;if(e===void 0)return  false;if(typeof e=="boolean")return e;if(typeof e=="object"){if(a==="property"){if(e.properties===void 0)return  false;if(typeof e.properties=="boolean")return e.properties;if(Array.isArray(e.properties))return e.properties.includes(o);throw new Error("Wrong format for invalidateOnChildChange.properties: boolean or array is expected")}if(a==="slot"){if(e.slots===void 0)return  false;if(typeof e.slots=="boolean")return e.slots;if(Array.isArray(e.slots))return e.slots.includes(o);throw new Error("Wrong format for invalidateOnChildChange.slots: boolean or array is expected")}}throw new Error("Wrong format for invalidateOnChildChange: boolean or object is expected")}getI18n(){return this.metadata.i18n||(this.metadata.i18n={}),this.metadata.i18n}};const g$2=(r,t)=>(r&&n$8(r).forEach(a=>{if(!(a instanceof t.type))throw new Error(`The element is not of type ${t.type.toString()}`)}),r);

  const r$3=()=>m$i("CustomStyle.eventProvider",new i$i),n$7="CustomCSSChange",i$5=t=>{r$3().attachEvent(n$7,t);},u$2=t=>r$3().fireEvent(n$7,t),c$4=()=>m$i("CustomStyle.customCSSFor",{});let s$6;i$5(t=>{s$6||C$4({tag:t});});const g$1=(t,e)=>{const o=c$4();o[t]||(o[t]=[]),o[t].push(e),s$6=true;try{u$2(t);}finally{s$6=false;}return C$4({tag:t})},l$4=t=>{const e=c$4();return e[t]?e[t].join(""):""};

  const e$3=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$2=new Map;i$5(t=>{e$2.delete(`${t}_normal`);});const y$2=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$u("OpenUI5Enablement");if(!e$2.has(n)){let l="";s&&(l=e$3(s.getBusyIndicatorStyles()));const a=l$4(o)||"",m=`${e$3(t.styles)} ${a} ${l}`;e$2.set(n,m);}return e$2.get(n)};

  const e$1=new Map;i$5(t=>{e$1.delete(`${t}_normal`);});const s$5=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$1.has(n)){const a=y$2(t),o=new CSSStyleSheet;o.replaceSync(a),e$1.set(n,[o]);}return e$1.get(n)};

  const s$4=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=s$5(e),e.renderer(o,t);};

  const r$2=[],o$3=t=>r$2.some(s=>t.startsWith(s));

  const t$2=new WeakMap,n$6=(e,o,r)=>{const s=new MutationObserver(o);t$2.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$2.get(e);o&&(o.disconnect(),t$2.delete(e));};

  const r$1=t=>t.matches(":dir(rtl)")?"rtl":"ltr";

  const s$3=["disabled","title","hidden","role","draggable"],r=e=>s$3.includes(e)||e.startsWith("aria")?true:![HTMLElement,Element,Node].some(t=>t.prototype.hasOwnProperty(e));
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    getCalendarType: i$9,
    getCustomElementsScopingRules: m$g,
    getCustomElementsScopingSuffix: c$i,
    getDefaultIconCollection: c$b,
    getDefaultLanguage: c$9,
    getDefaultTheme: g$6,
    getEffectiveDir: r$1,
    getEffectiveIconCollection: i$7,
    getEffectiveScopingSuffixForTag: g$c,
    ...
    isTablet: a$c,
    property: s$9,
    registerCustomI18nBundleGetter: y$4,
    registerI18nLoader: $,
    registerIconLoader: C,
    registerLocaleDataLoader: C$1,
    registerThemePropertiesLoader: p$6,
    renderDeferred: l$g,
    renderFinished: f$c,
    renderImmediately: c$e,
    sanitizeHTML: fnSanitizeHTML,
    scroll: n$j,
    setAnimationMode: m$8,
    setCustomElementsScopingRules: p$8,
    setCustomElementsScopingSuffix: l$n,
    setDefaultIconCollection: e$8,
    setFetchDefaultLanguage: m$6,
    setLanguage: L$1,
    setNoConflict: f$4,
    setTheme: u$9,
    slideDown: b$6,
