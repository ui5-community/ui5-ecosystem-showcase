sap.ui.define(['module', 'exports'], (function (module, exports) { 'use strict';
  ...
  const o$k=(t,n=document.body,r)=>{let e=document.querySelector(t);return e||(e=r?r():document.createElement(t),n.insertBefore(e,n.firstChild))};

  const u$i=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$l=()=>typeof document>"u"?null:o$k('meta[name="ui5-shared-resources"]',document.head,u$i),m$j=(t,o)=>{const r=t.split(".");let e=l$l();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const g$f=m$j("Tags",new Map),d$f=new Set;let i$n=new Map,c$m;const m$i=-1,h$8=e=>{d$f.add(e),g$f.set(e,I$4());},w$7=e=>d$f.has(e),R$4=()=>d$f.size>0,T$4=()=>[...d$f.values()],$$3=e=>{let n=g$f.get(e);n===void 0&&(n=m$i),i$n.has(n)||i$n.set(n,new Set),i$n.get(n).add(e),c$m||(c$m=setTimeout(()=>{y$b(),i$n=new Map,c$m=void 0;},1e3));},y$b=()=>{const e=$$2(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$n.keys()].forEach(s=>{let o,r;s===m$i?(o=1,r={description:"Older unknown runtime"}):(o=b$b(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${i$n.get(s).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...i$n.get(s)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const e$j={version:"2.22.0",major:2,minor:22,patch:0,suffix:"",isNext:false,buildTime:1778494735};

  let s$u,t$s={include:[/./],exclude:[]};const o$j=new Map,p$9=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$4()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$u=e;},c$l=()=>s$u,g$e=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$s=e,o$j.clear();},m$h=()=>t$s,i$m=e=>{if(!o$j.has(e)){const n=t$s.include.some(r=>e.match(r))&&!t$s.exclude.some(r=>e.match(r));o$j.set(e,n);}return o$j.get(e)},d$e=e=>{if(i$m(e))return c$l()};

  let i$l,s$t="";const u$h=new Map,n$w=m$j("Runtimes",[]),x$3=()=>{if(i$l===void 0){i$l=n$w.length;const t=e$j;n$w.push({...t,get scopingSuffix(){return c$l()},get registeredTags(){return T$4()},get scopingRules(){return m$h()},alias:s$t,description:`Runtime ${i$l} - ver ${t.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("webcomponents"), document.baseURI).href});}},I$4=()=>i$l,b$b=(t,m)=>{const o=`${t},${m}`;if(u$h.has(o))return u$h.get(o);const e=n$w[t],r=n$w[m];if(!e||!r)throw new Error("Invalid runtime index supplied");if(e.isNext||r.isNext)return e.buildTime-r.buildTime;const c=e.major-r.major;if(c)return c;const a=e.minor-r.minor;if(a)return a;const f=e.patch-r.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,r.suffix);return u$h.set(o,l),l},$$2=()=>n$w;

  const g$d=typeof document>"u",i$k=(e,t)=>t?`${e}|${t}`:e,l$k=e=>e===void 0?true:b$b(I$4(),parseInt(e))>=1,c$k=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$k(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$a=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$k(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$k(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$5=(e,t="")=>g$d?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$k(e,t)),f$i=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$k(e,t));},R$3=(e,t,r="",s)=>{S$5(t,r)?y$a(e,t,r,s):c$k(e,t,r,s);},m$g=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;
  ...
  const p$8=m$j("AllOpenedPopupsRegistry",{openedRegistry:[]}),i$j=e=>{p$8.openedRegistry.push(e);},a$m=e=>{const o=p$8.openedRegistry.findIndex(t=>t.instance===e);o===p$8.openedRegistry.length-1&&I$3(),o>-1&&p$8.openedRegistry.splice(o,1);},c$j=()=>p$8.openedRegistry.length===0?null:p$8.openedRegistry[p$8.openedRegistry.length-1].instance,l$j=e=>{for(let o=p$8.openedRegistry.length-1;o>=0;o--){const t=p$8.openedRegistry[o];if(t.type==="WebComponent")return  true;if(t.instance===e)break}return  false},s$s=e=>{const o=e.getContent();return o instanceof HTMLElement?o:o?.getDomRef()||null},d$d=e=>{if(!["OPENING","OPEN"].includes(e.getOpenState())||!r$p())return;const t=s$s(e);if(!t)return;const n=document.getElementById("sap-ui-blocklayer-popup");e.getModal()&&n&&(n.setAttribute("popover","manual"),n.hidePopover(),n.showPopover()),t.setAttribute("popover","manual"),t.showPopover();},g$c=e=>{const o=s$s(e);if(o&&(o.hasAttribute("popover")&&(o.hidePopover(),o.removeAttribute("popover")),c$j()===e&&e.getModal())){const t=document.getElementById("sap-ui-blocklayer-popup");t&&t.hasAttribute("popover")&&t.hidePopover();}},I$3=()=>{if(!r$p())return;const e=p$8.openedRegistry[p$8.openedRegistry.length-2];if(!e||e.type!=="OpenUI5"||!e.instance.getModal())return;const o=s$s(e.instance),t=document.getElementById("sap-ui-blocklayer-popup");o?.hidePopover(),t?.showPopover(),o?.showPopover();},r$p=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(o=>{const t=o.shadowRoot;return t&&r$p(t)}),P$6=e=>{const o=e.prototype.onsapescape;e.prototype.onsapescape=function(...n){l$j(this.oPopup)||o.apply(this,n);};},h$7=e=>{const o=e.prototype.open;e.prototype.open=function(...n){o.apply(this,n),d$d(this),i$j({type:"OpenUI5",instance:this});};},O$4=e=>{const o=e.prototype._closed;e.prototype._closed=function(...n){g$c(this),o.apply(this,n),a$m(this);};},f$h=e=>{const o=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(...n){l$j(this)||o.apply(this,n);};},v$3=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},m$f=(e,o)=>{o$i(),h$7(e),O$4(e),v$3(),f$h(e),P$6(o);};

  const e$h=new Map,s$r=(t,r)=>{e$h.set(t,r);},n$v=t=>e$h.get(t);

  var c$i={},e$g=c$i.hasOwnProperty,a$l=c$i.toString,o$h=e$g.toString,l$i=o$h.call(Object),i$i=function(r){var t,n;return !r||a$l.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$g.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$i):true)};

  var c$h=Object.create(null),u$g=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$h;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$i(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$i(n)?n:{},r[a]=u$g(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$f=function(n,t){return u$g(true,false,...arguments)};

  const _$3={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_auto","sap_horizon_dark","sap_horizon_hc_auto","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$e=_$3.themes.default,s$q=_$3.themes.all,a$k=_$3.languages.default,r$o=_$3.locales.default,n$u=_$3.locales.all;
  ...
  const o$g=typeof document>"u",n$t={search(){return o$g?"":window.location.search}},s$p=()=>o$g?"":window.location.href,u$e=()=>n$t.search();

  let u$d=false,t$q={animationMode:u$f.Full,theme:e$e,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const y$9=()=>(o$f(),t$q.animationMode),C$7=()=>(o$f(),t$q.theme),T$3=()=>(o$f(),t$q.themeRoot),S$4=()=>(o$f(),t$q.language),L$6=()=>(o$f(),t$q.fetchDefaultLanguage),F=()=>(o$f(),t$q.noConflict),U$2=()=>(o$f(),t$q.defaultFontLoading),b$a=()=>(o$f(),t$q.enableDefaultTooltips),D$4=()=>(o$f(),t$q.calendarType),R$2=()=>(o$f(),t$q.formatSettings),i$f=new Map;i$f.set("true",true),i$f.set("false",false);const M$4=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$q=e$f(t$q,e));}},z$1=()=>{const n=new URLSearchParams(u$e());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||p$7(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&p$7(a,e,"sap-ui");});},E$2=n=>n.split("@")[1],P$5=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,p$7=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$f.has(e)&&(e=i$f.get(r)),s==="theme"?(t$q.theme=P$5(s,e),e&&e.includes("@")&&(t$q.themeRoot=E$2(e))):t$q[s]=e;},w$6=()=>{const n=n$v("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$q=e$f(t$q,e);},o$f=()=>{typeof document>"u"||u$d||(g$b(),u$d=true);},g$b=n=>{M$4(),z$1(),w$6();};
  ...
  const t$p=new Set,n$s=e=>{t$p.add(e);},r$n=e=>t$p.has(e);

  const s$o=new Set,d$c=new i$h,n$r=new l$h;let t$o,a$j,m$e,i$e;const l$g=async e=>{n$r.add(e),await P$4();},c$g=e=>{d$c.fireEvent("beforeComponentRender",e),s$o.add(e),e._render();},h$6=e=>{n$r.remove(e),s$o.delete(e);},P$4=async()=>{i$e||(i$e=new Promise(e=>{window.requestAnimationFrame(()=>{n$r.process(c$g),i$e=null,e(),m$e||(m$e=setTimeout(()=>{m$e=void 0,n$r.isEmpty()&&U$1();},200));});})),await i$e;},y$8=()=>t$o||(t$o=new Promise(e=>{a$j=e,window.requestAnimationFrame(()=>{n$r.isEmpty()&&(t$o=void 0,e());});}),t$o),I$2=()=>{const e=T$4().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$g=async()=>{await I$2(),await y$8();},U$1=()=>{n$r.isEmpty()&&a$j&&(a$j(),a$j=void 0,t$o=void 0);},C$6=async e=>{s$o.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$n(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$g(r);}),await f$g();};

  const t$n=new i$h,r$m="themeRegistered",n$q=e=>{t$n.attachEvent(r$m,e);},s$n=e=>t$n.fireEvent(r$m,e);

  const l$f=new Map,T$2=new Map,h$5=new Map,u$c=new Map,a$i=new Set,f$f=(e,r,t,s="root")=>{T$2.set(`${e}/${r}`,t),u$c.set(e,{cssVariablesTarget:s}),a$i.add(r),s$n(r);},L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$f.get(s);if(o!==void 0)return o;if(!a$i.has(r)){const p=[...a$i.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$e}. Registered themes are: ${p}`),c$f(e,e$e)}const[n,g]=await Promise.all([c$f(e,r),t?c$f(e,t,true):void 0]),i=m$g(n,g);return i&&l$f.set(s,i),i},c$f=async(e,r,t=false)=>{const o=(t?h$5:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$d=()=>u$c,w$5=e=>a$i.has(e);

  const r$l=new Set,s$m=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$e=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$l.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$l.add("decode"));return}try{return JSON.parse(a)}catch{r$l.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$l.add("parse"));}}},d$b=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$l.has("object")||(console.warn("Malformed theme metadata Object",e),r$l.add("object"));return}return {themeName:t,baseThemeName:a}},m$c=()=>{const e=s$m();if(!e||e==="none")return;const t=o$e(e);if(t)return d$b(t)};

  const t$m=new i$h,d$a="themeLoaded",o$d=e=>{t$m.attachEvent(d$a,e);},n$p=e=>{t$m.detachEvent(d$a,e);},r$k=e=>t$m.fireEvent(d$a,e);
  ...
  const a$h=t=>{const e=document.querySelector(`META[name="${t}"]`);return e&&e.getAttribute("content")},g$a=(t,e=false)=>{const n=a$h("sap-allowed-theme-origins")??a$h("sap-allowedThemeOrigins");return n?e?true:n.split(",").some(r=>r==="*"||t===r.trim()):false},l$e=t=>{let e,n=false;try{if(t.startsWith(".")||t.startsWith("/")&&!t.startsWith("//"))e=new URL(t,s$p()).toString(),n=!0;else {const r=t.startsWith("//")?new URL(t,s$p()):new URL(t),i=r.origin,o=new URL(s$p()).origin;if(n=i===o,i&&g$a(i,n))e=r.toString();else return}return e.endsWith("/")||(e=`${e}/`),`${e}UI5/`}catch{return}};

  let t$l;i$g(()=>{t$l=void 0;});const r$j=()=>(t$l===void 0&&(t$l=T$3()),t$l),f$e=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$l=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$j();if(!n)return;const i=l$e(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$9(f$e(e,i),{"sap-ui-webcomponents-theme":e});};

  const t$k=new Map;let e$c;const n$o=()=>(e$c||(e$c=new CSSStyleSheet),e$c),r$i=(o,s)=>{t$k.set(o,s);const S=Array.from(t$k.values()).join(`
`);n$o().replaceSync(S);};

  let _lib="ui5",_package="webcomponents-theming";const a$g="@"+_lib+"/"+_package,E$1=()=>m$d().has(a$g),U=async e=>{if(!E$1())return;const t=await L$5(a$g,e);t&&R$3(t,"data-ui5-theme-properties",a$g,e);},w$4=()=>{f$i("data-ui5-theme-properties",a$g);},I$1=async(e,t)=>{const o=[...m$d().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$g)return;const i=await L$5(s,e,t);i&&(n==="root"?R$3(i,`data-ui5-component-properties-${I$4()}`,s):n==="host"&&r$i(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$c();if(t)return t;const r=n$v("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$j())return await s$l(e),m$c()},b$9=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U(e):w$4();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$5(e)?e:o||e$e;await I$1(s,r),B$2(o),r$k(e);};

  const d$8=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$n = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;

  let o$c;i$g(()=>{o$c=void 0;});const a$f=()=>(o$c===void 0&&(o$c=U$2()),o$c);

  const a$e=()=>{const t=n$v("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$d();},f$d=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$f()||t||S$5("data-ui5-font-face")||c$k(n$n,"data-ui5-font-face");};
  ...
  const r$h=()=>{R$3(s$k,"data-ui5-system-css-vars");};
   ...
   */
  var t$d;const i$a=window,s$h=i$a.trustedTypes,e$a=s$h?s$h.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$9="$lit$",n$m=`lit$${(Math.random()+"").slice(9)}$`,l$b="?"+n$m,h$2=`<${l$b}>`,r$c=document,u$9=()=>r$c.createComment(""),d$5=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$c=Array.isArray,v$2=t=>c$c(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$b="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$2=/-->/g,m$8=/>/g,p$5=RegExp(`>|${a$b}(?:([^\\s"'>=/]+)(${a$b}*=${a$b}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$7=/'/g,$$1=/"/g,y$6=/^(?:script|style|textarea|title)$/i,w$1=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$2=w$1(1),b$6=w$1(2),T$1=Symbol.for("lit-noChange"),A$2=Symbol.for("lit-nothing"),E=new WeakMap,C$3=r$c.createTreeWalker(r$c,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$a?e$a.createHTML(i):i}const V=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$2:void 0!==c[1]?u=m$8:void 0!==c[2]?(y$6.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$5):void 0!==c[3]&&(u=p$5):u===p$5?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$5:'"'===c[3]?$$1:g$7):u===$$1||u===g$7?u=p$5:u===_$2||u===m$8?u=f$9:(u=p$5,l=void 0);const w=u===p$5&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$2:v>=0?(e.push(d),s.slice(0,v)+o$9+s.slice(v)+n$m+w):s+n$m+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V(t,i);if(this.el=N.createElement(a,e),C$3.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$3.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$9)||i.startsWith(n$m)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$9).split(n$m),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H:"?"===i[1]?L$4:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$6.test(h.tagName)){const t=h.textContent.split(n$m),i=t.length-1;if(i>0){h.textContent=s$h?s$h.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$9()),C$3.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$9());}}}else if(8===h.nodeType)if(h.data===l$b)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$m,t+1));)v.push({type:7,index:r}),t+=n$m.length-1;}r++;}}static createElement(t,i){const s=r$c.createElement("template");return s.innerHTML=t,s}};function S$3(t,i,s=t,e){var o,n,l,h;if(i===T$1)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$5(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$3(t,r._$AS(t,i.values),r,e)),i}let M$3 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$c).importNode(s,true);C$3.currentNode=o;let n=C$3.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$1(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$3.nextNode(),l++);}return C$3.currentNode=r$c,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$1 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$2,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$3(this,t,i),d$5(t)?t===A$2||null==t||""===t?(this._$AH!==A$2&&this._$AR(),this._$AH=A$2):t!==this._$AH&&t!==T$1&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$2(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$2&&d$5(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$c.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$3(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$1(t)),i}T(t){c$c(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$9()),this.k(u$9()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$2,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$2;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$3(this,t,i,0),n=!d$5(t)||t!==this._$AH&&t!==T$1,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$3(this,e[s+l],i,l),h===T$1&&(h=this._$AH[l]),n||(n=!d$5(h)||h!==this._$AH[l]),h===A$2?t=A$2:t!==A$2&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$2?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$2?void 0:t;}}const I=s$h?s$h.emptyScript:"";let L$4 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$2?this.element.setAttribute(this.name,I):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$3(this,t,i,0))&&void 0!==s?s:A$2)===T$1)return;const e=this._$AH,o=t===A$2&&e!==A$2||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$2&&(e===A$2||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$3(this,t);}}const B$1=i$a.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$1),(null!==(t$d=i$a.litHtmlVersions)&&void 0!==t$d?t$d:i$a.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$9=Symbol.for(""),l$a=t=>{if((null==t?void 0:t.r)===e$9)return null==t?void 0:t._$litStatic$},o$8=t=>({_$litStatic$:t,r:e$9}),s$g=new Map,a$a=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$a(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$g.get(t))&&(n.raw=n,s$g.set(t,r=n)),e=u;}return t(r,...e)},n$l=a$a(x$2),u$8=a$a(b$6);

  let t$c = class t{static{this.html=n$l;}static{this.svg=u$8;}static{this.unsafeStatic=o$8;}};s$r("LitStatic",t$c);

  const t$b=new WeakMap;let a$9 = class a{static get tasks(){return t$b}static enqueue(s,e){t$b.has(s)||t$b.set(s,[]),t$b.get(s).push(e);}static run(s,e){return t$b.has(s)||t$b.set(s,[]),e().then(()=>{const T=t$b.get(s);if(T.length>0)return a.run(s,T.shift());t$b.delete(s);})}static push(s,e){t$b.get(s)?a.enqueue(s,e):a.run(s,e);}};
  ...
  const n$k=(r,c,a)=>{let o,l;return f$8({beforeStart:()=>{o=r.scrollLeft,l=r.scrollTop;},duration:v$1,element:r,advance:t=>{r.scrollLeft=o+t*c,r.scrollTop=l+t*a;}})};
  ...
  const u$7=o=>{let i,a,r,d,n,s,p,g,e,l,y,m;const h=f$8({beforeStart:()=>{const t=o;i=getComputedStyle(t),a=parseFloat(i.paddingTop),r=parseFloat(i.paddingBottom),d=parseFloat(i.marginTop),n=parseFloat(i.marginBottom),s=parseFloat(i.height),p=t.style.overflow,g=t.style.paddingTop,e=t.style.paddingBottom,l=t.style.marginTop,y=t.style.marginBottom,m=t.style.height,t.style.overflow="hidden";},duration:v$1,element:o,advance:t=>{o.style.paddingTop=`${a-a*t}px`,o.style.paddingBottom=`${r-r*t}px`,o.style.marginTop=`${d-d*t}px`,o.style.marginBottom=`${n-n*t}px`,o.style.height=`${s-s*t}px`;}});return h.promise().then(t=>{t instanceof Error||(o.style.overflow=p,o.style.paddingTop=g,o.style.paddingBottom=e,o.style.marginTop=l,o.style.marginBottom=y,o.style.height=m,o.style.display="none");}),h};

  let n$j;i$g(()=>{n$j=void 0;});const d$4=()=>(n$j===void 0&&(n$j=y$9()),n$j),m$7=o=>{Object.values(u$f).includes(o)&&(n$j=o);};

  var s$f=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$f||{});

  let n$i;i$g(()=>{n$i=void 0;});const i$9=()=>(n$i===void 0&&(n$i=D$4()),n$i&&n$i in s$f?n$i:s$f.Gregorian);

  let t$a;let a$8 = class a{static getLegacyDateCalendarCustomizing(){return t$a===void 0&&(t$a=R$2()),t$a.legacyDateCalendarCustomizing||[]}};s$r("LegacyDateFormats",a$8);

  let e$8;i$g(()=>{e$8=void 0;});const n$h=()=>(e$8===void 0&&(e$8=R$2()),e$8.firstDayOfWeek),i$8=n$v("LegacyDateFormats"),m$6=i$8?a$8.getLegacyDateCalendarCustomizing:()=>[];

  const t$9=new Map,e$7=(n,o)=>{t$9.set(n,o);},c$b=n=>t$9.get(n);

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$e=new Map;s$e.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$e.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$e.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$a=(n,e)=>{if(s$e.has(n)){s$e.set(n,{...e,...s$e.get(n)});return}s$e.set(n,e);},r$b=n=>{const e=m$9()?"legacy":"sap_horizon";return s$e.has(n)?s$e.get(n)[e]:n};

  var t$7=(s=>(s["SAP-icons"]="SAP-icons-v4",s.horizon="SAP-icons-v5",s["SAP-icons-TNT"]="tnt",s.BusinessSuiteInAppSymbols="business-suite",s))(t$7||{});const n$g=e=>t$7[e]?t$7[e]:e;

  const i$7=o=>{const t=c$b(r$d());return !o&&t?n$g(t):o?r$b(o):r$b("SAP-icons")};
  ...
  const t$6=typeof document>"u",o$7=()=>{if(t$6)return a$k;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$k};

  const e$6=new i$h,n$f="languageChange",t$5=a=>{e$6.attachEvent(n$f,a);},r$a=a=>{e$6.detachEvent(n$f,a);},o$6=a=>e$6.fireEventAsync(n$f,a);

  let n$e,t$4;i$g(()=>{n$e=void 0,t$4=void 0;});let a$7=false;C$5("language",e=>{n$e=e,a$7=true,o$6(e).then(()=>{a$7=false,O$2()&&C$6({languageAware:true});});});const c$9=()=>a$7,L$3=()=>(n$e===void 0&&(n$e=f$a("language")??S$4()),n$e),h$1=async e=>{n$e!==e&&(a$7=true,n$e=e,d$6("language",e),await o$6(e),a$7=false,O$2()&&await C$6({languageAware:true}));},C$2=()=>a$k,p$4=e=>{t$4=e;},D$3=()=>(t$4===void 0&&(t$4=L$6()),t$4);

  const n$d=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$9 = class r{constructor(s){const t=n$d.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$k,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

  const r$8=new Map,n$c=t=>(r$8.has(t)||r$8.set(t,new r$9(t)),r$8.get(t)),c$8=t=>{try{if(t&&typeof t=="string")return n$c(t)}catch{}return new r$9(r$o)},s$d=t=>{const e=L$3();return e?n$c(e):c$8(o$7())};

  const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$7=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$3=i=>{let e;if(!i)return r$o;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$7.exec(o))||r&&(e=c$7.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$o};

  const r$7={zh_HK:"zh_TW",in:"id"},n$b=t=>{if(!t)return r$o;if(r$7[t])return r$7[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$o?r$o:""};

  const d$3=new Set,m$4=new Set,g$6=new Map,l$9=new Map,u$6=new Map,$=(n,t,e)=>{const r=`${n}/${t}`;u$6.set(r,e);},f$6=(n,t)=>{g$6.set(n,t);},A$1=n=>g$6.get(n),h=(n,t)=>{const e=`${n}/${t}`;return u$6.has(e)},B=(n,t)=>{const e=`${n}/${t}`,r=u$6.get(e);return r&&!l$9.get(e)&&l$9.set(e,r(t)),l$9.get(e)},M$2=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$2=(n,t)=>t!==a$k&&!h(n,t),w=async n=>{const t=s$d().getLanguage(),e=s$d().getRegion(),r=s$d().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$3(s);L$2(n,s);)s=n$b(s);const I=D$3();if(s===a$k&&!I){f$6(n,null);return}if(!h(n,s)){M$2(n);return}try{const o=await B(n,s);f$6(n,o);}catch(o){const a=o;m$4.has(a.message)||(m$4.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$6.keys()];return Promise.all(t.map(w))});
  ...
  const r$6=new Map;let s$c;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$6=n=>{if(r$6.has(n))return r$6.get(n);const e=new u$5(n);return r$6.set(n,e),e},f$5=async n=>s$c?s$c(n):(await w(n),a$6(n)),y$5=n=>{s$c=n;};

  const e$5={key:"DRAG_DROP_MULTIPLE_TEXT",defaultText:"{0} items"};

  const l$8=2;const u$4=async e=>{const t=document.createElement("div"),n=await f$5("@ui5/webcomponents-base"),r=t.attachShadow({mode:"open"}),o=new CSSStyleSheet;return o.replaceSync(m$5),r.adoptedStyleSheets=[o],r.textContent=n.getText(e$5,e),t},s$b=async(e,t)=>{if(e<l$8){console.warn(`Cannot start multiple drag with count ${e}. Minimum is ${l$8}.`);return}if(!t.dataTransfer)return;const n=await u$4(e);document.body.appendChild(n),t.dataTransfer.setDragImage(n,0,0),requestAnimationFrame(()=>{n.remove();});};

  const c$6=["value-changed","click"];let e$4;i$g(()=>{e$4=void 0;});const s$a=t=>c$6.includes(t),l$7=t=>{const n=o$5();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$5=()=>(e$4===void 0&&(e$4=F()),e$4),f$4=t=>{e$4=t;},a$5=t=>{const n=o$5();return s$a(t)?false:n===true?true:!l$7(t)};
  ...
  const s$4=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$o(),...s$5(e)],e.renderer(o,t);};
  ...
  const i$2=async()=>{const e=o$1();await Promise.all(e),await C$6({rtlAware:true});};
