sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  const a$k=e=>{e.setAttribute("popover","manual"),e.showPopover();},l$l=e=>{e.hasAttribute("popover")&&(e.hidePopover(),e.removeAttribute("popover"));},i$p=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(o=>{const p=o.shadowRoot;return p&&i$p(p)}),u$i=e=>{const o=e.prototype.open;e.prototype.open=function(...t){o.apply(this,t);const n=i$p();if(["OPENING","OPEN"].includes(this.getOpenState())&&n){const c=this.getContent();if(c){const r=c instanceof HTMLElement?c:c?.getDomRef();r&&a$k(r);}}};},y$8=e=>{const o=e.prototype._closed;e.prototype._closed=function(...t){const n=this.getContent(),s=n instanceof HTMLElement?n:n?.getDomRef();o.apply(this,t),s&&l$l(s);};},v$4=e=>{const o=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(t){const n=t.type==="focus"||t.type==="activate",s=t.target;(!n||!s.closest("[ui5-popover],[ui5-responsive-popover],[ui5-dialog]"))&&o.call(this,t);};},d$e=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},h$7=e=>{u$i(e),y$8(e),d$e(),v$4(e);};

  const e$j=new Map,s$t=(t,r)=>{e$j.set(t,r);},n$u=t=>e$j.get(t);

  var c$l={},e$i=c$l.hasOwnProperty,a$j=c$l.toString,o$l=e$i.toString,l$k=o$l.call(Object),i$o=function(r){var t,n;return !r||a$j.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$l.call(n)===l$k):true)};

  var c$k=Object.create(null),u$h=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$k;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$o(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$o(n)?n:{},r[a]=u$h(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$h=function(n,t){return u$h(true,false,...arguments)};

  const _$3={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$g=_$3.themes.default,s$s=_$3.themes.all,a$i=_$3.languages.default,r$j=_$3.locales.default,n$t=_$3.locales.all;

  const o$k=typeof document>"u",n$s={search(){return o$k?"":window.location.search}},s$r=()=>o$k?"":window.location.href,u$g=()=>n$s.search();

  const o$j=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},s$q=e=>{const t=o$j("sap-allowedThemeOrigins");return t&&t.split(",").some(n=>n==="*"||e===n.trim())},a$h=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$c=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$r()).toString();else {const n=new URL(e),r=n.origin;r&&s$q(r)?t=n.toString():t=a$h(n.toString(),s$r());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  let p$9=false,t$m={animationMode:u$f.Full,theme:e$g,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$i(),t$m.animationMode),T$4=()=>(o$i(),t$m.theme),S$4=()=>(o$i(),t$m.themeRoot),L$3=()=>(o$i(),t$m.language),F$1=()=>(o$i(),t$m.fetchDefaultLanguage),U$2=()=>(o$i(),t$m.noConflict),b$b=()=>(o$i(),t$m.defaultFontLoading),D$2=()=>(o$i(),t$m.enableDefaultTooltips),I$6=()=>(o$i(),t$m.calendarType),M$2=()=>(o$i(),t$m.formatSettings),i$l=new Map;i$l.set("true",true),i$l.set("false",false);const z$1=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$m=e$h(t$m,e));}},E$2=()=>{const n=new URLSearchParams(u$g());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||u$e(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&u$e(a,e,"sap-ui");});},P$7=n=>{const e=n.split("@")[1];return g$c(e)},w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,u$e=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$l.has(e)&&(e=i$l.get(r)),s==="theme"?(t$m.theme=w$7(s,e),e&&e.includes("@")&&(t$m.themeRoot=P$7(e))):t$m[s]=e;},j=()=>{const n=n$u("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$m=e$h(t$m,e);},o$i=()=>{typeof document>"u"||p$9||(g$b(),p$9=true);},g$b=n=>{z$1(),E$2(),j();};
  ...
  const u$d=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$i=()=>typeof document>"u"?null:o$h('meta[name="ui5-shared-resources"]',document.head,u$d),m$f=(t,o)=>{const r=t.split(".");let e=l$i();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$e={version:"2.8.0",major:2,minor:8,patch:0,suffix:"",isNext:false,buildTime:1741075456};

  let s$p,t$l={include:[/^ui5-/],exclude:[]};const o$g=new Map,l$h=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$4()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$p=e;},c$j=()=>s$p,p$8=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$l=e,o$g.clear();},m$e=()=>t$l,i$k=e=>{if(!o$g.has(e)){const n=t$l.include.some(r=>e.match(r))&&!t$l.exclude.some(r=>e.match(r));o$g.set(e,n);}return o$g.get(e)},g$a=e=>{if(i$k(e))return c$j()};

  let i$j,s$o="";const u$c=new Map,r$i=m$f("Runtimes",[]),x$1=()=>{if(i$j===void 0){i$j=r$i.length;const e=e$e;r$i.push({...e,get scopingSuffix(){return c$j()},get registeredTags(){return T$3()},get scopingRules(){return m$e()},alias:s$o,description:`Runtime ${i$j} - ver ${e.version}${""}`});}},I$5=()=>i$j,b$a=(e,m)=>{const o=`${e},${m}`;if(u$c.has(o))return u$c.get(o);const t=r$i[e],n=r$i[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$c.set(o,l),l},$$3=()=>r$i;

  const g$9=m$f("Tags",new Map),d$d=new Set;let s$n=new Map,c$i;const m$d=-1,h$6=e=>{d$d.add(e),g$9.set(e,I$5());},w$6=e=>d$d.has(e),R$4=()=>d$d.size>0,T$3=()=>[...d$d.values()],$$2=e=>{let n=g$9.get(e);n===void 0&&(n=m$d),s$n.has(n)||s$n.set(n,new Set),s$n.get(n).add(e),c$i||(c$i=setTimeout(()=>{y$7(),s$n=new Map,c$i=void 0;},1e3));},y$7=()=>{const e=$$3(),n=I$5(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(i=>`
${i.description}`).join("")}`),[...s$n.keys()].forEach(i=>{let o,r;i===m$d?(o=1,r={description:"Older unknown runtime"}):(o=b$a(n,i),r=e[i]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$m=new Set,d$c=new i$n,n$q=new l$j;let t$j,a$g,m$c,i$i;const l$g=async e=>{n$q.add(e),await P$6();},c$h=e=>{d$c.fireEvent("beforeComponentRender",e),s$m.add(e),e._render();},h$5=e=>{n$q.remove(e),s$m.delete(e);},P$6=async()=>{i$i||(i$i=new Promise(e=>{window.requestAnimationFrame(()=>{n$q.process(c$h),i$i=null,e(),m$c||(m$c=setTimeout(()=>{m$c=void 0,n$q.isEmpty()&&U$1();},200));});})),await i$i;},y$6=()=>t$j||(t$j=new Promise(e=>{a$g=e,window.requestAnimationFrame(()=>{n$q.isEmpty()&&(t$j=void 0,e());});}),t$j),I$4=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$c=async()=>{await I$4(),await y$6();},U$1=()=>{n$q.isEmpty()&&a$g&&(a$g(),a$g=void 0,t$j=void 0);},C$3=async e=>{s$m.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$h(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$g(r);}),await f$c();};

  const g$8=typeof document>"u",i$h=(e,t)=>t?`${e}|${t}`:e,l$f=e=>e===void 0?true:b$a(I$5(),parseInt(e))===1,c$g=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$h(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$5=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$h(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$f(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$h(e,t)),f$b=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$h(e,t));},R$3=(e,t,r="",s)=>{S$3(t,r)?y$5(e,t,r,s):c$g(e,t,r,s);},m$b=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$i=new i$n,r$g="themeRegistered",n$p=e=>{t$i.attachEvent(r$g,e);},s$l=e=>t$i.fireEvent(r$g,e);

  const l$e=new Map,h$4=new Map,u$b=new Map,T$2=new Set,i$g=new Set,p$7=(e,r,t)=>{h$4.set(`${e}/${r}`,t),T$2.add(e),i$g.add(r),s$l(r);},m$a=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$e.get(g);if(s!==void 0)return s;if(!i$g.has(r)){const $=[...i$g.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$g}. Registered themes are: ${$}`),a$f(e,e$g)}const[n,d]=await Promise.all([a$f(e,r),t?a$f(e,t,true):void 0]),o=m$b(n,d);return o&&l$e.set(g,o),o},a$f=async(e,r,t=false)=>{const s=(t?u$b:h$4).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$5=e=>i$g.has(e);
  ...
  let t$g;i$m(()=>{t$g=void 0;});const n$n=()=>(t$g===void 0&&(t$g=S$4()),t$g),u$a=e=>`${n$n()}Base/baseLib/${e}/css_variables.css`,i$f=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$9(u$a(e),{"sap-ui-webcomponents-theme":e});};

  const s$j="@ui5/webcomponents-theming",S$2=()=>w$5().has(s$j),P$4=async e=>{if(!S$2())return;const t=await m$a(s$j,e);t&&R$3(t,"data-ui5-theme-properties",s$j,e);},E$1=()=>{f$b("data-ui5-theme-properties",s$j);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$j)return;const i=await m$a(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$9();if(t)return t;const r=n$u("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$n())return await i$f(e),m$9()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$4(e):E$1();const r=P$5(e)?e:t&&t.baseThemeName;await U(r||e$g,t&&t.themeName===e?e:void 0),r$e(e);};
  ...
  let o$d;i$m(()=>{o$d=void 0;});const a$d=()=>(o$d===void 0&&(o$d=b$b()),o$d);

  const i$e=()=>{const t=n$u("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$6(),c$f();},p$6=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$d()||t||S$3("data-ui5-font-face")||c$g(a$e,"data-ui5-font-face");},c$f=()=>{S$3("data-ui5-font-face-override")||c$g(n$m,"data-ui5-font-face-override");};
  ...
  const e$d=()=>{S$3("data-ui5-system-css-vars")||c$g(a$c,"data-ui5-system-css-vars");};

  const t$f=typeof document>"u",e$c={get userAgent(){return t$f?"":navigator.userAgent},get touch(){return t$f?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$f?false:/(Chrome|CriOS)/.test(e$c.userAgent)},get firefox(){return t$f?false:/Firefox/.test(e$c.userAgent)},get safari(){return t$f?false:!e$c.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$c.userAgent)},get webkit(){return t$f?false:/webkit/.test(e$c.userAgent)},get windows(){return t$f?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$f?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$f?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$c.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$f?false:!e$c.windows&&/Android/.test(e$c.userAgent)},get androidPhone(){return t$f?false:e$c.android&&/(?=android)(?=.*mobile)/i.test(e$c.userAgent)},get ipad(){return t$f?false:/ipad/i.test(e$c.userAgent)||/Macintosh/i.test(e$c.userAgent)&&"ontouchend"in document},_isPhone(){return u$9(),e$c.touch&&!r$d}};let o$c,i$d,r$d;const s$i=()=>{if(t$f||!e$c.windows)return  false;if(o$c===void 0){const n=e$c.userAgent.match(/Windows NT (\d+).(\d)/);o$c=n?parseFloat(n[1]):0;}return o$c>=8},c$e=()=>{if(t$f||!e$c.webkit)return  false;if(i$d===void 0){const n=e$c.userAgent.match(/(webkit)[ /]([\w.]+)/);i$d=n?parseFloat(n[1]):0;}return i$d>=537.1},u$9=()=>{if(t$f)return  false;if(r$d===void 0){if(e$c.ipad){r$d=true;return}if(e$c.touch){if(s$i()){r$d=true;return}if(e$c.chrome&&e$c.android){r$d=!/Mobile Safari\/[.0-9]+/.test(e$c.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$c.android&&c$e()&&(n=1),r$d=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$d=e$c.userAgent.indexOf("Touch")!==-1||e$c.android&&!e$c.androidPhone;}},l$d=()=>e$c.touch,h$3=()=>e$c.safari,g$7=()=>e$c.chrome,b$9=()=>e$c.firefox,a$b=()=>(u$9(),(e$c.touch||s$i())&&r$d),d$7=()=>e$c._isPhone(),f$a=()=>t$f?false:!a$b()&&!d$7()||s$i(),m$8=()=>a$b()&&f$a(),w$3=()=>e$c.iOS,P$3=()=>e$c.android||e$c.androidPhone;

  let t$e=false;const i$c=()=>{h$3()&&w$3()&&!t$e&&(document.body.addEventListener("touchstart",()=>{}),t$e=true);};

  let o$b=false,r$c;const p$5=new i$n,h$2=()=>o$b,P$2=e=>{if(!o$b){p$5.attachEvent("boot",e);return}e();},l$c=async()=>{if(r$c!==void 0)return r$c;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$p(b$8);const t=n$u("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$u("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$8(),await I$3(r$b()),t&&t.attachListeners(),i$e(),e$d(),i$c(),n(),o$b=true,p$5.fireEvent("boot");};return r$c=new Promise(e),r$c},b$8=e=>{o$b&&e===r$b()&&I$3(r$b());};

  let t$d;i$m(()=>{t$d=void 0;});const r$b=()=>(t$d===void 0&&(t$d=T$4()),t$d),u$8=async e=>{t$d!==e&&(t$d=e,h$2()&&(await I$3(t$d),await C$3({themeAware:true})));},g$6=()=>e$g,n$l=()=>{const e=r$b();return l$b(e)?!e.startsWith("sap_horizon"):!m$9()?.baseThemeName?.startsWith("sap_horizon")},l$b=e=>s$s.includes(e);
   ...
   */
  var t$c;const i$b=window,s$h=i$b.trustedTypes,e$b=s$h?s$h.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$a="$lit$",n$k=`lit$${(Math.random()+"").slice(9)}$`,l$a="?"+n$k,h$1=`<${l$a}>`,r$a=document,u$7=()=>r$a.createComment(""),d$6=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$d=Array.isArray,v$3=t=>c$d(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$9="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$2=/-->/g,m$7=/>/g,p$4=RegExp(`>|${a$9}(?:([^\\s"'>=/]+)(${a$9}*=${a$9}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$5=/'/g,$$1=/"/g,y$4=/^(?:script|style|textarea|title)$/i,w$2=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x=w$2(1),b$7=w$2(2),T$1=Symbol.for("lit-noChange"),A$2=Symbol.for("lit-nothing"),E=new WeakMap,C$2=r$a.createTreeWalker(r$a,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$b?e$b.createHTML(i):i}const V=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$2:void 0!==c[1]?u=m$7:void 0!==c[2]?(y$4.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$4):void 0!==c[3]&&(u=p$4):u===p$4?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$4:'"'===c[3]?$$1:g$5):u===$$1||u===g$5?u=p$4:u===_$2||u===m$7?u=f$9:(u=p$4,l=void 0);const w=u===p$4&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$1:v>=0?(e.push(d),s.slice(0,v)+o$a+s.slice(v)+n$k+w):s+n$k+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V(t,i);if(this.el=N.createElement(a,e),C$2.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$2.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$a)||i.startsWith(n$k)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$a).split(n$k),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H$1:"?"===i[1]?L$2:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$4.test(h.tagName)){const t=h.textContent.split(n$k),i=t.length-1;if(i>0){h.textContent=s$h?s$h.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$7()),C$2.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$7());}}}else if(8===h.nodeType)if(h.data===l$a)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$k,t+1));)v.push({type:7,index:r}),t+=n$k.length-1;}r++;}}static createElement(t,i){const s=r$a.createElement("template");return s.innerHTML=t,s}};function S$1(t,i,s=t,e){var o,n,l,h;if(i===T$1)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$6(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$1(t,r._$AS(t,i.values),r,e)),i}let M$1 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$a).importNode(s,true);C$2.currentNode=o;let n=C$2.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$2(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z$1(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$2.nextNode(),l++);}return C$2.currentNode=r$a,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$2 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$2,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$1(this,t,i),d$6(t)?t===A$2||null==t||""===t?(this._$AH!==A$2&&this._$AR(),this._$AH=A$2):t!==this._$AH&&t!==T$1&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$3(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$2&&d$6(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$a.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$1(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$1(t)),i}T(t){c$d(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$7()),this.k(u$7()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$2,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$2;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$1(this,t,i,0),n=!d$6(t)||t!==this._$AH&&t!==T$1,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$1(this,e[s+l],i,l),h===T$1&&(h=this._$AH[l]),n||(n=!d$6(h)||h!==this._$AH[l]),h===A$2?t=A$2:t!==A$2&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$2?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};let H$1 = class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$2?void 0:t;}};const I$2=s$h?s$h.emptyScript:"";let L$2 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$2?this.element.setAttribute(this.name,I$2):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$1(this,t,i,0))&&void 0!==s?s:A$2)===T$1)return;const e=this._$AH,o=t===A$2&&e!==A$2||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$2&&(e===A$2||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}let Z$1 = class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$1(this,t);}};const B$1=i$b.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$2),(null!==(t$c=i$b.litHtmlVersions)&&void 0!==t$c?t$c:i$b.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$a=Symbol.for(""),l$9=t=>{if((null==t?void 0:t.r)===e$a)return null==t?void 0:t._$litStatic$},o$9=t=>({_$litStatic$:t,r:e$a}),s$g=new Map,a$8=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$9(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$g.get(t))&&(n.raw=n,s$g.set(t,r=n)),e=u;}return t(r,...e)},n$j=a$8(x),u$6=a$8(b$7);
  ...
  let n$h;i$m(()=>{n$h=void 0;});const d$5=()=>(n$h===void 0&&(n$h=C$4()),n$h),m$6=o=>{Object.values(u$f).includes(o)&&(n$h=o);};

  var s$f=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$f||{});

  let n$g;i$m(()=>{n$g=void 0;});const i$a=()=>(n$g===void 0&&(n$g=I$6()),n$g&&n$g in s$f?n$g:s$f.Gregorian);
  ...
  let e$9;i$m(()=>{e$9=void 0;});const n$f=()=>(e$9===void 0&&(e$9=M$2()),e$9.firstDayOfWeek),i$9=n$u("LegacyDateFormats"),m$5=i$9?a$6.getLegacyDateCalendarCustomizing:()=>[];
  ...
  let e$6,n$c;i$m(()=>{e$6=void 0,n$c=void 0;});const d$4=()=>(e$6===void 0&&(e$6=L$3()),e$6),s$d=async t=>{e$6!==t&&(e$6=t,await o$8(t),h$2()&&await C$3({languageAware:true}));},m$4=()=>a$i,L$1=t=>{n$c=t;},c$a=()=>(n$c===void 0&&(n$c=F$1()),n$c);

  const c$9=["value-changed","click"];let e$5;i$m(()=>{e$5=void 0;});const s$c=t=>c$9.includes(t),l$8=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$5===void 0&&(e$5=U$2()),e$5),f$7=t=>{e$5=t;},a$5=t=>{const n=o$7();return s$c(t)?false:n===true?true:!l$8(t)};
  ...
  const s$a=new Map,o$6=new Map,n$b=new Map,c$7=e=>{if(!s$a.has(e)){const a=b$3(e.split("-"));s$a.set(e,a);}return s$a.get(e)},l$6=e=>{if(!o$6.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$6.set(e,a);}return o$6.get(e)},p$3=e=>l$6(e),b$3=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$b.get(e);if(a)return a;const t=c$7(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$b.set(e,r),r};
  ...
  const t$3=new WeakMap,n$8=(e,o,r)=>{const s=new MutationObserver(o);t$3.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$3.get(e);o&&(o.disconnect(),t$3.delete(e));};
