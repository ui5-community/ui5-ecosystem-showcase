sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  const u$j=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$n=()=>typeof document>"u"?null:o$m('meta[name="ui5-shared-resources"]',document.head,u$j),m$i=(t,o)=>{const r=t.split(".");let e=l$n();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const g$d=m$i("Tags",new Map),d$c=new Set;let i$n=new Map,c$j;const m$h=-1,h$7=e=>{d$c.add(e),g$d.set(e,I$4());},w$7=e=>d$c.has(e),R$5=()=>d$c.size>0,T$3=()=>[...d$c.values()],$$3=e=>{let n=g$d.get(e);n===void 0&&(n=m$h),i$n.has(n)||i$n.set(n,new Set),i$n.get(n).add(e),c$j||(c$j=setTimeout(()=>{y$a(),i$n=new Map,c$j=void 0;},1e3));},y$a=()=>{const e=$$2(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const e$k={version:"2.16.0",major:2,minor:16,patch:0,suffix:"",isNext:false,buildTime:1763722760};

  let s$u,t$p={include:[/^ui5-/],exclude:[]};const o$l=new Map,l$m=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$5()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$u=e;},c$i=()=>s$u,p$8=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$p=e,o$l.clear();},m$g=()=>t$p,i$m=e=>{if(!o$l.has(e)){const n=t$p.include.some(r=>e.match(r))&&!t$p.exclude.some(r=>e.match(r));o$l.set(e,n);}return o$l.get(e)},g$c=e=>{if(i$m(e))return c$i()};

  let i$l,s$t="";const u$i=new Map,r$k=m$i("Runtimes",[]),x$2=()=>{if(i$l===void 0){i$l=r$k.length;const e=e$k;r$k.push({...e,get scopingSuffix(){return c$i()},get registeredTags(){return T$3()},get scopingRules(){return m$g()},alias:s$t,description:`Runtime ${i$l} - ver ${e.version}${""}`});}},I$4=()=>i$l,b$b=(e,m)=>{const o=`${e},${m}`;if(u$i.has(o))return u$i.get(o);const t=r$k[e],n=r$k[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$i.set(o,l),l},$$2=()=>r$k;

  const g$b=typeof document>"u",i$k=(e,t)=>t?`${e}|${t}`:e,l$l=e=>e===void 0?true:b$b(I$4(),parseInt(e))===1,c$h=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$k(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$9=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$k(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$l(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$6=(e,t="")=>g$b?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$k(e,t)),f$e=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$k(e,t));},R$4=(e,t,r="",s)=>{S$6(t,r)?y$9(e,t,r,s):c$h(e,t,r,s);},m$f=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  var e$j = "[data-sap-ui-popup][popover]{border:none;overflow:visible;margin:0}";

  const o$k=()=>{S$6("data-ui5-popup-styles")||c$h(e$j,"data-ui5-popup-styles");};

  const p$7=m$i("AllOpenedPopupsRegistry",{openedRegistry:[]}),a$l=e=>{p$7.openedRegistry.push(e);},u$h=e=>{const o=p$7.openedRegistry.findIndex(t=>t.instance===e);o>-1&&p$7.openedRegistry.splice(o,1);},O$2=()=>p$7.openedRegistry[p$7.openedRegistry.length-1].instance,l$k=e=>{for(let o=p$7.openedRegistry.length-1;o>=0;o--){const t=p$7.openedRegistry[o];if(t.type==="WebComponent")return  true;if(t.instance===e)break}return  false},P$8=e=>{e.setAttribute("popover","manual"),e.showPopover();},f$d=e=>{e.hasAttribute("popover")&&(e.hidePopover(),e.removeAttribute("popover"));},y$8=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(o=>{const t=o.shadowRoot;return t&&y$8(t)}),d$b=e=>{const o=e.prototype.onsapescape;e.prototype.onsapescape=function(...n){l$k(this.oPopup)||o.apply(this,n);};},m$e=e=>{const o=e.prototype.open;e.prototype.open=function(...n){o.apply(this,n);const s=y$8();if(["OPENING","OPEN"].includes(this.getOpenState())&&s){const r=this.getContent();if(r){const i=r instanceof HTMLElement?r:r?.getDomRef();i&&P$8(i);}}a$l({type:"OpenUI5",instance:this});};},I$3=e=>{const o=e.prototype._closed;e.prototype._closed=function(...n){const s=this.getContent(),c=s instanceof HTMLElement?s:s?.getDomRef();o.apply(this,n),c&&f$d(c),u$h(this);};},v$4=e=>{const o=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(...n){l$k(this)||o.apply(this,n);};},C$5=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},S$5=(e,o,t)=>{o$k(),m$e(e),I$3(e),C$5(),v$4(e),d$b(o),d$b(t);};

  const e$i=new Map,s$s=(t,r)=>{e$i.set(t,r);},n$u=t=>e$i.get(t);

  var c$g={},e$h=c$g.hasOwnProperty,a$k=c$g.toString,o$j=e$h.toString,l$j=o$j.call(Object),i$j=function(r){var t,n;return !r||a$k.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$j.call(n)===l$j):true)};

  var c$f=Object.create(null),u$g=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$f;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$j(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$j(n)?n:{},r[a]=u$g(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$g=function(n,t){return u$g(true,false,...arguments)};

  const _$3={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$f=_$3.themes.default,s$r=_$3.themes.all,a$j=_$3.languages.default,r$j=_$3.locales.default,l$i=_$3.locales.all;

  const o$i=typeof document>"u",n$t={search(){return o$i?"":window.location.search}},s$q=()=>o$i?"":window.location.href,u$f=()=>n$t.search();

  const s$p=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$h=e=>{const t=s$p("sap-allowed-theme-origins")??s$p("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$i=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$a=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$q()).toString();else {const n=new URL(e),r=n.origin;r&&o$h(r)?t=n.toString():t=a$i(n.toString(),s$q());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  let p$6=false,t$n={animationMode:u$e.Full,theme:e$f,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$g(),t$n.animationMode),T$2=()=>(o$g(),t$n.theme),S$4=()=>{if(o$g(),t$n.themeRoot!==void 0){if(!g$a(t$n.themeRoot)){console.warn(`The ${t$n.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$n.themeRoot}},L$4=()=>(o$g(),t$n.language),R$3=()=>(o$g(),t$n.fetchDefaultLanguage),F$1=()=>(o$g(),t$n.noConflict),U$2=()=>(o$g(),t$n.defaultFontLoading),b$a=()=>(o$g(),t$n.enableDefaultTooltips),D$3=()=>(o$g(),t$n.calendarType),M$3=()=>(o$g(),t$n.formatSettings),i$g=new Map;i$g.set("true",true),i$g.set("false",false);const w$6=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$n=e$g(t$n,e));}},z$1=()=>{const n=new URLSearchParams(u$f());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$9(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$9(r,e,"sap-ui");});},E$2=n=>{const e=n.split("@")[1];return g$a(e)},P$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$9=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$g.has(e)&&(e=i$g.get(a)),s==="theme"?(t$n.theme=P$7(s,e),e&&e.includes("@")&&(t$n.themeRoot=E$2(e))):t$n[s]=e;},j$1=()=>{const n=n$u("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$n=e$g(t$n,e);},o$g=()=>{typeof document>"u"||p$6||(l$h(),p$6=true);},l$h=n=>{w$6(),z$1(),j$1();};
  ...
  const s$o=new Set,d$a=new i$i,n$r=new l$g;let t$l,a$h,m$d,i$f;const l$f=async e=>{n$r.add(e),await P$6();},c$e=e=>{d$a.fireEvent("beforeComponentRender",e),s$o.add(e),e._render();},h$6=e=>{n$r.remove(e),s$o.delete(e);},P$6=async()=>{i$f||(i$f=new Promise(e=>{window.requestAnimationFrame(()=>{n$r.process(c$e),i$f=null,e(),m$d||(m$d=setTimeout(()=>{m$d=void 0,n$r.isEmpty()&&U$1();},200));});})),await i$f;},y$7=()=>t$l||(t$l=new Promise(e=>{a$h=e,window.requestAnimationFrame(()=>{n$r.isEmpty()&&(t$l=void 0,e());});}),t$l),I$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$c=async()=>{await I$2(),await y$7();},U$1=()=>{n$r.isEmpty()&&a$h&&(a$h(),a$h=void 0,t$l=void 0);},C$3=async e=>{s$o.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$f(r);}),await f$c();};

  const t$k=new i$i,r$h="themeRegistered",n$q=e=>{t$k.attachEvent(r$h,e);},s$n=e=>t$k.fireEvent(r$h,e);

  const l$e=new Map,h$5=new Map,u$d=new Map,T$1=new Set,i$e=new Set,p$5=(e,r,t)=>{h$5.set(`${e}/${r}`,t),T$1.add(e),i$e.add(r),s$n(r);},m$c=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$e.get(g);if(s!==void 0)return s;if(!i$e.has(r)){const $=[...i$e.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$g(e,e$f)}const[n,d]=await Promise.all([a$g(e,r),t?a$g(e,t,true):void 0]),o=m$f(n,d);return o&&l$e.set(g,o),o},a$g=async(e,r,t=false)=>{const s=(t?u$d:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$1,P$5=e=>i$e.has(e);
  ...
  let t$i;i$h(()=>{t$i=void 0;});const n$o=()=>(t$i===void 0&&(t$i=S$4()),t$i),u$c=e=>`${n$o()}Base/baseLib/${e}/css_variables.css`,i$d=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$7(u$c(e),{"sap-ui-webcomponents-theme":e});};

  let _lib="ui5",_package="webcomponents-theming";const s$l="@"+_lib+"/"+_package,S$3=()=>w$5().has(s$l),P$4=async e=>{if(!S$3())return;const t=await m$c(s$l,e);t&&R$4(t,"data-ui5-theme-properties",s$l,e);},E$1=()=>{f$e("data-ui5-theme-properties",s$l);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$l)return;const i=await m$c(a,e,t);i&&R$4(i,`data-ui5-component-properties-${I$4()}`,a);});return Promise.all(o)},k$2=async e=>{const t=m$b();if(t)return t;const r=n$u("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$o())return await i$d(e),m$b()},w$4=async e=>{const t=await k$2(e);!t||e!==t.themeName?await P$4(e):E$1();const r=P$5(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  const a$e=()=>{const t=n$u("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$b();},f$b=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$f()||t||S$6("data-ui5-font-face")||c$h(n$n,"data-ui5-font-face");};
   ...
   */
  var t$d;const i$a=window,s$i=i$a.trustedTypes,e$b=s$i?s$i.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$a="$lit$",n$l=`lit$${(Math.random()+"").slice(9)}$`,l$b="?"+n$l,h$2=`<${l$b}>`,r$b=document,u$9=()=>r$b.createComment(""),d$4=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$c=Array.isArray,v$3=t=>c$c(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$a="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$2=/-->/g,m$9=/>/g,p$3=RegExp(`>|${a$a}(?:([^\\s"'>=/]+)(${a$a}*=${a$a}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$6=/'/g,$$1=/"/g,y$6=/^(?:script|style|textarea|title)$/i,w$2=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$1=w$2(1),b$7=w$2(2),T=Symbol.for("lit-noChange"),A$3=Symbol.for("lit-nothing"),E=new WeakMap,C$2=r$b.createTreeWalker(r$b,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$b?e$b.createHTML(i):i}const V=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$2:void 0!==c[1]?u=m$9:void 0!==c[2]?(y$6.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$3):void 0!==c[3]&&(u=p$3):u===p$3?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$3:'"'===c[3]?$$1:g$6):u===$$1||u===g$6?u=p$3:u===_$2||u===m$9?u=f$9:(u=p$3,l=void 0);const w=u===p$3&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$2:v>=0?(e.push(d),s.slice(0,v)+o$a+s.slice(v)+n$l+w):s+n$l+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V(t,i);if(this.el=N.createElement(a,e),C$2.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$2.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$a)||i.startsWith(n$l)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$a).split(n$l),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H:"?"===i[1]?L$3:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$6.test(h.tagName)){const t=h.textContent.split(n$l),i=t.length-1;if(i>0){h.textContent=s$i?s$i.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$9()),C$2.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$9());}}}else if(8===h.nodeType)if(h.data===l$b)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$l,t+1));)v.push({type:7,index:r}),t+=n$l.length-1;}r++;}}static createElement(t,i){const s=r$b.createElement("template");return s.innerHTML=t,s}};function S$2(t,i,s=t,e){var o,n,l,h;if(i===T)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$4(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$2(t,r._$AS(t,i.values),r,e)),i}let M$2 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$b).importNode(s,true);C$2.currentNode=o;let n=C$2.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$2(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$2.nextNode(),l++);}return C$2.currentNode=r$b,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$2 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$3,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$2(this,t,i),d$4(t)?t===A$3||null==t||""===t?(this._$AH!==A$3&&this._$AR(),this._$AH=A$3):t!==this._$AH&&t!==T&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$3(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$3&&d$4(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$b.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$2(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$1(t)),i}T(t){c$c(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$9()),this.k(u$9()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$3,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$3;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$2(this,t,i,0),n=!d$4(t)||t!==this._$AH&&t!==T,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$2(this,e[s+l],i,l),h===T&&(h=this._$AH[l]),n||(n=!d$4(h)||h!==this._$AH[l]),h===A$3?t=A$3:t!==A$3&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$3?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$3?void 0:t;}}const I$1=s$i?s$i.emptyScript:"";let L$3 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$3?this.element.setAttribute(this.name,I$1):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$2(this,t,i,0))&&void 0!==s?s:A$3)===T)return;const e=this._$AH,o=t===A$3&&e!==A$3||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$3&&(e===A$3||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$2(this,t);}}const B$1=i$a.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$2),(null!==(t$d=i$a.litHtmlVersions)&&void 0!==t$d?t$d:i$a.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$a=Symbol.for(""),l$a=t=>{if((null==t?void 0:t.r)===e$a)return null==t?void 0:t._$litStatic$},o$9=t=>({_$litStatic$:t,r:e$a}),s$h=new Map,a$9=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$a(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$h.get(t))&&(n.raw=n,s$h.set(t,r=n)),e=u;}return t(r,...e)},n$k=a$9(x$1),u$8=a$9(b$7);

  let t$c = class t{static{this.html=n$k;}static{this.svg=u$8;}static{this.unsafeStatic=o$9;}};s$s("LitStatic",t$c);
  ...
  const u$7=o=>{let i,a,r,d,n,s,p,g,e,l,y,m;const h=f$8({beforeStart:()=>{const t=o;i=getComputedStyle(t),a=parseFloat(i.paddingTop),r=parseFloat(i.paddingBottom),d=parseFloat(i.marginTop),n=parseFloat(i.marginBottom),s=parseFloat(i.height),p=t.style.overflow,g=t.style.paddingTop,e=t.style.paddingBottom,l=t.style.marginTop,y=t.style.marginBottom,m=t.style.height,t.style.overflow="hidden";},duration:v$2,element:o,advance:t=>{o.style.paddingTop=`${a-a*t}px`,o.style.paddingBottom=`${r-r*t}px`,o.style.marginTop=`${d-d*t}px`,o.style.marginBottom=`${n-n*t}px`,o.style.height=`${s-s*t}px`;}});return h.promise().then(t=>{t instanceof Error||(o.style.overflow=p,o.style.paddingTop=g,o.style.paddingBottom=e,o.style.marginTop=l,o.style.marginBottom=y,o.style.height=m,o.style.display="none");}),h};

  let n$i;i$h(()=>{n$i=void 0;});const d$3=()=>(n$i===void 0&&(n$i=C$4()),n$i),m$8=o=>{Object.values(u$e).includes(o)&&(n$i=o);};
  ...
  let e$6,t$4;i$h(()=>{e$6=void 0,t$4=void 0;});let a$6=false;const s$d=()=>a$6,l$9=()=>(e$6===void 0&&(e$6=L$4()),e$6),L$2=async n=>{e$6!==n&&(a$6=true,e$6=n,await o$7(n),a$6=false,h$3()&&await C$3({languageAware:true}));},c$9=()=>a$j,m$6=n=>{t$4=n;},h$1=()=>(t$4===void 0&&(t$4=R$3()),t$4);
  ...
  const r$7=new Map,n$c=t=>(r$7.has(t)||r$7.set(t,new r$8(t)),r$7.get(t)),c$8=t=>{try{if(t&&typeof t=="string")return n$c(t)}catch{}return new r$8(r$j)},s$c=t=>{const e=l$9();return e?n$c(e):c$8(o$8())};

  const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$7=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$2=i=>{let e;if(!i)return r$j;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$7.exec(o))||r&&(e=c$7.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$j};
  ...
  const d$2=new Set,m$5=new Set,g$5=new Map,l$8=new Map,u$6=new Map,$=(n,t,e)=>{const r=`${n}/${t}`;u$6.set(r,e);},f$6=(n,t)=>{g$5.set(n,t);},A$2=n=>g$5.get(n),h=(n,t)=>{const e=`${n}/${t}`;return u$6.has(e)},B=(n,t)=>{const e=`${n}/${t}`,r=u$6.get(e);return r&&!l$8.get(e)&&l$8.set(e,r(t)),l$8.get(e)},M$1=n=>{d$2.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$2.add(n));},L$1=(n,t)=>t!==a$j&&!h(n,t),w$1=async n=>{const t=s$c().getLanguage(),e=s$c().getRegion(),r=s$c().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$1(n,s))for(s=p$2(s);L$1(n,s);)s=n$b(s);const I=h$1();if(s===a$j&&!I){f$6(n,null);return}if(!h(n,s)){M$1(n);return}try{const o=await B(n,s);f$6(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$5.keys()];return Promise.all(t.map(w$1))});

  const g$4=/('')|'([^']+(?:''[^']*)*)(?:'|$)|\{([0-9]+(?:\s*,[^{}]*)?)\}|[{}]/g,i$6=(n,t)=>(t=t||[],n.replace(g$4,(p,s,e,r,o)=>{if(s)return "'";if(e)return e.replace(/''/g,"'");if(r){const a=typeof r=="string"?parseInt(r):r;return String(t[a])}throw new Error(`[i18n]: pattern syntax error at pos ${o}`)}));

  const r$5=new Map;let s$b;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$5=n=>{if(r$5.has(n))return r$5.get(n);const e=new u$5(n);return r$5.set(n,e),e},f$5=async n=>s$b?s$b(n):(await w$1(n),a$5(n)),y$5=n=>{s$b=n;};

  const e$5={key:"DRAG_DROP_MULTIPLE_TEXT",defaultText:"{0} items"};

  const l$7=2;const u$4=async e=>{const t=document.createElement("div"),n=await f$5("@ui5/webcomponents-base"),r=t.attachShadow({mode:"open"}),o=new CSSStyleSheet;return o.replaceSync(s$e),r.adoptedStyleSheets=[o],r.textContent=n.getText(e$5,e),t},m$4=async(e,t)=>{if(e<l$7){console.warn(`Cannot start multiple drag with count ${e}. Minimum is ${l$7}.`);return}if(!t.dataTransfer)return;const n=await u$4(e);document.body.appendChild(n),t.dataTransfer.setDragImage(n,0,0),requestAnimationFrame(()=>{n.remove();});};

  const c$6=["value-changed","click"];let e$4;i$h(()=>{e$4=void 0;});const s$a=t=>c$6.includes(t),l$6=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$4===void 0&&(e$4=F$1()),e$4),f$4=t=>{e$4=t;},a$4=t=>{const n=o$6();return s$a(t)?false:n===true?true:!l$6(t)};
  ...
  const y$4={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,ARROW_LEFT:37,ARROW_UP:38,ARROW_RIGHT:39,ARROW_DOWN:40},b$4=o=>(o.key?o.key==="Enter":o.keyCode===y$4.ENTER)&&!a$3(o),A$1=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$4.SPACE)&&!a$3(o),D$2=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$4.ARROW_LEFT)&&!a$3(o),R$1=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$4.ARROW_RIGHT)&&!a$3(o),P=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$4.ARROW_UP)&&!a$3(o),_=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$4.ARROW_DOWN)&&!a$3(o),M=o=>(o.key?o.key==="Home":o.keyCode===y$4.HOME)&&!a$3(o),n$a=o=>(o.key?o.key==="End":o.keyCode===y$4.END)&&!a$3(o),m$2=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$4.ESCAPE)&&!a$3(o),x=o=>(o.key?o.key==="Tab":o.keyCode===y$4.TAB)&&!a$3(o),j=o=>(o.key?o.key==="PageUp":o.keyCode===y$4.PAGE_UP)&&!a$3(o),q=o=>(o.key?o.key==="PageDown":o.keyCode===y$4.PAGE_DOWN)&&!a$3(o),Ko=o=>o.key==="Shift"||o.keyCode===y$4.SHIFT,a$3=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey);
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    registerThemePropertiesLoader: p$5,
    renderDeferred: l$f,
    renderFinished: f$c,
    ...
    setCustomElementsScopingSuffix: l$m,
