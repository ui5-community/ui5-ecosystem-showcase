sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  const a$k=e=>{e.setAttribute("popover","manual"),e.showPopover();},l$n=e=>{e.hasAttribute("popover")&&(e.hidePopover(),e.removeAttribute("popover"));},i$p=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(o=>{const p=o.shadowRoot;return p&&i$p(p)}),u$i=e=>{const o=e.prototype.open;e.prototype.open=function(...t){o.apply(this,t);const n=i$p();if(["OPENING","OPEN"].includes(this.getOpenState())&&n){const c=this.getContent();if(c){const r=c instanceof HTMLElement?c:c?.getDomRef();r&&a$k(r);}}};},y$8=e=>{const o=e.prototype._closed;e.prototype._closed=function(...t){const n=this.getContent(),s=n instanceof HTMLElement?n:n?.getDomRef();o.apply(this,t),s&&l$n(s);};},v$4=e=>{const o=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(t){const n=t.type==="focus"||t.type==="activate",s=t.target;(!n||!s.closest("[ui5-popover],[ui5-responsive-popover],[ui5-dialog]"))&&o.call(this,t);};},d$d=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},h$8=e=>{u$i(e),y$8(e),d$d(),v$4(e);};

  const e$i=new Map,s$t=(t,r)=>{e$i.set(t,r);},n$t=t=>e$i.get(t);

  var c$l={},e$h=c$l.hasOwnProperty,a$j=c$l.toString,o$l=e$h.toString,l$m=o$l.call(Object),i$o=function(r){var t,n;return !r||a$j.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$l.call(n)===l$m):true)};
  ...
  const e$e=new i$n,t$p="configurationReset",i$m=n=>{e$e.attachEvent(t$p,n);};

  let p$9=false,t$o={animationMode:u$f.Full,theme:e$f,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$i(),t$o.animationMode),T$4=()=>(o$i(),t$o.theme),S$4=()=>(o$i(),t$o.themeRoot),L$3=()=>(o$i(),t$o.language),F$1=()=>(o$i(),t$o.fetchDefaultLanguage),U$2=()=>(o$i(),t$o.noConflict),b$b=()=>(o$i(),t$o.defaultFontLoading),D$2=()=>(o$i(),t$o.enableDefaultTooltips),I$6=()=>(o$i(),t$o.calendarType),M$2=()=>(o$i(),t$o.formatSettings),i$l=new Map;i$l.set("true",true),i$l.set("false",false);const z$1=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$o=e$g(t$o,e));}},E$2=()=>{const n=new URLSearchParams(u$g());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||u$e(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&u$e(a,e,"sap-ui");});},P$7=n=>{const e=n.split("@")[1];return g$c(e)},w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,u$e=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$l.has(e)&&(e=i$l.get(r)),s==="theme"?(t$o.theme=w$7(s,e),e&&e.includes("@")&&(t$o.themeRoot=P$7(e))):t$o[s]=e;},j=()=>{const n=n$t("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$o=e$g(t$o,e);},o$i=()=>{typeof document>"u"||p$9||(g$b(),p$9=true);},g$b=n=>{z$1(),E$2(),j();};

  let l$k = class l{constructor(){this.list=[],this.lookup=new Set;}add(t){this.lookup.has(t)||(this.list.push(t),this.lookup.add(t));}remove(t){this.lookup.has(t)&&(this.list=this.list.filter(e=>e!==t),this.lookup.delete(t));}shift(){const t=this.list.shift();if(t)return this.lookup.delete(t),t}isEmpty(){return this.list.length===0}isAdded(t){return this.lookup.has(t)}process(t){let e;const s=new Map;for(e=this.shift();e;){const i=s.get(e)||0;if(i>10)throw new Error("Web component processed too many times this task, max allowed is: 10");t(e),s.set(e,i+1),e=this.shift();}}};
  ...
  const u$d=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$j=()=>typeof document>"u"?null:o$h('meta[name="ui5-shared-resources"]',document.head,u$d),m$f=(t,o)=>{const r=t.split(".");let e=l$j();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$d={version:"2.12.0",major:2,minor:12,patch:0,suffix:"",isNext:false,buildTime:1751620086};

  let s$p,t$n={include:[/^ui5-/],exclude:[]};const o$g=new Map,l$i=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$4()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$p=e;},c$j=()=>s$p,p$8=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$n=e,o$g.clear();},m$e=()=>t$n,i$k=e=>{if(!o$g.has(e)){const n=t$n.include.some(r=>e.match(r))&&!t$n.exclude.some(r=>e.match(r));o$g.set(e,n);}return o$g.get(e)},g$a=e=>{if(i$k(e))return c$j()};

  let i$j,s$o="";const u$c=new Map,r$j=m$f("Runtimes",[]),x$1=()=>{if(i$j===void 0){i$j=r$j.length;const e=e$d;r$j.push({...e,get scopingSuffix(){return c$j()},get registeredTags(){return T$3()},get scopingRules(){return m$e()},alias:s$o,description:`Runtime ${i$j} - ver ${e.version}${""}`});}},I$5=()=>i$j,b$a=(e,m)=>{const o=`${e},${m}`;if(u$c.has(o))return u$c.get(o);const t=r$j[e],n=r$j[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$c.set(o,l),l},$$3=()=>r$j;

  const g$9=m$f("Tags",new Map),d$c=new Set;let s$n=new Map,c$i;const m$d=-1,h$7=e=>{d$c.add(e),g$9.set(e,I$5());},w$6=e=>d$c.has(e),R$4=()=>d$c.size>0,T$3=()=>[...d$c.values()],$$2=e=>{let n=g$9.get(e);n===void 0&&(n=m$d),s$n.has(n)||s$n.set(n,new Set),s$n.get(n).add(e),c$i||(c$i=setTimeout(()=>{y$7(),s$n=new Map,c$i=void 0;},1e3));},y$7=()=>{const e=$$3(),n=I$5(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$m=new Set,n$r=e=>{t$m.add(e);},r$i=e=>t$m.has(e);

  const s$m=new Set,d$b=new i$n,n$q=new l$k;let t$l,a$g,m$c,i$i;const l$h=async e=>{n$q.add(e),await P$6();},c$h=e=>{d$b.fireEvent("beforeComponentRender",e),s$m.add(e),e._render();},h$6=e=>{n$q.remove(e),s$m.delete(e);},P$6=async()=>{i$i||(i$i=new Promise(e=>{window.requestAnimationFrame(()=>{n$q.process(c$h),i$i=null,e(),m$c||(m$c=setTimeout(()=>{m$c=void 0,n$q.isEmpty()&&U$1();},200));});})),await i$i;},y$6=()=>t$l||(t$l=new Promise(e=>{a$g=e,window.requestAnimationFrame(()=>{n$q.isEmpty()&&(t$l=void 0,e());});}),t$l),I$4=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$c=async()=>{await I$4(),await y$6();},U$1=()=>{n$q.isEmpty()&&a$g&&(a$g(),a$g=void 0,t$l=void 0);},C$3=async e=>{s$m.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$h(r);}),await f$c();};

  const g$8=typeof document>"u",i$h=(e,t)=>t?`${e}|${t}`:e,l$g=e=>e===void 0?true:b$a(I$5(),parseInt(e))===1,c$g=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$h(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$5=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$h(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$g(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$h(e,t)),f$b=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$h(e,t));},R$3=(e,t,r="",s)=>{S$3(t,r)?y$5(e,t,r,s):c$g(e,t,r,s);},m$b=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$k=new i$n,r$h="themeRegistered",n$p=e=>{t$k.attachEvent(r$h,e);},s$l=e=>t$k.fireEvent(r$h,e);

  const l$f=new Map,h$5=new Map,u$b=new Map,T$2=new Set,i$g=new Set,p$7=(e,r,t)=>{h$5.set(`${e}/${r}`,t),T$2.add(e),i$g.add(r),s$l(r);},m$a=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$f.get(g);if(s!==void 0)return s;if(!i$g.has(r)){const $=[...i$g.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$f(e,e$f)}const[n,d]=await Promise.all([a$f(e,r),t?a$f(e,t,true):void 0]),o=m$b(n,d);return o&&l$f.set(g,o),o},a$f=async(e,r,t=false)=>{const s=(t?u$b:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$5=e=>i$g.has(e);

  const r$g=new Set,s$k=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$f=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$a=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$9=()=>{const e=s$k();if(!e||e==="none")return;const t=o$f(e);if(t)return d$a(t)};

  const t$j=new i$n,d$9="themeLoaded",o$e=e=>{t$j.attachEvent(d$9,e);},n$o=e=>{t$j.detachEvent(d$9,e);},r$f=e=>t$j.fireEvent(d$9,e);

  const d$8=(r,n)=>{const e=document.createElement("link");return e.type="text/css",e.rel="stylesheet",n&&Object.entries(n).forEach(t=>e.setAttribute(...t)),e.href=r,document.head.appendChild(e),new Promise(t=>{e.addEventListener("load",t),e.addEventListener("error",t);})};

  let t$i;i$m(()=>{t$i=void 0;});const n$n=()=>(t$i===void 0&&(t$i=S$4()),t$i),u$a=e=>`${n$n()}Base/baseLib/${e}/css_variables.css`,i$f=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$8(u$a(e),{"sap-ui-webcomponents-theme":e});};

  const s$j="@ui5/webcomponents-theming",S$2=()=>w$5().has(s$j),P$4=async e=>{if(!S$2())return;const t=await m$a(s$j,e);t&&R$3(t,"data-ui5-theme-properties",s$j,e);},E$1=()=>{f$b("data-ui5-theme-properties",s$j);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$j)return;const i=await m$a(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$9();if(t)return t;const r=n$t("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$n())return await i$f(e),m$9()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$4(e):E$1();const r=P$5(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};

  const d$7=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});
  ...
  const i$e=()=>{const t=n$t("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$6(),c$f();},p$6=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$d()||t||S$3("data-ui5-font-face")||c$g(a$e,"data-ui5-font-face");},c$f=()=>{S$3("data-ui5-font-face-override")||c$g(n$m,"data-ui5-font-face-override");};
  ...
  const e$c=()=>{S$3("data-ui5-system-css-vars")||c$g(a$c,"data-ui5-system-css-vars");};

  const t$h=typeof document>"u",e$b={get userAgent(){return t$h?"":navigator.userAgent},get touch(){return t$h?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$h?false:/(Chrome|CriOS)/.test(e$b.userAgent)},get firefox(){return t$h?false:/Firefox/.test(e$b.userAgent)},get safari(){return t$h?false:!e$b.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$b.userAgent)},get webkit(){return t$h?false:/webkit/.test(e$b.userAgent)},get windows(){return t$h?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$h?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$h?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$b.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$h?false:!e$b.windows&&/Android/.test(e$b.userAgent)},get androidPhone(){return t$h?false:e$b.android&&/(?=android)(?=.*mobile)/i.test(e$b.userAgent)},get ipad(){return t$h?false:/ipad/i.test(e$b.userAgent)||/Macintosh/i.test(e$b.userAgent)&&"ontouchend"in document},_isPhone(){return u$9(),e$b.touch&&!r$e}};let o$c,i$d,r$e;const s$i=()=>{if(t$h||!e$b.windows)return  false;if(o$c===void 0){const n=e$b.userAgent.match(/Windows NT (\d+).(\d)/);o$c=n?parseFloat(n[1]):0;}return o$c>=8},c$e=()=>{if(t$h||!e$b.webkit)return  false;if(i$d===void 0){const n=e$b.userAgent.match(/(webkit)[ /]([\w.]+)/);i$d=n?parseFloat(n[1]):0;}return i$d>=537.1},u$9=()=>{if(t$h)return  false;if(r$e===void 0){if(e$b.ipad){r$e=true;return}if(e$b.touch){if(s$i()){r$e=true;return}if(e$b.chrome&&e$b.android){r$e=!/Mobile Safari\/[.0-9]+/.test(e$b.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$b.android&&c$e()&&(n=1),r$e=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$e=e$b.userAgent.indexOf("Touch")!==-1||e$b.android&&!e$b.androidPhone;}},l$e=()=>e$b.touch,h$4=()=>e$b.safari,g$7=()=>e$b.chrome,b$9=()=>e$b.firefox,a$b=()=>(u$9(),(e$b.touch||s$i())&&r$e),d$6=()=>e$b._isPhone(),f$a=()=>t$h?false:!a$b()&&!d$6()||s$i(),m$8=()=>a$b()&&f$a(),w$3=()=>e$b.iOS,P$3=()=>e$b.android||e$b.androidPhone;

  let t$g=false;const i$c=()=>{h$4()&&w$3()&&!t$g&&(document.body.addEventListener("touchstart",()=>{}),t$g=true);};

  let o$b=false,r$d;const p$5=new i$n,h$3=()=>o$b,P$2=e=>{if(!o$b){p$5.attachEvent("boot",e);return}e();},l$d=async()=>{if(r$d!==void 0)return r$d;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$p(b$8);const t=n$t("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$t("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$7(),await I$3(r$c()),t&&t.attachListeners(),i$e(),e$c(),i$c(),n(),o$b=true,p$5.fireEvent("boot");};return r$d=new Promise(e),r$d},b$8=e=>{o$b&&e===r$c()&&I$3(r$c());};

  let t$f;i$m(()=>{t$f=void 0;});const r$c=()=>(t$f===void 0&&(t$f=T$4()),t$f),u$8=async e=>{t$f!==e&&(t$f=e,h$3()&&(await I$3(t$f),await C$3({themeAware:true})));},g$6=()=>e$f,n$l=()=>{const e=r$c();return l$c(e)?!e.startsWith("sap_horizon"):!m$9()?.baseThemeName?.startsWith("sap_horizon")},l$c=e=>s$s.includes(e);

  let t$e = class t{static isAtLeastVersion116(){if(!window.sap.ui.version)return  true;const e=window.sap.ui.version.split(".");return !e||e.length<2?false:parseInt(e[0])>1||parseInt(e[1])>=116}static isOpenUI5Detected(){return typeof window.sap?.ui?.require=="function"}static init(){return t.isOpenUI5Detected()?(t.initPromise||(t.initPromise=new Promise(a=>{window.sap.ui.require(["sap/ui/core/Core"],async e=>{const i=()=>{let n=["sap/ui/core/Popup","sap/ui/core/Patcher","sap/ui/core/LocaleData"];t.isAtLeastVersion116()&&(n=[...n,"sap/base/i18n/Formatting","sap/base/i18n/Localization","sap/ui/core/ControlBehavior","sap/ui/core/Theming","sap/ui/core/date/CalendarUtils"]),window.sap.ui.require(n,(o,r)=>{p$a(r),h$8(o),a();});};t.isAtLeastVersion116()?(await e.ready(),i()):e.attachInit(i);});})),t.initPromise):Promise.resolve()}static getConfigurationSettingsObject(){if(!t.isOpenUI5Detected())return {};if(t.isAtLeastVersion116()){const n=window.sap.ui.require("sap/ui/core/ControlBehavior"),o=window.sap.ui.require("sap/base/i18n/Localization"),r=window.sap.ui.require("sap/ui/core/Theming"),s=window.sap.ui.require("sap/base/i18n/Formatting"),c=window.sap.ui.require("sap/ui/core/date/CalendarUtils");return {animationMode:n.getAnimationMode(),language:o.getLanguage(),theme:r.getTheme(),themeRoot:r.getThemeRoot(),rtl:o.getRTL(),timezone:o.getTimezone(),calendarType:s.getCalendarType(),formatSettings:{firstDayOfWeek:c.getWeekConfigurationValues().firstDayOfWeek,legacyDateCalendarCustomizing:s.getCustomIslamicCalendarData?.()??s.getLegacyDateCalendarCustomizing?.()}}}const e=window.sap.ui.require("sap/ui/core/Core").getConfiguration(),i=window.sap.ui.require("sap/ui/core/LocaleData");return {animationMode:e.getAnimationMode(),language:e.getLanguage(),theme:e.getTheme(),themeRoot:e.getThemeRoot(),rtl:e.getRTL(),timezone:e.getTimezone(),calendarType:e.getCalendarType(),formatSettings:{firstDayOfWeek:i?i.getInstance(e.getLocale()).getFirstDayOfWeek():void 0,legacyDateCalendarCustomizing:e.getFormatSettings().getLegacyDateCalendarCustomizing()}}}static getLocaleDataObject(){if(!t.isOpenUI5Detected())return;const a=window.sap.ui.require("sap/ui/core/LocaleData");if(t.isAtLeastVersion116()){const n=window.sap.ui.require("sap/base/i18n/Localization");return a.getInstance(n.getLanguageTag())._get()}const i=window.sap.ui.require("sap/ui/core/Core").getConfiguration();return a.getInstance(i.getLocale())._get()}static _listenForThemeChange(){if(t.isAtLeastVersion116()){const a=window.sap.ui.require("sap/ui/core/Theming");a.attachApplied(()=>{u$8(a.getTheme());});}else {const a=window.sap.ui.require("sap/ui/core/Core"),e=a.getConfiguration();a.attachThemeChanged(()=>{u$8(e.getTheme());});}}static attachListeners(){t.isOpenUI5Detected()&&t._listenForThemeChange();}static cssVariablesLoaded(){if(!t.isOpenUI5Detected())return;const a=[...document.head.children].find(e=>e.id==="sap-ui-theme-sap.ui.core");return a?!!a.href.match(/\/css(-|_)variables\.css/):false}};s$t("OpenUI5Support",t$e);
   ...
   */
  var t$d;const i$b=window,s$h=i$b.trustedTypes,e$a=s$h?s$h.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$a="$lit$",n$k=`lit$${(Math.random()+"").slice(9)}$`,l$b="?"+n$k,h$2=`<${l$b}>`,r$b=document,u$7=()=>r$b.createComment(""),d$5=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$d=Array.isArray,v$3=t=>c$d(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$a="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$2=/-->/g,m$7=/>/g,p$4=RegExp(`>|${a$a}(?:([^\\s"'>=/]+)(${a$a}*=${a$a}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$5=/'/g,$$1=/"/g,y$4=/^(?:script|style|textarea|title)$/i,w$2=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x=w$2(1),b$7=w$2(2),T$1=Symbol.for("lit-noChange"),A$2=Symbol.for("lit-nothing"),E=new WeakMap,C$2=r$b.createTreeWalker(r$b,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$a?e$a.createHTML(i):i}const V=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$2:void 0!==c[1]?u=m$7:void 0!==c[2]?(y$4.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$4):void 0!==c[3]&&(u=p$4):u===p$4?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$4:'"'===c[3]?$$1:g$5):u===$$1||u===g$5?u=p$4:u===_$2||u===m$7?u=f$9:(u=p$4,l=void 0);const w=u===p$4&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$2:v>=0?(e.push(d),s.slice(0,v)+o$a+s.slice(v)+n$k+w):s+n$k+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V(t,i);if(this.el=N.createElement(a,e),C$2.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$2.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$a)||i.startsWith(n$k)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$a).split(n$k),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H$1:"?"===i[1]?L$2:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$4.test(h.tagName)){const t=h.textContent.split(n$k),i=t.length-1;if(i>0){h.textContent=s$h?s$h.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$7()),C$2.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$7());}}}else if(8===h.nodeType)if(h.data===l$b)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$k,t+1));)v.push({type:7,index:r}),t+=n$k.length-1;}r++;}}static createElement(t,i){const s=r$b.createElement("template");return s.innerHTML=t,s}};function S$1(t,i,s=t,e){var o,n,l,h;if(i===T$1)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$5(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$1(t,r._$AS(t,i.values),r,e)),i}let M$1 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$b).importNode(s,true);C$2.currentNode=o;let n=C$2.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$2(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z$1(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$2.nextNode(),l++);}return C$2.currentNode=r$b,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$2 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$2,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$1(this,t,i),d$5(t)?t===A$2||null==t||""===t?(this._$AH!==A$2&&this._$AR(),this._$AH=A$2):t!==this._$AH&&t!==T$1&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$3(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$2&&d$5(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$b.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$1(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$1(t)),i}T(t){c$d(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$7()),this.k(u$7()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$2,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$2;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$1(this,t,i,0),n=!d$5(t)||t!==this._$AH&&t!==T$1,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$1(this,e[s+l],i,l),h===T$1&&(h=this._$AH[l]),n||(n=!d$5(h)||h!==this._$AH[l]),h===A$2?t=A$2:t!==A$2&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$2?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};let H$1 = class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$2?void 0:t;}};const I$2=s$h?s$h.emptyScript:"";let L$2 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$2?this.element.setAttribute(this.name,I$2):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$1(this,t,i,0))&&void 0!==s?s:A$2)===T$1)return;const e=this._$AH,o=t===A$2&&e!==A$2||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$2&&(e===A$2||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}let Z$1 = class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$1(this,t);}};const B$1=i$b.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$2),(null!==(t$d=i$b.litHtmlVersions)&&void 0!==t$d?t$d:i$b.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$9=Symbol.for(""),l$a=t=>{if((null==t?void 0:t.r)===e$9)return null==t?void 0:t._$litStatic$},o$9=t=>({_$litStatic$:t,r:e$9}),s$g=new Map,a$9=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$a(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$g.get(t))&&(n.raw=n,s$g.set(t,r=n)),e=u;}return t(r,...e)},n$j=a$9(x),u$6=a$9(b$7);

  let t$c = class t{static{this.html=n$j;}static{this.svg=u$6;}static{this.unsafeStatic=o$9;}};s$t("LitStatic",t$c);
  ...
  let n$h;i$m(()=>{n$h=void 0;});const d$4=()=>(n$h===void 0&&(n$h=C$4()),n$h),m$6=o=>{Object.values(u$f).includes(o)&&(n$h=o);};
  ...
  let t$a;let a$7 = class a{static getLegacyDateCalendarCustomizing(){return t$a===void 0&&(t$a=M$2()),t$a.legacyDateCalendarCustomizing||[]}};s$t("LegacyDateFormats",a$7);

  let e$8;i$m(()=>{e$8=void 0;});const n$f=()=>(e$8===void 0&&(e$8=M$2()),e$8.firstDayOfWeek),i$9=n$t("LegacyDateFormats"),m$5=i$9?a$7.getLegacyDateCalendarCustomizing:()=>[];

  const t$9=new Map,e$7=(n,o)=>{t$9.set(n,o);},c$c=n=>t$9.get(n);

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$e=new Map;s$e.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$e.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$e.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$b=(n,e)=>{if(s$e.has(n)){s$e.set(n,{...e,...s$e.get(n)});return}s$e.set(n,e);},r$a=n=>{const e=n$l()?"legacy":"sap_horizon";return s$e.has(n)?s$e.get(n)[e]:n};
  ...
  const i$8=o=>{const t=c$c(r$c());return !o&&t?n$e(t):o?r$a(o):r$a("SAP-icons")};

  const e$6=new i$n,n$d="languageChange",t$6=a=>{e$6.attachEvent(n$d,a);},r$9=a=>{e$6.detachEvent(n$d,a);},o$8=a=>e$6.fireEventAsync(n$d,a);

  let e$5,t$5;i$m(()=>{e$5=void 0,t$5=void 0;});let a$6=false;const s$d=()=>a$6,l$9=()=>(e$5===void 0&&(e$5=L$3()),e$5),L$1=async n=>{e$5!==n&&(a$6=true,e$5=n,await o$8(n),a$6=false,h$3()&&await C$3({languageAware:true}));},c$a=()=>a$i,m$4=n=>{t$5=n;},h$1=()=>(t$5===void 0&&(t$5=F$1()),t$5);

  const c$9=["value-changed","click"];let e$4;i$m(()=>{e$4=void 0;});const s$c=t=>c$9.includes(t),l$8=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$4===void 0&&(e$4=U$2()),e$4),f$7=t=>{e$4=t;},a$5=t=>{const n=o$7();return s$c(t)?false:n===true?true:!l$8(t)};
  ...
  const r$7=()=>m$f("CustomStyle.eventProvider",new i$n),n$a="CustomCSSChange",i$6=t=>{r$7().attachEvent(n$a,t);},u$4=t=>r$7().fireEvent(n$a,t),c$6=()=>m$f("CustomStyle.customCSSFor",{});let s$8;i$6(t=>{s$8||C$3({tag:t});});const g$3=(t,e)=>{const o=c$6();o[t]||(o[t]=[]),o[t].push(e),s$8=true;try{u$4(t);}finally{s$8=false;}return C$3({tag:t})},l$5=t=>{const e=c$6();return e[t]?e[t].join(""):""};

  const e$3=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$2=new Map;i$6(t=>{e$2.delete(`${t}_normal`);});const y$2=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$t("OpenUI5Enablement");if(!e$2.has(n)){let l="";s&&(l=e$3(s.getBusyIndicatorStyles()));const a=l$5(o)||"",m=`${e$3(t.styles)} ${a} ${l}`;e$2.set(n,m);}return e$2.get(n)};
  ...
  const r$2=new Map,n$4=t=>(r$2.has(t)||r$2.set(t,new r$3(t)),r$2.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$4(t)}catch{}return new r$3(r$k)},s$3=t=>{const e=l$9();return e?n$4(e):c$5(o$2())};
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    setCustomElementsScopingSuffix: l$i,
    setDefaultIconCollection: e$7,
    setFetchDefaultLanguage: m$4,
    setLanguage: L$1,
    setNoConflict: f$7,
    setTheme: u$8,
    slideDown: b$6,
