sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  const e$m=t=>{const p=t.openEnd;t.openEnd=function(){return this._mAttributes?.popover&&delete this._mAttributes.popover,p.apply(this)};},n$v=t=>{"prototype"in t&&"openEnd"in t.prototype?e$m(t.prototype):"openEnd"in t&&e$m(t);};
  ...
  const u$h=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$l=()=>typeof document>"u"?null:o$l('meta[name="ui5-shared-resources"]',document.head,u$h),m$j=(t,o)=>{const r=t.split(".");let e=l$l();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const g$f=m$j("Tags",new Map),d$f=new Set;let i$p=new Map,c$m;const m$i=-1,h$8=e=>{d$f.add(e),g$f.set(e,I$4());},w$9=e=>d$f.has(e),R$4=()=>d$f.size>0,T$3=()=>[...d$f.values()],$$3=e=>{let n=g$f.get(e);n===void 0&&(n=m$i),i$p.has(n)||i$p.set(n,new Set),i$p.get(n).add(e),c$m||(c$m=setTimeout(()=>{y$a(),i$p=new Map,c$m=void 0;},1e3));},y$a=()=>{const e=$$2(),n=I$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$p.keys()].forEach(s=>{let o,r;s===m$i?(o=1,r={description:"Older unknown runtime"}):(o=b$b(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${i$p.get(s).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...i$p.get(s)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const e$l={version:"2.20.0",major:2,minor:20,patch:0,suffix:"",isNext:false,buildTime:1772704608};

  let s$v,t$r={include:[/^ui5-/],exclude:[]};const o$k=new Map,p$8=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$4()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$v=e;},c$l=()=>s$v,g$e=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$r=e,o$k.clear();},m$h=()=>t$r,i$o=e=>{if(!o$k.has(e)){const n=t$r.include.some(r=>e.match(r))&&!t$r.exclude.some(r=>e.match(r));o$k.set(e,n);}return o$k.get(e)},d$e=e=>{if(i$o(e))return c$l()};

  let i$n,s$u="";const u$g=new Map,r$o=m$j("Runtimes",[]),x$2=()=>{if(i$n===void 0){i$n=r$o.length;const e=e$l;r$o.push({...e,get scopingSuffix(){return c$l()},get registeredTags(){return T$3()},get scopingRules(){return m$h()},alias:s$u,description:`Runtime ${i$n} - ver ${e.version}${""}`});}},I$4=()=>i$n,b$b=(e,m)=>{const o=`${e},${m}`;if(u$g.has(o))return u$g.get(o);const t=r$o[e],n=r$o[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$g.set(o,l),l},$$2=()=>r$o;

  const g$d=typeof document>"u",i$m=(e,t)=>t?`${e}|${t}`:e,l$k=e=>e===void 0?true:b$b(I$4(),parseInt(e))>=1,c$k=(e,t,r="",s)=>{const d=I$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$m(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$9=(e,t,r="",s)=>{const d=I$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$m(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$k(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$5=(e,t="")=>g$d?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$m(e,t)),f$g=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$m(e,t));},R$3=(e,t,r="",s)=>{S$5(t,r)?y$9(e,t,r,s):c$k(e,t,r,s);},m$g=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  var e$k = "[data-sap-ui-popup][popover]{border:none;overflow:visible;margin:0}.sapUiBLy[popover]{width:100%;height:100%}";

  const o$j=()=>{S$5("data-ui5-popup-styles")||c$k(e$k,"data-ui5-popup-styles");};

  const p$7=m$j("AllOpenedPopupsRegistry",{openedRegistry:[]}),i$l=e=>{p$7.openedRegistry.push(e);},a$l=e=>{const o=p$7.openedRegistry.findIndex(t=>t.instance===e);o===p$7.openedRegistry.length-1&&I$3(),o>-1&&p$7.openedRegistry.splice(o,1);},c$j=()=>p$7.openedRegistry.length===0?null:p$7.openedRegistry[p$7.openedRegistry.length-1].instance,l$j=e=>{for(let o=p$7.openedRegistry.length-1;o>=0;o--){const t=p$7.openedRegistry[o];if(t.type==="WebComponent")return  true;if(t.instance===e)break}return  false},s$t=e=>{const o=e.getContent();return o instanceof HTMLElement?o:o?.getDomRef()||null},d$d=e=>{if(!["OPENING","OPEN"].includes(e.getOpenState())||!r$n())return;const t=s$t(e);if(!t)return;const n=document.getElementById("sap-ui-blocklayer-popup");e.getModal()&&n&&(n.setAttribute("popover","manual"),n.hidePopover(),n.showPopover()),t.setAttribute("popover","manual"),t.showPopover();},g$c=e=>{const o=s$t(e);if(o&&(o.hasAttribute("popover")&&(o.hidePopover(),o.removeAttribute("popover")),c$j()===e&&e.getModal())){const t=document.getElementById("sap-ui-blocklayer-popup");t&&t.hasAttribute("popover")&&t.hidePopover();}},I$3=()=>{if(!r$n())return;const e=p$7.openedRegistry[p$7.openedRegistry.length-2];if(!e||e.type!=="OpenUI5"||!e.instance.getModal())return;const o=s$t(e.instance),t=document.getElementById("sap-ui-blocklayer-popup");o?.hidePopover(),t?.showPopover(),o?.showPopover();},r$n=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(o=>{const t=o.shadowRoot;return t&&r$n(t)}),P$6=e=>{const o=e.prototype.onsapescape;e.prototype.onsapescape=function(...n){l$j(this.oPopup)||o.apply(this,n);};},h$7=e=>{const o=e.prototype.open;e.prototype.open=function(...n){o.apply(this,n),d$d(this),i$l({type:"OpenUI5",instance:this});};},O$4=e=>{const o=e.prototype._closed;e.prototype._closed=function(...n){g$c(this),o.apply(this,n),a$l(this);};},f$f=e=>{const o=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(...n){l$j(this)||o.apply(this,n);};},v$3=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},m$f=(e,o)=>{o$j(),h$7(e),O$4(e),v$3(),f$f(e),P$6(o);};

  const e$j=new Map,s$s=(t,r)=>{e$j.set(t,r);},n$u=t=>e$j.get(t);

  var c$i={},e$i=c$i.hasOwnProperty,a$k=c$i.toString,o$i=e$i.toString,l$i=o$i.call(Object),i$k=function(r){var t,n;return !r||a$k.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$i.call(n)===l$i):true)};

  var c$h=Object.create(null),u$f=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$h;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$k(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$k(n)?n:{},r[a]=u$f(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$h=function(n,t){return u$f(true,false,...arguments)};

  const _$3={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$g=_$3.themes.default,s$r=_$3.themes.all,a$j=_$3.languages.default,r$m=_$3.locales.default,l$h=_$3.locales.all;

  const o$h=typeof document>"u",n$t={search(){return o$h?"":window.location.search}},s$q=()=>o$h?"":window.location.href,u$e=()=>n$t.search();

  const s$p=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$g=e=>{const t=s$p("sap-allowed-theme-origins")??s$p("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$i=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$b=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$q()).toString();else {const n=new URL(e),r=n.origin;r&&o$g(r)?t=n.toString():t=a$i(n.toString(),s$q());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};

  var u$d=(l=>(l.Full="full",l.Basic="basic",l.Minimal="minimal",l.None="none",l))(u$d||{});
  ...
  const e$f=new i$j,t$q="configurationReset",i$i=n=>{e$f.attachEvent(t$q,n);};

  let p$6=false,t$p={animationMode:u$d.Full,theme:e$g,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$f(),t$p.animationMode),T$2=()=>(o$f(),t$p.theme),S$4=()=>{if(o$f(),t$p.themeRoot!==void 0){if(!g$b(t$p.themeRoot)){console.warn(`The ${t$p.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$p.themeRoot}},L$6=()=>(o$f(),t$p.language),R$2=()=>(o$f(),t$p.fetchDefaultLanguage),F=()=>(o$f(),t$p.noConflict),U$2=()=>(o$f(),t$p.defaultFontLoading),b$a=()=>(o$f(),t$p.enableDefaultTooltips),D$3=()=>(o$f(),t$p.calendarType),M$4=()=>(o$f(),t$p.formatSettings),i$h=new Map;i$h.set("true",true),i$h.set("false",false);const w$8=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$p=e$h(t$p,e));}},z$1=()=>{const n=new URLSearchParams(u$e());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$a(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$a(r,e,"sap-ui");});},E$3=n=>{const e=n.split("@")[1];return g$b(e)},P$5=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$a=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$h.has(e)&&(e=i$h.get(a)),s==="theme"?(t$p.theme=P$5(s,e),e&&e.includes("@")&&(t$p.themeRoot=E$3(e))):t$p[s]=e;},j$1=()=>{const n=n$u("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$p=e$h(t$p,e);},o$f=()=>{typeof document>"u"||p$6||(l$g(),p$6=true);},l$g=n=>{w$8(),z$1(),j$1();};

  let l$f = class l{constructor(){this.list=[],this.lookup=new Set;}add(t){this.lookup.has(t)||(this.list.push(t),this.lookup.add(t));}remove(t){this.lookup.has(t)&&(this.list=this.list.filter(e=>e!==t),this.lookup.delete(t));}shift(){const t=this.list.shift();if(t)return this.lookup.delete(t),t}isEmpty(){return this.list.length===0}isAdded(t){return this.lookup.has(t)}process(t){let e;const s=new Map;for(e=this.shift();e;){const i=s.get(e)||0;if(i>10)throw new Error("Web component processed too many times this task, max allowed is: 10");t(e),s.set(e,i+1),e=this.shift();}}};

  const t$o=new Set,n$s=e=>{t$o.add(e);},r$l=e=>t$o.has(e);

  const s$o=new Set,d$c=new i$j,n$r=new l$f;let t$n,a$h,m$e,i$g;const l$e=async e=>{n$r.add(e),await P$4();},c$g=e=>{d$c.fireEvent("beforeComponentRender",e),s$o.add(e),e._render();},h$6=e=>{n$r.remove(e),s$o.delete(e);},P$4=async()=>{i$g||(i$g=new Promise(e=>{window.requestAnimationFrame(()=>{n$r.process(c$g),i$g=null,e(),m$e||(m$e=setTimeout(()=>{m$e=void 0,n$r.isEmpty()&&U$1();},200));});})),await i$g;},y$8=()=>t$n||(t$n=new Promise(e=>{a$h=e,window.requestAnimationFrame(()=>{n$r.isEmpty()&&(t$n=void 0,e());});}),t$n),I$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$e=async()=>{await I$2(),await y$8();},U$1=()=>{n$r.isEmpty()&&a$h&&(a$h(),a$h=void 0,t$n=void 0);},C$3=async e=>{s$o.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$l(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$e(r);}),await f$e();};

  const t$m=new i$j,r$k="themeRegistered",n$q=e=>{t$m.attachEvent(r$k,e);},s$n=e=>t$m.fireEvent(r$k,e);

  const l$d=new Map,T$1=new Map,h$5=new Map,u$c=new Map,a$g=new Set,f$d=(e,r,t,s="root")=>{T$1.set(`${e}/${r}`,t),u$c.set(e,{cssVariablesTarget:s}),a$g.add(r),s$n(r);},L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$d.get(s);if(o!==void 0)return o;if(!a$g.has(r)){const p=[...a$g.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$g}. Registered themes are: ${p}`),c$f(e,e$g)}const[n,g]=await Promise.all([c$f(e,r),t?c$f(e,t,true):void 0]),i=m$g(n,g);return i&&l$d.set(s,i),i},c$f=async(e,r,t=false)=>{const o=(t?h$5:T$1).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$d=()=>u$c,w$7=e=>a$g.has(e);

  const r$j=new Set,s$m=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$e=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$j.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$j.add("decode"));return}try{return JSON.parse(a)}catch{r$j.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$j.add("parse"));}}},d$b=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$j.has("object")||(console.warn("Malformed theme metadata Object",e),r$j.add("object"));return}return {themeName:t,baseThemeName:a}},m$c=()=>{const e=s$m();if(!e||e==="none")return;const t=o$e(e);if(t)return d$b(t)};

  const t$l=new i$j,d$a="themeLoaded",o$d=e=>{t$l.attachEvent(d$a,e);},n$p=e=>{t$l.detachEvent(d$a,e);},r$i=e=>t$l.fireEvent(d$a,e);
  ...
  let t$k;i$i(()=>{t$k=void 0;});const n$o=()=>(t$k===void 0&&(t$k=S$4()),t$k),u$b=e=>`${n$o()}Base/baseLib/${e}/css_variables.css`,i$f=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$9(u$b(e),{"sap-ui-webcomponents-theme":e});};

  const t$j=new Map;let e$e;const n$n=()=>(e$e||(e$e=new CSSStyleSheet),e$e),r$h=(o,s)=>{t$j.set(o,s);const S=Array.from(t$j.values()).join(`
`);n$n().replaceSync(S);};

  let _lib="ui5",_package="webcomponents-theming";const a$f="@"+_lib+"/"+_package,E$2=()=>m$d().has(a$f),U=async e=>{if(!E$2())return;const t=await L$5(a$f,e);t&&R$3(t,"data-ui5-theme-properties",a$f,e);},w$6=()=>{f$g("data-ui5-theme-properties",a$f);},I$1=async(e,t)=>{const o=[...m$d().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$f)return;const i=await L$5(s,e,t);i&&(n==="root"?R$3(i,`data-ui5-component-properties-${I$4()}`,s):n==="host"&&r$h(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$c();if(t)return t;const r=n$u("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$o())return await i$f(e),m$c()},b$9=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U(e):w$6();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$7(e)?e:o||e$g;await I$1(s,r),w$3(o),r$i(e);};

  const d$8=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$m = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$c;i$i(()=>{o$c=void 0;});const a$e=()=>(o$c===void 0&&(o$c=U$2()),o$c);

  const a$d=()=>{const t=n$u("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$c();},f$c=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$e()||t||S$5("data-ui5-font-face")||c$k(n$m,"data-ui5-font-face");};

  var s$l = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

  const r$g=()=>{R$3(s$l,"data-ui5-system-css-vars");};

  var t$i = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

  const s$k=()=>{S$5("data-ui5-scrollbar-styles")||c$k(t$i,"data-ui5-scrollbar-styles");};

  const t$h=typeof document>"u",e$d={get userAgent(){return t$h?"":navigator.userAgent},get touch(){return t$h?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$h?false:/(Chrome|CriOS)/.test(e$d.userAgent)},get firefox(){return t$h?false:/Firefox/.test(e$d.userAgent)},get safari(){return t$h?false:!e$d.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$d.userAgent)},get webkit(){return t$h?false:/webkit/.test(e$d.userAgent)},get windows(){return t$h?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$h?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$h?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$d.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$h?false:!e$d.windows&&/Android/.test(e$d.userAgent)},get androidPhone(){return t$h?false:e$d.android&&/(?=android)(?=.*mobile)/i.test(e$d.userAgent)},get ipad(){return t$h?false:/ipad/i.test(e$d.userAgent)||/Macintosh/i.test(e$d.userAgent)&&"ontouchend"in document},_isPhone(){return u$a(),e$d.touch&&!r$f}};let o$b,i$e,r$f;const s$j=()=>{if(t$h||!e$d.windows)return  false;if(o$b===void 0){const n=e$d.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$e=()=>{if(t$h||!e$d.webkit)return  false;if(i$e===void 0){const n=e$d.userAgent.match(/(webkit)[ /]([\w.]+)/);i$e=n?parseFloat(n[1]):0;}return i$e>=537.1},u$a=()=>{if(t$h)return  false;if(r$f===void 0){if(e$d.ipad){r$f=true;return}if(e$d.touch){if(s$j()){r$f=true;return}if(e$d.chrome&&e$d.android){r$f=!/Mobile Safari\/[.0-9]+/.test(e$d.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$d.android&&c$e()&&(n=1),r$f=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$f=e$d.userAgent.indexOf("Touch")!==-1||e$d.android&&!e$d.androidPhone;}},l$c=()=>e$d.touch,h$4=()=>e$d.safari,g$9=()=>e$d.chrome,b$8=()=>e$d.firefox,a$c=()=>(u$a(),(e$d.touch||s$j())&&r$f),d$7=()=>e$d._isPhone(),f$b=()=>t$h?false:!a$c()&&!d$7()||s$j(),m$b=()=>a$c()&&f$b(),w$5=()=>e$d.iOS,P$3=()=>e$d.android||e$d.androidPhone;

  let t$g=false;const i$d=()=>{h$4()&&w$5()&&!t$g&&(document.body.addEventListener("touchstart",()=>{}),t$g=true);};

  let r$e=false,i$c,p$5=false;const m$a=new i$j,O$2=()=>r$e,P$2=t=>{if(!r$e){m$a.attachEvent("boot",t);return}t();},f$a=async()=>{const t=n$u("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$u("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$d=()=>{if(p$5)return;const t=n$u("OpenUI5Support");t&&(p$5=t.attachListeners());},u$9=async()=>{if(i$c!==void 0)return i$c;const t=async e=>{if(x$2(),typeof document>"u"){e();return}n$q(b$7),await f$a(),await d$8(),await b$9(r$d()),c$d(),a$d(),r$g(),s$k(),i$d(),e(),r$e=true,m$a.fireEvent("boot");};return i$c=new Promise(t),i$c},w$4=async()=>{await u$9(),await f$a(),c$d();},b$7=t=>{if(!r$e)return;const e=r$d(),o=E$1();(t===e||t===o)&&b$9(e);};

  let t$f,n$l;i$i(()=>{t$f=void 0;});const r$d=()=>(t$f===void 0&&(t$f=T$2()),t$f),g$8=async e=>{t$f!==e&&(t$f=e,O$2()&&(await b$9(t$f),await C$3({themeAware:true})));},d$6=()=>e$g,i$b=()=>{const e=r$d();return y$7(e)?!e.startsWith("sap_horizon"):!m$c()?.baseThemeName?.startsWith("sap_horizon")},y$7=e=>s$r.includes(e),E$1=()=>n$l,w$3=e=>{n$l=e;};

  const h$3=100;let t$e = class t{static{this.enablePolling=false;}static isAtLeastVersion116(){if(!window.sap.ui.version)return  true;const e=window.sap.ui.version.split(".");return !e||e.length<2?false:parseInt(e[0])>1||parseInt(e[1])>=116}static isOpenUI5Detected(){return typeof window.sap?.ui?.require=="function"}static{this.OpenUI5DelayedInit=async()=>{t.init(),await w$4();};}static awaitForOpenUI5(){if(t.enablePolling){const a=setInterval(()=>{t.isOpenUI5Detected()&&(clearInterval(a),t.OpenUI5DelayedInit());},h$3);}else document.addEventListener("sap-ui-core-ready",()=>{t.OpenUI5DelayedInit();});}static init(){return t.isOpenUI5Detected()?(t.initPromise||(t.initPromise=new Promise(a=>{window.sap.ui.require(["sap/ui/core/Core"],async e=>{const i=()=>{let n=["sap/ui/core/Popup","sap/m/Dialog","sap/ui/core/Patcher","sap/ui/core/LocaleData"];t.isAtLeastVersion116()&&(n=[...n,"sap/base/i18n/Formatting","sap/base/i18n/Localization","sap/ui/core/ControlBehavior","sap/ui/core/Theming","sap/ui/core/date/CalendarUtils"]),window.sap.ui.require(n,(o,r,s)=>{n$v(s),m$f(o,r),a();});};t.isAtLeastVersion116()?(await e.ready(),i()):e.attachInit(i);});})),t.initPromise):t.awaitForOpenUI5()}static getConfigurationSettingsObject(){if(!t.isOpenUI5Detected())return {};if(t.isAtLeastVersion116()){const n=window.sap.ui.require("sap/ui/core/ControlBehavior"),o=window.sap.ui.require("sap/base/i18n/Localization"),r=window.sap.ui.require("sap/ui/core/Theming"),s=window.sap.ui.require("sap/base/i18n/Formatting"),c=window.sap.ui.require("sap/ui/core/date/CalendarUtils");return {animationMode:n.getAnimationMode(),language:o.getLanguage(),theme:r.getTheme(),themeRoot:r.getThemeRoot(),rtl:o.getRTL(),timezone:o.getTimezone(),calendarType:s.getCalendarType(),formatSettings:{firstDayOfWeek:c.getWeekConfigurationValues().firstDayOfWeek,legacyDateCalendarCustomizing:s.getCustomIslamicCalendarData?.()??s.getLegacyDateCalendarCustomizing?.()}}}const e=window.sap.ui.require("sap/ui/core/Core").getConfiguration(),i=window.sap.ui.require("sap/ui/core/LocaleData");return {animationMode:e.getAnimationMode(),language:e.getLanguage(),theme:e.getTheme(),themeRoot:typeof e.getThemeRoot=="function"?e.getThemeRoot():void 0,rtl:e.getRTL(),timezone:typeof e.getTimezone=="function"?e.getTimezone():void 0,calendarType:e.getCalendarType(),formatSettings:{firstDayOfWeek:i?i.getInstance(e.getLocale()).getFirstDayOfWeek():void 0,legacyDateCalendarCustomizing:e.getFormatSettings().getLegacyDateCalendarCustomizing()}}}static getLocaleDataObject(){if(!t.isOpenUI5Detected())return;const a=window.sap.ui.require("sap/ui/core/LocaleData");if(t.isAtLeastVersion116()){const n=window.sap.ui.require("sap/base/i18n/Localization");return a.getInstance(n.getLanguageTag())._get()}const i=window.sap.ui.require("sap/ui/core/Core").getConfiguration();return a.getInstance(i.getLocale())._get()}static _listenForThemeChange(){if(t.isAtLeastVersion116()){const a=window.sap.ui.require("sap/ui/core/Theming");a.attachApplied(()=>{g$8(a.getTheme());});}else {const a=window.sap.ui.require("sap/ui/core/Core"),e=a.getConfiguration();a.attachThemeChanged(()=>{g$8(e.getTheme());});}}static attachListeners(){return t.isOpenUI5Detected()?(t._listenForThemeChange(),true):false}static cssVariablesLoaded(){if(!t.isOpenUI5Detected())return;const a=[...document.head.children].find(e=>e.id==="sap-ui-theme-sap.ui.core");return a?!!a.href.match(/\/css(-|_)variables\.css/)||!!a.href.match(/\/library\.css/):false}static addOpenedPopup(a){i$l(a);}static removeOpenedPopup(a){a$l(a);}static getTopmostPopup(){return c$j()}};s$s("OpenUI5Support",t$e);
   ...
   */
  var t$d;const i$a=window,s$i=i$a.trustedTypes,e$c=s$i?s$i.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$a="$lit$",n$k=`lit$${(Math.random()+"").slice(9)}$`,l$b="?"+n$k,h$2=`<${l$b}>`,r$c=document,u$8=()=>r$c.createComment(""),d$5=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$c=Array.isArray,v$2=t=>c$c(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$b="[ \t\n\f\r]",f$9=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$2=/-->/g,m$9=/>/g,p$4=RegExp(`>|${a$b}(?:([^\\s"'>=/]+)(${a$b}*=${a$b}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$7=/'/g,$$1=/"/g,y$6=/^(?:script|style|textarea|title)$/i,w$2=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$1=w$2(1),b$6=w$2(2),T=Symbol.for("lit-noChange"),A$3=Symbol.for("lit-nothing"),E=new WeakMap,C$2=r$c.createTreeWalker(r$c,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$c?e$c.createHTML(i):i}const V=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$9;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$9?"!--"===c[1]?u=_$2:void 0!==c[1]?u=m$9:void 0!==c[2]?(y$6.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$4):void 0!==c[3]&&(u=p$4):u===p$4?">"===c[0]?(u=null!=l?l:f$9,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$4:'"'===c[3]?$$1:g$7):u===$$1||u===g$7?u=p$4:u===_$2||u===m$9?u=f$9:(u=p$4,l=void 0);const w=u===p$4&&t[i+1].startsWith("/>")?" ":"";r+=u===f$9?s+h$2:v>=0?(e.push(d),s.slice(0,v)+o$a+s.slice(v)+n$k+w):s+n$k+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};let N$1 = class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V(t,i);if(this.el=N.createElement(a,e),C$2.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$2.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$a)||i.startsWith(n$k)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$a).split(n$k),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H:"?"===i[1]?L$4:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$6.test(h.tagName)){const t=h.textContent.split(n$k),i=t.length-1;if(i>0){h.textContent=s$i?s$i.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$8()),C$2.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$8());}}}else if(8===h.nodeType)if(h.data===l$b)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$k,t+1));)v.push({type:7,index:r}),t+=n$k.length-1;}r++;}}static createElement(t,i){const s=r$c.createElement("template");return s.innerHTML=t,s}};function S$3(t,i,s=t,e){var o,n,l,h;if(i===T)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$5(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$3(t,r._$AS(t,i.values),r,e)),i}let M$3 = class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$c).importNode(s,true);C$2.currentNode=o;let n=C$2.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$1(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$2.nextNode(),l++);}return C$2.currentNode=r$c,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let R$1 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$3,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$3(this,t,i),d$5(t)?t===A$3||null==t||""===t?(this._$AH!==A$3&&this._$AR(),this._$AH=A$3):t!==this._$AH&&t!==T&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$2(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$3&&d$5(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$c.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N$1.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M$3(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N$1(t)),i}T(t){c$c(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$8()),this.k(u$8()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$3,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$3;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$3(this,t,i,0),n=!d$5(t)||t!==this._$AH&&t!==T,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$3(this,e[s+l],i,l),h===T&&(h=this._$AH[l]),n||(n=!d$5(h)||h!==this._$AH[l]),h===A$3?t=A$3:t!==A$3&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$3?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$3?void 0:t;}}const I=s$i?s$i.emptyScript:"";let L$4 = class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$3?this.element.setAttribute(this.name,I):this.element.removeAttribute(this.name);}};class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$3(this,t,i,0))&&void 0!==s?s:A$3)===T)return;const e=this._$AH,o=t===A$3&&e!==A$3||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$3&&(e===A$3||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$3(this,t);}}const B$1=i$a.litHtmlPolyfillSupport;null==B$1||B$1(N$1,R$1),(null!==(t$d=i$a.litHtmlVersions)&&void 0!==t$d?t$d:i$a.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$b=Symbol.for(""),l$a=t=>{if((null==t?void 0:t.r)===e$b)return null==t?void 0:t._$litStatic$},o$9=t=>({_$litStatic$:t,r:e$b}),s$h=new Map,a$a=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$a(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$h.get(t))&&(n.raw=n,s$h.set(t,r=n)),e=u;}return t(r,...e)},n$j=a$a(x$1),u$7=a$a(b$6);

  let t$c = class t{static{this.html=n$j;}static{this.svg=u$7;}static{this.unsafeStatic=o$9;}};s$s("LitStatic",t$c);
  ...
  const n$i=(r,c,a)=>{let o,l;return f$8({beforeStart:()=>{o=r.scrollLeft,l=r.scrollTop;},duration:v$1,element:r,advance:t=>{r.scrollLeft=o+t*c,r.scrollTop=l+t*a;}})};
  ...
  const u$6=o=>{let i,a,r,d,n,s,p,g,e,l,y,m;const h=f$8({beforeStart:()=>{const t=o;i=getComputedStyle(t),a=parseFloat(i.paddingTop),r=parseFloat(i.paddingBottom),d=parseFloat(i.marginTop),n=parseFloat(i.marginBottom),s=parseFloat(i.height),p=t.style.overflow,g=t.style.paddingTop,e=t.style.paddingBottom,l=t.style.marginTop,y=t.style.marginBottom,m=t.style.height,t.style.overflow="hidden";},duration:v$1,element:o,advance:t=>{o.style.paddingTop=`${a-a*t}px`,o.style.paddingBottom=`${r-r*t}px`,o.style.marginTop=`${d-d*t}px`,o.style.marginBottom=`${n-n*t}px`,o.style.height=`${s-s*t}px`;}});return h.promise().then(t=>{t instanceof Error||(o.style.overflow=p,o.style.paddingTop=g,o.style.paddingBottom=e,o.style.marginTop=l,o.style.marginBottom=y,o.style.height=m,o.style.display="none");}),h};

  let n$h;i$i(()=>{n$h=void 0;});const d$4=()=>(n$h===void 0&&(n$h=C$4()),n$h),m$8=o=>{Object.values(u$d).includes(o)&&(n$h=o);};

  var s$g=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$g||{});

  let n$g;i$i(()=>{n$g=void 0;});const i$9=()=>(n$g===void 0&&(n$g=D$3()),n$g&&n$g in s$g?n$g:s$g.Gregorian);

  let t$a;let a$8 = class a{static getLegacyDateCalendarCustomizing(){return t$a===void 0&&(t$a=M$4()),t$a.legacyDateCalendarCustomizing||[]}};s$s("LegacyDateFormats",a$8);

  let e$a;i$i(()=>{e$a=void 0;});const n$f=()=>(e$a===void 0&&(e$a=M$4()),e$a.firstDayOfWeek),i$8=n$u("LegacyDateFormats"),m$7=i$8?a$8.getLegacyDateCalendarCustomizing:()=>[];

  const t$9=new Map,e$9=(n,o)=>{t$9.set(n,o);},c$b=n=>t$9.get(n);

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$f=new Map;s$f.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$f.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$f.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$a=(n,e)=>{if(s$f.has(n)){s$f.set(n,{...e,...s$f.get(n)});return}s$f.set(n,e);},r$b=n=>{const e=i$b()?"legacy":"sap_horizon";return s$f.has(n)?s$f.get(n)[e]:n};
  ...
  const i$7=o=>{const t=c$b(r$d());return !o&&t?n$e(t):o?r$b(o):r$b("SAP-icons")};

  var m$6 = ":host{justify-content:center;align-items:center;display:flex;color:var(--sapList_TextColor);background-color:var(--sapList_Background);font-family:var(--sapFontFamily);height:var(--sapElement_LineHeight);border-bottom:var(--sapList_BorderWidth) solid var(--sapList_BorderColor);opacity:.8;position:absolute;padding:0 1rem;top:-1000px;left:-1000px}";

  const t$6=typeof document>"u",o$8=()=>{if(t$6)return a$j;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$j};

  const e$8=new i$j,n$d="languageChange",t$5=a=>{e$8.attachEvent(n$d,a);},r$a=a=>{e$8.detachEvent(n$d,a);},o$7=a=>e$8.fireEventAsync(n$d,a);

  let e$7,t$4;i$i(()=>{e$7=void 0,t$4=void 0;});let a$7=false;const s$e=()=>a$7,l$9=()=>(e$7===void 0&&(e$7=L$6()),e$7),L$3=async n=>{e$7!==n&&(a$7=true,e$7=n,await o$7(n),a$7=false,O$2()&&await C$3({languageAware:true}));},c$9=()=>a$j,m$5=n=>{t$4=n;},h$1=()=>(t$4===void 0&&(t$4=R$2()),t$4);

  const n$c=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$9 = class r{constructor(s){const t=n$c.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$j,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

  const r$8=new Map,n$b=t=>(r$8.has(t)||r$8.set(t,new r$9(t)),r$8.get(t)),c$8=t=>{try{if(t&&typeof t=="string")return n$b(t)}catch{}return new r$9(r$m)},s$d=t=>{const e=l$9();return e?n$b(e):c$8(o$8())};

  const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$7=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$3=i=>{let e;if(!i)return r$m;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$7.exec(o))||r&&(e=c$7.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$m};

  const r$7={zh_HK:"zh_TW",in:"id"},n$a=t=>{if(!t)return r$m;if(r$7[t])return r$7[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$m?r$m:""};

  const d$3=new Set,m$4=new Set,g$6=new Map,l$8=new Map,u$5=new Map,$=(n,t,e)=>{const r=`${n}/${t}`;u$5.set(r,e);},f$6=(n,t)=>{g$6.set(n,t);},A$2=n=>g$6.get(n),h=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$8.get(e)&&l$8.set(e,r(t)),l$8.get(e)},M$2=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$2=(n,t)=>t!==a$j&&!h(n,t),w$1=async n=>{const t=s$d().getLanguage(),e=s$d().getRegion(),r=s$d().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$3(s);L$2(n,s);)s=n$a(s);const I=h$1();if(s===a$j&&!I){f$6(n,null);return}if(!h(n,s)){M$2(n);return}try{const o=await B(n,s);f$6(n,o);}catch(o){const a=o;m$4.has(a.message)||(m$4.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$6.keys()];return Promise.all(t.map(w$1))});
  ...
  const r$6=new Map;let s$c;let u$4 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$6=n=>{if(r$6.has(n))return r$6.get(n);const e=new u$4(n);return r$6.set(n,e),e},f$5=async n=>s$c?s$c(n):(await w$1(n),a$6(n)),y$5=n=>{s$c=n;};

  const e$6={key:"DRAG_DROP_MULTIPLE_TEXT",defaultText:"{0} items"};

  const l$7=2;const u$3=async e=>{const t=document.createElement("div"),n=await f$5("@ui5/webcomponents-base"),r=t.attachShadow({mode:"open"}),o=new CSSStyleSheet;return o.replaceSync(m$6),r.adoptedStyleSheets=[o],r.textContent=n.getText(e$6,e),t},s$b=async(e,t)=>{if(e<l$7){console.warn(`Cannot start multiple drag with count ${e}. Minimum is ${l$7}.`);return}if(!t.dataTransfer)return;const n=await u$3(e);document.body.appendChild(n),t.dataTransfer.setDragImage(n,0,0),requestAnimationFrame(()=>{n.remove();});};

  const c$6=["value-changed","click"];let e$5;i$i(()=>{e$5=void 0;});const s$a=t=>c$6.includes(t),l$6=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$5===void 0&&(e$5=F()),e$5),f$4=t=>{e$5=t;},a$5=t=>{const n=o$6();return s$a(t)?false:n===true?true:!l$6(t)};
  ...
  const y$4={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,ARROW_LEFT:37,ARROW_UP:38,ARROW_RIGHT:39,ARROW_DOWN:40},b$3=o=>(o.key?o.key==="Enter":o.keyCode===y$4.ENTER)&&!a$4(o),A$1=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$4.SPACE)&&!a$4(o),K=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$4.SPACE)&&e$4(o,false,false,true),D$2=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$4.ARROW_LEFT)&&!a$4(o),R=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$4.ARROW_RIGHT)&&!a$4(o),P=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$4.ARROW_UP)&&!a$4(o),_=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$4.ARROW_DOWN)&&!a$4(o),M$1=o=>(o.key?o.key==="Home":o.keyCode===y$4.HOME)&&!a$4(o),n$9=o=>(o.key?o.key==="End":o.keyCode===y$4.END)&&!a$4(o),m$2=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$4.ESCAPE)&&!a$4(o),x=o=>(o.key?o.key==="Tab":o.keyCode===y$4.TAB)&&!a$4(o),j=o=>(o.key?o.key==="PageUp":o.keyCode===y$4.PAGE_UP)&&!a$4(o),q=o=>(o.key?o.key==="PageDown":o.keyCode===y$4.PAGE_DOWN)&&!a$4(o),Ko=o=>o.key==="Shift"||o.keyCode===y$4.SHIFT,a$4=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey),e$4=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k(o)===r;
  ...
  const w="legacy",s=new Map,c$1=m$j("SVGIcons.registry",new Map),i$1=m$j("SVGIcons.promises",new Map),l="ICON_NOT_FOUND",C=(e,t)=>{s.set(e,t);},N=async e=>{if(!i$1.has(e)){if(!s.has(e))throw new Error(`No loader registered for the ${e} icons collection. Probably you forgot to import the "AllIcons.js" module for the respective package.`);const t=s.get(e);i$1.set(e,t(e));}return i$1.get(e)},f=e=>{Object.keys(e.data).forEach(t=>{const a=e.data[t];y(t,{pathData:a.path||a.paths,ltr:a.ltr,accData:a.acc,collection:e.collection,packageName:e.packageName});});},y=(e,t)=>{const a=`${t.collection}/${e}`,o={collection:t.collection,packageName:t.packageName,pathData:t.pathData,viewBox:t.viewBox,ltr:t.ltr,accData:t.accData,customTemplate:t.customTemplate};c$1.set(a,o);},u=e=>{e.startsWith("sap-icon://")&&(e=e.replace("sap-icon://",""));let t;return [e,t]=e.split("/").reverse(),e=e.replace("icon-",""),t&&(t=n$e(t)),{name:e,collection:t}},D=e=>{const{name:t,collection:a}=u(e);return g(a,t)},n=async e=>{const{name:t,collection:a}=u(e);let o=l;try{o=await N(i$7(a));}catch(r){console.error(r.message);}if(o===l)return o;const p=g(a,t);return p||(Array.isArray(o)?o.forEach(r=>{f(r),c$a(a,{[r.themeFamily||w]:r.collection});}):f(o),g(a,t))},g=(e,t)=>{const a=`${i$7(e)}/${t}`;return c$1.get(a)},A=async e=>{if(!e)return;let t=D(e);if(t||(t=await n(e)),t&&t!==l&&t.accData)return t.packageName?(await f$5(t.packageName)).getText(t.accData):t.accData?.defaultText||""};
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    getDefaultLanguage: c$9,
    getDefaultTheme: d$6,
    getEffectiveDir: r$2,
    getEffectiveIconCollection: i$7,
    getEffectiveScopingSuffixForTag: d$e,
    getFetchDefaultLanguage: h$1,
    getFirstDayOfWeek: n$f,
    getI18nBundle: f$5,
    getLanguage: l$9,
    getLegacyDateCalendarCustomizing: m$7,
    getNoConflict: o$6,
    getTheme: r$d,
    isAndroid: P$3,
    isChrome: g$9,
    ...
    registerThemePropertiesLoader: f$d,
    renderDeferred: l$e,
    renderFinished: f$e,
    renderImmediately: c$g,
    sanitizeHTML: fnSanitizeHTML,
    scroll: n$i,
    setAnimationMode: m$8,
    setCustomElementsScopingRules: g$e,
    setCustomElementsScopingSuffix: p$8,
    setDefaultIconCollection: e$9,
    setFetchDefaultLanguage: m$5,
    setLanguage: L$3,
    setNoConflict: f$4,
    setTheme: g$8,
    slideDown: b$5,
