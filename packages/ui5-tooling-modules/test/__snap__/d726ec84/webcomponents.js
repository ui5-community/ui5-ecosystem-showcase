...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const e$k={version:"2.17.0",major:2,minor:17,patch:0,suffix:"",isNext:false,buildTime:1765979913};
  ...
  const p$7=m$i("AllOpenedPopupsRegistry",{openedRegistry:[]}),a$l=e=>{p$7.openedRegistry.push(e);},u$h=e=>{const o=p$7.openedRegistry.findIndex(t=>t.instance===e);o>-1&&p$7.openedRegistry.splice(o,1);},h$7=()=>p$7.openedRegistry[p$7.openedRegistry.length-1].instance,l$k=e=>{for(let o=p$7.openedRegistry.length-1;o>=0;o--){const t=p$7.openedRegistry[o];if(t.type==="WebComponent")return  true;if(t.instance===e)break}return  false},f$d=e=>{e.setAttribute("popover","manual"),e.showPopover();},O$2=e=>{e.hasAttribute("popover")&&(e.hidePopover(),e.removeAttribute("popover"));},y$8=(e=document)=>e.querySelector(":popover-open")?true:Array.from(e.querySelectorAll("*")).some(o=>{const t=o.shadowRoot;return t&&y$8(t)}),P$8=e=>{const o=e.prototype.onsapescape;e.prototype.onsapescape=function(...n){l$k(this.oPopup)||o.apply(this,n);};},m$e=e=>{const o=e.prototype.open;e.prototype.open=function(...n){o.apply(this,n);const s=y$8();if(["OPENING","OPEN"].includes(this.getOpenState())&&s){const r=this.getContent();if(r){const i=r instanceof HTMLElement?r:r?.getDomRef();i&&f$d(i);}}a$l({type:"OpenUI5",instance:this});};},v$4=e=>{const o=e.prototype._closed;e.prototype._closed=function(...n){const s=this.getContent(),c=s instanceof HTMLElement?s:s?.getDomRef();o.apply(this,n),c&&O$2(c),u$h(this);};},I$3=e=>{const o=e.prototype.onFocusEvent;e.prototype.onFocusEvent=function(...n){l$k(this)||o.apply(this,n);};},S$5=()=>{const e=new CSSStyleSheet;e.replaceSync(".sapMPopup-CTX:popover-open { inset: unset; }"),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e];},C$5=(e,o)=>{o$k(),m$e(e),v$4(e),S$5(),I$3(e),P$8(o);};
