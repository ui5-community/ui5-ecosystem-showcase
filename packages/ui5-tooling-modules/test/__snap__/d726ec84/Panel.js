sap.ui.define(['./webcomponents'], (function (webcomponentsBase) { 'use strict';
    ...
    function g$1(e,t,o){const n=e.getMetadata().getEvents();Object.keys(t).forEach(s=>{if(s.startsWith("on")){const a=s.slice(2),c=webcomponentsBase.p(a),l=a.charAt(0).toLowerCase()+a.slice(1);let i;c in n?i=c:l in n&&(i=l),i&&s!=="onClick"&&(t[`onui5-${i}`]=t[s],delete t[s]);}});}function isUI5ElementClass(e){return typeof e=="function"&&"getMetadata"in e}function preprocess(e,t,o){let n;return isUI5ElementClass(e)?(n=e.getMetadata().getTag(),g$1(e,t)):n=e,typeof t.class=="object"&&(t.class=o$1(t.class)),n}
...
`;
    ...
    webcomponentsBase.f("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    webcomponentsBase.f("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme, "host");
...
`;
    ...
    let Button = Button_1 = class Button extends webcomponentsBase.S {
        ...
        getDefaultTooltip() {
            ...
            return webcomponentsBase.x$1(this.icon);
        }
        get buttonTypeText() {
    ...
    webcomponentsBase.y(name$1, { pathData: pathData$1, ltr: ltr$1, viewBox: viewBox$1, collection: collection$1, packageName: packageName$1 });
    ...
    webcomponentsBase.y(name, { pathData, ltr, viewBox, collection, packageName });
