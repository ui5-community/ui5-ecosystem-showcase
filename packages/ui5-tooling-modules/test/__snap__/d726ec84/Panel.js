...
`;
    ...
    let Button = Button_1 = class Button extends webcomponentsBase.S {
        ...
        _onkeydown(e) {
            if (webcomponentsBase.Ko(e) || webcomponentsBase.m$2(e)) {
        ...
        _onkeyup(e) {
            ...
            const isCancelKey = webcomponentsBase.Ko(e) || webcomponentsBase.m$2(e);
...
`;
    ...
    let Panel = Panel_1 = class Panel extends webcomponentsBase.S {
        ...
        _headerKeyDown(e) {
            ...
            if (webcomponentsBase.m$2(e) && this._pendingToggle) {
                e.preventDefault();
                this._pendingToggle = false;
            }
        }
