sap.ui.define((function () { 'use strict';
    ...
    var c$h={},e$h=c$h.hasOwnProperty,a$e=c$h.toString,o$g=e$h.toString,l$h=o$g.call(Object),i$l=function(r){var t,n;return !r||a$e.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$g.call(n)===l$h):true)};

    var c$g=Object.create(null),u$d=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$g;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$l(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$l(n)?n:{},r[a]=u$d(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};
    ...
    const u$c=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$g=()=>typeof document>"u"?null:o$f('meta[name="ui5-shared-resources"]',document.head,u$c),m$e=(t,o)=>{const r=t.split(".");let e=l$g();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

    const g$b=m$e("Tags",new Map),d$a=new Set;let i$j=new Map,c$f;const m$d=-1,h$6=e=>{d$a.add(e),g$b.set(e,I$3());},w$8=e=>d$a.has(e),T$3=()=>[...d$a.values()],$$2=e=>{let n=g$b.get(e);n===void 0&&(n=m$d),i$j.has(n)||i$j.set(n,new Set),i$j.get(n).add(e),c$f||(c$f=setTimeout(()=>{y$a(),i$j=new Map,c$f=void 0;},1e3));},y$a=()=>{const e=$$1(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$j.keys()].forEach(s=>{let o,r;s===m$d?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${i$j.get(s).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...i$j.get(s)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    const e$f={version:"2.20.0",major:2,minor:20,patch:0,suffix:"",isNext:false,buildTime:1772704608};

    let s$o,t$l={include:[/^ui5-/],exclude:[]};const o$e=new Map,c$e=()=>s$o,m$c=()=>t$l,i$i=e=>{if(!o$e.has(e)){const n=t$l.include.some(r=>e.match(r))&&!t$l.exclude.some(r=>e.match(r));o$e.set(e,n);}return o$e.get(e)},d$9=e=>{if(i$i(e))return c$e()};

    let i$h,s$n="";const u$b=new Map,r$l=m$e("Runtimes",[]),x$2=()=>{if(i$h===void 0){i$h=r$l.length;const e=e$f;r$l.push({...e,get scopingSuffix(){return c$e()},get registeredTags(){return T$3()},get scopingRules(){return m$c()},alias:s$n,description:`Runtime ${i$h} - ver ${e.version}${""}`});}},I$3=()=>i$h,b$6=(e,m)=>{const o=`${e},${m}`;if(u$b.has(o))return u$b.get(o);const t=r$l[e],n=r$l[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$b.set(o,l),l},$$1=()=>r$l;

    const g$a=typeof document>"u",i$g=(e,t)=>t?`${e}|${t}`:e,l$f=e=>e===void 0?true:b$6(I$3(),parseInt(e))>=1,c$d=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$g(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$9=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$g(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$f(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$a?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$g(e,t)),f$c=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$g(e,t));},R$1=(e,t,r="",s)=>{S$4(t,r)?y$9(e,t,r,s):c$d(e,t,r,s);},m$b=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

    const e$e=new Map,n$m=t=>e$e.get(t);

    var n$l = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const _$2={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$d=_$2.themes.default,s$m=_$2.themes.all,a$d=_$2.languages.default,r$k=_$2.locales.default,l$e=_$2.locales.all;

    const o$d=typeof document>"u",n$k={search(){return o$d?"":window.location.search}},s$l=()=>o$d?"":window.location.href,u$a=()=>n$k.search();

    const s$k=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$c=e=>{const t=s$k("sap-allowed-theme-origins")??s$k("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$c=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$9=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$l()).toString();else {const n=new URL(e),r=n.origin;r&&o$c(r)?t=n.toString():t=a$c(n.toString(),s$l());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};

    var u$9=(l=>(l.Full="full",l.Basic="basic",l.Minimal="minimal",l.None="none",l))(u$9||{});

    const e$c=new i$k,t$k="configurationReset",i$f=n=>{e$c.attachEvent(t$k,n);};

    let p$5=false,t$j={animationMode:u$9.Full,theme:e$d,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const T$2=()=>(o$b(),t$j.theme),S$3=()=>{if(o$b(),t$j.themeRoot!==void 0){if(!g$9(t$j.themeRoot)){console.warn(`The ${t$j.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$j.themeRoot}},L$4=()=>(o$b(),t$j.language),R=()=>(o$b(),t$j.fetchDefaultLanguage),F$1=()=>(o$b(),t$j.noConflict),U$2=()=>(o$b(),t$j.defaultFontLoading),b$5=()=>(o$b(),t$j.enableDefaultTooltips),i$e=new Map;i$e.set("true",true),i$e.set("false",false);const w$7=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$j=e$g(t$j,e));}},z$1=()=>{const n=new URLSearchParams(u$a());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$8(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$8(r,e,"sap-ui");});},E$4=n=>{const e=n.split("@")[1];return g$9(e)},P$2=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$8=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$e.has(e)&&(e=i$e.get(a)),s==="theme"?(t$j.theme=P$2(s,e),e&&e.includes("@")&&(t$j.themeRoot=E$4(e))):t$j[s]=e;},j$1=()=>{const n=n$m("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$j=e$g(t$j,e);},o$b=()=>{typeof document>"u"||p$5||(l$d(),p$5=true);},l$d=n=>{w$7(),z$1(),j$1();};

    let o$a;i$f(()=>{o$a=void 0;});const a$b=()=>(o$a===void 0&&(o$a=U$2()),o$a);

    const a$a=()=>{const t=n$m("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$b();},f$b=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$b()||t||S$4("data-ui5-font-face")||c$d(n$l,"data-ui5-font-face");};
    ...
    const r$j=()=>{R$1(s$j,"data-ui5-system-css-vars");};

    var t$i = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

    const s$i=()=>{S$4("data-ui5-scrollbar-styles")||c$d(t$i,"data-ui5-scrollbar-styles");};

    let l$c = class l{constructor(){this.list=[],this.lookup=new Set;}add(t){this.lookup.has(t)||(this.list.push(t),this.lookup.add(t));}remove(t){this.lookup.has(t)&&(this.list=this.list.filter(e=>e!==t),this.lookup.delete(t));}shift(){const t=this.list.shift();if(t)return this.lookup.delete(t),t}isEmpty(){return this.list.length===0}isAdded(t){return this.lookup.has(t)}process(t){let e;const s=new Map;for(e=this.shift();e;){const i=s.get(e)||0;if(i>10)throw new Error("Web component processed too many times this task, max allowed is: 10");t(e),s.set(e,i+1),e=this.shift();}}};

    const t$h=new Set,n$j=e=>{t$h.add(e);},r$i=e=>t$h.has(e);

    const s$h=new Set,d$8=new i$k,n$i=new l$c;let t$g,a$9,m$a,i$d;const l$b=async e=>{n$i.add(e),await P$1();},c$c=e=>{d$8.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$5=e=>{n$i.remove(e),s$h.delete(e);},P$1=async()=>{i$d||(i$d=new Promise(e=>{window.requestAnimationFrame(()=>{n$i.process(c$c),i$d=null,e(),m$a||(m$a=setTimeout(()=>{m$a=void 0,n$i.isEmpty()&&U$1();},200));});})),await i$d;},y$8=()=>t$g||(t$g=new Promise(e=>{a$9=e,window.requestAnimationFrame(()=>{n$i.isEmpty()&&(t$g=void 0,e());});}),t$g),I$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$a=async()=>{await I$2(),await y$8();},U$1=()=>{n$i.isEmpty()&&a$9&&(a$9(),a$9=void 0,t$g=void 0);},C$2=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$b(r);}),await f$a();};

    const t$f=new i$k,r$h="themeRegistered",n$h=e=>{t$f.attachEvent(r$h,e);},s$g=e=>t$f.fireEvent(r$h,e);

    const l$a=new Map,T$1=new Map,h$4=new Map,u$8=new Map,a$8=new Set,f$9=(e,r,t,s="root")=>{T$1.set(`${e}/${r}`,t),u$8.set(e,{cssVariablesTarget:s}),a$8.add(r),s$g(r);},L$3=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$a.get(s);if(o!==void 0)return o;if(!a$8.has(r)){const p=[...a$8.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$d}. Registered themes are: ${p}`),c$b(e,e$d)}const[n,g]=await Promise.all([c$b(e,r),t?c$b(e,t,true):void 0]),i=m$b(n,g);return i&&l$a.set(s,i),i},c$b=async(e,r,t=false)=>{const o=(t?h$4:T$1).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$9=()=>u$8,w$6=e=>a$8.has(e);

    const r$g=new Set,s$f=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$9=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$7=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$8=()=>{const e=s$f();if(!e||e==="none")return;const t=o$9(e);if(t)return d$7(t)};

    const t$e=new i$k,d$6="themeLoaded",r$f=e=>t$e.fireEvent(d$6,e);
    ...
    let t$d;i$f(()=>{t$d=void 0;});const n$g=()=>(t$d===void 0&&(t$d=S$3()),t$d),u$7=e=>`${n$g()}Base/baseLib/${e}/css_variables.css`,i$c=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$5(u$7(e),{"sap-ui-webcomponents-theme":e});};

    const t$c=new Map;let e$b;const n$f=()=>(e$b||(e$b=new CSSStyleSheet),e$b),r$e=(o,s)=>{t$c.set(o,s);const S=Array.from(t$c.values()).join(`
`);n$f().replaceSync(S);};

    let _lib="ui5",_package="webcomponents-theming";const a$7="@"+_lib+"/"+_package,E$3=()=>m$9().has(a$7),U=async e=>{if(!E$3())return;const t=await L$3(a$7,e);t&&R$1(t,"data-ui5-theme-properties",a$7,e);},w$5=()=>{f$c("data-ui5-theme-properties",a$7);},I$1=async(e,t)=>{const o=[...m$9().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$7)return;const i=await L$3(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$e(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$8();if(t)return t;const r=n$m("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$g())return await i$c(e),m$8()},b$4=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U(e):w$5();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$6(e)?e:o||e$d;await I$1(s,r),w$4(o),r$f(e);};

    let t$b,n$e;i$f(()=>{t$b=void 0;});const r$d=()=>(t$b===void 0&&(t$b=T$2()),t$b),i$b=()=>{const e=r$d();return y$7(e)?!e.startsWith("sap_horizon"):!m$8()?.baseThemeName?.startsWith("sap_horizon")},y$7=e=>s$m.includes(e),E$2=()=>n$e,w$4=e=>{n$e=e;};

    const t$a=typeof document>"u",e$a={get userAgent(){return t$a?"":navigator.userAgent},get touch(){return t$a?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$a?false:/(Chrome|CriOS)/.test(e$a.userAgent)},get firefox(){return t$a?false:/Firefox/.test(e$a.userAgent)},get safari(){return t$a?false:!e$a.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$a.userAgent)},get webkit(){return t$a?false:/webkit/.test(e$a.userAgent)},get windows(){return t$a?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$a?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$a?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$a.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$a?false:!e$a.windows&&/Android/.test(e$a.userAgent)},get androidPhone(){return t$a?false:e$a.android&&/(?=android)(?=.*mobile)/i.test(e$a.userAgent)},get ipad(){return t$a?false:/ipad/i.test(e$a.userAgent)||/Macintosh/i.test(e$a.userAgent)&&"ontouchend"in document},_isPhone(){return u$6(),e$a.touch&&!r$c}};let o$8,i$a,r$c;const s$e=()=>{if(t$a||!e$a.windows)return  false;if(o$8===void 0){const n=e$a.userAgent.match(/Windows NT (\d+).(\d)/);o$8=n?parseFloat(n[1]):0;}return o$8>=8},c$a=()=>{if(t$a||!e$a.webkit)return  false;if(i$a===void 0){const n=e$a.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$6=()=>{if(t$a)return  false;if(r$c===void 0){if(e$a.ipad){r$c=true;return}if(e$a.touch){if(s$e()){r$c=true;return}if(e$a.chrome&&e$a.android){r$c=!/Mobile Safari\/[.0-9]+/.test(e$a.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$a.android&&c$a()&&(n=1),r$c=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$c=e$a.userAgent.indexOf("Touch")!==-1||e$a.android&&!e$a.androidPhone;}},h$3=()=>e$a.safari,a$6=()=>(u$6(),(e$a.touch||s$e())&&r$c),d$4=()=>e$a._isPhone(),f$8=()=>t$a?false:!a$6()&&!d$4()||s$e(),w$3=()=>e$a.iOS;

    let t$9=false;const i$9=()=>{h$3()&&w$3()&&!t$9&&(document.body.addEventListener("touchstart",()=>{}),t$9=true);};

    let r$b=false,i$8,p$4=false;const m$7=new i$k,f$7=async()=>{const t=n$m("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$m("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$9=()=>{if(p$4)return;const t=n$m("OpenUI5Support");t&&(p$4=t.attachListeners());},u$5=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(x$2(),typeof document>"u"){e();return}n$h(b$3),await f$7(),await d$b(),await b$4(r$d()),c$9(),a$a(),r$j(),s$i(),i$9(),e(),r$b=true,m$7.fireEvent("boot");};return i$8=new Promise(t),i$8},b$3=t=>{if(!r$b)return;const e=r$d(),o=E$2();(t===e||t===o)&&b$4(e);};

    const s$d=new Map,o$7=new Map,n$d=new Map,c$8=e=>{if(!s$d.has(e)){const a=b$2(e.split("-"));s$d.set(e,a);}return s$d.get(e)},l$9=e=>{if(!o$7.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$7.set(e,a);}return o$7.get(e)},p$3=e=>l$9(e),b$2=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$d.get(e);if(a)return a;const t=c$8(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$d.set(e,r),r};

    const o$6=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$c=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$c=t=>t.reduce((e,r)=>e.concat(n$c(r)),[]);

    let p$2 = class p{constructor(t){this.metadata=t;}getInitialState(){if(Object.prototype.hasOwnProperty.call(this,"_initialState"))return this._initialState;const t={};if(this.slotsAreManaged()){const o=this.getSlots();for(const[e,s]of Object.entries(o)){const n=s.propertyName||e;t[n]=[],t[c$8(n)]=t[n];}}return this._initialState=t,t}static validateSlotValue(t,a){return g$7(t,a)}getPureTag(){return this.metadata.tag||""}getTag(){const t=this.metadata.tag;if(!t)return "";const a=d$9(t);return a?`${t}-${a}`:t}hasAttribute(t){const a=this.getProperties()[t];return a.type!==Object&&!a.noAttribute}getPropertiesList(){return Object.keys(this.getProperties())}getAttributesList(){return this.getPropertiesList().filter(this.hasAttribute.bind(this)).map(l$9)}canSlotText(){return this.getSlots().default?.type===Node}hasSlots(){return !!Object.entries(this.getSlots()).length}hasIndividualSlots(){return this.slotsAreManaged()&&Object.values(this.getSlots()).some(t=>t.individualSlots)}slotsAreManaged(){return !!this.metadata.managedSlots}supportsF6FastNavigation(){return !!this.metadata.fastNavigation}getProperties(){return this.metadata.properties||(this.metadata.properties={}),this.metadata.properties}getEvents(){return this.metadata.events||(this.metadata.events={}),this.metadata.events}getSlots(){return this.metadata.slots||(this.metadata.slots={}),this.metadata.slots}isLanguageAware(){return !!this.metadata.languageAware}isThemeAware(){return !!this.metadata.themeAware}needsCLDR(){return !!this.metadata.cldr}getShadowRootOptions(){return this.metadata.shadowRootOptions||{}}isFormAssociated(){return !!this.metadata.formAssociated}shouldInvalidateOnChildChange(t,a,o){const e=this.getSlots()[t].invalidateOnChildChange;if(e===void 0)return  false;if(typeof e=="boolean")return e;if(typeof e=="object"){if(a==="property"){if(e.properties===void 0)return  false;if(typeof e.properties=="boolean")return e.properties;if(Array.isArray(e.properties))return e.properties.includes(o);throw new Error("Wrong format for invalidateOnChildChange.properties: boolean or array is expected")}if(a==="slot"){if(e.slots===void 0)return  false;if(typeof e.slots=="boolean")return e.slots;if(Array.isArray(e.slots))return e.slots.includes(o);throw new Error("Wrong format for invalidateOnChildChange.slots: boolean or array is expected")}}throw new Error("Wrong format for invalidateOnChildChange: boolean or object is expected")}getI18n(){return this.metadata.i18n||(this.metadata.i18n={}),this.metadata.i18n}};const g$7=(r,t)=>(r&&n$c(r).forEach(a=>{if(!(a instanceof t.type))throw new Error(`The element is not of type ${t.type.toString()}`)}),r);

    const r$a=()=>m$e("CustomStyle.eventProvider",new i$k),n$b="CustomCSSChange",i$7=t=>{r$a().attachEvent(n$b,t);},c$7=()=>m$e("CustomStyle.customCSSFor",{});i$7(t=>{C$2({tag:t});});const l$8=t=>{const e=c$7();return e[t]?e[t].join(""):""};

    const e$9=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

    const e$8=new Map;i$7(t=>{e$8.delete(`${t}_normal`);});const y$6=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$m("OpenUI5Enablement");if(!e$8.has(n)){let l="";s&&(l=e$9(s.getBusyIndicatorStyles()));const a=l$8(o)||"",m=`${e$9(t.styles)} ${a} ${l}`;e$8.set(n,m);}return e$8.get(n)};

    const e$7=new Map;i$7(t=>{e$7.delete(`${t}_normal`);});const s$b=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$7.has(n)){const a=y$6(t),o=new CSSStyleSheet;o.replaceSync(a),e$7.set(n,[o]);}return e$7.get(n)};

    const s$a=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$f(),...s$b(e)],e.renderer(o,t);};

    const r$9=[],o$5=t=>r$9.some(s=>t.startsWith(s));

    const t$8=new WeakMap,n$a=(e,o,r)=>{const s=new MutationObserver(o);t$8.set(e,s),s.observe(e,r);},b$1=e=>{const o=t$8.get(e);o&&(o.disconnect(),t$8.delete(e));};

    const c$6=["value-changed","click"];let e$6;i$f(()=>{e$6=void 0;});const s$9=t=>c$6.includes(t),l$7=t=>{const n=o$4();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$4=()=>(e$6===void 0&&(e$6=F$1()),e$6),a$5=t=>{const n=o$4();return s$9(t)?false:n===true?true:!l$7(t)};

    const r$8=t=>t.matches(":dir(rtl)")?"rtl":"ltr";

    const s$8=["disabled","title","hidden","role","draggable"],r$7=e=>s$8.includes(e)||e.startsWith("aria")?true:![HTMLElement,Element,Node].some(t=>t.prototype.hasOwnProperty(e));

    const n$9=(t,r)=>{if(t.length!==r.length)return  false;for(let e=0;e<t.length;e++)if(t[e]!==r[e])return  false;return  true};

    const n$8=(e,t)=>e.call(t);

    const s$7=t=>{o$3(t)&&i$6(t);},i$6=t=>{if(t._internals?.form){if(e$5(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},e$5=async t=>{if(!(!t.isUI5Element||!t._internals?.form))if(t._internals.setValidity({customError:true}," "),await t.definePromise,t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},m$6=async t=>{const r=[...t._internals?.form?.elements??[]];await Promise.all(r.map(n=>o$3(n)?e$5(n):Promise.resolve())),t._internals?.form?.requestSubmit();},a$4=t=>{t._internals?.form?.reset();},o$3=t=>"formFormattedValue"in t&&"name"in t;

    const t$7=typeof document>"u",o$2=()=>{if(t$7)return a$d;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$d};

    const e$4=new i$k,n$7="languageChange",t$6=a=>{e$4.attachEvent(n$7,a);};

    let e$3,t$5;i$f(()=>{e$3=void 0,t$5=void 0;});let a$3=false;const s$6=()=>a$3,l$6=()=>(e$3===void 0&&(e$3=L$4()),e$3),h$2=()=>(t$5===void 0&&(t$5=R()),t$5);
    ...
    const r$5=new Map,n$5=t=>(r$5.has(t)||r$5.set(t,new r$6(t)),r$5.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$5(t)}catch{}return new r$6(r$k)},s$5=t=>{const e=l$6();return e?n$5(e):c$5(o$2())};
    ...
    const r$4={zh_HK:"zh_TW",in:"id"},n$4=t=>{if(!t)return r$k;if(r$4[t])return r$4[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$k?r$k:""};

    const d$3=new Set,m$5=new Set,g$6=new Map,l$5=new Map,u$4=new Map,f$5=(n,t)=>{g$6.set(n,t);},A$4=n=>g$6.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$4.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$4.get(e);return r&&!l$5.get(e)&&l$5.set(e,r(t)),l$5.get(e)},M$2=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$2=(n,t)=>t!==a$d&&!h$1(n,t),w$2=async n=>{const t=s$5().getLanguage(),e=s$5().getRegion(),r=s$5().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$1(s);L$2(n,s);)s=n$4(s);const I=h$2();if(s===a$d&&!I){f$5(n,null);return}if(!h$1(n,s)){M$2(n);return}try{const o=await B$1(n,s);f$5(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$6(n=>{const t=[...g$6.keys()];return Promise.all(t.map(w$2))});
    ...
    const y$1={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32},b=o=>(o.key?o.key==="Enter":o.keyCode===y$1.ENTER)&&!a(o),A$2=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$1.SPACE)&&!a(o),K=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$1.SPACE)&&e$1(o,false,false,true),m$1=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$1.ESCAPE)&&!a(o),x=o=>(o.key?o.key==="Tab":o.keyCode===y$1.TAB)&&!a(o),Ko=o=>o.key==="Shift"||o.keyCode===y$1.SHIFT,a=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey),e$1=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k(o)===r;
...
`;
    ...
    f$9("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    f$9("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme, "host");
        ...
        */
        ...
        async onBeforeRendering() {
            ...
            if ("customTemplate" in iconData && iconData.customTemplate) {
                this.customTemplate = n$8(iconData.customTemplate, this);
            }
