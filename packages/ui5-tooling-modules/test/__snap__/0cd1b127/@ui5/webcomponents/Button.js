sap.ui.define(['module'], (function (module) { 'use strict';
    ...
    var c$i={},e$f=c$i.hasOwnProperty,a$f=c$i.toString,o$h=e$f.toString,l$g=o$h.call(Object),i$j=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$f.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$g):true)};
    ...
    const e$e=function(n,t){return u$f(true,false,...arguments)};

    const d$c=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});
    ...
    const u$e=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$f=()=>typeof document>"u"?null:o$g('meta[name="ui5-shared-resources"]',document.head,u$e),m$f=(t,o)=>{const r=t.split(".");let e=l$f();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

    const g$d=m$f("Tags",new Map),d$b=new Set;let i$h=new Map,c$g;const m$e=-1,h$5=e=>{d$b.add(e),g$d.set(e,I$3());},w$6=e=>d$b.has(e),T$5=()=>[...d$b.values()],$$2=e=>{let n=g$d.get(e);n===void 0&&(n=m$e),i$h.has(n)||i$h.set(n,new Set),i$h.get(n).add(e),c$g||(c$g=setTimeout(()=>{y$a(),i$h=new Map,c$g=void 0;},1e3));},y$a=()=>{const e=$$1(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$h.keys()].forEach(s=>{let o,r;s===m$e?(o=1,r={description:"Older unknown runtime"}):(o=b$7(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    let s$n,t$m={include:[/./],exclude:[]};const o$f=new Map,c$f=()=>s$n,m$d=()=>t$m,i$g=e=>{if(!o$f.has(e)){const n=t$m.include.some(r=>e.match(r))&&!t$m.exclude.some(r=>e.match(r));o$f.set(e,n);}return o$f.get(e)},d$a=e=>{if(i$g(e))return c$f()};

    let i$f,s$m="";const u$d=new Map,n$o=m$f("Runtimes",[]),x$3=()=>{if(i$f===void 0){i$f=n$o.length;const t=e$d;n$o.push({...t,get scopingSuffix(){return c$f()},get registeredTags(){return T$5()},get scopingRules(){return m$d()},alias:s$m,description:`Runtime ${i$f} - ver ${t.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("Button"), document.baseURI).href});}},I$3=()=>i$f,b$7=(t,m)=>{const o=`${t},${m}`;if(u$d.has(o))return u$d.get(o);const e=n$o[t],r=n$o[m];if(!e||!r)throw new Error("Invalid runtime index supplied");if(e.isNext||r.isNext)return e.buildTime-r.buildTime;const c=e.major-r.major;if(c)return c;const a=e.minor-r.minor;if(a)return a;const f=e.patch-r.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,r.suffix);return u$d.set(o,l),l},$$1=()=>n$o;

    const g$c=typeof document>"u",i$e=(e,t)=>t?`${e}|${t}`:e,l$e=e=>e===void 0?true:b$7(I$3(),parseInt(e))>=1,c$e=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$e(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$9=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$e(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$e(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$c?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$e(e,t)),f$f=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$e(e,t));},R=(e,t,r="",s)=>{S$4(t,r)?y$9(e,t,r,s):c$e(e,t,r,s);},m$c=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

    const e$c=new Map,n$n=t=>e$c.get(t);

    var n$m = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const _$2={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_auto","sap_horizon_dark","sap_horizon_hc_auto","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$b=_$2.themes.default,s$l=_$2.themes.all,a$e=_$2.languages.default,r$m=_$2.locales.default,n$l=_$2.locales.all;

    var u$c=(l=>(l.Full="full",l.Basic="basic",l.Minimal="minimal",l.None="none",l))(u$c||{});

    const e$a=new i$i,t$l="configurationReset",i$d=n=>{e$a.attachEvent(t$l,n);};

    const o$e=typeof document>"u",n$k={search(){return o$e?"":window.location.search}},s$k=()=>o$e?"":window.location.href,u$b=()=>n$k.search();

    let u$a=false,t$k={animationMode:u$c.Full,theme:e$b,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$5=()=>(o$d(),t$k.theme),T$4=()=>(o$d(),t$k.themeRoot),S$3=()=>(o$d(),t$k.language),L$5=()=>(o$d(),t$k.fetchDefaultLanguage),F$1=()=>(o$d(),t$k.noConflict),U$2=()=>(o$d(),t$k.defaultFontLoading),b$6=()=>(o$d(),t$k.enableDefaultTooltips),i$c=new Map;i$c.set("true",true),i$c.set("false",false);const M$3=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$k=e$e(t$k,e));}},z$1=()=>{const n=new URLSearchParams(u$b());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||p$5(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&p$5(a,e,"sap-ui");});},E$3=n=>n.split("@")[1],P$2=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,p$5=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$c.has(e)&&(e=i$c.get(r)),s==="theme"?(t$k.theme=P$2(s,e),e&&e.includes("@")&&(t$k.themeRoot=E$3(e))):t$k[s]=e;},w$5=()=>{const n=n$n("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$k=e$e(t$k,e);},o$d=()=>{typeof document>"u"||u$a||(g$b(),u$a=true);},g$b=n=>{M$3(),z$1(),w$5();};

    let o$c;i$d(()=>{o$c=void 0;});const a$d=()=>(o$c===void 0&&(o$c=U$2()),o$c);

    const a$c=()=>{const t=n$n("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$e();},f$e=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$d()||t||S$4("data-ui5-font-face")||c$e(n$m,"data-ui5-font-face");};
    ...
    const s$i=()=>{S$4("data-ui5-scrollbar-styles")||c$e(t$j,"data-ui5-scrollbar-styles");};
    ...
    const t$i=new Set,n$j=e=>{t$i.add(e);},r$k=e=>t$i.has(e);

    const s$h=new Set,d$9=new i$i,n$i=new l$d;let t$h,a$b,m$b,i$b;const l$c=async e=>{n$i.add(e),await P$1();},c$d=e=>{d$9.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$4=e=>{n$i.remove(e),s$h.delete(e);},P$1=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$i.process(c$d),i$b=null,e(),m$b||(m$b=setTimeout(()=>{m$b=void 0,n$i.isEmpty()&&U$1();},200));});})),await i$b;},y$8=()=>t$h||(t$h=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$i.isEmpty()&&(t$h=void 0,e());});}),t$h),I$2=()=>{const e=T$5().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$d=async()=>{await I$2(),await y$8();},U$1=()=>{n$i.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$h=void 0);},C$4=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$k(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$d();};

    const t$g=new i$i,r$j="themeRegistered",n$h=e=>{t$g.attachEvent(r$j,e);},s$g=e=>t$g.fireEvent(r$j,e);

    const l$b=new Map,T$3=new Map,h$3=new Map,u$9=new Map,a$a=new Set,f$c=(e,r,t,s="root")=>{T$3.set(`${e}/${r}`,t),u$9.set(e,{cssVariablesTarget:s}),a$a.add(r),s$g(r);},L$4=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$b.get(s);if(o!==void 0)return o;if(!a$a.has(r)){const p=[...a$a.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$b}. Registered themes are: ${p}`),c$c(e,e$b)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$c(n,g);return i&&l$b.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$3:T$3).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$a=()=>u$9,w$4=e=>a$a.has(e);

    const r$i=new Set,s$f=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$b=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$i.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$i.add("decode"));return}try{return JSON.parse(a)}catch{r$i.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$i.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$i.has("object")||(console.warn("Malformed theme metadata Object",e),r$i.add("object"));return}return {themeName:t,baseThemeName:a}},m$9=()=>{const e=s$f();if(!e||e==="none")return;const t=o$b(e);if(t)return d$8(t)};

    const t$f=new i$i,d$7="themeLoaded",r$h=e=>t$f.fireEvent(d$7,e);
    ...
    const a$9=t=>{const e=document.querySelector(`META[name="${t}"]`);return e&&e.getAttribute("content")},g$a=(t,e=false)=>{const n=a$9("sap-allowed-theme-origins")??a$9("sap-allowedThemeOrigins");return n?e?true:n.split(",").some(r=>r==="*"||t===r.trim()):false},l$a=t=>{let e,n=false;try{if(t.startsWith(".")||t.startsWith("/")&&!t.startsWith("//"))e=new URL(t,s$k()).toString(),n=!0;else {const r=t.startsWith("//")?new URL(t,s$k()):new URL(t),i=r.origin,o=new URL(s$k()).origin;if(n=i===o,i&&g$a(i,n))e=r.toString();else return}return e.endsWith("/")||(e=`${e}/`),`${e}UI5/`}catch{return}};

    let t$e;i$d(()=>{t$e=void 0;});const r$g=()=>(t$e===void 0&&(t$e=T$4()),t$e),f$b=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$e=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$g();if(!n)return;const i=l$a(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$6(f$b(e,i),{"sap-ui-webcomponents-theme":e});};

    const t$d=new Map;let e$9;const n$g=()=>(e$9||(e$9=new CSSStyleSheet),e$9),r$f=(o,s)=>{t$d.set(o,s);const S=Array.from(t$d.values()).join(`
`);n$g().replaceSync(S);};

    let _lib="ui5",_package="webcomponents-theming";const a$8="@"+_lib+"/"+_package,E$2=()=>m$a().has(a$8),U=async e=>{if(!E$2())return;const t=await L$4(a$8,e);t&&R(t,"data-ui5-theme-properties",a$8,e);},w$3=()=>{f$f("data-ui5-theme-properties",a$8);},I$1=async(e,t)=>{const o=[...m$a().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$8)return;const i=await L$4(s,e,t);i&&(n==="root"?R(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$f(s,i));});return Promise.all(o)},O$4=async e=>{const t=m$9();if(t)return t;const r=n$n("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$g())return await s$e(e),m$9()},b$5=async e=>{const t=await O$4(e);!t||e!==t.themeName?await U(e):w$3();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$4(e)?e:o||e$b;await I$1(s,r),B$2(o),r$h(e);};

    const g$9=()=>m$f("ConfigChange.eventProvider",new i$i),r$e=()=>m$f("ConfigChange.values",{}),a$7="configChange",t$c=new Set,C$3=(n,e)=>{g$9().attachEvent(a$7,i=>{i.name===n&&!t$c.has(n)&&e(i.value);});},f$a=n=>r$e()[n];

    let t$b,o$a;i$d(()=>{t$b=void 0;}),C$3("theme",e=>{t$b=e,O$3()&&b$5(t$b).then(()=>C$4({themeAware:true}));});const r$d=()=>(t$b===void 0&&(t$b=f$a("theme")??C$5()),t$b),m$8=()=>{const e=r$d();return C$2(e)?!e.startsWith("sap_horizon"):!m$9()?.baseThemeName?.startsWith("sap_horizon")},C$2=e=>s$l.includes(e),A$3=()=>o$a,B$2=e=>{o$a=e;};

    const t$a=typeof document>"u",e$8={get userAgent(){return t$a?"":navigator.userAgent},get touch(){return t$a?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$a?false:/(Chrome|CriOS)/.test(e$8.userAgent)},get firefox(){return t$a?false:/Firefox/.test(e$8.userAgent)},get safari(){return t$a?false:!e$8.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$8.userAgent)},get webkit(){return t$a?false:/webkit/.test(e$8.userAgent)},get windows(){return t$a?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$a?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$a?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$8.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$a?false:!e$8.windows&&/Android/.test(e$8.userAgent)},get androidPhone(){return t$a?false:e$8.android&&/(?=android)(?=.*mobile)/i.test(e$8.userAgent)},get ipad(){return t$a?false:/ipad/i.test(e$8.userAgent)||/Macintosh/i.test(e$8.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$8.touch&&!r$c}};let o$9,i$a,r$c;const s$d=()=>{if(t$a||!e$8.windows)return  false;if(o$9===void 0){const n=e$8.userAgent.match(/Windows NT (\d+).(\d)/);o$9=n?parseFloat(n[1]):0;}return o$9>=8},c$b=()=>{if(t$a||!e$8.webkit)return  false;if(i$a===void 0){const n=e$8.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$8=()=>{if(t$a)return  false;if(r$c===void 0){if(e$8.ipad){r$c=true;return}if(e$8.touch){if(s$d()){r$c=true;return}if(e$8.chrome&&e$8.android){r$c=!/Mobile Safari\/[.0-9]+/.test(e$8.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$8.android&&c$b()&&(n=1),r$c=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$c=e$8.userAgent.indexOf("Touch")!==-1||e$8.android&&!e$8.androidPhone;}},h$2=()=>e$8.safari,a$6=()=>(u$8(),(e$8.touch||s$d())&&r$c),d$5=()=>e$8._isPhone(),f$9=()=>t$a?false:!a$6()&&!d$5()||s$d(),w$2=()=>e$8.iOS;

    let t$9=false;const i$9=()=>{h$2()&&w$2()&&!t$9&&(document.body.addEventListener("touchstart",()=>{}),t$9=true);};

    let r$b=false,i$8,p$4=false;const m$7=new i$i,O$3=()=>r$b,f$8=async()=>{const t=n$n("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$n("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$a=()=>{if(p$4)return;const t=n$n("OpenUI5Support");t&&(p$4=t.attachListeners());},u$7=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(x$3(),typeof document>"u"){e();return}n$h(b$4),await f$8(),await d$c(),await b$5(r$d()),c$a(),a$c(),r$l(),s$i(),i$9(),e(),r$b=true,m$7.fireEvent("boot");};return i$8=new Promise(t),i$8},b$4=t=>{if(!r$b)return;const e=r$d(),o=A$3();(t===e||t===o)&&b$5(e);};

    const s$c=new Map,o$8=new Map,n$f=new Map,c$9=e=>{if(!s$c.has(e)){const a=b$3(e.split("-"));s$c.set(e,a);}return s$c.get(e)},l$9=e=>{if(!o$8.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$8.set(e,a);}return o$8.get(e)},p$3=e=>l$9(e),b$3=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$f.get(e);if(a)return a;const t=c$9(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$f.set(e,r),r};

    const o$7=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$e=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$b=t=>t.reduce((e,r)=>e.concat(n$e(r)),[]);

    let p$2 = class p{constructor(t){this.metadata=t;}getInitialState(){if(Object.prototype.hasOwnProperty.call(this,"_initialState"))return this._initialState;const t={};if(this.slotsAreManaged()){const o=this.getSlots();for(const[e,s]of Object.entries(o)){const n=s.propertyName||e;t[n]=[],t[c$9(n)]=t[n];}}return this._initialState=t,t}static validateSlotValue(t,a){return g$8(t,a)}getPureTag(){return this.metadata.tag||""}getTag(){const t=this.metadata.tag;if(!t)return "";const a=d$a(t);return a?`${t}-${a}`:t}hasAttribute(t){const a=this.getProperties()[t];return a.type!==Object&&!a.noAttribute}getPropertiesList(){return Object.keys(this.getProperties())}getAttributesList(){return this.getPropertiesList().filter(this.hasAttribute.bind(this)).map(l$9)}canSlotText(){return this.getSlots().default?.type===Node}hasSlots(){return !!Object.entries(this.getSlots()).length}hasIndividualSlots(){return this.slotsAreManaged()&&Object.values(this.getSlots()).some(t=>t.individualSlots)}slotsAreManaged(){return !!this.metadata.managedSlots}supportsF6FastNavigation(){return !!this.metadata.fastNavigation}getProperties(){return this.metadata.properties||(this.metadata.properties={}),this.metadata.properties}getEvents(){return this.metadata.events||(this.metadata.events={}),this.metadata.events}getSlots(){return this.metadata.slots||(this.metadata.slots={}),this.metadata.slots}isLanguageAware(){return !!this.metadata.languageAware}isThemeAware(){return !!this.metadata.themeAware}needsCLDR(){return !!this.metadata.cldr}getShadowRootOptions(){return this.metadata.shadowRootOptions||{}}isFormAssociated(){return !!this.metadata.formAssociated}shouldInvalidateOnChildChange(t,a,o){const e=this.getSlots()[t].invalidateOnChildChange;if(e===void 0)return  false;if(typeof e=="boolean")return e;if(typeof e=="object"){if(a==="property"){if(e.properties===void 0)return  false;if(typeof e.properties=="boolean")return e.properties;if(Array.isArray(e.properties))return e.properties.includes(o);throw new Error("Wrong format for invalidateOnChildChange.properties: boolean or array is expected")}if(a==="slot"){if(e.slots===void 0)return  false;if(typeof e.slots=="boolean")return e.slots;if(Array.isArray(e.slots))return e.slots.includes(o);throw new Error("Wrong format for invalidateOnChildChange.slots: boolean or array is expected")}}throw new Error("Wrong format for invalidateOnChildChange: boolean or object is expected")}getI18n(){return this.metadata.i18n||(this.metadata.i18n={}),this.metadata.i18n}};const g$8=(r,t)=>(r&&n$e(r).forEach(a=>{if(!(a instanceof t.type))throw new Error(`The element is not of type ${t.type.toString()}`)}),r);

    const r$a=()=>m$f("CustomStyle.eventProvider",new i$i),n$d="CustomCSSChange",i$7=t=>{r$a().attachEvent(n$d,t);},c$8=()=>m$f("CustomStyle.customCSSFor",{});i$7(t=>{C$4({tag:t});});const l$8=t=>{const e=c$8();return e[t]?e[t].join(""):""};

    const e$7=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

    const e$6=new Map;i$7(t=>{e$6.delete(`${t}_normal`);});const y$7=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$n("OpenUI5Enablement");if(!e$6.has(n)){let l="";s&&(l=e$7(s.getBusyIndicatorStyles()));const a=l$8(o)||"",m=`${e$7(t.styles)} ${a} ${l}`;e$6.set(n,m);}return e$6.get(n)};
    ...
    const s$9=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$g(),...s$a(e)],e.renderer(o,t);};

    const r$9=[],o$6=t=>r$9.some(s=>t.startsWith(s));

    const t$8=new WeakMap,n$c=(e,o,r)=>{const s=new MutationObserver(o);t$8.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$8.get(e);o&&(o.disconnect(),t$8.delete(e));};

    const c$7=["value-changed","click"];let e$4;i$d(()=>{e$4=void 0;});const s$8=t=>c$7.includes(t),l$7=t=>{const n=o$5();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$5=()=>(e$4===void 0&&(e$4=F$1()),e$4),a$5=t=>{const n=o$5();return s$8(t)?false:n===true?true:!l$7(t)};
    ...
    const m$6=t=>{const r=t.getAttribute("form");if(r){const e=document.getElementById(r);return e instanceof HTMLFormElement?e:null}return t._internals?.form??null},a$4=t=>{s$6(t)&&i$6(t);},i$6=t=>{if(t._internals?.form){if(n$9(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},n$9=async t=>{if(!(!t.isUI5Element||!t._internals?.form))if(t._internals.setValidity({customError:true}," "),await t.definePromise,t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},l$6=async t=>{const r=m$6(t);if(!r)return;const e=[...r.elements];await Promise.all(e.map(o=>s$6(o)?n$9(o):Promise.resolve())),r.requestSubmit();},u$6=t=>{m$6(t)?.reset();},s$6=t=>"formFormattedValue"in t&&"name"in t;

    const t$7=typeof document>"u",o$4=()=>{if(t$7)return a$e;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$e};

    const e$3=new i$i,n$8="languageChange",t$6=a=>{e$3.attachEvent(n$8,a);},o$3=a=>e$3.fireEventAsync(n$8,a);

    let n$7,t$5;i$d(()=>{n$7=void 0,t$5=void 0;});let a$3=false;C$3("language",e=>{n$7=e,a$3=true,o$3(e).then(()=>{a$3=false,O$3()&&C$4({languageAware:true});});});const c$6=()=>a$3,L$3=()=>(n$7===void 0&&(n$7=f$a("language")??S$3()),n$7),D$3=()=>(t$5===void 0&&(t$5=L$5()),t$5);

    const n$6=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$6 = class r{constructor(s){const t=n$6.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$e,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

    const r$5=new Map,n$5=t=>(r$5.has(t)||r$5.set(t,new r$6(t)),r$5.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$5(t)}catch{}return new r$6(r$m)},s$5=t=>{const e=L$3();return e?n$5(e):c$5(o$4())};

    const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$4=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$1=i=>{let e;if(!i)return r$m;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$4.exec(o))||r&&(e=c$4.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$m};

    const r$4={zh_HK:"zh_TW",in:"id"},n$4=t=>{if(!t)return r$m;if(r$4[t])return r$4[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$m?r$m:""};

    const d$4=new Set,m$5=new Set,g$7=new Map,l$5=new Map,u$5=new Map,f$6=(n,t)=>{g$7.set(n,t);},A$2=n=>g$7.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$5.get(e)&&l$5.set(e,r(t)),l$5.get(e)},M$2=n=>{d$4.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$4.add(n));},L$2=(n,t)=>t!==a$e&&!h$1(n,t),w$1=async n=>{const t=s$5().getLanguage(),e=s$5().getRegion(),r=s$5().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$1(s);L$2(n,s);)s=n$4(s);const I=D$3();if(s===a$e&&!I){f$6(n,null);return}if(!h$1(n,s)){M$2(n);return}try{const o=await B$1(n,s);f$6(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$6(n=>{const t=[...g$7.keys()];return Promise.all(t.map(w$1))});
    ...
    const l$2=new WeakMap,y$3=(e,r)=>{let t=l$2.get(e);t||(t=J(e),l$2.set(e,t));const m=e.render(),o=u$2(t.Provider,{value:e,children:m});e.__shouldHydrate?(e.shadowRoot?.querySelectorAll("style").forEach(d=>d.remove()),E$1(o,r),e.__shouldHydrate=false):D$1(o,r);};
...
`;
    ...
    f$c("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    f$c("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme, "host");
...
`;
     ...
     * @public
     */
    let Button$1 = Button_1 = class Button extends S$1 {
        constructor() {
            super();
            /**
    ...
    __decorate([
        s$3()
    ], Button$1.prototype, "form", void 0);
    __decorate([
        s$3()
    ...
    __decorate([
        s$3({ type: Boolean, noAttribute: true })
    ], Button$1.prototype, "_isSpacePressed", void 0);
    __decorate([
        s$3({ noAttribute: true })
    ], Button$1.prototype, "_accessibleNameRefTexts", void 0);
    __decorate([
