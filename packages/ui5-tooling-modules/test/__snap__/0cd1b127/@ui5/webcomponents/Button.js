sap.ui.define(['module'], (function (module) { 'use strict';
    ...
    var c$i={},e$f=c$i.hasOwnProperty,a$f=c$i.toString,o$g=e$f.toString,l$g=o$g.call(Object),i$j=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$f.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$g.call(n)===l$g):true)};

    var c$h=Object.create(null),u$e=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$h;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$j(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$j(n)?n:{},r[a]=u$e(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

    const e$e=function(n,t){return u$e(true,false,...arguments)};
    ...
    const o$f=(t,n=document.body,r)=>{let e=document.querySelector(t);return e||(e=r?r():document.createElement(t),n.insertBefore(e,n.firstChild))};

    const u$d=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$f=()=>typeof document>"u"?null:o$f('meta[name="ui5-shared-resources"]',document.head,u$d),m$f=(t,o)=>{const r=t.split(".");let e=l$f();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

    const g$c=m$f("Tags",new Map),d$a=new Set;let i$h=new Map,c$g;const m$e=-1,h$5=e=>{d$a.add(e),g$c.set(e,I$3());},w$6=e=>d$a.has(e),T$4=()=>[...d$a.values()],$$2=e=>{let n=g$c.get(e);n===void 0&&(n=m$e),i$h.has(n)||i$h.set(n,new Set),i$h.get(n).add(e),c$g||(c$g=setTimeout(()=>{y$9(),i$h=new Map,c$g=void 0;},1e3));},y$9=()=>{const e=$$1(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$h.keys()].forEach(s=>{let o,r;s===m$e?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    const e$d={version:"2.21.1",major:2,minor:21,patch:1,suffix:"",isNext:false,buildTime:1776341110};

    let s$n,t$m={include:[/./],exclude:[]};const o$e=new Map,c$f=()=>s$n,m$d=()=>t$m,i$g=e=>{if(!o$e.has(e)){const n=t$m.include.some(r=>e.match(r))&&!t$m.exclude.some(r=>e.match(r));o$e.set(e,n);}return o$e.get(e)},d$9=e=>{if(i$g(e))return c$f()};

    let i$f,s$m="";const u$c=new Map,n$o=m$f("Runtimes",[]),x$3=()=>{if(i$f===void 0){i$f=n$o.length;const t=e$d;n$o.push({...t,get scopingSuffix(){return c$f()},get registeredTags(){return T$4()},get scopingRules(){return m$d()},alias:s$m,description:`Runtime ${i$f} - ver ${t.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("Button"), document.baseURI).href});}},I$3=()=>i$f,b$6=(t,m)=>{const o=`${t},${m}`;if(u$c.has(o))return u$c.get(o);const e=n$o[t],r=n$o[m];if(!e||!r)throw new Error("Invalid runtime index supplied");if(e.isNext||r.isNext)return e.buildTime-r.buildTime;const c=e.major-r.major;if(c)return c;const a=e.minor-r.minor;if(a)return a;const f=e.patch-r.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,r.suffix);return u$c.set(o,l),l},$$1=()=>n$o;

    const g$b=typeof document>"u",i$e=(e,t)=>t?`${e}|${t}`:e,l$e=e=>e===void 0?true:b$6(I$3(),parseInt(e))>=1,c$e=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$e(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$8=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$e(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$e(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$b?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$e(e,t)),f$e=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$e(e,t));},R=(e,t,r="",s)=>{S$4(t,r)?y$8(e,t,r,s):c$e(e,t,r,s);},m$c=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

    const e$c=new Map,n$n=t=>e$c.get(t);

    var n$m = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.34.1/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.34.1/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const o$d=typeof document>"u",n$k={search(){return o$d?"":window.location.search}},s$k=()=>o$d?"":window.location.href,u$a=()=>n$k.search();

    let u$9=false,t$k={animationMode:u$b.Full,theme:e$b,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$5=()=>(o$c(),t$k.theme),T$3=()=>(o$c(),t$k.themeRoot),S$3=()=>(o$c(),t$k.language),L$5=()=>(o$c(),t$k.fetchDefaultLanguage),F$1=()=>(o$c(),t$k.noConflict),U$2=()=>(o$c(),t$k.defaultFontLoading),b$5=()=>(o$c(),t$k.enableDefaultTooltips),i$c=new Map;i$c.set("true",true),i$c.set("false",false);const M$3=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$k=e$e(t$k,e));}},z$1=()=>{const n=new URLSearchParams(u$a());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||p$5(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&p$5(a,e,"sap-ui");});},E$3=n=>n.split("@")[1],P$2=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,p$5=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$c.has(e)&&(e=i$c.get(r)),s==="theme"?(t$k.theme=P$2(s,e),e&&e.includes("@")&&(t$k.themeRoot=E$3(e))):t$k[s]=e;},w$5=()=>{const n=n$n("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$k=e$e(t$k,e);},o$c=()=>{typeof document>"u"||u$9||(g$a(),u$9=true);},g$a=n=>{M$3(),z$1(),w$5();};

    let o$b;i$d(()=>{o$b=void 0;});const a$d=()=>(o$b===void 0&&(o$b=U$2()),o$b);

    const a$c=()=>{const t=n$n("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$d();},f$d=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$d()||t||S$4("data-ui5-font-face")||c$e(n$m,"data-ui5-font-face");};
    ...
    const s$h=new Set,d$8=new i$i,n$i=new l$d;let t$h,a$b,m$b,i$b;const l$c=async e=>{n$i.add(e),await P$1();},c$d=e=>{d$8.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$4=e=>{n$i.remove(e),s$h.delete(e);},P$1=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$i.process(c$d),i$b=null,e(),m$b||(m$b=setTimeout(()=>{m$b=void 0,n$i.isEmpty()&&U$1();},200));});})),await i$b;},y$7=()=>t$h||(t$h=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$i.isEmpty()&&(t$h=void 0,e());});}),t$h),I$2=()=>{const e=T$4().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$c=async()=>{await I$2(),await y$7();},U$1=()=>{n$i.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$h=void 0);},C$4=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$k(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$c();};

    const t$g=new i$i,r$j="themeRegistered",n$h=e=>{t$g.attachEvent(r$j,e);},s$g=e=>t$g.fireEvent(r$j,e);

    const l$b=new Map,T$2=new Map,h$3=new Map,u$8=new Map,a$a=new Set,f$b=(e,r,t,s="root")=>{T$2.set(`${e}/${r}`,t),u$8.set(e,{cssVariablesTarget:s}),a$a.add(r),s$g(r);},L$4=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$b.get(s);if(o!==void 0)return o;if(!a$a.has(r)){const p=[...a$a.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$b}. Registered themes are: ${p}`),c$c(e,e$b)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$c(n,g);return i&&l$b.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$3:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$a=()=>u$8,w$4=e=>a$a.has(e);

    const r$i=new Set,s$f=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$a=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$i.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$i.add("decode"));return}try{return JSON.parse(a)}catch{r$i.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$i.add("parse"));}}},d$7=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$i.has("object")||(console.warn("Malformed theme metadata Object",e),r$i.add("object"));return}return {themeName:t,baseThemeName:a}},m$9=()=>{const e=s$f();if(!e||e==="none")return;const t=o$a(e);if(t)return d$7(t)};

    const t$f=new i$i,d$6="themeLoaded",r$h=e=>t$f.fireEvent(d$6,e);
    ...
    const a$9=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},g$9=(e,t=false)=>{const n=a$9("sap-allowed-theme-origins")??a$9("sap-allowedThemeOrigins");return n?t?true:n.split(",").some(r=>r==="*"||e===r.trim()):false},l$a=e=>{let t,n=false;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$k()).toString(),n=!0;else {const r=new URL(e),i=r.origin,o=new URL(s$k()).origin;if(n=i===o,i&&g$9(i,n))t=r.toString();else return}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{return}};

    let t$e;i$d(()=>{t$e=void 0;});const r$g=()=>(t$e===void 0&&(t$e=T$3()),t$e),f$a=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$e=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$g();if(!n)return;const i=l$a(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$5(f$a(e,i),{"sap-ui-webcomponents-theme":e});};

    const t$d=new Map;let e$9;const n$g=()=>(e$9||(e$9=new CSSStyleSheet),e$9),r$f=(o,s)=>{t$d.set(o,s);const S=Array.from(t$d.values()).join(`
`);n$g().replaceSync(S);};

    let _lib="ui5",_package="webcomponents-theming";const a$8="@"+_lib+"/"+_package,E$2=()=>m$a().has(a$8),U=async e=>{if(!E$2())return;const t=await L$4(a$8,e);t&&R(t,"data-ui5-theme-properties",a$8,e);},w$3=()=>{f$e("data-ui5-theme-properties",a$8);},I$1=async(e,t)=>{const o=[...m$a().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$8)return;const i=await L$4(s,e,t);i&&(n==="root"?R(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$f(s,i));});return Promise.all(o)},O$4=async e=>{const t=m$9();if(t)return t;const r=n$n("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$g())return await s$e(e),m$9()},b$4=async e=>{const t=await O$4(e);!t||e!==t.themeName?await U(e):w$3();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$4(e)?e:o||e$b;await I$1(s,r),B$2(o),r$h(e);};

    const g$8=()=>m$f("ConfigChange.eventProvider",new i$i),r$e=()=>m$f("ConfigChange.values",{}),a$7="configChange",t$c=new Set,C$3=(n,e)=>{g$8().attachEvent(a$7,i=>{i.name===n&&!t$c.has(n)&&e(i.value);});},f$9=n=>r$e()[n];

    let t$b,o$9;i$d(()=>{t$b=void 0;}),C$3("theme",e=>{t$b=e,O$3()&&b$4(t$b).then(()=>C$4({themeAware:true}));});const r$d=()=>(t$b===void 0&&(t$b=f$9("theme")??C$5()),t$b),m$8=()=>{const e=r$d();return C$2(e)?!e.startsWith("sap_horizon"):!m$9()?.baseThemeName?.startsWith("sap_horizon")},C$2=e=>s$l.includes(e),A$4=()=>o$9,B$2=e=>{o$9=e;};

    const t$a=typeof document>"u",e$8={get userAgent(){return t$a?"":navigator.userAgent},get touch(){return t$a?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$a?false:/(Chrome|CriOS)/.test(e$8.userAgent)},get firefox(){return t$a?false:/Firefox/.test(e$8.userAgent)},get safari(){return t$a?false:!e$8.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$8.userAgent)},get webkit(){return t$a?false:/webkit/.test(e$8.userAgent)},get windows(){return t$a?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$a?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$a?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$8.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$a?false:!e$8.windows&&/Android/.test(e$8.userAgent)},get androidPhone(){return t$a?false:e$8.android&&/(?=android)(?=.*mobile)/i.test(e$8.userAgent)},get ipad(){return t$a?false:/ipad/i.test(e$8.userAgent)||/Macintosh/i.test(e$8.userAgent)&&"ontouchend"in document},_isPhone(){return u$7(),e$8.touch&&!r$c}};let o$8,i$a,r$c;const s$d=()=>{if(t$a||!e$8.windows)return  false;if(o$8===void 0){const n=e$8.userAgent.match(/Windows NT (\d+).(\d)/);o$8=n?parseFloat(n[1]):0;}return o$8>=8},c$b=()=>{if(t$a||!e$8.webkit)return  false;if(i$a===void 0){const n=e$8.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$7=()=>{if(t$a)return  false;if(r$c===void 0){if(e$8.ipad){r$c=true;return}if(e$8.touch){if(s$d()){r$c=true;return}if(e$8.chrome&&e$8.android){r$c=!/Mobile Safari\/[.0-9]+/.test(e$8.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$8.android&&c$b()&&(n=1),r$c=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$c=e$8.userAgent.indexOf("Touch")!==-1||e$8.android&&!e$8.androidPhone;}},h$2=()=>e$8.safari,a$6=()=>(u$7(),(e$8.touch||s$d())&&r$c),d$4=()=>e$8._isPhone(),f$8=()=>t$a?false:!a$6()&&!d$4()||s$d(),w$2=()=>e$8.iOS;

    let t$9=false;const i$9=()=>{h$2()&&w$2()&&!t$9&&(document.body.addEventListener("touchstart",()=>{}),t$9=true);};

    let r$b=false,i$8,p$4=false;const m$7=new i$i,O$3=()=>r$b,f$7=async()=>{const t=n$n("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$n("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$a=()=>{if(p$4)return;const t=n$n("OpenUI5Support");t&&(p$4=t.attachListeners());},u$6=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(x$3(),typeof document>"u"){e();return}n$h(b$3),await f$7(),await d$b(),await b$4(r$d()),c$a(),a$c(),r$l(),s$i(),i$9(),e(),r$b=true,m$7.fireEvent("boot");};return i$8=new Promise(t),i$8},b$3=t=>{if(!r$b)return;const e=r$d(),o=A$4();(t===e||t===o)&&b$4(e);};

    const s$c=new Map,o$7=new Map,n$f=new Map,c$9=e=>{if(!s$c.has(e)){const a=b$2(e.split("-"));s$c.set(e,a);}return s$c.get(e)},l$9=e=>{if(!o$7.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$7.set(e,a);}return o$7.get(e)},p$3=e=>l$9(e),b$2=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$f.get(e);if(a)return a;const t=c$9(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$f.set(e,r),r};

    const o$6=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$e=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$b=t=>t.reduce((e,r)=>e.concat(n$e(r)),[]);

    let p$2 = class p{constructor(t){this.metadata=t;}getInitialState(){if(Object.prototype.hasOwnProperty.call(this,"_initialState"))return this._initialState;const t={};if(this.slotsAreManaged()){const o=this.getSlots();for(const[e,s]of Object.entries(o)){const n=s.propertyName||e;t[n]=[],t[c$9(n)]=t[n];}}return this._initialState=t,t}static validateSlotValue(t,a){return g$7(t,a)}getPureTag(){return this.metadata.tag||""}getTag(){const t=this.metadata.tag;if(!t)return "";const a=d$9(t);return a?`${t}-${a}`:t}hasAttribute(t){const a=this.getProperties()[t];return a.type!==Object&&!a.noAttribute}getPropertiesList(){return Object.keys(this.getProperties())}getAttributesList(){return this.getPropertiesList().filter(this.hasAttribute.bind(this)).map(l$9)}canSlotText(){return this.getSlots().default?.type===Node}hasSlots(){return !!Object.entries(this.getSlots()).length}hasIndividualSlots(){return this.slotsAreManaged()&&Object.values(this.getSlots()).some(t=>t.individualSlots)}slotsAreManaged(){return !!this.metadata.managedSlots}supportsF6FastNavigation(){return !!this.metadata.fastNavigation}getProperties(){return this.metadata.properties||(this.metadata.properties={}),this.metadata.properties}getEvents(){return this.metadata.events||(this.metadata.events={}),this.metadata.events}getSlots(){return this.metadata.slots||(this.metadata.slots={}),this.metadata.slots}isLanguageAware(){return !!this.metadata.languageAware}isThemeAware(){return !!this.metadata.themeAware}needsCLDR(){return !!this.metadata.cldr}getShadowRootOptions(){return this.metadata.shadowRootOptions||{}}isFormAssociated(){return !!this.metadata.formAssociated}shouldInvalidateOnChildChange(t,a,o){const e=this.getSlots()[t].invalidateOnChildChange;if(e===void 0)return  false;if(typeof e=="boolean")return e;if(typeof e=="object"){if(a==="property"){if(e.properties===void 0)return  false;if(typeof e.properties=="boolean")return e.properties;if(Array.isArray(e.properties))return e.properties.includes(o);throw new Error("Wrong format for invalidateOnChildChange.properties: boolean or array is expected")}if(a==="slot"){if(e.slots===void 0)return  false;if(typeof e.slots=="boolean")return e.slots;if(Array.isArray(e.slots))return e.slots.includes(o);throw new Error("Wrong format for invalidateOnChildChange.slots: boolean or array is expected")}}throw new Error("Wrong format for invalidateOnChildChange: boolean or object is expected")}getI18n(){return this.metadata.i18n||(this.metadata.i18n={}),this.metadata.i18n}};const g$7=(r,t)=>(r&&n$e(r).forEach(a=>{if(!(a instanceof t.type))throw new Error(`The element is not of type ${t.type.toString()}`)}),r);
    ...
    const e$6=new Map;i$7(t=>{e$6.delete(`${t}_normal`);});const y$6=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$n("OpenUI5Enablement");if(!e$6.has(n)){let l="";s&&(l=e$7(s.getBusyIndicatorStyles()));const a=l$8(o)||"",m=`${e$7(t.styles)} ${a} ${l}`;e$6.set(n,m);}return e$6.get(n)};

    const e$5=new Map;i$7(t=>{e$5.delete(`${t}_normal`);});const s$a=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$5.has(n)){const a=y$6(t),o=new CSSStyleSheet;o.replaceSync(a),e$5.set(n,[o]);}return e$5.get(n)};
    ...
    const r$9=[],o$5=t=>r$9.some(s=>t.startsWith(s));

    const t$8=new WeakMap,n$c=(e,o,r)=>{const s=new MutationObserver(o);t$8.set(e,s),s.observe(e,r);},b$1=e=>{const o=t$8.get(e);o&&(o.disconnect(),t$8.delete(e));};

    const c$7=["value-changed","click"];let e$4;i$d(()=>{e$4=void 0;});const s$8=t=>c$7.includes(t),l$7=t=>{const n=o$4();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$4=()=>(e$4===void 0&&(e$4=F$1()),e$4),a$5=t=>{const n=o$4();return s$8(t)?false:n===true?true:!l$7(t)};
    ...
    const r$5=new Map,n$5=t=>(r$5.has(t)||r$5.set(t,new r$6(t)),r$5.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$5(t)}catch{}return new r$6(r$m)},s$5=t=>{const e=L$3();return e?n$5(e):c$5(o$3())};

    const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$4=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$6={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$1=i=>{let e;if(!i)return r$m;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$6[t]||t,o&&(e=c$4.exec(o))||r&&(e=c$4.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$m};
    ...
    const y$1={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32},b=o=>(o.key?o.key==="Enter":o.keyCode===y$1.ENTER)&&!a(o),A$1=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$1.SPACE)&&!a(o),K=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$1.SPACE)&&e$1(o,false,false,true),m$1=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$1.ESCAPE)&&!a(o),x$1=o=>(o.key?o.key==="Tab":o.keyCode===y$1.TAB)&&!a(o),Ko=o=>o.key==="Shift"||o.keyCode===y$1.SHIFT,a=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey),e$1=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k(o)===r;
...
`;
    ...
    f$b("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    f$b("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme, "host");
...
`;
    ...
    let Icon = Icon_1 = class Icon extends S$1 {
        ...
        _onkeyup(e) {
            if (this.mode === IconMode$1.Interactive && A$1(e)) {
                this.fireDecoratorEvent("click");
            }
        }
        /**
