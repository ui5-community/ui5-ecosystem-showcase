sap.ui.define(['module'], (function (module) { 'use strict';
    ...
    var c$j={},e$f=c$j.hasOwnProperty,a$h=c$j.toString,o$i=e$f.toString,l$i=o$i.call(Object),i$i=function(r){var t,n;return !r||a$h.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$f.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$i.call(n)===l$i):true)};

    var c$i=Object.create(null),u$i=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$i;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$i(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$i(n)?n:{},r[a]=u$i(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

    const e$e=function(n,t){return u$i(true,false,...arguments)};

    const d$e=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});
    ...
    const u$h=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$h=()=>typeof document>"u"?null:o$h('meta[name="ui5-shared-resources"]',document.head,u$h),m$f=(t,o)=>{const r=t.split(".");let e=l$h();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

    const g$d=m$f("Tags",new Map),d$d=new Set;let i$g=new Map,c$h;const m$e=-1,h$5=e=>{d$d.add(e),g$d.set(e,h$4());},w$8=e=>d$d.has(e),T$6=()=>[...d$d.values()],$$1=e=>{let n=g$d.get(e);n===void 0&&(n=m$e),i$g.has(n)||i$g.set(n,new Set),i$g.get(n).add(e),c$h||(c$h=setTimeout(()=>{y$b(),i$g=new Map,c$h=void 0;},1e3));},y$b=()=>{const e=b$9(),n=h$4(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$g.keys()].forEach(s=>{let o,r;s===m$e?(o=1,r={description:"Older unknown runtime"}):(o=I$2(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    const e$d={version:"2.23.1",major:2,minor:23,patch:1,suffix:"",isNext:false,buildTime:1781204653};

    let s$n,t$n={include:[/./],exclude:[]};const o$g=new Map,c$g=()=>s$n,m$d=()=>t$n,i$f=e=>{if(!o$g.has(e)){const n=t$n.include.some(r=>e.match(r))&&!t$n.exclude.some(r=>e.match(r));o$g.set(e,n);}return o$g.get(e)},d$c=e=>{if(i$f(e))return c$g()};

    let s$m,u$g="";const c$f=new Map,o$f=m$f("Runtimes",[]),d$b=()=>{if(s$m===void 0){s$m=o$f.length;const e=e$d;o$f.push({...e,get scopingSuffix(){return c$g()},get registeredTags(){return T$6()},get scopingRules(){return m$d()},alias:u$g,description:`Runtime ${s$m} - ver ${e.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("Panel"), document.baseURI).href});}},h$4=()=>s$m,a$g=(e,t)=>{if(e.isNext||t.isNext)return e.buildTime-t.buildTime;const r=e.major-t.major;if(r)return r;const n=e.minor-t.minor;if(n)return n;const i=e.patch-t.patch;return i||new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,t.suffix)},I$2=(e,t)=>{const r=`${e},${t}`;if(c$f.has(r))return c$f.get(r);const n=o$f[e],i=o$f[t];if(!n||!i)throw new Error("Invalid runtime index supplied");const m=a$g(n,i);return c$f.set(r,m),m},b$9=()=>o$f;

    const g$c=typeof document>"u",i$e=(e,t)=>t?`${e}|${t}`:e,l$g=e=>e===void 0?true:I$2(h$4(),parseInt(e))>=1,c$e=(e,t,r="",s)=>{const d=h$4(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$e(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$a=(e,t,r="",s)=>{const d=h$4(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$e(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$g(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$c?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$e(e,t)),f$g=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$e(e,t));},R=(e,t,r="",s)=>{S$4(t,r)?y$a(e,t,r,s):c$e(e,t,r,s);},m$c=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

    const e$c=new Map,n$o=t=>e$c.get(t);

    var n$n = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const e$a=new i$h,t$m="configurationReset",i$d=n=>{e$a.attachEvent(t$m,n);};

    const o$e=typeof document>"u",n$l={search(){return o$e?"":window.location.search}},s$k=()=>o$e?"":window.location.href,u$e=()=>n$l.search();

    let g$b=false,t$l={animationMode:u$f.Full,theme:e$b,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true,ignoreUrlParams:false};const y$9=()=>(o$d(),t$l.animationMode),C$5=()=>(o$d(),t$l.theme),T$5=()=>(o$d(),t$l.themeRoot),S$3=()=>(o$d(),t$l.language),U$3=()=>(o$d(),t$l.fetchDefaultLanguage),L$5=()=>(o$d(),t$l.noConflict),F$1=()=>(o$d(),t$l.defaultFontLoading),b$8=()=>(o$d(),t$l.enableDefaultTooltips),i$c=new Map;i$c.set("true",true),i$c.set("false",false);const M$3=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$l=e$e(t$l,e));}},z$1=()=>{const n=new URLSearchParams(u$e());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||l$f(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&l$f(r,e,"sap-ui");});},E$3=n=>n.split("@")[1],w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,l$f=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$c.has(e)&&(e=i$c.get(a)),s==="theme"?(t$l.theme=w$7(s,e),e&&e.includes("@")&&(t$l.themeRoot=E$3(e))):t$l[s]=e;},j$1=()=>{const n=n$o("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$l=e$e(t$l,e);},o$d=()=>{typeof document>"u"||g$b||(u$d(),g$b=true);},u$d=n=>{M$3(),t$l.ignoreUrlParams||z$1(),j$1();};

    let o$c;i$d(()=>{o$c=void 0;});const a$e=()=>(o$c===void 0&&(o$c=F$1()),o$c);
    ...
    const i$b=new Set,m$b=new i$h,n$j=new l$e;let t$i,a$c,d$a,s$h;const l$d=async e=>{n$j.add(e),await U$2();},c$d=e=>{i$b.add(e);},f$e=e=>{i$b.delete(e);},u$c=e=>{m$b.fireEvent("beforeComponentRender",e),c$d(e),e._render();},P$1=e=>{n$j.remove(e),f$e(e);},U$2=async()=>{s$h||(s$h=new Promise(e=>{window.requestAnimationFrame(()=>{n$j.process(u$c),s$h=null,e(),d$a||(d$a=setTimeout(()=>{d$a=void 0,n$j.isEmpty()&&T$4();},200));});})),await s$h;},y$8=()=>t$i||(t$i=new Promise(e=>{a$c=e,window.requestAnimationFrame(()=>{n$j.isEmpty()&&(t$i=void 0,e());});}),t$i),C$4=()=>{const e=T$6().map(r=>customElements.whenDefined(r));return Promise.all(e)},w$6=async()=>{await C$4(),await y$8();},T$4=()=>{n$j.isEmpty()&&a$c&&(a$c(),a$c=void 0,t$i=void 0);},b$7=async e=>{i$b.forEach(r=>{const o=r.constructor,E=o.getMetadata().getTag(),p=r$k(o),g=o.getMetadata().isLanguageAware(),v=o.getMetadata().isThemeAware();(!e||e.tag===E||e.rtlAware&&p||e.languageAware&&g||e.themeAware&&v)&&l$d(r);}),await w$6();};

    const t$h=new i$h,r$j="themeRegistered",n$i=e=>{t$h.attachEvent(r$j,e);},s$g=e=>t$h.fireEvent(r$j,e);

    const l$c=new Map,T$3=new Map,h$3=new Map,u$b=new Map,a$b=new Set,f$d=(e,r,t,s="root")=>{T$3.set(`${e}/${r}`,t),u$b.set(e,{cssVariablesTarget:s}),a$b.add(r),s$g(r);},L$4=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$c.get(s);if(o!==void 0)return o;if(!a$b.has(r)){const p=[...a$b.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$b}. Registered themes are: ${p}`),c$c(e,e$b)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$c(n,g);return i&&l$c.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$3:T$3).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$a=()=>u$b,w$5=e=>a$b.has(e);
    ...
    const t$g=new i$h,d$8="themeLoaded",r$h=e=>t$g.fireEvent(d$8,e);
    ...
    let t$f;i$d(()=>{t$f=void 0;});const r$g=()=>(t$f===void 0&&(t$f=T$5()),t$f),f$c=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$e=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$g();if(!n)return;const i=l$b(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$7(f$c(e,i),{"sap-ui-webcomponents-theme":e});};

    const t$e=new Map;let e$9;const n$h=()=>(e$9||(e$9=new CSSStyleSheet),e$9),r$f=(o,s)=>{t$e.set(o,s);const S=Array.from(t$e.values()).join(`
`);n$h().replaceSync(S);};

    let _lib="ui5",_package="webcomponents-theming";const a$9="@"+_lib+"/"+_package,E$2=()=>m$a().has(a$9),U$1=async e=>{if(!E$2())return;const t=await L$4(a$9,e);t&&R(t,"data-ui5-theme-properties",a$9,e);},w$4=()=>{f$g("data-ui5-theme-properties",a$9);},I$1=async(e,t)=>{const o=[...m$a().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$9)return;const i=await L$4(s,e,t);i&&(n==="root"?R(i,`data-ui5-component-properties-${h$4()}`,s):n==="host"&&r$f(s,i));});return Promise.all(o)},O$2=async e=>{const t=m$9();if(t)return t;const r=n$o("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$g())return await s$e(e),m$9()},b$6=async e=>{const t=await O$2(e);!t||e!==t.themeName?await U$1(e):w$4();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$5(e)?e:o||e$b;await I$1(s,r),B$2(o),r$h(e);};

    const g$9=()=>m$f("ConfigChange.eventProvider",new i$h),r$e=()=>m$f("ConfigChange.values",{}),a$8="configChange",t$d=new Set,C$3=(n,e)=>{g$9().attachEvent(a$8,i=>{i.name===n&&!t$d.has(n)&&e(i.value);});},f$b=n=>r$e()[n];

    let t$c,o$a;i$d(()=>{t$c=void 0;}),C$3("theme",e=>{t$c=e,w$2()&&b$6(t$c).then(()=>b$7({themeAware:true}));});const r$d=()=>(t$c===void 0&&(t$c=f$b("theme")??C$5()),t$c),m$8=()=>{const e=r$d();return C$2(e)?!e.startsWith("sap_horizon"):!m$9()?.baseThemeName?.startsWith("sap_horizon")},C$2=e=>s$l.includes(e),A$3=()=>o$a,B$2=e=>{o$a=e;};

    const t$b=typeof document>"u",e$8={get userAgent(){return t$b?"":navigator.userAgent},get touch(){return t$b?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$8.userAgent)},get firefox(){return t$b?false:/Firefox/.test(e$8.userAgent)},get safari(){return t$b?false:!e$8.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$8.userAgent)},get webkit(){return t$b?false:/webkit/.test(e$8.userAgent)},get windows(){return t$b?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$b?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$8.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$b?false:!e$8.windows&&/Android/.test(e$8.userAgent)},get androidPhone(){return t$b?false:e$8.android&&/(?=android)(?=.*mobile)/i.test(e$8.userAgent)},get ipad(){return t$b?false:/ipad/i.test(e$8.userAgent)||/Macintosh/i.test(e$8.userAgent)&&"ontouchend"in document},_isPhone(){return u$a(),e$8.touch&&!r$c}};let o$9,i$a,r$c;const s$d=()=>{if(t$b||!e$8.windows)return  false;if(o$9===void 0){const n=e$8.userAgent.match(/Windows NT (\d+).(\d)/);o$9=n?parseFloat(n[1]):0;}return o$9>=8},c$b=()=>{if(t$b||!e$8.webkit)return  false;if(i$a===void 0){const n=e$8.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$a=()=>{if(t$b)return  false;if(r$c===void 0){if(e$8.ipad){r$c=true;return}if(e$8.touch){if(s$d()){r$c=true;return}if(e$8.chrome&&e$8.android){r$c=!/Mobile Safari\/[.0-9]+/.test(e$8.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$8.android&&c$b()&&(n=1),r$c=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$c=e$8.userAgent.indexOf("Touch")!==-1||e$8.android&&!e$8.androidPhone;}},l$a=()=>e$8.touch,h$2=()=>e$8.safari,a$7=()=>(u$a(),(e$8.touch||s$d())&&r$c),d$6=()=>e$8._isPhone(),f$a=()=>t$b?false:!a$7()&&!d$6()||s$d(),w$3=()=>e$8.iOS;

    let t$a=false;const i$9=()=>{h$2()&&w$3()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

    let r$b=false,i$8,p$3=false;const m$7=new i$h,w$2=()=>r$b,f$9=async()=>{const t=n$o("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$o("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$a=()=>{if(p$3)return;const t=n$o("OpenUI5Support");t&&(p$3=t.attachListeners());},u$9=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(d$b(),typeof document>"u"){e();return}n$i(b$5),await f$9(),await d$e(),await b$6(r$d()),c$a(),a$d(),r$l(),s$i(),i$9(),e(),r$b=true,m$7.fireEvent("boot");};return i$8=new Promise(t),i$8},b$5=t=>{if(!r$b)return;const e=r$d(),o=A$3();(t===e||t===o)&&b$6(e);};

    const s$c=new Map,o$8=new Map,n$g=new Map,c$9=e=>{if(!s$c.has(e)){const a=b$4(e.split("-"));s$c.set(e,a);}return s$c.get(e)},l$9=e=>{if(!o$8.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$8.set(e,a);}return o$8.get(e)},p$2=e=>l$9(e),b$4=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$g.get(e);if(a)return a;const t=c$9(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$g.set(e,r),r};
    ...
    const c$7=["value-changed","click"];let e$4;i$d(()=>{e$4=void 0;});const s$8=t=>c$7.includes(t),l$7=t=>{const n=o$5();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$5=()=>(e$4===void 0&&(e$4=L$5()),e$4),a$6=t=>{const n=o$5();return s$8(t)?false:n===true?true:!l$7(t)};
    ...
    const e$3=new i$h,n$9="languageChange",t$7=a=>{e$3.attachEvent(n$9,a);},o$3=a=>e$3.fireEventAsync(n$9,a);

    let n$8,t$6;i$d(()=>{n$8=void 0,t$6=void 0;});let a$4=false;C$3("language",e=>{n$8=e,a$4=true,o$3(e).then(()=>{a$4=false,w$2()&&b$7({languageAware:true});});});const c$6=()=>a$4,L$3=()=>(n$8===void 0&&(n$8=f$b("language")??S$3()),n$8),D$3=()=>(t$6===void 0&&(t$6=U$3()),t$6);
    ...
    function g$2(e,t,o){const n=e.getMetadata().getEvents();Object.keys(t).forEach(s=>{if(s.startsWith("on")){const a=s.slice(2),c=p$2(a),l=a.charAt(0).toLowerCase()+a.slice(1);let i;c in n?i=c:l in n&&(i=l),i&&s!=="onClick"&&(t[`onui5-${i}`]=t[s],delete t[s]);}});}function isUI5ElementClass(e){return typeof e=="function"&&"getMetadata"in e}function preprocess(e,t,o){let n;return isUI5ElementClass(e)?(n=e.getMetadata().getTag(),g$2(e,t)):n=e,typeof t.class=="object"&&(t.class=o$1(t.class)),n}
    ...
    let e;const l=()=>(e===void 0&&(e=b$8()),e);
    ...
    function IconTemplate() {
        if (this.hasFontIcon) {
            return (jsx("span", { class: "ui5-icon-root", part: "root", tabindex: this._tabIndex, role: this.effectiveAccessibleRole, "aria-label": this.effectiveAccessibleName, "aria-hidden": this.effectiveAriaHidden, onKeyDown: this._onkeydown, onKeyUp: this._onkeyup, onClick: this._onclick, children: jsx("slot", { name: "fontIcon" }) }));
        }
...
`;
    ...
    let Panel$1 = Panel_1 = class Panel extends S$1 {
        ...
        get shouldNotAnimate() {
            return this.noAnimation || d$1() === u$f.None;
        }
        _isMobile() {
            if (l$a()) {
                this._touched = true;
