sap.ui.define((function () { 'use strict';
    ...
    var c$f={},e$g=c$f.hasOwnProperty,a$e=c$f.toString,o$h=e$g.toString,l$j=o$h.call(Object),i$k=function(r){var t,n;return !r||a$e.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$g.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$j):true)};
    ...
    const u$c=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$i=()=>typeof document>"u"?null:o$g('meta[name="ui5-shared-resources"]',document.head,u$c),m$d=(t,o)=>{const r=t.split(".");let e=l$i();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

    const g$a=m$d("Tags",new Map),d$a=new Set;let i$i=new Map,c$d;const m$c=-1,h$6=e=>{d$a.add(e),g$a.set(e,I$3());},w$7=e=>d$a.has(e),T$3=()=>[...d$a.values()],$$2=e=>{let n=g$a.get(e);n===void 0&&(n=m$c),i$i.has(n)||i$i.set(n,new Set),i$i.get(n).add(e),c$d||(c$d=setTimeout(()=>{y$8(),i$i=new Map,c$d=void 0;},1e3));},y$8=()=>{const e=$$1(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    let s$o,t$l={include:[/^ui5-/],exclude:[]};const o$f=new Map,c$c=()=>s$o,m$b=()=>t$l,i$h=e=>{if(!o$f.has(e)){const n=t$l.include.some(r=>e.match(r))&&!t$l.exclude.some(r=>e.match(r));o$f.set(e,n);}return o$f.get(e)},g$9=e=>{if(i$h(e))return c$c()};

    let i$g,s$n="";const u$b=new Map,r$i=m$d("Runtimes",[]),x$2=()=>{if(i$g===void 0){i$g=r$i.length;const e=e$e;r$i.push({...e,get scopingSuffix(){return c$c()},get registeredTags(){return T$3()},get scopingRules(){return m$b()},alias:s$n,description:`Runtime ${i$g} - ver ${e.version}${""}`});}},I$3=()=>i$g,b$7=(e,m)=>{const o=`${e},${m}`;if(u$b.has(o))return u$b.get(o);const t=r$i[e],n=r$i[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$b.set(o,l),l},$$1=()=>r$i;

    const g$8=typeof document>"u",i$f=(e,t)=>t?`${e}|${t}`:e,l$h=e=>e===void 0?true:b$7(I$3(),parseInt(e))===1,c$b=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$f(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$7=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$f(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$h(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$f(e,t)),f$b=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$f(e,t));},R$3=(e,t,r="",s)=>{S$3(t,r)?y$7(e,t,r,s):c$b(e,t,r,s);},m$a=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const _$3={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$c=_$3.themes.default,s$m=_$3.themes.all,a$d=_$3.languages.default,r$h=_$3.locales.default,l$g=_$3.locales.all;

    const o$e=typeof document>"u",n$l={search(){return o$e?"":window.location.search}},s$l=()=>o$e?"":window.location.href,u$a=()=>n$l.search();
    ...
    let p$6=false,t$j={animationMode:u$9.Full,theme:e$c,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$c(),t$j.animationMode),T$2=()=>(o$c(),t$j.theme),S$2=()=>{if(o$c(),t$j.themeRoot!==void 0){if(!g$7(t$j.themeRoot)){console.warn(`The ${t$j.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$j.themeRoot}},L$1=()=>(o$c(),t$j.language),R$2=()=>(o$c(),t$j.fetchDefaultLanguage),F$2=()=>(o$c(),t$j.noConflict),U$2=()=>(o$c(),t$j.defaultFontLoading),b$6=()=>(o$c(),t$j.enableDefaultTooltips),i$d=new Map;i$d.set("true",true),i$d.set("false",false);const w$6=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$j=e$f(t$j,e));}},z$1=()=>{const n=new URLSearchParams(u$a());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$6(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$6(r,e,"sap-ui");});},E$3=n=>{const e=n.split("@")[1];return g$7(e)},P$4=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$6=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$d.has(e)&&(e=i$d.get(a)),s==="theme"?(t$j.theme=P$4(s,e),e&&e.includes("@")&&(t$j.themeRoot=E$3(e))):t$j[s]=e;},j$1=()=>{const n=n$n("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$j=e$f(t$j,e);},o$c=()=>{typeof document>"u"||p$6||(l$f(),p$6=true);},l$f=n=>{w$6(),z$1(),j$1();};

    let o$b;i$e(()=>{o$b=void 0;});const a$b=()=>(o$b===void 0&&(o$b=U$2()),o$b);

    const a$a=()=>{const t=n$n("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$a();},f$a=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$b()||t||S$3("data-ui5-font-face")||c$b(n$m,"data-ui5-font-face");};
    ...
    const e$a=()=>{S$3("data-ui5-system-css-vars")||c$b(a$9,"data-ui5-system-css-vars");};

    var t$i = "html:not(:has(.ui5-content-native-scrollbars)){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

    const s$j=()=>{S$3("data-ui5-scrollbar-styles")||c$b(t$i,"data-ui5-scrollbar-styles");};
    ...
    const s$i=new Set,d$9=new i$j,n$j=new l$e;let t$g,a$8,m$9,i$c;const l$d=async e=>{n$j.add(e),await P$3();},c$a=e=>{d$9.fireEvent("beforeComponentRender",e),s$i.add(e),e._render();},h$5=e=>{n$j.remove(e),s$i.delete(e);},P$3=async()=>{i$c||(i$c=new Promise(e=>{window.requestAnimationFrame(()=>{n$j.process(c$a),i$c=null,e(),m$9||(m$9=setTimeout(()=>{m$9=void 0,n$j.isEmpty()&&U$1();},200));});})),await i$c;},y$6=()=>t$g||(t$g=new Promise(e=>{a$8=e,window.requestAnimationFrame(()=>{n$j.isEmpty()&&(t$g=void 0,e());});}),t$g),I$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$9=async()=>{await I$2(),await y$6();},U$1=()=>{n$j.isEmpty()&&a$8&&(a$8(),a$8=void 0,t$g=void 0);},C$3=async e=>{s$i.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$g(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$d(r);}),await f$9();};

    const t$f=new i$j,r$f="themeRegistered",n$i=e=>{t$f.attachEvent(r$f,e);},s$h=e=>t$f.fireEvent(r$f,e);

    const l$c=new Map,h$4=new Map,u$8=new Map,T$1=new Set,i$b=new Set,p$5=(e,r,t)=>{h$4.set(`${e}/${r}`,t),T$1.add(e),i$b.add(r),s$h(r);},m$8=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$c.get(g);if(s!==void 0)return s;if(!i$b.has(r)){const $=[...i$b.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$c}. Registered themes are: ${$}`),a$7(e,e$c)}const[n,d]=await Promise.all([a$7(e,r),t?a$7(e,t,true):void 0]),o=m$a(n,d);return o&&l$c.set(g,o),o},a$7=async(e,r,t=false)=>{const s=(t?u$8:h$4).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$1,P$2=e=>i$b.has(e);
    ...
    const c$6=["value-changed","click"];let e$5;i$e(()=>{e$5=void 0;});const s$9=t=>c$6.includes(t),l$8=t=>{const n=o$4();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$4=()=>(e$5===void 0&&(e$5=F$2()),e$5),a$5=t=>{const n=o$4();return s$9(t)?false:n===true?true:!l$8(t)};
    ...
    let e$2,t$6;i$e(()=>{e$2=void 0,t$6=void 0;});let a$4=false;const s$6=()=>a$4,l$7=()=>(e$2===void 0&&(e$2=L$1()),e$2),h$2=()=>(t$6===void 0&&(t$6=R$2()),t$6);
    ...
    const r$4=new Map,n$6=t=>(r$4.has(t)||r$4.set(t,new r$5(t)),r$4.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$6(t)}catch{}return new r$5(r$h)},s$5=t=>{const e=l$7();return e?n$6(e):c$5(o$2())};

    const _$2=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$4=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$1=i=>{let e;if(!i)return r$h;if(typeof i=="string"&&(e=_$2.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$4.exec(o))||r&&(e=c$4.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$h};
    ...
    const d$4=new Set,m$5=new Set,g$4=new Map,l$6=new Map,u$5=new Map,f$6=(n,t)=>{g$4.set(n,t);},A$4=n=>g$4.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$6.get(e)&&l$6.set(e,r(t)),l$6.get(e)},M$1=n=>{d$4.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$4.add(n));},L=(n,t)=>t!==a$d&&!h$1(n,t),w$2=async n=>{const t=s$5().getLanguage(),e=s$5().getRegion(),r=s$5().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L(n,s))for(s=p$1(s);L(n,s);)s=n$5(s);const I=h$2();if(s===a$d&&!I){f$6(n,null);return}if(!h$1(n,s)){M$1(n);return}try{const o=await B$1(n,s);f$6(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$7(n=>{const t=[...g$4.keys()];return Promise.all(t.map(w$2))});
    ...
    let n$3;i$e(()=>{n$3=void 0;});const d=()=>(n$3===void 0&&(n$3=C$4()),n$3);
...
`;
    ...
    p$5("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    p$5("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme);
    var panelCss = `.ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:-1000px;top:-1000px;pointer-events:none;font-size:0}:host(:not([hidden])){display:block}:host{font-family:var(--sapFontFamily);background-color:var(--sapGroup_TitleBackground);border-radius:var(--_ui5-v2-15-1_panel_border_radius)}:host(:not([collapsed])){border-bottom:var(--_ui5-v2-15-1_panel_border_bottom)}:host([fixed]) .ui5-panel-header{padding-left:1rem}.ui5-panel-header{min-height:var(--_ui5-v2-15-1_panel_header_height);width:100%;position:relative;display:flex;justify-content:flex-start;align-items:center;outline:none;box-sizing:border-box;padding-right:var(--_ui5-v2-15-1_panel_header_padding_right);font-family:var(--sapFontHeaderFamily);font-size:var(--sapGroup_Title_FontSize);font-weight:400;color:var(--sapGroup_TitleTextColor)}.ui5-panel-header-icon{color:var(--_ui5-v2-15-1_panel_icon_color)}.ui5-panel-header-button-animated{transition:transform .4s ease-out}:host(:not([_has-header]):not([fixed])) .ui5-panel-header{cursor:pointer}:host(:not([_has-header]):not([fixed])) .ui5-panel-header:focus:after{content:"";position:absolute;pointer-events:none;z-index:2;border:var(--_ui5-v2-15-1_panel_focus_border);border-radius:var(--_ui5-v2-15-1_panel_border_radius);top:var(--_ui5-v2-15-1_panel_focus_offset);bottom:var(--_ui5-v2-15-1_panel_focus_bottom_offset);left:var(--_ui5-v2-15-1_panel_focus_offset);right:var(--_ui5-v2-15-1_panel_focus_offset)}:host(:not([collapsed]):not([_has-header]):not([fixed])) .ui5-panel-header:focus:after{border-radius:var(--_ui5-v2-15-1_panel_border_radius_expanded)}:host(:not([collapsed])) .ui5-panel-header-button:not(.ui5-panel-header-button-with-icon),:host(:not([collapsed])) .ui5-panel-header-icon-wrapper [ui5-icon]{transform:var(--_ui5-v2-15-1_panel_toggle_btn_rotation)}:host([fixed]) .ui5-panel-header-title{width:100%}.ui5-panel-heading-wrapper.ui5-panel-heading-wrapper-sticky{position:sticky;top:0;background-color:var(--_ui5-v2-15-1_panel_header_background_color);z-index:100;border-radius:var(--_ui5-v2-15-1_panel_border_radius)}.ui5-panel-header-title{width:calc(100% - var(--_ui5-v2-15-1_panel_button_root_width));overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ui5-panel-content{padding:var(--_ui5-v2-15-1_panel_content_padding);background-color:var(--sapGroup_ContentBackground);outline:none;border-bottom-left-radius:var(--_ui5-v2-15-1_panel_border_radius);border-bottom-right-radius:var(--_ui5-v2-15-1_panel_border_radius);overflow:auto}.ui5-panel-header-button-root{display:flex;justify-content:center;align-items:center;flex-shrink:0;width:var(--_ui5-v2-15-1_panel_button_root_width);height:var(--_ui5-v2-15-1_panel_button_root_height);padding:var(--_ui5-v2-15-1_panel_header_button_wrapper_padding);box-sizing:border-box}:host([fixed]:not([collapsed]):not([_has-header])) .ui5-panel-header,:host([collapsed]) .ui5-panel-header{border-bottom:.0625rem solid var(--sapGroup_TitleBorderColor)}:host([collapsed]) .ui5-panel-header{border-bottom-left-radius:var(--_ui5-v2-15-1_panel_border_radius);border-bottom-right-radius:var(--_ui5-v2-15-1_panel_border_radius)}:host(:not([fixed]):not([collapsed])) .ui5-panel-header{border-bottom:var(--_ui5-v2-15-1_panel_default_header_border)}[ui5-button].ui5-panel-header-button{display:flex;justify-content:center;align-items:center;min-width:initial;height:100%;width:100%}.ui5-panel-header-icon-wrapper{display:flex;justify-content:center;align-items:center}.ui5-panel-header-icon-wrapper,.ui5-panel-header-icon-wrapper .ui5-panel-header-icon{color:inherit}.ui5-panel-header-icon-wrapper,[ui5-button].ui5-panel-header-button-with-icon [ui5-icon]{pointer-events:none}.ui5-panel-root{height:100%;display:flex;flex-direction:column}
`;
    ...
    let Panel$1 = Panel_1 = class Panel extends b$2 {
        ...
        get shouldNotAnimate() {
            return this.noAnimation || d() === u$9.None;
        }
        _headerClick(e) {
