sap.ui.define((function () { 'use strict';
    ...
    const getEnableDefaultTooltips$1 = () => {
        initConfiguration();
    ...
    class UI5Element extends HTMLElement {
      ...
      static define() {
        const defineSequence = async () => {
          await boot();
          const result = await Promise.all([this.fetchI18nBundles(), this.fetchCLDR(), this.onDefine()]);
    ...
    const getEnableDefaultTooltips = () => {
        if (_enableDefaultTooltips === undefined) {
            _enableDefaultTooltips = getEnableDefaultTooltips$1();
        }
...
` };
    ...
    __decorate$1([property()], Button.prototype, "accessibleDescription", void 0);
