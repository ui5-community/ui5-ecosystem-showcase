sap.ui.define(['module'], (function (module) { 'use strict';
    ...
    var c$i={},e$f=c$i.hasOwnProperty,a$g=c$i.toString,o$g=e$f.toString,l$h=o$g.call(Object),i$j=function(r){var t,n;return !r||a$g.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$f.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$g.call(n)===l$h):true)};
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    let s$n,t$n={include:[/./],exclude:[]};const o$e=new Map,c$f=()=>s$n,m$d=()=>t$n,i$g=e=>{if(!o$e.has(e)){const n=t$n.include.some(r=>e.match(r))&&!t$n.exclude.some(r=>e.match(r));o$e.set(e,n);}return o$e.get(e)},d$a=e=>{if(i$g(e))return c$f()};

    let i$f,s$m="";const u$d=new Map,n$p=m$f("Runtimes",[]),x$3=()=>{if(i$f===void 0){i$f=n$p.length;const t=e$d;n$p.push({...t,get scopingSuffix(){return c$f()},get registeredTags(){return T$4()},get scopingRules(){return m$d()},alias:s$m,description:`Runtime ${i$f} - ver ${t.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("Panel"), document.baseURI).href});}},I$3=()=>i$f,b$7=(t,m)=>{const o=`${t},${m}`;if(u$d.has(o))return u$d.get(o);const e=n$p[t],r=n$p[m];if(!e||!r)throw new Error("Invalid runtime index supplied");if(e.isNext||r.isNext)return e.buildTime-r.buildTime;const c=e.major-r.major;if(c)return c;const a=e.minor-r.minor;if(a)return a;const f=e.patch-r.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,r.suffix);return u$d.set(o,l),l},$$1=()=>n$p;

    const g$b=typeof document>"u",i$e=(e,t)=>t?`${e}|${t}`:e,l$f=e=>e===void 0?true:b$7(I$3(),parseInt(e))>=1,c$e=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$e(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$9=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$e(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$f(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$b?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$e(e,t)),f$f=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$e(e,t));},R=(e,t,r="",s)=>{S$4(t,r)?y$9(e,t,r,s):c$e(e,t,r,s);},m$c=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.34.1/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const o$d=typeof document>"u",n$l={search(){return o$d?"":window.location.search}},s$k=()=>o$d?"":window.location.href,u$b=()=>n$l.search();

    let u$a=false,t$l={animationMode:u$c.Full,theme:e$b,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const y$8=()=>(o$c(),t$l.animationMode),C$5=()=>(o$c(),t$l.theme),T$3=()=>(o$c(),t$l.themeRoot),S$3=()=>(o$c(),t$l.language),L$5=()=>(o$c(),t$l.fetchDefaultLanguage),F$1=()=>(o$c(),t$l.noConflict),U$2=()=>(o$c(),t$l.defaultFontLoading),b$6=()=>(o$c(),t$l.enableDefaultTooltips),i$c=new Map;i$c.set("true",true),i$c.set("false",false);const M$3=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$l=e$e(t$l,e));}},z$1=()=>{const n=new URLSearchParams(u$b());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||p$5(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&p$5(a,e,"sap-ui");});},E$3=n=>n.split("@")[1],P$2=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,p$5=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$c.has(e)&&(e=i$c.get(r)),s==="theme"?(t$l.theme=P$2(s,e),e&&e.includes("@")&&(t$l.themeRoot=E$3(e))):t$l[s]=e;},w$5=()=>{const n=n$o("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$l=e$e(t$l,e);},o$c=()=>{typeof document>"u"||u$a||(g$a(),u$a=true);},g$a=n=>{M$3(),z$1(),w$5();};

    let o$b;i$d(()=>{o$b=void 0;});const a$e=()=>(o$b===void 0&&(o$b=U$2()),o$b);

    const a$d=()=>{const t=n$o("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$e();},f$e=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$e()||t||S$4("data-ui5-font-face")||c$e(n$n,"data-ui5-font-face");};
    ...
    const s$h=new Set,d$9=new i$i,n$j=new l$e;let t$i,a$c,m$b,i$b;const l$d=async e=>{n$j.add(e),await P$1();},c$d=e=>{d$9.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$4=e=>{n$j.remove(e),s$h.delete(e);},P$1=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$j.process(c$d),i$b=null,e(),m$b||(m$b=setTimeout(()=>{m$b=void 0,n$j.isEmpty()&&U$1();},200));});})),await i$b;},y$7=()=>t$i||(t$i=new Promise(e=>{a$c=e,window.requestAnimationFrame(()=>{n$j.isEmpty()&&(t$i=void 0,e());});}),t$i),I$2=()=>{const e=T$4().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$d=async()=>{await I$2(),await y$7();},U$1=()=>{n$j.isEmpty()&&a$c&&(a$c(),a$c=void 0,t$i=void 0);},C$4=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$k(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$d(r);}),await f$d();};

    const t$h=new i$i,r$j="themeRegistered",n$i=e=>{t$h.attachEvent(r$j,e);},s$g=e=>t$h.fireEvent(r$j,e);

    const l$c=new Map,T$2=new Map,h$3=new Map,u$9=new Map,a$b=new Set,f$c=(e,r,t,s="root")=>{T$2.set(`${e}/${r}`,t),u$9.set(e,{cssVariablesTarget:s}),a$b.add(r),s$g(r);},L$4=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$c.get(s);if(o!==void 0)return o;if(!a$b.has(r)){const p=[...a$b.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$b}. Registered themes are: ${p}`),c$c(e,e$b)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$c(n,g);return i&&l$c.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$3:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$a=()=>u$9,w$4=e=>a$b.has(e);

    const r$i=new Set,s$f=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$a=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$i.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$i.add("decode"));return}try{return JSON.parse(a)}catch{r$i.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$i.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$i.has("object")||(console.warn("Malformed theme metadata Object",e),r$i.add("object"));return}return {themeName:t,baseThemeName:a}},m$9=()=>{const e=s$f();if(!e||e==="none")return;const t=o$a(e);if(t)return d$8(t)};

    const t$g=new i$i,d$7="themeLoaded",r$h=e=>t$g.fireEvent(d$7,e);
...
`);n$h().replaceSync(S);};
    ...
    const e$6=new Map;i$7(t=>{e$6.delete(`${t}_normal`);});const y$6=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$o("OpenUI5Enablement");if(!e$6.has(n)){let l="";s&&(l=e$7(s.getBusyIndicatorStyles()));const a=l$8(o)||"",m=`${e$7(t.styles)} ${a} ${l}`;e$6.set(n,m);}return e$6.get(n)};
    ...
    const t$9=new WeakMap,n$d=(e,o,r)=>{const s=new MutationObserver(o);t$9.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$9.get(e);o&&(o.disconnect(),t$9.delete(e));};

    const c$7=["value-changed","click"];let e$4;i$d(()=>{e$4=void 0;});const s$8=t=>c$7.includes(t),l$7=t=>{const n=o$4();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$4=()=>(e$4===void 0&&(e$4=F$1()),e$4),a$6=t=>{const n=o$4();return s$8(t)?false:n===true?true:!l$7(t)};
    ...
    const t$8=typeof document>"u",o$3=()=>{if(t$8)return a$f;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$f};

    const e$3=new i$i,n$9="languageChange",t$7=a=>{e$3.attachEvent(n$9,a);},o$2=a=>e$3.fireEventAsync(n$9,a);

    let n$8,t$6;i$d(()=>{n$8=void 0,t$6=void 0;});let a$4=false;C$3("language",e=>{n$8=e,a$4=true,o$2(e).then(()=>{a$4=false,O$3()&&C$4({languageAware:true});});});const c$6=()=>a$4,L$3=()=>(n$8===void 0&&(n$8=f$a("language")??S$3()),n$8),D$3=()=>(t$6===void 0&&(t$6=L$5()),t$6);
    ...
    const r$5=new Map,n$6=t=>(r$5.has(t)||r$5.set(t,new r$6(t)),r$5.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$6(t)}catch{}return new r$6(r$m)},s$5=t=>{const e=L$3();return e?n$6(e):c$5(o$3())};
    ...
    const d$4=new Set,m$5=new Set,g$6=new Map,l$5=new Map,u$5=new Map,f$6=(n,t)=>{g$6.set(n,t);},A$3=n=>g$6.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$5.get(e)&&l$5.set(e,r(t)),l$5.get(e)},M$2=n=>{d$4.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$4.add(n));},L$2=(n,t)=>t!==a$f&&!h$1(n,t),w$1=async n=>{const t=s$5().getLanguage(),e=s$5().getRegion(),r=s$5().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$1(s);L$2(n,s);)s=n$5(s);const I=D$3();if(s===a$f&&!I){f$6(n,null);return}if(!h$1(n,s)){M$2(n);return}try{const o=await B$1(n,s);f$6(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$7(n=>{const t=[...g$6.keys()];return Promise.all(t.map(w$1))});
    ...
    let n$3;i$d(()=>{n$3=void 0;});const d=()=>(n$3===void 0&&(n$3=y$8()),n$3);
...
`;
    ...
    let Panel$1 = Panel_1 = class Panel extends S$1 {
        ...
        get shouldNotAnimate() {
            return this.noAnimation || d() === u$c.None;
        }
        _isMobile() {
            if (l$a()) {
                this._touched = true;
