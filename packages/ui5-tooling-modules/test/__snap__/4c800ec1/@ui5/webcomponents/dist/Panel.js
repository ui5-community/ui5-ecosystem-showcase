sap.ui.define(['module'], (function (module) { 'use strict';

    var c$i={},e$f=c$i.hasOwnProperty,a$g=c$i.toString,o$h=e$f.toString,l$h=o$h.call(Object),i$j=function(r){var t,n;return !r||a$g.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$f.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$h.call(n)===l$h):true)};

    var c$h=Object.create(null),u$g=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$h;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$j(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$j(n)?n:{},r[a]=u$g(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

    const e$e=function(n,t){return u$g(true,false,...arguments)};

    const d$d=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

    let i$i = class i{constructor(){this._eventRegistry=new Map;}attachEvent(t,r){const n=this._eventRegistry,e=n.get(t);if(!Array.isArray(e)){n.set(t,[r]);return}e.includes(r)||e.push(r);}detachEvent(t,r){const n=this._eventRegistry,e=n.get(t);if(!e)return;const s=e.indexOf(r);s!==-1&&e.splice(s,1),e.length===0&&n.delete(t);}fireEvent(t,r){const e=this._eventRegistry.get(t);return e?e.map(s=>s.call(this,r)):[]}fireEventAsync(t,r){return Promise.all(this.fireEvent(t,r))}isHandlerAttached(t,r){const e=this._eventRegistry.get(t);return e?e.includes(r):false}hasListeners(t){return !!this._eventRegistry.get(t)}};
    ...
    const u$f=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$g=()=>typeof document>"u"?null:o$g('meta[name="ui5-shared-resources"]',document.head,u$f),m$f=(t,o)=>{const r=t.split(".");let e=l$g();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

    const g$d=m$f("Tags",new Map),d$c=new Set;let i$h=new Map,c$g;const m$e=-1,h$5=e=>{d$c.add(e),g$d.set(e,I$3());},w$6=e=>d$c.has(e),T$5=()=>[...d$c.values()],$$2=e=>{let n=g$d.get(e);n===void 0&&(n=m$e),i$h.has(n)||i$h.set(n,new Set),i$h.get(n).add(e),c$g||(c$g=setTimeout(()=>{y$b(),i$h=new Map,c$g=void 0;},1e3));},y$b=()=>{const e=$$1(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$h.keys()].forEach(s=>{let o,r;s===m$e?(o=1,r={description:"Older unknown runtime"}):(o=b$8(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${i$h.get(s).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...i$h.get(s)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    const e$d={version:"2.22.0",major:2,minor:22,patch:0,suffix:"",isNext:false,buildTime:1778494735};

    let s$n,t$n={include:[/./],exclude:[]};const o$f=new Map,c$f=()=>s$n,m$d=()=>t$n,i$g=e=>{if(!o$f.has(e)){const n=t$n.include.some(r=>e.match(r))&&!t$n.exclude.some(r=>e.match(r));o$f.set(e,n);}return o$f.get(e)},d$b=e=>{if(i$g(e))return c$f()};

    let i$f,s$m="";const u$e=new Map,n$p=m$f("Runtimes",[]),x$3=()=>{if(i$f===void 0){i$f=n$p.length;const t=e$d;n$p.push({...t,get scopingSuffix(){return c$f()},get registeredTags(){return T$5()},get scopingRules(){return m$d()},alias:s$m,description:`Runtime ${i$f} - ver ${t.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("Panel"), document.baseURI).href});}},I$3=()=>i$f,b$8=(t,m)=>{const o=`${t},${m}`;if(u$e.has(o))return u$e.get(o);const e=n$p[t],r=n$p[m];if(!e||!r)throw new Error("Invalid runtime index supplied");if(e.isNext||r.isNext)return e.buildTime-r.buildTime;const c=e.major-r.major;if(c)return c;const a=e.minor-r.minor;if(a)return a;const f=e.patch-r.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,r.suffix);return u$e.set(o,l),l},$$1=()=>n$p;

    const g$c=typeof document>"u",i$e=(e,t)=>t?`${e}|${t}`:e,l$f=e=>e===void 0?true:b$8(I$3(),parseInt(e))>=1,c$e=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$e(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$a=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$e(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$f(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$c?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$e(e,t)),f$g=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$e(e,t));},R=(e,t,r="",s)=>{S$4(t,r)?y$a(e,t,r,s):c$e(e,t,r,s);},m$c=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

    const e$c=new Map,n$o=t=>e$c.get(t);
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const _$2={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_auto","sap_horizon_dark","sap_horizon_hc_auto","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$b=_$2.themes.default,s$l=_$2.themes.all,a$f=_$2.languages.default,r$m=_$2.locales.default,n$m=_$2.locales.all;

    var u$d=(l=>(l.Full="full",l.Basic="basic",l.Minimal="minimal",l.None="none",l))(u$d||{});

    const e$a=new i$i,t$m="configurationReset",i$d=n=>{e$a.attachEvent(t$m,n);};

    const o$e=typeof document>"u",n$l={search(){return o$e?"":window.location.search}},s$k=()=>o$e?"":window.location.href,u$c=()=>n$l.search();

    let u$b=false,t$l={animationMode:u$d.Full,theme:e$b,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const y$9=()=>(o$d(),t$l.animationMode),C$5=()=>(o$d(),t$l.theme),T$4=()=>(o$d(),t$l.themeRoot),S$3=()=>(o$d(),t$l.language),L$5=()=>(o$d(),t$l.fetchDefaultLanguage),F$1=()=>(o$d(),t$l.noConflict),U$2=()=>(o$d(),t$l.defaultFontLoading),b$7=()=>(o$d(),t$l.enableDefaultTooltips),i$c=new Map;i$c.set("true",true),i$c.set("false",false);const M$3=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$l=e$e(t$l,e));}},z$1=()=>{const n=new URLSearchParams(u$c());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||p$5(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&p$5(a,e,"sap-ui");});},E$3=n=>n.split("@")[1],P$2=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,p$5=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$c.has(e)&&(e=i$c.get(r)),s==="theme"?(t$l.theme=P$2(s,e),e&&e.includes("@")&&(t$l.themeRoot=E$3(e))):t$l[s]=e;},w$5=()=>{const n=n$o("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$l=e$e(t$l,e);},o$d=()=>{typeof document>"u"||u$b||(g$b(),u$b=true);},g$b=n=>{M$3(),z$1(),w$5();};

    let o$c;i$d(()=>{o$c=void 0;});const a$e=()=>(o$c===void 0&&(o$c=U$2()),o$c);

    const a$d=()=>{const t=n$o("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$f();},f$f=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$e()||t||S$4("data-ui5-font-face")||c$e(n$n,"data-ui5-font-face");};

    var s$j = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

    const r$l=()=>{R(s$j,"data-ui5-system-css-vars");};

    var t$k = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

    const s$i=()=>{S$4("data-ui5-scrollbar-styles")||c$e(t$k,"data-ui5-scrollbar-styles");};
    ...
    const t$j=new Set,n$k=e=>{t$j.add(e);},r$k=e=>t$j.has(e);

    const s$h=new Set,d$a=new i$i,n$j=new l$e;let t$i,a$c,m$b,i$b;const l$d=async e=>{n$j.add(e),await P$1();},c$d=e=>{d$a.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$4=e=>{n$j.remove(e),s$h.delete(e);},P$1=async()=>{i$b||(i$b=new Promise(e=>{window.requestAnimationFrame(()=>{n$j.process(c$d),i$b=null,e(),m$b||(m$b=setTimeout(()=>{m$b=void 0,n$j.isEmpty()&&U$1();},200));});})),await i$b;},y$8=()=>t$i||(t$i=new Promise(e=>{a$c=e,window.requestAnimationFrame(()=>{n$j.isEmpty()&&(t$i=void 0,e());});}),t$i),I$2=()=>{const e=T$5().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$e=async()=>{await I$2(),await y$8();},U$1=()=>{n$j.isEmpty()&&a$c&&(a$c(),a$c=void 0,t$i=void 0);},C$4=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$k(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$d(r);}),await f$e();};

    const t$h=new i$i,r$j="themeRegistered",n$i=e=>{t$h.attachEvent(r$j,e);},s$g=e=>t$h.fireEvent(r$j,e);

    const l$c=new Map,T$3=new Map,h$3=new Map,u$a=new Map,a$b=new Set,f$d=(e,r,t,s="root")=>{T$3.set(`${e}/${r}`,t),u$a.set(e,{cssVariablesTarget:s}),a$b.add(r),s$g(r);},L$4=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$c.get(s);if(o!==void 0)return o;if(!a$b.has(r)){const p=[...a$b.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$b}. Registered themes are: ${p}`),c$c(e,e$b)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$c(n,g);return i&&l$c.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$3:T$3).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$a=()=>u$a,w$4=e=>a$b.has(e);

    const r$i=new Set,s$f=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$b=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$i.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$i.add("decode"));return}try{return JSON.parse(a)}catch{r$i.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$i.add("parse"));}}},d$9=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$i.has("object")||(console.warn("Malformed theme metadata Object",e),r$i.add("object"));return}return {themeName:t,baseThemeName:a}},m$9=()=>{const e=s$f();if(!e||e==="none")return;const t=o$b(e);if(t)return d$9(t)};

    const t$g=new i$i,d$8="themeLoaded",r$h=e=>t$g.fireEvent(d$8,e);
    ...
    const a$a=t=>{const e=document.querySelector(`META[name="${t}"]`);return e&&e.getAttribute("content")},g$a=(t,e=false)=>{const n=a$a("sap-allowed-theme-origins")??a$a("sap-allowedThemeOrigins");return n?e?true:n.split(",").some(r=>r==="*"||t===r.trim()):false},l$b=t=>{let e,n=false;try{if(t.startsWith(".")||t.startsWith("/")&&!t.startsWith("//"))e=new URL(t,s$k()).toString(),n=!0;else {const r=t.startsWith("//")?new URL(t,s$k()):new URL(t),i=r.origin,o=new URL(s$k()).origin;if(n=i===o,i&&g$a(i,n))e=r.toString();else return}return e.endsWith("/")||(e=`${e}/`),`${e}UI5/`}catch{return}};

    let t$f;i$d(()=>{t$f=void 0;});const r$g=()=>(t$f===void 0&&(t$f=T$4()),t$f),f$c=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$e=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$g();if(!n)return;const i=l$b(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$7(f$c(e,i),{"sap-ui-webcomponents-theme":e});};

    const t$e=new Map;let e$9;const n$h=()=>(e$9||(e$9=new CSSStyleSheet),e$9),r$f=(o,s)=>{t$e.set(o,s);const S=Array.from(t$e.values()).join(`
`);n$h().replaceSync(S);};

    let _lib="ui5",_package="webcomponents-theming";const a$9="@"+_lib+"/"+_package,E$2=()=>m$a().has(a$9),U=async e=>{if(!E$2())return;const t=await L$4(a$9,e);t&&R(t,"data-ui5-theme-properties",a$9,e);},w$3=()=>{f$g("data-ui5-theme-properties",a$9);},I$1=async(e,t)=>{const o=[...m$a().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$9)return;const i=await L$4(s,e,t);i&&(n==="root"?R(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$f(s,i));});return Promise.all(o)},O$4=async e=>{const t=m$9();if(t)return t;const r=n$o("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$g())return await s$e(e),m$9()},b$6=async e=>{const t=await O$4(e);!t||e!==t.themeName?await U(e):w$3();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$4(e)?e:o||e$b;await I$1(s,r),B$2(o),r$h(e);};

    const g$9=()=>m$f("ConfigChange.eventProvider",new i$i),r$e=()=>m$f("ConfigChange.values",{}),a$8="configChange",t$d=new Set,C$3=(n,e)=>{g$9().attachEvent(a$8,i=>{i.name===n&&!t$d.has(n)&&e(i.value);});},f$b=n=>r$e()[n];

    let t$c,o$a;i$d(()=>{t$c=void 0;}),C$3("theme",e=>{t$c=e,O$3()&&b$6(t$c).then(()=>C$4({themeAware:true}));});const r$d=()=>(t$c===void 0&&(t$c=f$b("theme")??C$5()),t$c),m$8=()=>{const e=r$d();return C$2(e)?!e.startsWith("sap_horizon"):!m$9()?.baseThemeName?.startsWith("sap_horizon")},C$2=e=>s$l.includes(e),A$3=()=>o$a,B$2=e=>{o$a=e;};

    const t$b=typeof document>"u",e$8={get userAgent(){return t$b?"":navigator.userAgent},get touch(){return t$b?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$8.userAgent)},get firefox(){return t$b?false:/Firefox/.test(e$8.userAgent)},get safari(){return t$b?false:!e$8.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$8.userAgent)},get webkit(){return t$b?false:/webkit/.test(e$8.userAgent)},get windows(){return t$b?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$b?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$8.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$b?false:!e$8.windows&&/Android/.test(e$8.userAgent)},get androidPhone(){return t$b?false:e$8.android&&/(?=android)(?=.*mobile)/i.test(e$8.userAgent)},get ipad(){return t$b?false:/ipad/i.test(e$8.userAgent)||/Macintosh/i.test(e$8.userAgent)&&"ontouchend"in document},_isPhone(){return u$9(),e$8.touch&&!r$c}};let o$9,i$a,r$c;const s$d=()=>{if(t$b||!e$8.windows)return  false;if(o$9===void 0){const n=e$8.userAgent.match(/Windows NT (\d+).(\d)/);o$9=n?parseFloat(n[1]):0;}return o$9>=8},c$b=()=>{if(t$b||!e$8.webkit)return  false;if(i$a===void 0){const n=e$8.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$9=()=>{if(t$b)return  false;if(r$c===void 0){if(e$8.ipad){r$c=true;return}if(e$8.touch){if(s$d()){r$c=true;return}if(e$8.chrome&&e$8.android){r$c=!/Mobile Safari\/[.0-9]+/.test(e$8.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$8.android&&c$b()&&(n=1),r$c=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$c=e$8.userAgent.indexOf("Touch")!==-1||e$8.android&&!e$8.androidPhone;}},l$a=()=>e$8.touch,h$2=()=>e$8.safari,a$7=()=>(u$9(),(e$8.touch||s$d())&&r$c),d$6=()=>e$8._isPhone(),f$a=()=>t$b?false:!a$7()&&!d$6()||s$d(),w$2=()=>e$8.iOS;

    let t$a=false;const i$9=()=>{h$2()&&w$2()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

    let r$b=false,i$8,p$4=false;const m$7=new i$i,O$3=()=>r$b,f$9=async()=>{const t=n$o("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$o("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$a=()=>{if(p$4)return;const t=n$o("OpenUI5Support");t&&(p$4=t.attachListeners());},u$8=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(x$3(),typeof document>"u"){e();return}n$i(b$5),await f$9(),await d$d(),await b$6(r$d()),c$a(),a$d(),r$l(),s$i(),i$9(),e(),r$b=true,m$7.fireEvent("boot");};return i$8=new Promise(t),i$8},b$5=t=>{if(!r$b)return;const e=r$d(),o=A$3();(t===e||t===o)&&b$6(e);};

    const s$c=new Map,o$8=new Map,n$g=new Map,c$9=e=>{if(!s$c.has(e)){const a=b$4(e.split("-"));s$c.set(e,a);}return s$c.get(e)},l$9=e=>{if(!o$8.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$8.set(e,a);}return o$8.get(e)},p$3=e=>l$9(e),b$4=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$g.get(e);if(a)return a;const t=c$9(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$g.set(e,r),r};

    const o$7=t=>{if(!(t instanceof HTMLElement))return "default";const e=t.getAttribute("slot");if(e){const r=e.match(/^(.+?)-\d+$/);return r?r[1]:e}return "default"},n$f=t=>t instanceof HTMLSlotElement?t.assignedNodes({flatten:true}).filter(e=>e instanceof HTMLElement):[t],s$b=t=>t.reduce((e,r)=>e.concat(n$f(r)),[]);

    let p$2 = class p{constructor(t){this.metadata=t;}getInitialState(){if(Object.prototype.hasOwnProperty.call(this,"_initialState"))return this._initialState;const t={};if(this.slotsAreManaged()){const o=this.getSlots();for(const[e,s]of Object.entries(o)){const n=s.propertyName||e;t[n]=[],t[c$9(n)]=t[n];}}return this._initialState=t,t}static validateSlotValue(t,a){return g$8(t,a)}getPureTag(){return this.metadata.tag||""}getTag(){const t=this.metadata.tag;if(!t)return "";const a=d$b(t);return a?`${t}-${a}`:t}hasAttribute(t){const a=this.getProperties()[t];return a.type!==Object&&!a.noAttribute}getPropertiesList(){return Object.keys(this.getProperties())}getAttributesList(){return this.getPropertiesList().filter(this.hasAttribute.bind(this)).map(l$9)}canSlotText(){return this.getSlots().default?.type===Node}hasSlots(){return !!Object.entries(this.getSlots()).length}hasIndividualSlots(){return this.slotsAreManaged()&&Object.values(this.getSlots()).some(t=>t.individualSlots)}slotsAreManaged(){return !!this.metadata.managedSlots}supportsF6FastNavigation(){return !!this.metadata.fastNavigation}getProperties(){return this.metadata.properties||(this.metadata.properties={}),this.metadata.properties}getEvents(){return this.metadata.events||(this.metadata.events={}),this.metadata.events}getSlots(){return this.metadata.slots||(this.metadata.slots={}),this.metadata.slots}isLanguageAware(){return !!this.metadata.languageAware}isThemeAware(){return !!this.metadata.themeAware}needsCLDR(){return !!this.metadata.cldr}getShadowRootOptions(){return this.metadata.shadowRootOptions||{}}isFormAssociated(){return !!this.metadata.formAssociated}shouldInvalidateOnChildChange(t,a,o){const e=this.getSlots()[t].invalidateOnChildChange;if(e===void 0)return  false;if(typeof e=="boolean")return e;if(typeof e=="object"){if(a==="property"){if(e.properties===void 0)return  false;if(typeof e.properties=="boolean")return e.properties;if(Array.isArray(e.properties))return e.properties.includes(o);throw new Error("Wrong format for invalidateOnChildChange.properties: boolean or array is expected")}if(a==="slot"){if(e.slots===void 0)return  false;if(typeof e.slots=="boolean")return e.slots;if(Array.isArray(e.slots))return e.slots.includes(o);throw new Error("Wrong format for invalidateOnChildChange.slots: boolean or array is expected")}}throw new Error("Wrong format for invalidateOnChildChange: boolean or object is expected")}getI18n(){return this.metadata.i18n||(this.metadata.i18n={}),this.metadata.i18n}};const g$8=(r,t)=>(r&&n$f(r).forEach(a=>{if(!(a instanceof t.type))throw new Error(`The element is not of type ${t.type.toString()}`)}),r);

    const r$a=()=>m$f("CustomStyle.eventProvider",new i$i),n$e="CustomCSSChange",i$7=t=>{r$a().attachEvent(n$e,t);},c$8=()=>m$f("CustomStyle.customCSSFor",{});i$7(t=>{C$4({tag:t});});const l$8=t=>{const e=c$8();return e[t]?e[t].join(""):""};

    const e$7=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

    const e$6=new Map;i$7(t=>{e$6.delete(`${t}_normal`);});const y$7=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$o("OpenUI5Enablement");if(!e$6.has(n)){let l="";s&&(l=e$7(s.getBusyIndicatorStyles()));const a=l$8(o)||"",m=`${e$7(t.styles)} ${a} ${l}`;e$6.set(n,m);}return e$6.get(n)};

    const e$5=new Map;i$7(t=>{e$5.delete(`${t}_normal`);});const s$a=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$5.has(n)){const a=y$7(t),o=new CSSStyleSheet;o.replaceSync(a),e$5.set(n,[o]);}return e$5.get(n)};

    const s$9=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$h(),...s$a(e)],e.renderer(o,t);};

    const r$9=[],o$6=t=>r$9.some(s=>t.startsWith(s));

    const t$9=new WeakMap,n$d=(e,o,r)=>{const s=new MutationObserver(o);t$9.set(e,s),s.observe(e,r);},b$3=e=>{const o=t$9.get(e);o&&(o.disconnect(),t$9.delete(e));};

    const c$7=["value-changed","click"];let e$4;i$d(()=>{e$4=void 0;});const s$8=t=>c$7.includes(t),l$7=t=>{const n=o$5();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$5=()=>(e$4===void 0&&(e$4=F$1()),e$4),a$6=t=>{const n=o$5();return s$8(t)?false:n===true?true:!l$7(t)};

    const r$8=t=>t.matches(":dir(rtl)")?"rtl":"ltr";

    const s$7=["disabled","title","hidden","role","draggable"],r$7=e=>s$7.includes(e)||e.startsWith("aria")?true:![HTMLElement,Element,Node].some(t=>t.prototype.hasOwnProperty(e));

    const n$c=(t,r)=>{if(t.length!==r.length)return  false;for(let e=0;e<t.length;e++)if(t[e]!==r[e])return  false;return  true};

    const n$b=(e,t)=>e.call(t);

    const m$6=t=>{const r=t.getAttribute("form");if(r){const e=document.getElementById(r);return e instanceof HTMLFormElement?e:null}return t._internals?.form??null},a$5=t=>{s$6(t)&&i$6(t);},i$6=t=>{if(t._internals?.form){if(n$a(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},n$a=async t=>{if(!(!t.isUI5Element||!t._internals?.form))if(t._internals.setValidity({customError:true}," "),await t.definePromise,t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},l$6=async t=>{const r=m$6(t);if(!r)return;const e=[...r.elements];await Promise.all(e.map(o=>s$6(o)?n$a(o):Promise.resolve())),r.requestSubmit();},u$7=t=>{m$6(t)?.reset();},s$6=t=>"formFormattedValue"in t&&"name"in t;

    const t$8=typeof document>"u",o$4=()=>{if(t$8)return a$f;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$f};

    const e$3=new i$i,n$9="languageChange",t$7=a=>{e$3.attachEvent(n$9,a);},o$3=a=>e$3.fireEventAsync(n$9,a);

    let n$8,t$6;i$d(()=>{n$8=void 0,t$6=void 0;});let a$4=false;C$3("language",e=>{n$8=e,a$4=true,o$3(e).then(()=>{a$4=false,O$3()&&C$4({languageAware:true});});});const c$6=()=>a$4,L$3=()=>(n$8===void 0&&(n$8=f$b("language")??S$3()),n$8),D$3=()=>(t$6===void 0&&(t$6=L$5()),t$6);

    const n$7=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$6 = class r{constructor(s){const t=n$7.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$f,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

    const r$5=new Map,n$6=t=>(r$5.has(t)||r$5.set(t,new r$6(t)),r$5.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$6(t)}catch{}return new r$6(r$m)},s$5=t=>{const e=L$3();return e?n$6(e):c$5(o$4())};

    const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$4=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$8={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$1=i=>{let e;if(!i)return r$m;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$8[t]||t,o&&(e=c$4.exec(o))||r&&(e=c$4.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$m};

    const r$4={zh_HK:"zh_TW",in:"id"},n$5=t=>{if(!t)return r$m;if(r$4[t])return r$4[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$m?r$m:""};

    const d$5=new Set,m$5=new Set,g$7=new Map,l$5=new Map,u$6=new Map,f$7=(n,t)=>{g$7.set(n,t);},A$2=n=>g$7.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$6.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$6.get(e);return r&&!l$5.get(e)&&l$5.set(e,r(t)),l$5.get(e)},M$2=n=>{d$5.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$5.add(n));},L$2=(n,t)=>t!==a$f&&!h$1(n,t),w$1=async n=>{const t=s$5().getLanguage(),e=s$5().getRegion(),r=s$5().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$1(s);L$2(n,s);)s=n$5(s);const I=D$3();if(s===a$f&&!I){f$7(n,null);return}if(!h$1(n,s)){M$2(n);return}try{const o=await B$1(n,s);f$7(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$7(n=>{const t=[...g$7.keys()];return Promise.all(t.map(w$1))});

    const g$6=/('')|'([^']+(?:''[^']*)*)(?:'|$)|\{([0-9]+(?:\s*,[^{}]*)?)\}|[{}]/g,i$5=(n,t)=>(t=t||[],n.replace(g$6,(p,s,e,r,o)=>{if(s)return "'";if(e)return e.replace(/''/g,"'");if(r){const a=typeof r=="string"?parseInt(r):r;return String(t[a])}throw new Error(`[i18n]: pattern syntax error at pos ${o}`)}));

    const r$3=new Map;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$5(l,i)}};const a$3=n=>{if(r$3.has(n))return r$3.get(n);const e=new u$5(n);return r$3.set(n,e),e},f$6=async n=>(await w$1(n),a$3(n));

    const f$5=new Map,s$4=new Map,i$4=new Map,L$1=new Set;let d$4=false;const O$2={iw:"he",ji:"yi",in:"id"},D$2=t=>{d$4||(console.warn(`[LocaleData] Supported locale "${t}" not configured, import the "Assets.js" module from the webcomponents package you are using.`),d$4=true);},y$6=(t,e,n)=>{t=t&&O$2[t]||t,t==="no"&&(t="nb"),t==="zh"&&!e&&(n==="Hans"?e="CN":n==="Hant"&&(e="TW")),(t==="sh"||t==="sr"&&n==="Latn")&&(t="sr",e="Latn");let o=`${t}_${e}`;return n$m.includes(o)?s$4.has(o)?o:(D$2(o),r$m):(o=t,n$m.includes(o)?s$4.has(o)?o:(D$2(o),r$m):r$m)},u$4=(t,e)=>{f$5.set(t,e);},S$2=t=>{if(!i$4.get(t)){const e=s$4.get(t);if(!e)throw new Error(`CLDR data for locale ${t} is not loaded!`);i$4.set(t,e(t));}return i$4.get(t)},g$5=async(t,e,n)=>{const o=y$6(t,e,n),p=n$o("OpenUI5Support");if(p){const r=p.getLocaleDataObject();if(r){u$4(o,r);return}}try{const r=await S$2(o);u$4(o,r);}catch(r){const c=r;L$1.has(c.message)||(L$1.add(c.message),console.error(c.message));}},m$4=(t,e)=>{s$4.set(t,e);};m$4("en",async()=>(console.warn('[LocaleData] Falling back to loading "en" locale data from CDN.','For production usage, please configure locale data loading via the "Assets.js" module of the webcomponents package you are using.'),(await fetch("https://cdn.jsdelivr.net/npm/@openui5/sap.ui.core@1.120.17/src/sap/ui/core/cldr/en.json")).json())),t$7(()=>{const t=s$5();return g$5(t.getLanguage(),t.getRegion(),t.getScript())});

    function r$2(n){return e=>e!==void 0&&n in e&&e[n]===true}

    let it=0;const O$1=new Map,M$1=new Map,L={fromAttribute(c,f){if(f===Boolean)return c!==null;if(f===Number)return c===null?void 0:parseFloat(c);if(f===Object||f===Array)try{return JSON.parse(c)}catch{return c}return c},toAttribute(c,f){return f===Boolean?c?"":null:f===Object||f===Array?JSON.stringify(c):c==null?null:String(c)}};function g$4(c){this._suppressInvalidation||this.constructor.getMetadata().isLanguageAware()&&c$6()||(this.onInvalidation(c),this._changedState.push(c),l$d(this),this._invalidationEventProvider.fireEvent("invalidate",{...c,target:this}));}function rt(c,f){do{const t=Object.getOwnPropertyDescriptor(c,f);if(t)return t;c=Object.getPrototypeOf(c);}while(c&&c!==HTMLElement.prototype)}let S$1 = class S extends HTMLElement{constructor(){super();this.__shouldHydrate=false;this._rendered=false;const t=this.constructor;this._changedState=[],this._suppressInvalidation=true,this._inDOM=false,this._fullyConnected=false,this._childChangeListeners=new Map,this._slotChangeListeners=new Map,this._invalidationEventProvider=new i$i,this._componentStateFinalizedEventProvider=new i$i;let e;this._domRefReadyPromise=new Promise(n=>{e=n;}),this._domRefReadyPromise._deferredResolve=e,this._doNotSyncAttributes=new Set,this._slotsAssignedNodes=new WeakMap,this._state={...t.getMetadata().getInitialState()},this.initializedProperties=new Map,this.constructor.getMetadata().getPropertiesList().forEach(n=>{if(this.hasOwnProperty(n)){const o=this[n];this.initializedProperties.set(n,o);}}),this._internals=this.attachInternals(),this._initShadowRoot();}_initShadowRoot(){const t=this.constructor;if(t._needsShadowDOM()){const e={mode:"open"};this.shadowRoot?this.__shouldHydrate=true:this.attachShadow({...e,...t.getMetadata().getShadowRootOptions()}),t.getMetadata().slotsAreManaged()&&this.shadowRoot.addEventListener("slotchange",this._onShadowRootSlotChange.bind(this));}}_onShadowRootSlotChange(t){t.target?.getRootNode()===this.shadowRoot&&this._processChildren();}get _id(){return this.__id||(this.__id=`ui5wc_${++it}`),this.__id}render(){const t=this.constructor.template;return n$b(t,this)}async connectedCallback(){const t=this.constructor;this.setAttribute(t.getMetadata().getPureTag(),""),t.getMetadata().supportsF6FastNavigation()&&!this.hasAttribute("data-sap-ui-fastnavgroup")&&this.setAttribute("data-sap-ui-fastnavgroup","true");const e=t.getMetadata().slotsAreManaged();this._inDOM=true,e&&(this._startObservingDOMChildren(),await this._processChildren()),t.asyncFinished||await t._definePromise,this._inDOM&&(c$d(this),this._domRefReadyPromise._deferredResolve(),this._fullyConnected=true,this.onEnterDOM());}get definePromise(){const t=this.constructor;return !t.asyncFinished&&t._definePromise?t._definePromise:Promise.resolve()}disconnectedCallback(){const e=this.constructor.getMetadata().slotsAreManaged();this._inDOM=false,e&&this._stopObservingDOMChildren(),this._fullyConnected&&(this.onExitDOM(),this._fullyConnected=false),this._domRefReadyPromise._deferredResolve(),h$4(this);}onBeforeRendering(){}onAfterRendering(){}onEnterDOM(){}onExitDOM(){}_startObservingDOMChildren(){const e=this.constructor.getMetadata();if(!e.hasSlots())return;const n=e.canSlotText(),o={childList:true,subtree:n,characterData:n};n$d(this,this._processChildren.bind(this),o);}_stopObservingDOMChildren(){b$3(this);}async _processChildren(){this.constructor.getMetadata().hasSlots()&&await this._updateSlots();}async _updateSlots(){const t=this.constructor,e=t.getMetadata().getSlots(),s=t.getMetadata().canSlotText(),n=Array.from(s?this.childNodes:this.children),o=new Map,i=new Map;for(const[l,h]of Object.entries(e)){const d=h.propertyName||l;i.set(d,l),o.set(d,[...this._state[d]]),this._clearSlot(l,h);}const r=new Map,a=new Map;n.forEach((l,h)=>{const d=o$7(l),p=e[d];if(p===void 0){if(d!=="default"){const I=Object.keys(e).join(", ");console.warn(`Unknown slotName: ${d}, ignoring`,l,`Valid values are: ${I}`);}return}const _=p.propertyName||d;a.has(_)?a.get(_).push({child:l,idx:h}):a.set(_,[{child:l,idx:h}]);}),a.forEach((l,h)=>{this._state[h]=l.sort((d,p)=>d.idx-p.idx).map(d=>d.child),this._state[c$9(h)]=this._state[h];});const u=n.map(async l=>{const h=o$7(l),d=e[h];if(d!==void 0){if(d.individualSlots){const p=(r.get(h)||0)+1;r.set(h,p),l._individualSlot=`${h}-${p}`;}if(l instanceof HTMLElement){const p=l.localName;if(p.includes("-")&&!o$6(p)){if(!customElements.get(p)){const U=customElements.whenDefined(p);let E=O$1.get(p);E||(E=new Promise(k=>setTimeout(k,1e3)),O$1.set(p,E)),await Promise.race([U,E]);}customElements.upgrade(l);}}if(l=t.getMetadata().constructor.validateSlotValue(l,d),y$5(l)&&d.invalidateOnChildChange){const p=this._getChildChangeListener(h);l.attachInvalidate.call(l,p);}l instanceof HTMLSlotElement&&this._attachSlotChange(l,h,!!d.invalidateOnChildChange);}});await Promise.all(u);let v=false;for(const[l,h]of Object.entries(e)){const d=h.propertyName||l;n$c(o.get(d),this._state[d])||(g$4.call(this,{type:"slot",name:i.get(d),reason:"children"}),v=true,t.getMetadata().isFormAssociated()&&i$6(this));}v||g$4.call(this,{type:"slot",name:"default",reason:"textcontent"});}_clearSlot(t,e){const s=e.propertyName||t;this._state[s].forEach(o=>{if(y$5(o)){const i=this._getChildChangeListener(t);o.detachInvalidate.call(o,i);}o instanceof HTMLSlotElement&&this._detachSlotChange(o,t);}),this._state[s]=[],this._state[c$9(s)]=this._state[s];}attachInvalidate(t){this._invalidationEventProvider.attachEvent("invalidate",t);}detachInvalidate(t){this._invalidationEventProvider.detachEvent("invalidate",t);}_onChildChange(t,e){this.constructor.getMetadata().shouldInvalidateOnChildChange(t,e.type,e.name)&&g$4.call(this,{type:"slot",name:t,reason:"childchange",child:e.target});}attributeChangedCallback(t,e,s){let n;if(this._doNotSyncAttributes.has(t))return;const o=this.constructor.getMetadata().getProperties(),i=t.replace(/^ui5-/,""),r=c$9(i);if(o.hasOwnProperty(r)){const a=o[r];n=(a.converter??L).fromAttribute(s,a.type),this[r]=n;}}formAssociatedCallback(){this.constructor.getMetadata().isFormAssociated()&&a$5(this);}static get formAssociated(){return this.getMetadata().isFormAssociated()}_updateAttribute(t,e){const s=this.constructor;if(!s.getMetadata().hasAttribute(t))return;const o=s.getMetadata().getProperties()[t],i=l$9(t),a=(o.converter||L).toAttribute(e,o.type);this._doNotSyncAttributes.add(i),a==null?this.removeAttribute(i):this.setAttribute(i,a),this._doNotSyncAttributes.delete(i);}_getChildChangeListener(t){return this._childChangeListeners.has(t)||this._childChangeListeners.set(t,this._onChildChange.bind(this,t)),this._childChangeListeners.get(t)}_getSlotChangeListener(t){return this._slotChangeListeners.has(t)||this._slotChangeListeners.set(t,this._onSlotChange.bind(this,t)),this._slotChangeListeners.get(t)}_attachSlotChange(t,e,s){const n=this._getSlotChangeListener(e);t.addEventListener("slotchange",o=>{if(n.call(t,o),s){const i=this._slotsAssignedNodes.get(t);i&&i.forEach(a=>{if(y$5(a)){const u=this._getChildChangeListener(e);a.detachInvalidate.call(a,u);}});const r=s$b([t]);this._slotsAssignedNodes.set(t,r),r.forEach(a=>{if(y$5(a)){const u=this._getChildChangeListener(e);a.attachInvalidate.call(a,u);}});}});}_detachSlotChange(t,e){t.removeEventListener("slotchange",this._getSlotChangeListener(e));}_onSlotChange(t){g$4.call(this,{type:"slot",name:t,reason:"slotchange"});}onInvalidation(t){}updateAttributes(){const e=this.constructor.getMetadata().getProperties();for(const[s,n]of Object.entries(e))this._updateAttribute(s,this[s]);}_render(){const t=this.constructor,e=t.getMetadata().hasIndividualSlots();this.initializedProperties.size>0&&(Array.from(this.initializedProperties.entries()).forEach(([s,n])=>{delete this[s],this[s]=n;}),this.initializedProperties.clear()),this._suppressInvalidation=true;try{this.onBeforeRendering(),this._rendered||this.updateAttributes(),this._componentStateFinalizedEventProvider.fireEvent("componentStateFinalized");}finally{this._suppressInvalidation=false;}this._changedState=[],t._needsShadowDOM()&&s$9(this),this._rendered=true,e&&this._assignIndividualSlotsToChildren(),this.onAfterRendering();}_assignIndividualSlotsToChildren(){Array.from(this.children).forEach(e=>{e._individualSlot&&e.setAttribute("slot",e._individualSlot);});}_waitForDomRef(){return this._domRefReadyPromise}getDomRef(){if(typeof this._getRealDomRef=="function")return this._getRealDomRef();if(!(!this.shadowRoot||this.shadowRoot.children.length===0))return this.shadowRoot.children[0]}getFocusDomRef(){const t=this.getDomRef();if(t)return t.querySelector("[data-sap-focus-ref]")||t}async getFocusDomRefAsync(){return await this._waitForDomRef(),this.getFocusDomRef()}async focus(t){await this._waitForDomRef();const e=this.getFocusDomRef();e===this||!this.isConnected?HTMLElement.prototype.focus.call(this,t):e&&typeof e.focus=="function"&&e.focus(t);}fireEvent(t,e,s=false,n=true){const o=this._fireEvent(t,e,s,n),i=C$1(t);return i!==t?o&&this._fireEvent(i,e,s,n):o}fireDecoratorEvent(t,e){const s=this.getEventData(t),n=s?s.cancelable:false,o=s?s.bubbles:false,i=this._fireEvent(t,e,n,o),r=C$1(t);return r!==t?i&&this._fireEvent(r,e,n,o):i}_fireEvent(t,e,s=false,n=true){const o=new CustomEvent(`ui5-${t}`,{detail:e,composed:false,bubbles:n,cancelable:s}),i=this.dispatchEvent(o);if(a$6(t))return i;const r=new CustomEvent(t,{detail:e,composed:false,bubbles:n,cancelable:s});return this.dispatchEvent(r)&&i}getEventData(t){return this.constructor.getMetadata().getEvents()[t]}getSlottedNodes(t){return s$b(this[t])}attachComponentStateFinalized(t){this._componentStateFinalizedEventProvider.attachEvent("componentStateFinalized",t);}detachComponentStateFinalized(t){this._componentStateFinalizedEventProvider.detachEvent("componentStateFinalized",t);}get effectiveDir(){return n$k(this.constructor),r$8(this)}get isUI5Element(){return  true}get isUI5AbstractElement(){return !this.constructor._needsShadowDOM()}get classes(){return {}}get accessibilityInfo(){}static get observedAttributes(){return this.getMetadata().getAttributesList()}static get tagsToScope(){const t=this.getMetadata().getPureTag(),e=this.getUniqueDependencies().map(s=>s.getMetadata().getPureTag()).filter(i$g);return i$g(t)&&e.push(t),e}static _needsShadowDOM(){return !!this.template||Object.prototype.hasOwnProperty.call(this.prototype,"render")}static _generateAccessors(){const t=this.prototype,e=this.getMetadata().slotsAreManaged(),s=this.getMetadata().getProperties();for(const[n,o]of Object.entries(s)){r$7(n)||console.warn(`"${n}" is not a valid property name. Use a name that does not collide with DOM APIs`);const i=rt(t,n);let r;i?.set&&(r=i.set);let a;i?.get&&(a=i.get),Object.defineProperty(t,n,{get(){return a?a.call(this):this._state[n]},set(u){const v=this.constructor,l=a?a.call(this):this._state[n];if(l!==u){if(r?r.call(this,u):this._state[n]=u,g$4.call(this,{type:"property",name:n,newValue:u,oldValue:l}),this._rendered){const d=a?a.call(this):this._state[n];this._updateAttribute(n,d);}v.getMetadata().isFormAssociated()&&i$6(this);}}});}if(e){const n=this.getMetadata().getSlots();for(const[o,i]of Object.entries(n)){r$7(o)||console.warn(`"${o}" is not a valid property name. Use a name that does not collide with DOM APIs`);const r=i.propertyName||o,a={get(){return this._state[r]!==void 0?this._state[r]:[]},set(){throw new Error("Cannot set slot content directly, use the DOM APIs (appendChild, removeChild, etc...)")}};Object.defineProperty(t,r,a),r!==c$9(r)&&Object.defineProperty(t,c$9(r),a);}}}static{this.metadata={};}static{this.styles="";}static get dependencies(){return []}static cacheUniqueDependencies(){const t=this.dependencies.filter((e,s,n)=>n.indexOf(e)===s);M$1.set(this,t);}static getUniqueDependencies(){return M$1.has(this)||this.cacheUniqueDependencies(),M$1.get(this)||[]}static async onDefine(){return Promise.resolve()}static fetchI18nBundles(){return Promise.all(Object.entries(this.getMetadata().getI18n()).map(t=>{const{bundleName:e}=t[1];return f$6(e)}))}static fetchCLDR(){return this.getMetadata().needsCLDR()?g$5(s$5().getLanguage(),s$5().getRegion(),s$5().getScript()):Promise.resolve()}static{this.i18nBundleStorage={};}static get i18nBundles(){return this.i18nBundleStorage}static define(){const t=async()=>{await u$8();const o=await Promise.all([this.fetchI18nBundles(),this.fetchCLDR(),this.onDefine()]),[i]=o;Object.entries(this.getMetadata().getI18n()).forEach((r,a)=>{const u=r[1].bundleName;this.i18nBundleStorage[u]=i[a];}),this.asyncFinished=true;};this._definePromise=t();const e=this.getMetadata().getTag(),s=w$6(e),n=customElements.get(e);return n&&!s?$$2(e):n||(this._generateAccessors(),h$5(e),customElements.define(e,this)),this}static getMetadata(){if(this.hasOwnProperty("_metadata"))return this._metadata;const t=[this.metadata];let e=this;for(;e!==S;)e=Object.getPrototypeOf(e),t.unshift(e.metadata);const s=e$e({},...t);return this._metadata=new p$2(s),this._metadata}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}};const y$5=r$2("isUI5Element");
    ...
    function d$3(t){return (r,a)=>{const n=r.constructor;Object.prototype.hasOwnProperty.call(n,"metadata")||(n.metadata={});const o=n.metadata;o.slots||(o.slots={});const e=o.slots;if(t&&t.default&&e.default)throw new Error("Only one slot can be the default slot.");const l=t&&t.default?"default":a;t=t||{type:HTMLElement},t.type||(t.type=HTMLElement),e[l]||(e[l]=t),t.default&&(delete e.default.default,e.default.propertyName=a),n.metadata.managedSlots=true;}}

    var n$4,l$3,t$5,i$3,o$2,r$1,e$2,f$4,c$3,s$2,a$2,h,p={},v$2=[],y$4=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,d$2=Array.isArray;function w(n,l){for(var t in l)n[t]=l[t];return n}function _(n){n&&n.parentNode&&n.parentNode.removeChild(n);}function g$3(l,t,u){var i,o,r,e={};for(r in t)"key"==r?i=t[r]:"ref"==r?o=t[r]:e[r]=t[r];if(arguments.length>2&&(e.children=arguments.length>3?n$4.call(arguments,2):u),"function"==typeof l&&null!=l.defaultProps)for(r in l.defaultProps) void 0===e[r]&&(e[r]=l.defaultProps[r]);return m$2(l,e,i,o,null)}function m$2(n,u,i,o,r){var e={type:n,props:u,key:i,ref:o,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:null==r?++t$5:r,__i:-1,__u:0};return null==r&&null!=l$3.vnode&&l$3.vnode(e),e}function k$2(n){return n.children}function x$2(n,l){this.props=n,this.context=l;}function C(n,l){if(null==l)return n.__?C(n.__,n.__i+1):null;for(var t;l<n.__k.length;l++)if(null!=(t=n.__k[l])&&null!=t.__e)return t.__e;return "function"==typeof n.type?C(n):null}function S(n){var l,t;if(null!=(n=n.__)&&null!=n.__c){for(n.__e=n.__c.base=null,l=0;l<n.__k.length;l++)if(null!=(t=n.__k[l])&&null!=t.__e){n.__e=n.__c.base=t.__e;break}return S(n)}}function M(n){(!n.__d&&(n.__d=true)&&i$3.push(n)&&!P.__r++||o$2!==l$3.debounceRendering)&&((o$2=l$3.debounceRendering)||r$1)(P);}function P(){var n,t,u,o,r,f,c,s;for(i$3.sort(e$2);n=i$3.shift();)n.__d&&(t=i$3.length,o=void 0,f=(r=(u=n).__v).__e,c=[],s=[],u.__P&&((o=w({},r)).__v=r.__v+1,l$3.vnode&&l$3.vnode(o),F(u.__P,o,r,u.__n,u.__P.namespaceURI,32&r.__u?[f]:null,c,null==f?C(r):f,!!(32&r.__u),s),o.__v=r.__v,o.__.__k[o.__i]=o,z(c,o,s),o.__e!=f&&S(o)),i$3.length>t&&i$3.sort(e$2));P.__r=0;}function $(n,l,t,u,i,o,r,e,f,c,s){var a,h,y,d,w,_,g=u&&u.__k||v$2,m=l.length;for(f=I(t,l,g,f),a=0;a<m;a++)null!=(y=t.__k[a])&&(h=-1===y.__i?p:g[y.__i]||p,y.__i=a,_=F(n,y,h,i,o,r,e,f,c,s),d=y.__e,y.ref&&h.ref!=y.ref&&(h.ref&&V(h.ref,null,y),s.push(y.ref,y.__c||d,y)),null==w&&null!=d&&(w=d),4&y.__u||h.__k===y.__k?f=H(y,f,n):"function"==typeof y.type&&void 0!==_?f=_:d&&(f=d.nextSibling),y.__u&=-7);return t.__e=w,f}function I(n,l,t,u){var i,o,r,e,f,c=l.length,s=t.length,a=s,h=0;for(n.__k=[],i=0;i<c;i++)null!=(o=l[i])&&"boolean"!=typeof o&&"function"!=typeof o?(e=i+h,(o=n.__k[i]="string"==typeof o||"number"==typeof o||"bigint"==typeof o||o.constructor==String?m$2(null,o,null,null,null):d$2(o)?m$2(k$2,{children:o},null,null,null):void 0===o.constructor&&o.__b>0?m$2(o.type,o.props,o.key,o.ref?o.ref:null,o.__v):o).__=n,o.__b=n.__b+1,r=null,-1!==(f=o.__i=O(o,t,e,a))&&(a--,(r=t[f])&&(r.__u|=2)),null==r||null===r.__v?(-1==f&&h--,"function"!=typeof o.type&&(o.__u|=4)):f!==e&&(f==e-1?h--:f==e+1?h++:(f>e?h--:h++,o.__u|=4))):o=n.__k[i]=null;if(a)for(i=0;i<s;i++)null!=(r=t[i])&&0==(2&r.__u)&&(r.__e==u&&(u=C(r)),q(r,r));return u}function H(n,l,t){var u,i;if("function"==typeof n.type){for(u=n.__k,i=0;u&&i<u.length;i++)u[i]&&(u[i].__=n,l=H(u[i],l,t));return l}n.__e!=l&&(l&&n.type&&!t.contains(l)&&(l=C(n)),t.insertBefore(n.__e,l||null),l=n.__e);do{l=l&&l.nextSibling;}while(null!=l&&8===l.nodeType);return l}function O(n,l,t,u){var i=n.key,o=n.type,r=t-1,e=t+1,f=l[t];if(null===f||f&&i==f.key&&o===f.type&&0==(2&f.__u))return t;if(("function"!=typeof o||o===k$2||i)&&u>(null!=f&&0==(2&f.__u)?1:0))for(;r>=0||e<l.length;){if(r>=0){if((f=l[r])&&0==(2&f.__u)&&i==f.key&&o===f.type)return r;r--;}if(e<l.length){if((f=l[e])&&0==(2&f.__u)&&i==f.key&&o===f.type)return e;e++;}}return  -1}function T$2(n,l,t){"-"===l[0]?n.setProperty(l,null==t?"":t):n[l]=null==t?"":"number"!=typeof t||y$4.test(l)?t:t+"px";}function j(n,l,t,u,i){var o,r;n:if("style"===l)if("string"==typeof t)n.style.cssText=t;else {if("string"==typeof u&&(n.style.cssText=u=""),u)for(l in u)t&&l in t||T$2(n.style,l,"");if(t)for(l in t)u&&t[l]===u[l]||T$2(n.style,l,t[l]);}else if("o"===l[0]&&"n"===l[1])o=l!==(l=l.replace(f$4,"$1")),l=l.toLowerCase()in n||"onFocusOut"===l||"onFocusIn"===l?l.toLowerCase().slice(2):l.slice(2),n.l||(n.l={}),n.l[l+o]=t,t?u?t.t=u.t:(t.t=c$3,n.addEventListener(l,o?a$2:s$2,o)):n.removeEventListener(l,o?a$2:s$2,o);else {if("http://www.w3.org/2000/svg"==i)l=l.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if("width"!=l&&"height"!=l&&"href"!=l&&"list"!=l&&"form"!=l&&"tabIndex"!=l&&"download"!=l&&"rowSpan"!=l&&"colSpan"!=l&&"role"!=l&&"popover"!=l&&l in n)try{r=n.tagName&&n.tagName.includes("-"),/*t!==u&&*/(n[l]=null!=t||r?t:"");break n}catch(n){}"function"==typeof t||(null==t||false===t&&"-"!==l[4]?n.removeAttribute(l):n.setAttribute(l,"popover"==l&&1==t?"":t));}}function A$1(n){return function(t){if(this.l){var u=this.l[t.type+n];if(null==t.u)t.u=c$3++;else if(t.u<u.t)return;return u(l$3.event?l$3.event(t):t)}}}function F(n,t,u,i,o,r,e,f,c,s){var a,h,p,v,y,g,m,b,C,S,M,P,I,H,L,O,T,j=t.type;if(void 0!==t.constructor)return null;128&u.__u&&(c=!!(32&u.__u),r=[f=t.__e=u.__e]),(a=l$3.__b)&&a(t);n:if("function"==typeof j)try{if(b=t.props,C="prototype"in j&&j.prototype.render,S=(a=j.contextType)&&i[a.__c],M=a?S?S.props.value:a.__:i,u.__c?m=(h=t.__c=u.__c).__=h.__E:(C?t.__c=h=new j(b,M):(t.__c=h=new x$2(b,M),h.constructor=j,h.render=B),S&&S.sub(h),h.props=b,h.state||(h.state={}),h.context=M,h.__n=i,p=h.__d=!0,h.__h=[],h._sb=[]),C&&null==h.__s&&(h.__s=h.state),C&&null!=j.getDerivedStateFromProps&&(h.__s==h.state&&(h.__s=w({},h.__s)),w(h.__s,j.getDerivedStateFromProps(b,h.__s))),v=h.props,y=h.state,h.__v=t,p)C&&null==j.getDerivedStateFromProps&&null!=h.componentWillMount&&h.componentWillMount(),C&&null!=h.componentDidMount&&h.__h.push(h.componentDidMount);else {if(C&&null==j.getDerivedStateFromProps&&b!==v&&null!=h.componentWillReceiveProps&&h.componentWillReceiveProps(b,M),!h.__e&&(null!=h.shouldComponentUpdate&&!1===h.shouldComponentUpdate(b,h.__s,M)||t.__v===u.__v)){for(t.__v!==u.__v&&(h.props=b,h.state=h.__s,h.__d=!1),t.__e=u.__e,t.__k=u.__k,t.__k.some(function(n){n&&(n.__=t);}),P=0;P<h._sb.length;P++)h.__h.push(h._sb[P]);h._sb=[],h.__h.length&&e.push(h);break n}null!=h.componentWillUpdate&&h.componentWillUpdate(b,h.__s,M),C&&null!=h.componentDidUpdate&&h.__h.push(function(){h.componentDidUpdate(v,y,g);});}if(h.context=M,h.props=b,h.__P=n,h.__e=!1,I=l$3.__r,H=0,C){for(h.state=h.__s,h.__d=!1,I&&I(t),a=h.render(h.props,h.state,h.context),L=0;L<h._sb.length;L++)h.__h.push(h._sb[L]);h._sb=[];}else do{h.__d=!1,I&&I(t),a=h.render(h.props,h.state,h.context),h.state=h.__s;}while(h.__d&&++H<25);h.state=h.__s,null!=h.getChildContext&&(i=w(w({},i),h.getChildContext())),C&&!p&&null!=h.getSnapshotBeforeUpdate&&(g=h.getSnapshotBeforeUpdate(v,y)),f=$(n,d$2(O=null!=a&&a.type===k$2&&null==a.key?a.props.children:a)?O:[O],t,u,i,o,r,e,f,c,s),h.base=t.__e,t.__u&=-161,h.__h.length&&e.push(h),m&&(h.__E=h.__=null);}catch(n){if(t.__v=null,c||null!=r)if(n.then){for(t.__u|=c?160:128;f&&8===f.nodeType&&f.nextSibling;)f=f.nextSibling;r[r.indexOf(f)]=null,t.__e=f;}else for(T=r.length;T--;)_(r[T]);else t.__e=u.__e,t.__k=u.__k;l$3.__e(n,t,u);}else null==r&&t.__v===u.__v?(t.__k=u.__k,t.__e=u.__e):f=t.__e=N$1(u.__e,t,u,i,o,r,e,c,s);return (a=l$3.diffed)&&a(t),128&t.__u?void 0:f}function z(n,t,u){for(var i=0;i<u.length;i++)V(u[i],u[++i],u[++i]);l$3.__c&&l$3.__c(t,n),n.some(function(t){try{n=t.__h,t.__h=[],n.some(function(n){n.call(t);});}catch(n){l$3.__e(n,t.__v);}});}function N$1(t,u,i,o,r,e,f,c,s){var a,h,v,y,w,g,m,b,k=i.props,x=u.props,S=u.type;if("svg"===S?r="http://www.w3.org/2000/svg":"math"===S?r="http://www.w3.org/1998/Math/MathML":r||(r="http://www.w3.org/1999/xhtml"),null!=e)for(a=0;a<e.length;a++)if((w=e[a])&&"setAttribute"in w==!!S&&(S?w.localName===S:3===w.nodeType)){t=w,e[a]=null;break}if(null==t){if(null===S)return document.createTextNode(x);t=document.createElementNS(r,S,x.is&&x),c&&(l$3.__m&&l$3.__m(u,e),c=false),e=null;}if(null===S)k===x||c&&t.data===x||(t.data=x);else {if(e=e&&n$4.call(t.childNodes),k=i.props||p,!c&&null!=e)for(k={},a=0;a<t.attributes.length;a++)k[(w=t.attributes[a]).name]=w.value;for(a in k)if(w=k[a],"children"==a);else if("dangerouslySetInnerHTML"==a)v=w;else if(!(a in x)){if("value"==a&&"defaultValue"in x||"checked"==a&&"defaultChecked"in x)continue;j(t,a,null,w,r);}for(a in x)w=x[a],"children"==a?y=w:"dangerouslySetInnerHTML"==a?h=w:"value"==a?g=w:"checked"==a?m=w:c&&"function"!=typeof w||k[a]===w||((a.startsWith("on")||"ref"===a&&"function"==typeof w)&&(b=o[Object.keys(o)[0]])&&(w=w.bind(b.props.value)),j(t,a,w,k[a],r));if(h)c||v&&(h.__html===v.__html||h.__html===t.innerHTML)||(t.innerHTML=h.__html),u.__k=[];else if(v&&(t.innerHTML=""),$(t,d$2(y)?y:[y],u,i,o,"foreignObject"===S?"http://www.w3.org/1999/xhtml":r,e,f,e?e[0]:i.__k&&C(i,0),c,s),null!=e)for(a=e.length;a--;)_(e[a]);c||(a="value","progress"===S&&null==g?t.removeAttribute("value"):void 0!==g&&(g!==t[a]||"progress"===S&&!g||"option"===S&&g!==k[a])&&j(t,a,g,k[a],r),a="checked",void 0!==m&&m!==t[a]&&j(t,a,m,k[a],r));}return t}function V(n,t,u){try{if("function"==typeof n){var i="function"==typeof n.__u;i&&n.__u(),i&&null==t||(n.__u=n(t));}else n.current=t;}catch(n){l$3.__e(n,u);}}function q(n,t,u){var i,o;if(l$3.unmount&&l$3.unmount(n),(i=n.ref)&&(i.current&&i.current!==n.__e||V(i,null,t)),null!=(i=n.__c)){if(i.componentWillUnmount)try{i.componentWillUnmount();}catch(n){l$3.__e(n,t);}i.base=i.__P=null;}if(i=n.__k)for(o=0;o<i.length;o++)i[o]&&q(i[o],t,u||"function"!=typeof n.type);u||_(n.__e),n.__c=n.__=n.__e=void 0;}function B(n,l,t){return this.constructor(n,t)}function D$1(t,u,i){var o,r,e,f;u===document&&(u=document.documentElement),l$3.__&&l$3.__(t,u),r=(o="function"==typeof i)?null:i&&i.__k||u.__k,e=[],f=[],F(u,t=(!o&&i||u).__k=g$3(k$2,null,[t]),r||p,p,u.namespaceURI,!o&&i?[i]:r?null:u.firstChild?n$4.call(u.childNodes):null,e,!o&&i?i:r?r.__e:u.firstChild,o,f),z(e,t,f);}function E$1(n,l){D$1(n,l,E$1);}function J(n,l){var t={__c:l="__cC"+h++,__:n,Consumer:function(n,l){return n.children(l)},Provider:function(n){var t,u;return this.getChildContext||(t=new Set,(u={})[l]=this,this.getChildContext=function(){return u},this.componentWillUnmount=function(){t=null;},this.shouldComponentUpdate=function(n){this.props.value!==n.value&&t.forEach(function(n){n.__e=true,M(n);});},this.sub=function(n){t.add(n);var l=n.componentWillUnmount;n.componentWillUnmount=function(){t&&t.delete(n),l&&l.call(n);};}),n.children}};return t.Provider.__=t.Consumer.contextType=t}n$4=v$2.slice,l$3={__e:function(n,l,t,u){for(var i,o,r;l=l.__;)if((i=l.__c)&&!i.__)try{if((o=i.constructor)&&null!=o.getDerivedStateFromError&&(i.setState(o.getDerivedStateFromError(n)),r=i.__d),null!=i.componentDidCatch&&(i.componentDidCatch(n,u||{}),r=i.__d),r)return i.__E=i}catch(l){n=l;}throw n}},t$5=0,x$2.prototype.setState=function(n,l){var t;t=null!=this.__s&&this.__s!==this.state?this.__s:this.__s=w({},this.state),"function"==typeof n&&(n=n(w({},t),this.props)),n&&w(t,n),null!=n&&this.__v&&(l&&this._sb.push(l),M(this));},x$2.prototype.forceUpdate=function(n){this.__v&&(this.__e=true,n&&this.__h.push(n),M(this));},x$2.prototype.render=k$2,i$3=[],r$1="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,e$2=function(n,l){return n.__v.__b-l.__v.__b},P.__r=0,f$4=/(PointerCapture)$|Capture$/i,c$3=0,s$2=A$1(false),a$2=A$1(true),h=0;

    var f$3=0;function u$3(e,t,n,o,i,u){t||(t={});var a,c,l=t;"ref"in t&&(a=t.ref,delete t.ref);var p={type:e,props:l,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:--f$3,__i:-1,__u:0,__source:i,__self:u};if("function"==typeof e&&(a=e.defaultProps))for(c in a) void 0===l[c]&&(l[c]=a[c]);return l$3.vnode&&l$3.vnode(p),p}

    const l$2=new WeakMap,y$3=(e,r)=>{let t=l$2.get(e);t||(t=J(e),l$2.set(e,t));const m=e.render(),o=u$3(t.Provider,{value:e,children:m});e.__shouldHydrate?(e.shadowRoot?.querySelectorAll("style").forEach(d=>d.remove()),E$1(o,r),e.__shouldHydrate=false):D$1(o,r);};
    ...
    const u$2=o=>{let i,a,r,d,n,s,p,g,e,l,y,m;const h=f$2({beforeStart:()=>{const t=o;i=getComputedStyle(t),a=parseFloat(i.paddingTop),r=parseFloat(i.paddingBottom),d=parseFloat(i.marginTop),n=parseFloat(i.marginBottom),s=parseFloat(i.height),p=t.style.overflow,g=t.style.paddingTop,e=t.style.paddingBottom,l=t.style.marginTop,y=t.style.marginBottom,m=t.style.height,t.style.overflow="hidden";},duration:v$1,element:o,advance:t=>{o.style.paddingTop=`${a-a*t}px`,o.style.paddingBottom=`${r-r*t}px`,o.style.marginTop=`${d-d*t}px`,o.style.marginBottom=`${n-n*t}px`,o.style.height=`${s-s*t}px`;}});return h.promise().then(t=>{t instanceof Error||(o.style.overflow=p,o.style.paddingTop=g,o.style.paddingBottom=e,o.style.marginTop=l,o.style.marginBottom=y,o.style.height=m,o.style.display="none");}),h};

    const y$2={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32},b$1=o=>(o.key?o.key==="Enter":o.keyCode===y$2.ENTER)&&!a(o),A=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$2.SPACE)&&!a(o),K=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$2.SPACE)&&e$1(o,false,false,true),m$1=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$2.ESCAPE)&&!a(o),x$1=o=>(o.key?o.key==="Tab":o.keyCode===y$2.TAB)&&!a(o),Ko=o=>o.key==="Shift"||o.keyCode===y$2.SHIFT,a=o=>o.shiftKey||o.altKey||k$1(o),k$1=o=>!!(o.metaKey||o.ctrlKey),e$1=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k$1(o)===r;

    let n$3;i$d(()=>{n$3=void 0;});const d$1=()=>(n$3===void 0&&(n$3=y$9()),n$3);
    ...
    function o$1(t){let r="";for(const n in t)t[n]&&(r&&(r+=" "),r+=n);return r}

    function g$2(e,t,o){const n=e.getMetadata().getEvents();Object.keys(t).forEach(s=>{if(s.startsWith("on")){const a=s.slice(2),c=p$3(a),l=a.charAt(0).toLowerCase()+a.slice(1);let i;c in n?i=c:l in n&&(i=l),i&&s!=="onClick"&&(t[`onui5-${i}`]=t[s],delete t[s]);}});}function isUI5ElementClass(e){return typeof e=="function"&&"getMetadata"in e}function preprocess(e,t,o){let n;return isUI5ElementClass(e)?(n=e.getMetadata().getTag(),g$2(e,t)):n=e,typeof t.class=="object"&&(t.class=o$1(t.class)),n}
    ...
    const b=new WeakMap,o=new WeakMap,v={attributes:true,childList:true,characterData:true,subtree:true},E=e=>{const t=e.accessibleNameRef?.split(" ")??[];let s="";return t.forEach((n,c)=>{const l=m(e,n),a=`${l&&l.textContent?l.textContent:""}`;a&&(s+=a,c<t.length-1&&(s+=" "));}),s},f$1=e=>{const t=new Set;u$1(e).forEach(r=>{t.add(r);});const n=e.accessibleNameRef,c=e.accessibleDescriptionRef,l=[n,c].filter(Boolean).join(" ");return (l?l.split(" "):[]).forEach(r=>{const i=m(e,r);i&&t.add(i);}),Array.from(t)},u$1=e=>{const t=e.getRootNode().querySelectorAll(`[for="${e.id}"]`);return Array.from(t)},m=(e,t)=>e.getRootNode().querySelector(`[id='${t}']`)||document.getElementById(t),k=e=>s=>{const n=s&&s.type==="property"&&s.name==="accessibleNameRef",c=s&&s.type==="property"&&s.name==="accessibleDescriptionRef";if(!n&&!c)return;const l=o.get(e);if(!l)return;const a=l.observedElements,r=f$1(e);a.forEach(i=>{r.includes(i)||d(l,i);}),r.forEach(i=>{a.includes(i)||(g$1(l,i),l.observedElements.push(i));}),l?.callback();},y$1=(e,t)=>{if(o.has(e))return;const s=f$1(e),n=k(e),c={host:e,observedElements:s,callback:t,invalidationCallback:n};o.set(e,c),e.attachInvalidate(n),s.forEach(l=>{g$1(c,l);}),t();},g$1=(e,t)=>{let s=b.get(t);if(!s){s={observer:null,callbacks:[]};const n=new MutationObserver(()=>{s.callbacks.forEach(a=>{a();});const l=document.getElementById(t.id);e.host.id===t.getAttribute("for")||l||d(e,t);});s.observer=n,n.observe(t,v),b.set(t,s);}s.callbacks.includes(e.callback)||s.callbacks.push(e.callback);},d=(e,t)=>{const s=b.get(t);s&&(s.callbacks=s.callbacks.filter(n=>n!==e.callback),s.callbacks.length||(s.observer?.disconnect(),b.delete(t))),e.observedElements=e.observedElements.filter(n=>n!==t);},T$1=e=>{const t=o.get(e);if(!t)return;[...t.observedElements].forEach(n=>{d(t,n);}),e.detachInvalidate(t.invalidationCallback),o.delete(e);};
    ...
    var t$2=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$2||{});const s$1=new Map;s$1.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$1.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$1.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$2=(n,e)=>{if(s$1.has(n)){s$1.set(n,{...e,...s$1.get(n)});return}s$1.set(n,e);},r=n=>{const e=m$8()?"legacy":"sap_horizon";return s$1.has(n)?s$1.get(n)[e]:n};

    const t$1=new Map,c$1=n=>t$1.get(n);

    const i$1=o=>{const t=c$1(r$d());return !o&&t?n$2(t):o?r(o):r("SAP-icons")};

    const T="legacy",s=new Map,c=m$f("SVGIcons.registry",new Map),i=m$f("SVGIcons.promises",new Map),l$1="ICON_NOT_FOUND",N=async e=>{if(!i.has(e)){if(!s.has(e))throw new Error(`No loader registered for the ${e} icons collection. Probably you forgot to import the "AllIcons.js" module for the respective package.`);const t=s.get(e);i.set(e,t(e));}return i.get(e)},f=e=>{Object.keys(e.data).forEach(t=>{const o=e.data[t];y(t,{pathData:o.path||o.paths,ltr:o.ltr,viewBox:o.viewBox,accData:o.acc,collection:e.collection,packageName:e.packageName});});},y=(e,t)=>{const o=`${t.collection}/${e}`,a={collection:t.collection,packageName:t.packageName,pathData:t.pathData,viewBox:t.viewBox,ltr:t.ltr,accData:t.accData,customTemplate:t.customTemplate};c.set(o,a);},u=e=>{e.startsWith("sap-icon://")&&(e=e.replace("sap-icon://",""));let t;return [e,t]=e.split("/").reverse(),e=e.replace("icon-",""),t&&(t=n$2(t)),{name:e,collection:t}},D=e=>{const{name:t,collection:o}=u(e);return g(o,t)},n$1=async e=>{const{name:t,collection:o}=u(e);let a=l$1;try{a=await N(i$1(o));}catch(r){console.error(r.message);}if(a===l$1)return a;const p=g(o,t);return p||(Array.isArray(a)?a.forEach(r=>{f(r),c$2(o,{[r.themeFamily||T]:r.collection});}):f(a),g(o,t))},g=(e,t)=>{const o=`${i$1(e)}/${t}`;return c.get(o)},x=async e=>{if(!e)return;let t=D(e);if(t||(t=await n$1(e)),t&&t!==l$1&&t.accData)return t.packageName?(await f$6(t.packageName)).getText(t.accData):t.accData?.defaultText||""};
    ...
    let e;const l=()=>(e===void 0&&(e=b$7()),e);
...
`;
    ...
    f$d("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    f$d("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme, "host");
...
`;
     ...
     * @public
     */
    let Icon = Icon_1 = class Icon extends S$1 {
        constructor() {
            super(...arguments);
            /**
        ...
        _onkeyup(e) {
            if (this.mode === IconMode$1.Interactive && A(e)) {
                this.fireDecoratorEvent("click");
            }
        }
        /**
        ...
        */
        ...
        async onBeforeRendering() {
            ...
            if ("customTemplate" in iconData && iconData.customTemplate) {
                this.customTemplate = n$b(iconData.customTemplate, this);
            }
            ...
            if (this.accessibleName) {
                ...
                if (this.packageName) {
                    const i18nBundle = await f$6(this.packageName);
    ...
    __decorate$4([
        s$3({ type: Array, noAttribute: true })
...
`;
     ...
     */
    let Label = Label_1 = class Label extends S$1 {
        constructor() {
            super(...arguments);
            /**
...
`;
     ...
     * @since 0.12.0
     */
    let BusyIndicator = BusyIndicator_1 = class BusyIndicator extends S$1 {
        constructor() {
            super();
            /**
...
`;
     ...
     * @public
     */
    let Button = Button_1 = class Button extends S$1 {
        constructor() {
            super();
            /**
        ...
        onEnterDOM() {
            ...
            y$1(this, this._updateAccessibleNameRefTexts.bind(this));
        }
        _updateAccessibleNameRefTexts() {
            this._accessibleNameRefTexts = E(this);
        }
        onExitDOM() {
            if (this._clickHandlerAttached) {
        ...
        _onkeyup(e) {
            const isSpaceKey = A(e);
            const isCancelKey = Ko(e) || m$1(e);
            if (isSpaceKey || K(e)) {
    ...
    __decorate$1([
        d$3({ type: Node, "default": true })
    ], Button.prototype, "text", void 0);
    __decorate$1([
        d$3({ type: HTMLElement, invalidateOnChildChange: true })
    ...
    const pathData$1 = "M5.178 2.87c-.237-.228-.237-.466 0-.715A.445.445 0 0 1 5.505 2c.119 0 .228.052.327.155l4.9 5.13c.179.207.268.446.268.715 0 .27-.09.497-.267.684l-4.901 5.16A.46.46 0 0 1 5.49 14a.46.46 0 0 1-.341-.155.503.503 0 0 1 0-.716L9.9 8.155c.119-.103.119-.217 0-.342L5.178 2.87Z";
    const ltr$1 = false;
    const viewBox$1 = "0 0 16 16";
    const collection$1 = "SAP-icons-v4";
    const packageName$1 = "@ui5/webcomponents-icons";

    y(name$1, { pathData: pathData$1, ltr: ltr$1, viewBox: viewBox$1, collection: collection$1, packageName: packageName$1 });
    ...
    y(name, { pathData, ltr, viewBox, collection, packageName });
...
`;
    ...
    let Panel$1 = Panel_1 = class Panel extends S$1 {
        ...
        get shouldNotAnimate() {
            return this.noAnimation || d$1() === u$d.None;
        }
        _isMobile() {
            if (l$a()) {
                this._touched = true;
        ...
        _toggleOpen() {
            ...
            [].forEach.call(elements, oElement => {
                if (this.collapsed) {
                    animations.push(u$2(oElement).promise());
                }
                else {
                    animations.push(b$2(oElement).promise());
                }
            });
    ...
    __decorate([
        s$3({ type: Boolean, noAttribute: true })
    ], Panel$1.prototype, "_pendingToggle", void 0);
    __decorate([
        s$3({ type: Boolean })
    ], Panel$1.prototype, "_touched", void 0);
    __decorate([
        d$3()
