sap.ui.define((function () { 'use strict';
    ...
    var c$h={},e$h=c$h.hasOwnProperty,a$f=c$h.toString,o$g=e$h.toString,l$i=o$g.call(Object),i$l=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$h.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$g.call(n)===l$i):true)};

    var c$g=Object.create(null),u$e=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$g;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$l(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$l(n)?n:{},r[a]=u$e(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

    const e$g=function(n,t){return u$e(true,false,...arguments)};
    ...
    const u$d=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$h=()=>typeof document>"u"?null:o$f('meta[name="ui5-shared-resources"]',document.head,u$d),m$e=(t,o)=>{const r=t.split(".");let e=l$h();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

    const g$b=m$e("Tags",new Map),d$b=new Set;let i$j=new Map,c$f;const m$d=-1,h$6=e=>{d$b.add(e),g$b.set(e,I$3());},w$8=e=>d$b.has(e),T$3=()=>[...d$b.values()],$$2=e=>{let n=g$b.get(e);n===void 0&&(n=m$d),i$j.has(n)||i$j.set(n,new Set),i$j.get(n).add(e),c$f||(c$f=setTimeout(()=>{y$a(),i$j=new Map,c$f=void 0;},1e3));},y$a=()=>{const e=$$1(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$j.keys()].forEach(s=>{let o,r;s===m$d?(o=1,r={description:"Older unknown runtime"}):(o=b$7(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
    ...
    let s$o,t$m={include:[/^ui5-/],exclude:[]};const o$e=new Map,c$e=()=>s$o,m$c=()=>t$m,i$i=e=>{if(!o$e.has(e)){const n=t$m.include.some(r=>e.match(r))&&!t$m.exclude.some(r=>e.match(r));o$e.set(e,n);}return o$e.get(e)},d$a=e=>{if(i$i(e))return c$e()};

    let i$h,s$n="";const u$c=new Map,r$l=m$e("Runtimes",[]),x$2=()=>{if(i$h===void 0){i$h=r$l.length;const e=e$f;r$l.push({...e,get scopingSuffix(){return c$e()},get registeredTags(){return T$3()},get scopingRules(){return m$c()},alias:s$n,description:`Runtime ${i$h} - ver ${e.version}${""}`});}},I$3=()=>i$h,b$7=(e,m)=>{const o=`${e},${m}`;if(u$c.has(o))return u$c.get(o);const t=r$l[e],n=r$l[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$c.set(o,l),l},$$1=()=>r$l;

    const g$a=typeof document>"u",i$g=(e,t)=>t?`${e}|${t}`:e,l$g=e=>e===void 0?true:b$7(I$3(),parseInt(e))>=1,c$d=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$g(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$9=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$g(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$g(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$a?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$g(e,t)),f$d=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$g(e,t));},R$1=(e,t,r="",s)=>{S$4(t,r)?y$9(e,t,r,s):c$d(e,t,r,s);},m$b=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

    const e$e=new Map,n$n=t=>e$e.get(t);
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
    ...
    const _$2={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$d=_$2.themes.default,s$m=_$2.themes.all,a$e=_$2.languages.default,r$k=_$2.locales.default,l$f=_$2.locales.all;

    const o$d=typeof document>"u",n$l={search(){return o$d?"":window.location.search}},s$l=()=>o$d?"":window.location.href,u$b=()=>n$l.search();

    const s$k=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$c=e=>{const t=s$k("sap-allowed-theme-origins")??s$k("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$d=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$9=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$l()).toString();else {const n=new URL(e),r=n.origin;r&&o$c(r)?t=n.toString():t=a$d(n.toString(),s$l());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};

    var u$a=(l=>(l.Full="full",l.Basic="basic",l.Minimal="minimal",l.None="none",l))(u$a||{});

    const e$c=new i$k,t$l="configurationReset",i$f=n=>{e$c.attachEvent(t$l,n);};

    let p$5=false,t$k={animationMode:u$a.Full,theme:e$d,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$3=()=>(o$b(),t$k.animationMode),T$2=()=>(o$b(),t$k.theme),S$3=()=>{if(o$b(),t$k.themeRoot!==void 0){if(!g$9(t$k.themeRoot)){console.warn(`The ${t$k.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$k.themeRoot}},L$4=()=>(o$b(),t$k.language),R=()=>(o$b(),t$k.fetchDefaultLanguage),F$1=()=>(o$b(),t$k.noConflict),U$2=()=>(o$b(),t$k.defaultFontLoading),b$6=()=>(o$b(),t$k.enableDefaultTooltips),i$e=new Map;i$e.set("true",true),i$e.set("false",false);const w$7=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$k=e$g(t$k,e));}},z$1=()=>{const n=new URLSearchParams(u$b());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$8(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$8(r,e,"sap-ui");});},E$4=n=>{const e=n.split("@")[1];return g$9(e)},P$2=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$8=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$e.has(e)&&(e=i$e.get(a)),s==="theme"?(t$k.theme=P$2(s,e),e&&e.includes("@")&&(t$k.themeRoot=E$4(e))):t$k[s]=e;},j$1=()=>{const n=n$n("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$k=e$g(t$k,e);},o$b=()=>{typeof document>"u"||p$5||(l$e(),p$5=true);},l$e=n=>{w$7(),z$1(),j$1();};

    let o$a;i$f(()=>{o$a=void 0;});const a$c=()=>(o$a===void 0&&(o$a=U$2()),o$a);

    const a$b=()=>{const t=n$n("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$c();},f$c=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$c()||t||S$4("data-ui5-font-face")||c$d(n$m,"data-ui5-font-face");};
    ...
    const s$i=()=>{S$4("data-ui5-scrollbar-styles")||c$d(t$j,"data-ui5-scrollbar-styles");};
    ...
    const t$i=new Set,n$k=e=>{t$i.add(e);},r$i=e=>t$i.has(e);

    const s$h=new Set,d$9=new i$k,n$j=new l$d;let t$h,a$a,m$a,i$d;const l$c=async e=>{n$j.add(e),await P$1();},c$c=e=>{d$9.fireEvent("beforeComponentRender",e),s$h.add(e),e._render();},h$5=e=>{n$j.remove(e),s$h.delete(e);},P$1=async()=>{i$d||(i$d=new Promise(e=>{window.requestAnimationFrame(()=>{n$j.process(c$c),i$d=null,e(),m$a||(m$a=setTimeout(()=>{m$a=void 0,n$j.isEmpty()&&U$1();},200));});})),await i$d;},y$8=()=>t$h||(t$h=new Promise(e=>{a$a=e,window.requestAnimationFrame(()=>{n$j.isEmpty()&&(t$h=void 0,e());});}),t$h),I$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$b=async()=>{await I$2(),await y$8();},U$1=()=>{n$j.isEmpty()&&a$a&&(a$a(),a$a=void 0,t$h=void 0);},C$2=async e=>{s$h.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$b();};

    const t$g=new i$k,r$h="themeRegistered",n$i=e=>{t$g.attachEvent(r$h,e);},s$g=e=>t$g.fireEvent(r$h,e);

    const l$b=new Map,T$1=new Map,h$4=new Map,u$9=new Map,a$9=new Set,f$a=(e,r,t,s="root")=>{T$1.set(`${e}/${r}`,t),u$9.set(e,{cssVariablesTarget:s}),a$9.add(r),s$g(r);},L$3=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$b.get(s);if(o!==void 0)return o;if(!a$9.has(r)){const p=[...a$9.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$d}. Registered themes are: ${p}`),c$b(e,e$d)}const[n,g]=await Promise.all([c$b(e,r),t?c$b(e,t,true):void 0]),i=m$b(n,g);return i&&l$b.set(s,i),i},c$b=async(e,r,t=false)=>{const o=(t?h$4:T$1).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$9=()=>u$9,w$6=e=>a$9.has(e);

    const r$g=new Set,s$f=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$9=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$8=()=>{const e=s$f();if(!e||e==="none")return;const t=o$9(e);if(t)return d$8(t)};

    const t$f=new i$k,d$7="themeLoaded",r$f=e=>t$f.fireEvent(d$7,e);
    ...
    let t$e;i$f(()=>{t$e=void 0;});const n$h=()=>(t$e===void 0&&(t$e=S$3()),t$e),u$8=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$c=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$6(u$8(e),{"sap-ui-webcomponents-theme":e});};

    const t$d=new Map;let e$b;const n$g=()=>(e$b||(e$b=new CSSStyleSheet),e$b),r$e=(o,s)=>{t$d.set(o,s);const S=Array.from(t$d.values()).join(`
`);n$g().replaceSync(S);};

    let _lib="ui5",_package="webcomponents-theming";const a$8="@"+_lib+"/"+_package,E$3=()=>m$9().has(a$8),U=async e=>{if(!E$3())return;const t=await L$3(a$8,e);t&&R$1(t,"data-ui5-theme-properties",a$8,e);},w$5=()=>{f$d("data-ui5-theme-properties",a$8);},I$1=async(e,t)=>{const o=[...m$9().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$8)return;const i=await L$3(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$e(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$8();if(t)return t;const r=n$n("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$c(e),m$8()},b$5=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U(e):w$5();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$6(e)?e:o||e$d;await I$1(s,r),w$4(o),r$f(e);};

    let t$c,n$f;i$f(()=>{t$c=void 0;});const r$d=()=>(t$c===void 0&&(t$c=T$2()),t$c),i$b=()=>{const e=r$d();return y$7(e)?!e.startsWith("sap_horizon"):!m$8()?.baseThemeName?.startsWith("sap_horizon")},y$7=e=>s$m.includes(e),E$2=()=>n$f,w$4=e=>{n$f=e;};

    const t$b=typeof document>"u",e$a={get userAgent(){return t$b?"":navigator.userAgent},get touch(){return t$b?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$a.userAgent)},get firefox(){return t$b?false:/Firefox/.test(e$a.userAgent)},get safari(){return t$b?false:!e$a.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$a.userAgent)},get webkit(){return t$b?false:/webkit/.test(e$a.userAgent)},get windows(){return t$b?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$b?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$a.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$b?false:!e$a.windows&&/Android/.test(e$a.userAgent)},get androidPhone(){return t$b?false:e$a.android&&/(?=android)(?=.*mobile)/i.test(e$a.userAgent)},get ipad(){return t$b?false:/ipad/i.test(e$a.userAgent)||/Macintosh/i.test(e$a.userAgent)&&"ontouchend"in document},_isPhone(){return u$7(),e$a.touch&&!r$c}};let o$8,i$a,r$c;const s$e=()=>{if(t$b||!e$a.windows)return  false;if(o$8===void 0){const n=e$a.userAgent.match(/Windows NT (\d+).(\d)/);o$8=n?parseFloat(n[1]):0;}return o$8>=8},c$a=()=>{if(t$b||!e$a.webkit)return  false;if(i$a===void 0){const n=e$a.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$7=()=>{if(t$b)return  false;if(r$c===void 0){if(e$a.ipad){r$c=true;return}if(e$a.touch){if(s$e()){r$c=true;return}if(e$a.chrome&&e$a.android){r$c=!/Mobile Safari\/[.0-9]+/.test(e$a.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$a.android&&c$a()&&(n=1),r$c=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$c=e$a.userAgent.indexOf("Touch")!==-1||e$a.android&&!e$a.androidPhone;}},l$a=()=>e$a.touch,h$3=()=>e$a.safari,a$7=()=>(u$7(),(e$a.touch||s$e())&&r$c),d$5=()=>e$a._isPhone(),f$9=()=>t$b?false:!a$7()&&!d$5()||s$e(),w$3=()=>e$a.iOS;

    let t$a=false;const i$9=()=>{h$3()&&w$3()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

    let r$b=false,i$8,p$4=false;const m$7=new i$k,f$8=async()=>{const t=n$n("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$n("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$9=()=>{if(p$4)return;const t=n$n("OpenUI5Support");t&&(p$4=t.attachListeners());},u$6=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(x$2(),typeof document>"u"){e();return}n$i(b$4),await f$8(),await d$c(),await b$5(r$d()),c$9(),a$b(),r$j(),s$i(),i$9(),e(),r$b=true,m$7.fireEvent("boot");};return i$8=new Promise(t),i$8},b$4=t=>{if(!r$b)return;const e=r$d(),o=E$2();(t===e||t===o)&&b$5(e);};

    const s$d=new Map,o$7=new Map,n$e=new Map,c$8=e=>{if(!s$d.has(e)){const a=b$3(e.split("-"));s$d.set(e,a);}return s$d.get(e)},l$9=e=>{if(!o$7.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$7.set(e,a);}return o$7.get(e)},p$3=e=>l$9(e),b$3=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$1=e=>{const a=n$e.get(e);if(a)return a;const t=c$8(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$e.set(e,r),r};
    ...
    const s$a=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[n$g(),...s$b(e)],e.renderer(o,t);};

    const r$9=[],o$5=t=>r$9.some(s=>t.startsWith(s));

    const t$9=new WeakMap,n$b=(e,o,r)=>{const s=new MutationObserver(o);t$9.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$9.get(e);o&&(o.disconnect(),t$9.delete(e));};

    const c$6=["value-changed","click"];let e$6;i$f(()=>{e$6=void 0;});const s$9=t=>c$6.includes(t),l$7=t=>{const n=o$4();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$4=()=>(e$6===void 0&&(e$6=F$1()),e$6),a$6=t=>{const n=o$4();return s$9(t)?false:n===true?true:!l$7(t)};
    ...
    const s$7=t=>{o$3(t)&&i$6(t);},i$6=t=>{if(t._internals?.form){if(e$5(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},e$5=async t=>{if(!(!t.isUI5Element||!t._internals?.form))if(t._internals.setValidity({customError:true}," "),await t.definePromise,t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},m$6=async t=>{const r=[...t._internals?.form?.elements??[]];await Promise.all(r.map(n=>o$3(n)?e$5(n):Promise.resolve())),t._internals?.form?.requestSubmit();},a$5=t=>{t._internals?.form?.reset();},o$3=t=>"formFormattedValue"in t&&"name"in t;

    const t$8=typeof document>"u",o$2=()=>{if(t$8)return a$e;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$e};

    const e$4=new i$k,n$8="languageChange",t$7=a=>{e$4.attachEvent(n$8,a);};

    let e$3,t$6;i$f(()=>{e$3=void 0,t$6=void 0;});let a$4=false;const s$6=()=>a$4,l$6=()=>(e$3===void 0&&(e$3=L$4()),e$3),h$2=()=>(t$6===void 0&&(t$6=R()),t$6);
    ...
    const r$5=new Map,n$6=t=>(r$5.has(t)||r$5.set(t,new r$6(t)),r$5.get(t)),c$5=t=>{try{if(t&&typeof t=="string")return n$6(t)}catch{}return new r$6(r$k)},s$5=t=>{const e=l$6();return e?n$6(e):c$5(o$2())};

    const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$4=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$7={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$1=i=>{let e;if(!i)return r$k;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$7[t]||t,o&&(e=c$4.exec(o))||r&&(e=c$4.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$k};

    const r$4={zh_HK:"zh_TW",in:"id"},n$5=t=>{if(!t)return r$k;if(r$4[t])return r$4[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$k?r$k:""};

    const d$4=new Set,m$5=new Set,g$6=new Map,l$5=new Map,u$5=new Map,f$6=(n,t)=>{g$6.set(n,t);},A$4=n=>g$6.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$5.get(e)&&l$5.set(e,r(t)),l$5.get(e)},M$2=n=>{d$4.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$4.add(n));},L$2=(n,t)=>t!==a$e&&!h$1(n,t),w$2=async n=>{const t=s$5().getLanguage(),e=s$5().getRegion(),r=s$5().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$2(n,s))for(s=p$1(s);L$2(n,s);)s=n$5(s);const I=h$2();if(s===a$e&&!I){f$6(n,null);return}if(!h$1(n,s)){M$2(n);return}try{const o=await B$1(n,s);f$6(n,o);}catch(o){const a=o;m$5.has(a.message)||(m$5.add(a.message),console.error(a.message));}};t$7(n=>{const t=[...g$6.keys()];return Promise.all(t.map(w$2))});
    ...
    let n$3;i$f(()=>{n$3=void 0;});const d=()=>(n$3===void 0&&(n$3=C$3()),n$3);
...
`;
    ...
    f$a("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    f$a("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme, "host");
