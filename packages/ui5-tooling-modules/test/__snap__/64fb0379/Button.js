...
`;
    ...
    webcomponents.f$2("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    webcomponents.f$2("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme, "host");
...
`;
     ...
     * @public
     */
    let Icon = Icon_1 = class Icon extends webcomponents.S {
        constructor() {
            super(...arguments);
            /**
        ...
        */
        ...
        async onBeforeRendering() {
            ...
            let iconData = webcomponents.D$1(name);
            if (!iconData) {
    ...
    __decorate$3([
        Keys.d({ type: HTMLElement })
    ], Icon.prototype, "fontIcon", void 0);
    __decorate$3([
        Keys.s({ type: Array, noAttribute: true })
...
`;
     ...
     */
    let Label = Label_1 = class Label extends webcomponents.S {
        constructor() {
            super(...arguments);
            /**
...
`;
     ...
     * @since 0.12.0
     */
    let BusyIndicator = BusyIndicator_1 = class BusyIndicator extends webcomponents.S {
        constructor() {
            super();
            /**
...
`;
     ...
     * @public
     */
    let Button = Button_1 = class Button extends webcomponents.S {
        constructor() {
            super();
            /**
        ...
        onEnterDOM() {
            ...
            y(this, this._updateAccessibleNameRefTexts.bind(this));
        }
        ...
        _onclick(e) {
            ...
            if (this._isSubmit) {
                webcomponents.l$4(this);
            }
            if (this._isReset) {
                webcomponents.u$2(this);
            }
            if (webcomponents.h()) {
        ...
        _onkeyup(e) {
            const isSpaceKey = Keys.A(e);
            const isCancelKey = Keys.Ko(e) || Keys.m$1(e);
            if (isSpaceKey || Keys.K(e)) {
        ...
        getDefaultTooltip() {
            ...
            return webcomponents.x(this.icon);
        }
        get buttonTypeText() {
