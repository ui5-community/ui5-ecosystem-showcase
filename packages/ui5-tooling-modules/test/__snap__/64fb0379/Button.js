sap.ui.define(['./webcomponents', './Keys'], (function (webcomponents, Keys) { 'use strict';
    ...
    let e;const l=()=>(e===void 0&&(e=webcomponents.b$2()),e);
    ...
    function g(e,t,o){const n=e.getMetadata().getEvents();Object.keys(t).forEach(s=>{if(s.startsWith("on")){const a=s.slice(2),c=webcomponents.p$2(a),l=a.charAt(0).toLowerCase()+a.slice(1);let i;c in n?i=c:l in n&&(i=l),i&&s!=="onClick"&&(t[`onui5-${i}`]=t[s],delete t[s]);}});}function isUI5ElementClass(e){return typeof e=="function"&&"getMetadata"in e}function preprocess(e,t,o$1){let n;return isUI5ElementClass(e)?(n=e.getMetadata().getTag(),g(e,t)):n=e,typeof t.class=="object"&&(t.class=o(t.class)),n}
...
`;
    ...
    webcomponents.p("@" + "ui5" + "/" + "webcomponents-theming", "sap_horizon", async () => defaultThemeBase);
    webcomponents.p("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", "sap_horizon", async () => defaultTheme);
...
`;
     ...
     * @public
     */
    let Icon = class Icon extends webcomponents.b {
        constructor() {
            super(...arguments);
            /**
        ...
        _onkeyup(e) {
            if (this.mode === IconMode$1.Interactive && Keys.A(e)) {
                this.fireDecoratorEvent("click");
            }
        }
        /**
        ...
        */
        ...
        async onBeforeRendering() {
            ...
            let iconData = webcomponents.D(name);
            if (!iconData) {
                iconData = await webcomponents.n$2(name);
            }
            if (!iconData) {
                this.invalid = true;
            ...
            if ("customTemplate" in iconData && iconData.customTemplate) {
                this.customTemplate = webcomponents.n$3(iconData.customTemplate, this);
            }
            ...
            if (this.accessibleName) {
                ...
                if (this.packageName) {
                    const i18nBundle = await webcomponents.f(this.packageName);
    ...
    __decorate$3([
        Keys.s({ type: Object, noAttribute: true })
    ], Icon.prototype, "accData", void 0);
    __decorate$3([
        Keys.s({ type: Boolean })
    ], Icon.prototype, "invalid", void 0);
    __decorate$3([
        Keys.s({ noAttribute: true })
...
`;
     ...
     */
    let Label = Label_1 = class Label extends webcomponents.b {
        constructor() {
            super(...arguments);
            /**
...
`;
     ...
     * @since 0.12.0
     */
    let BusyIndicator = BusyIndicator_1 = class BusyIndicator extends webcomponents.b {
        constructor() {
            super();
            /**
...
`;
     ...
     * @public
     */
    let Button = Button_1 = class Button extends webcomponents.b {
        constructor() {
            super();
            /**
        ...
        _onclick(e) {
            ...
            if (this._isSubmit) {
                webcomponents.i$4(this);
            }
            if (this._isReset) {
                webcomponents.m$6(this);
            }
            if (webcomponents.h$2()) {
        ...
        _onkeydown(e) {
            this._cancelAction = Keys.Ko(e) || Keys.m$1(e);
            if (Keys.A(e) || Keys.b(e)) {
                this._setActiveState(true);
            }
        ...
        getDefaultTooltip() {
            ...
            return webcomponents.A(this.icon);
        }
        get buttonTypeText() {
    ...
    __decorate([
        Keys.s({ type: Boolean, noAttribute: true })
    ], Button.prototype, "_cancelAction", void 0);
    __decorate([
        Keys.d({ type: Node, "default": true })
    ], Button.prototype, "text", void 0);
    __decorate([
        Keys.d({ type: HTMLElement, invalidateOnChildChange: true })
