sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$i={},e$j=c$i.hasOwnProperty,a$e=c$i.toString,o$k=e$j.toString,l$i=o$k.call(Object),i$m=function(r){var t,n;return !r||a$e.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$j.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$i):true)};
  ...
  const e$f=new i$l,t$k="configurationReset",i$k=n=>{e$f.attachEvent(t$k,n);};

  let p$8=false,t$j={animationMode:u$e.Full,theme:e$g,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$h(),t$j.animationMode),T$4=()=>(o$h(),t$j.theme),S$4=()=>(o$h(),t$j.themeRoot),L$3=()=>(o$h(),t$j.language),F=()=>(o$h(),t$j.fetchDefaultLanguage),U$2=()=>(o$h(),t$j.noConflict),b$7=()=>(o$h(),t$j.defaultFontLoading),D$1=()=>(o$h(),t$j.enableDefaultTooltips),I$6=()=>(o$h(),t$j.calendarType),M$2=()=>(o$h(),t$j.formatSettings),i$j=new Map;i$j.set("true",true),i$j.set("false",false);const z$1=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$j=e$i(t$j,e));}},E$2=()=>{const n=new URLSearchParams(u$f());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||u$d(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&u$d(a,e,"sap-ui");});},P$6=n=>{const e=n.split("@")[1];return g$c(e)},w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,u$d=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$j.has(e)&&(e=i$j.get(r)),s==="theme"?(t$j.theme=w$7(s,e),e&&e.includes("@")&&(t$j.themeRoot=P$6(e))):t$j[s]=e;},j=()=>{const n=n$r("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$j=e$i(t$j,e);},o$h=()=>{typeof document>"u"||p$8||(g$b(),p$8=true);},g$b=n=>{z$1(),E$2(),j();};

  let n$o;i$k(()=>{n$o=void 0;});const d$c=()=>(n$o===void 0&&(n$o=C$4()),n$o),m$e=o=>{Object.values(u$e).includes(o)&&(n$o=o);};
  ...
  let t$i;let a$b = class a{static getLegacyDateCalendarCustomizing(){return t$i===void 0&&(t$i=M$2()),t$i.legacyDateCalendarCustomizing||[]}};s$s("LegacyDateFormats",a$b);

  let e$e;i$k(()=>{e$e=void 0;});const n$m=()=>(e$e===void 0&&(e$e=M$2()),e$e.firstDayOfWeek),i$h=n$r("LegacyDateFormats"),m$d=i$h?a$b.getLegacyDateCalendarCustomizing:()=>[];
  ...
  const u$c=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$g=()=>typeof document>"u"?null:o$g('meta[name="ui5-shared-resources"]',document.head,u$c),m$c=(t,o)=>{const r=t.split(".");let e=l$g();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$c={version:"2.8.0",major:2,minor:8,patch:0,suffix:"",isNext:false,buildTime:1741075456};

  let s$n,t$g={include:[/^ui5-/],exclude:[]};const o$f=new Map,l$f=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$4()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$n=e;},c$f=()=>s$n,p$7=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$g=e,o$f.clear();},m$b=()=>t$g,i$g=e=>{if(!o$f.has(e)){const n=t$g.include.some(r=>e.match(r))&&!t$g.exclude.some(r=>e.match(r));o$f.set(e,n);}return o$f.get(e)},g$a=e=>{if(i$g(e))return c$f()};

  let i$f,s$m="";const u$b=new Map,r$i=m$c("Runtimes",[]),x$1=()=>{if(i$f===void 0){i$f=r$i.length;const e=e$c;r$i.push({...e,get scopingSuffix(){return c$f()},get registeredTags(){return T$3()},get scopingRules(){return m$b()},alias:s$m,description:`Runtime ${i$f} - ver ${e.version}${""}`});}},I$5=()=>i$f,b$6=(e,m)=>{const o=`${e},${m}`;if(u$b.has(o))return u$b.get(o);const t=r$i[e],n=r$i[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$b.set(o,l),l},$$3=()=>r$i;

  const g$9=m$c("Tags",new Map),d$b=new Set;let s$l=new Map,c$e;const m$a=-1,h$6=e=>{d$b.add(e),g$9.set(e,I$5());},w$6=e=>d$b.has(e),R$4=()=>d$b.size>0,T$3=()=>[...d$b.values()],$$2=e=>{let n=g$9.get(e);n===void 0&&(n=m$a),s$l.has(n)||s$l.set(n,new Set),s$l.get(n).add(e),c$e||(c$e=setTimeout(()=>{y$6(),s$l=new Map,c$e=void 0;},1e3));},y$6=()=>{const e=$$3(),n=I$5(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$k=new Set,d$a=new i$l,n$k=new l$h;let t$e,a$a,m$9,i$e;const l$e=async e=>{n$k.add(e),await P$5();},c$d=e=>{d$a.fireEvent("beforeComponentRender",e),s$k.add(e),e._render();},h$5=e=>{n$k.remove(e),s$k.delete(e);},P$5=async()=>{i$e||(i$e=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$d),i$e=null,e(),m$9||(m$9=setTimeout(()=>{m$9=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$e;},y$5=()=>t$e||(t$e=new Promise(e=>{a$a=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$e=void 0,e());});}),t$e),I$4=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$9=async()=>{await I$4(),await y$5();},U$1=()=>{n$k.isEmpty()&&a$a&&(a$a(),a$a=void 0,t$e=void 0);},C$3=async e=>{s$k.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$h(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$e(r);}),await f$9();};

  const g$8=typeof document>"u",i$d=(e,t)=>t?`${e}|${t}`:e,l$d=e=>e===void 0?true:b$6(I$5(),parseInt(e))===1,c$c=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$d(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$d(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$d(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$d(e,t)),f$8=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$d(e,t));},R$3=(e,t,r="",s)=>{S$3(t,r)?y$4(e,t,r,s):c$c(e,t,r,s);},m$8=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$d=new i$l,r$g="themeRegistered",n$j=e=>{t$d.attachEvent(r$g,e);},s$j=e=>t$d.fireEvent(r$g,e);

  const l$c=new Map,h$4=new Map,u$a=new Map,T$2=new Set,i$c=new Set,p$6=(e,r,t)=>{h$4.set(`${e}/${r}`,t),T$2.add(e),i$c.add(r),s$j(r);},m$7=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$c.get(g);if(s!==void 0)return s;if(!i$c.has(r)){const $=[...i$c.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$g}. Registered themes are: ${$}`),a$9(e,e$g)}const[n,d]=await Promise.all([a$9(e,r),t?a$9(e,t,true):void 0]),o=m$8(n,d);return o&&l$c.set(g,o),o},a$9=async(e,r,t=false)=>{const s=(t?u$a:h$4).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$4=e=>i$c.has(e);

  const r$f=new Set,s$i=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$e=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$f.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$f.add("decode"));return}try{return JSON.parse(a)}catch{r$f.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$f.add("parse"));}}},d$9=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$f.has("object")||(console.warn("Malformed theme metadata Object",e),r$f.add("object"));return}return {themeName:t,baseThemeName:a}},m$6=()=>{const e=s$i();if(!e||e==="none")return;const t=o$e(e);if(t)return d$9(t)};

  const t$c=new i$l,d$8="themeLoaded",o$d=e=>{t$c.attachEvent(d$8,e);},n$i=e=>{t$c.detachEvent(d$8,e);},r$e=e=>t$c.fireEvent(d$8,e);
  ...
  let t$b;i$k(()=>{t$b=void 0;});const n$h=()=>(t$b===void 0&&(t$b=S$4()),t$b),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$b=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$7(u$9(e),{"sap-ui-webcomponents-theme":e});};

  const s$h="@ui5/webcomponents-theming",S$2=()=>w$5().has(s$h),P$3=async e=>{if(!S$2())return;const t=await m$7(s$h,e);t&&R$3(t,"data-ui5-theme-properties",s$h,e);},E$1=()=>{f$8("data-ui5-theme-properties",s$h);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$h)return;const i=await m$7(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$6();if(t)return t;const r=n$r("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$b(e),m$6()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$g,t&&t.themeName===e?e:void 0),r$e(e);};
  ...
  let o$c;i$k(()=>{o$c=void 0;});const a$7=()=>(o$c===void 0&&(o$c=b$7()),o$c);

  const i$a=()=>{const t=n$r("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$b();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$7()||t||S$3("data-ui5-font-face")||c$c(a$8,"data-ui5-font-face");},c$b=()=>{S$3("data-ui5-font-face-override")||c$c(n$g,"data-ui5-font-face-override");};
  ...
  const e$b=()=>{S$3("data-ui5-system-css-vars")||c$c(a$6,"data-ui5-system-css-vars");};

  const t$a=typeof document>"u",e$a={get userAgent(){return t$a?"":navigator.userAgent},get touch(){return t$a?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$a?false:/(Chrome|CriOS)/.test(e$a.userAgent)},get firefox(){return t$a?false:/Firefox/.test(e$a.userAgent)},get safari(){return t$a?false:!e$a.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$a.userAgent)},get webkit(){return t$a?false:/webkit/.test(e$a.userAgent)},get windows(){return t$a?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$a?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$a?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$a.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$a?false:!e$a.windows&&/Android/.test(e$a.userAgent)},get androidPhone(){return t$a?false:e$a.android&&/(?=android)(?=.*mobile)/i.test(e$a.userAgent)},get ipad(){return t$a?false:/ipad/i.test(e$a.userAgent)||/Macintosh/i.test(e$a.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$a.touch&&!r$d}};let o$b,i$9,r$d;const s$g=()=>{if(t$a||!e$a.windows)return  false;if(o$b===void 0){const n=e$a.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$a=()=>{if(t$a||!e$a.webkit)return  false;if(i$9===void 0){const n=e$a.userAgent.match(/(webkit)[ /]([\w.]+)/);i$9=n?parseFloat(n[1]):0;}return i$9>=537.1},u$8=()=>{if(t$a)return  false;if(r$d===void 0){if(e$a.ipad){r$d=true;return}if(e$a.touch){if(s$g()){r$d=true;return}if(e$a.chrome&&e$a.android){r$d=!/Mobile Safari\/[.0-9]+/.test(e$a.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$a.android&&c$a()&&(n=1),r$d=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$d=e$a.userAgent.indexOf("Touch")!==-1||e$a.android&&!e$a.androidPhone;}},l$b=()=>e$a.touch,h$3=()=>e$a.safari,g$7=()=>e$a.chrome,b$5=()=>e$a.firefox,a$5=()=>(u$8(),(e$a.touch||s$g())&&r$d),d$5=()=>e$a._isPhone(),f$7=()=>t$a?false:!a$5()&&!d$5()||s$g(),m$5=()=>a$5()&&f$7(),w$3=()=>e$a.iOS,P$2=()=>e$a.android||e$a.androidPhone;

  let t$9=false;const i$8=()=>{h$3()&&w$3()&&!t$9&&(document.body.addEventListener("touchstart",()=>{}),t$9=true);};

  let o$a=false,r$c;const p$4=new i$l,h$2=()=>o$a,P$1=e=>{if(!o$a){p$4.attachEvent("boot",e);return}e();},l$a=async()=>{if(r$c!==void 0)return r$c;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$j(b$4);const t=n$r("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$r("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$6(),await I$3(r$b()),t&&t.attachListeners(),i$a(),e$b(),i$8(),n(),o$a=true,p$4.fireEvent("boot");};return r$c=new Promise(e),r$c},b$4=e=>{o$a&&e===r$b()&&I$3(r$b());};

  let t$8;i$k(()=>{t$8=void 0;});const r$b=()=>(t$8===void 0&&(t$8=T$4()),t$8),u$7=async e=>{t$8!==e&&(t$8=e,h$2()&&(await I$3(t$8),await C$3({themeAware:true})));},g$6=()=>e$g,n$f=()=>{const e=r$b();return l$9(e)?!e.startsWith("sap_horizon"):!m$6()?.baseThemeName?.startsWith("sap_horizon")},l$9=e=>s$r.includes(e);
  ...
  const i$7=o=>{const t=c$g(r$b());return !o&&t?n$e(t):o?r$a(o):r$a("SAP-icons")};

  const e$9=new i$l,n$d="languageChange",t$5=a=>{e$9.attachEvent(n$d,a);},r$9=a=>{e$9.detachEvent(n$d,a);},o$9=a=>e$9.fireEventAsync(n$d,a);

  let e$8,n$c;i$k(()=>{e$8=void 0,n$c=void 0;});const d$4=()=>(e$8===void 0&&(e$8=L$3()),e$8),s$e=async t=>{e$8!==t&&(e$8=t,await o$9(t),h$2()&&await C$3({languageAware:true}));},m$4=()=>a$d,L$2=t=>{n$c=t;},c$8=()=>(n$c===void 0&&(n$c=F()),n$c);

  const c$7=["value-changed","click"];let e$7;i$k(()=>{e$7=void 0;});const s$d=t=>c$7.includes(t),l$8=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$7===void 0&&(e$7=U$2()),e$7),f$6=t=>{e$7=t;},a$4=t=>{const n=o$8();return s$d(t)?false:n===true?true:!l$8(t)};
  ...
  const s$c=new Map,o$7=new Map,n$b=new Map,c$6=e=>{if(!s$c.has(e)){const a=b$3(e.split("-"));s$c.set(e,a);}return s$c.get(e)},l$6=e=>{if(!o$7.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$7.set(e,a);}return o$7.get(e)},p$3=e=>l$6(e),b$3=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$2=e=>{const a=n$b.get(e);if(a)return a;const t=c$6(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$b.set(e,r),r};
  ...
  const r$7=()=>m$c("CustomStyle.eventProvider",new i$l),n$9="CustomCSSChange",i$6=t=>{r$7().attachEvent(n$9,t);},u$6=t=>r$7().fireEvent(n$9,t),c$5=()=>m$c("CustomStyle.customCSSFor",{});let s$a;i$6(t=>{s$a||C$3({tag:t});});const g$4=(t,e)=>{const o=c$5();o[t]||(o[t]=[]),o[t].push(e),s$a=true;try{u$6(t);}finally{s$a=false;}return C$3({tag:t})},l$5=t=>{const e=c$5();return e[t]?e[t].join(""):""};

  const e$6=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$5=new Map;i$6(t=>{e$5.delete(`${t}_normal`);});const y$3=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$r("OpenUI5Enablement");if(!e$5.has(n)){let l="";s&&(l=e$6(s.getBusyIndicatorStyles()));const a=l$5(o)||"",m=`${e$6(t.styles)} ${a} ${l}`;e$5.set(n,m);}return e$5.get(n)};

  const e$4=new Map;i$6(t=>{e$4.delete(`${t}_normal`);});const s$9=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$4.has(n)){const a=y$3(t),o=new CSSStyleSheet;o.replaceSync(a),e$4.set(n,[o]);}return e$4.get(n)};
  ...
  const t$4=new WeakMap,n$8=(e,o,r)=>{const s=new MutationObserver(o);t$4.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$4.get(e);o&&(o.disconnect(),t$4.delete(e));};
  ...
  const t$3=typeof document>"u",o$3=()=>{if(t$3)return a$d;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$d};
