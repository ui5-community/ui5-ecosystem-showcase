sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$i={},e$i=c$i.hasOwnProperty,a$f=c$i.toString,o$k=e$i.toString,l$k=o$k.call(Object),i$m=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$k):true)};
  ...
  const e$e=new i$l,t$l="configurationReset",i$k=n=>{e$e.attachEvent(t$l,n);};

  let p$8=false,t$k={animationMode:u$e.Full,theme:e$f,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$h(),t$k.animationMode),T$4=()=>(o$h(),t$k.theme),S$4=()=>(o$h(),t$k.themeRoot),L$3=()=>(o$h(),t$k.language),F=()=>(o$h(),t$k.fetchDefaultLanguage),U$2=()=>(o$h(),t$k.noConflict),b$7=()=>(o$h(),t$k.defaultFontLoading),D$1=()=>(o$h(),t$k.enableDefaultTooltips),I$6=()=>(o$h(),t$k.calendarType),M$2=()=>(o$h(),t$k.formatSettings),i$j=new Map;i$j.set("true",true),i$j.set("false",false);const z$1=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$k=e$h(t$k,e));}},E$2=()=>{const n=new URLSearchParams(u$f());n.forEach((e,a)=>{const r=a.split("sap-").length;r===0||r===a.split("sap-ui-").length||u$d(a,e,"sap");}),n.forEach((e,a)=>{a.startsWith("sap-ui")&&u$d(a,e,"sap-ui");});},P$6=n=>{const e=n.split("@")[1];return g$c(e)},w$7=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,u$d=(n,e,a)=>{const r=e.toLowerCase(),s=n.split(`${a}-`)[1];i$j.has(e)&&(e=i$j.get(r)),s==="theme"?(t$k.theme=w$7(s,e),e&&e.includes("@")&&(t$k.themeRoot=P$6(e))):t$k[s]=e;},j=()=>{const n=n$q("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$k=e$h(t$k,e);},o$h=()=>{typeof document>"u"||p$8||(g$b(),p$8=true);},g$b=n=>{z$1(),E$2(),j();};

  let n$o;i$k(()=>{n$o=void 0;});const d$b=()=>(n$o===void 0&&(n$o=C$4()),n$o),m$e=o=>{Object.values(u$e).includes(o)&&(n$o=o);};

  var s$o=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$o||{});

  let n$n;i$k(()=>{n$n=void 0;});const i$i=()=>(n$n===void 0&&(n$n=I$6()),n$n&&n$n in s$o?n$n:s$o.Gregorian);

  let t$j;let a$c = class a{static getLegacyDateCalendarCustomizing(){return t$j===void 0&&(t$j=M$2()),t$j.legacyDateCalendarCustomizing||[]}};s$s("LegacyDateFormats",a$c);
  ...
  const t$i=new Map,e$c=(n,o)=>{t$i.set(n,o);},c$g=n=>t$i.get(n);
  ...
  const u$c=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$h=()=>typeof document>"u"?null:o$g('meta[name="ui5-shared-resources"]',document.head,u$c),m$c=(t,o)=>{const r=t.split(".");let e=l$h();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$b={version:"2.12.0",major:2,minor:12,patch:0,suffix:"",isNext:false,buildTime:1751620086};

  let s$n,t$h={include:[/^ui5-/],exclude:[]};const o$f=new Map,l$g=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$4()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$n=e;},c$f=()=>s$n,p$7=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$h=e,o$f.clear();},m$b=()=>t$h,i$g=e=>{if(!o$f.has(e)){const n=t$h.include.some(r=>e.match(r))&&!t$h.exclude.some(r=>e.match(r));o$f.set(e,n);}return o$f.get(e)},g$a=e=>{if(i$g(e))return c$f()};

  let i$f,s$m="";const u$b=new Map,r$j=m$c("Runtimes",[]),x$1=()=>{if(i$f===void 0){i$f=r$j.length;const e=e$b;r$j.push({...e,get scopingSuffix(){return c$f()},get registeredTags(){return T$3()},get scopingRules(){return m$b()},alias:s$m,description:`Runtime ${i$f} - ver ${e.version}${""}`});}},I$5=()=>i$f,b$6=(e,m)=>{const o=`${e},${m}`;if(u$b.has(o))return u$b.get(o);const t=r$j[e],n=r$j[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$b.set(o,l),l},$$3=()=>r$j;

  const g$9=m$c("Tags",new Map),d$a=new Set;let s$l=new Map,c$e;const m$a=-1,h$7=e=>{d$a.add(e),g$9.set(e,I$5());},w$6=e=>d$a.has(e),R$4=()=>d$a.size>0,T$3=()=>[...d$a.values()],$$2=e=>{let n=g$9.get(e);n===void 0&&(n=m$a),s$l.has(n)||s$l.set(n,new Set),s$l.get(n).add(e),c$e||(c$e=setTimeout(()=>{y$6(),s$l=new Map,c$e=void 0;},1e3));},y$6=()=>{const e=$$3(),n=I$5(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(i=>`
${i.description}`).join("")}`),[...s$l.keys()].forEach(i=>{let o,r;i===m$a?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,i),r=e[i]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$g=new Set,n$l=e=>{t$g.add(e);},r$i=e=>t$g.has(e);

  const s$k=new Set,d$9=new i$l,n$k=new l$i;let t$f,a$b,m$9,i$e;const l$f=async e=>{n$k.add(e),await P$5();},c$d=e=>{d$9.fireEvent("beforeComponentRender",e),s$k.add(e),e._render();},h$6=e=>{n$k.remove(e),s$k.delete(e);},P$5=async()=>{i$e||(i$e=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$d),i$e=null,e(),m$9||(m$9=setTimeout(()=>{m$9=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$e;},y$5=()=>t$f||(t$f=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$f=void 0,e());});}),t$f),I$4=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$9=async()=>{await I$4(),await y$5();},U$1=()=>{n$k.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$f=void 0);},C$3=async e=>{s$k.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$f(r);}),await f$9();};

  const g$8=typeof document>"u",i$d=(e,t)=>t?`${e}|${t}`:e,l$e=e=>e===void 0?true:b$6(I$5(),parseInt(e))===1,c$c=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$d(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$d(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$e(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$d(e,t)),f$8=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$d(e,t));},R$3=(e,t,r="",s)=>{S$3(t,r)?y$4(e,t,r,s):c$c(e,t,r,s);},m$8=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$e=new i$l,r$h="themeRegistered",n$j=e=>{t$e.attachEvent(r$h,e);},s$j=e=>t$e.fireEvent(r$h,e);

  const l$d=new Map,h$5=new Map,u$a=new Map,T$2=new Set,i$c=new Set,p$6=(e,r,t)=>{h$5.set(`${e}/${r}`,t),T$2.add(e),i$c.add(r),s$j(r);},m$7=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$d.get(g);if(s!==void 0)return s;if(!i$c.has(r)){const $=[...i$c.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$a(e,e$f)}const[n,d]=await Promise.all([a$a(e,r),t?a$a(e,t,true):void 0]),o=m$8(n,d);return o&&l$d.set(g,o),o},a$a=async(e,r,t=false)=>{const s=(t?u$a:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$4=e=>i$c.has(e);

  const r$g=new Set,s$i=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$e=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$6=()=>{const e=s$i();if(!e||e==="none")return;const t=o$e(e);if(t)return d$8(t)};

  const t$d=new i$l,d$7="themeLoaded",o$d=e=>{t$d.attachEvent(d$7,e);},n$i=e=>{t$d.detachEvent(d$7,e);},r$f=e=>t$d.fireEvent(d$7,e);
  ...
  let t$c;i$k(()=>{t$c=void 0;});const n$h=()=>(t$c===void 0&&(t$c=S$4()),t$c),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$b=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$6(u$9(e),{"sap-ui-webcomponents-theme":e});};

  const s$h="@ui5/webcomponents-theming",S$2=()=>w$5().has(s$h),P$3=async e=>{if(!S$2())return;const t=await m$7(s$h,e);t&&R$3(t,"data-ui5-theme-properties",s$h,e);},E$1=()=>{f$8("data-ui5-theme-properties",s$h);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$h)return;const i=await m$7(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$6();if(t)return t;const r=n$q("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$b(e),m$6()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};
  ...
  let o$c;i$k(()=>{o$c=void 0;});const a$8=()=>(o$c===void 0&&(o$c=b$7()),o$c);

  const i$a=()=>{const t=n$q("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$b();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$8()||t||S$3("data-ui5-font-face")||c$c(a$9,"data-ui5-font-face");},c$b=()=>{S$3("data-ui5-font-face-override")||c$c(n$g,"data-ui5-font-face-override");};
  ...
  const e$a=()=>{S$3("data-ui5-system-css-vars")||c$c(a$7,"data-ui5-system-css-vars");};

  const t$b=typeof document>"u",e$9={get userAgent(){return t$b?"":navigator.userAgent},get touch(){return t$b?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$9.userAgent)},get firefox(){return t$b?false:/Firefox/.test(e$9.userAgent)},get safari(){return t$b?false:!e$9.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$9.userAgent)},get webkit(){return t$b?false:/webkit/.test(e$9.userAgent)},get windows(){return t$b?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$b?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$9.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$b?false:!e$9.windows&&/Android/.test(e$9.userAgent)},get androidPhone(){return t$b?false:e$9.android&&/(?=android)(?=.*mobile)/i.test(e$9.userAgent)},get ipad(){return t$b?false:/ipad/i.test(e$9.userAgent)||/Macintosh/i.test(e$9.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$9.touch&&!r$e}};let o$b,i$9,r$e;const s$g=()=>{if(t$b||!e$9.windows)return  false;if(o$b===void 0){const n=e$9.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$a=()=>{if(t$b||!e$9.webkit)return  false;if(i$9===void 0){const n=e$9.userAgent.match(/(webkit)[ /]([\w.]+)/);i$9=n?parseFloat(n[1]):0;}return i$9>=537.1},u$8=()=>{if(t$b)return  false;if(r$e===void 0){if(e$9.ipad){r$e=true;return}if(e$9.touch){if(s$g()){r$e=true;return}if(e$9.chrome&&e$9.android){r$e=!/Mobile Safari\/[.0-9]+/.test(e$9.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$9.android&&c$a()&&(n=1),r$e=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$e=e$9.userAgent.indexOf("Touch")!==-1||e$9.android&&!e$9.androidPhone;}},l$c=()=>e$9.touch,h$4=()=>e$9.safari,g$7=()=>e$9.chrome,b$5=()=>e$9.firefox,a$6=()=>(u$8(),(e$9.touch||s$g())&&r$e),d$4=()=>e$9._isPhone(),f$7=()=>t$b?false:!a$6()&&!d$4()||s$g(),m$5=()=>a$6()&&f$7(),w$3=()=>e$9.iOS,P$2=()=>e$9.android||e$9.androidPhone;

  let t$a=false;const i$8=()=>{h$4()&&w$3()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

  let o$a=false,r$d;const p$4=new i$l,h$3=()=>o$a,P$1=e=>{if(!o$a){p$4.attachEvent("boot",e);return}e();},l$b=async()=>{if(r$d!==void 0)return r$d;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$j(b$4);const t=n$q("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$q("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$5(),await I$3(r$c()),t&&t.attachListeners(),i$a(),e$a(),i$8(),n(),o$a=true,p$4.fireEvent("boot");};return r$d=new Promise(e),r$d},b$4=e=>{o$a&&e===r$c()&&I$3(r$c());};

  let t$9;i$k(()=>{t$9=void 0;});const r$c=()=>(t$9===void 0&&(t$9=T$4()),t$9),u$7=async e=>{t$9!==e&&(t$9=e,h$3()&&(await I$3(t$9),await C$3({themeAware:true})));},g$6=()=>e$f,n$f=()=>{const e=r$c();return l$a(e)?!e.startsWith("sap_horizon"):!m$6()?.baseThemeName?.startsWith("sap_horizon")},l$a=e=>s$r.includes(e);
  ...
  const i$7=o=>{const t=c$g(r$c());return !o&&t?n$e(t):o?r$b(o):r$b("SAP-icons")};

  const e$8=new i$l,n$d="languageChange",t$6=a=>{e$8.attachEvent(n$d,a);},r$a=a=>{e$8.detachEvent(n$d,a);},o$9=a=>e$8.fireEventAsync(n$d,a);

  let e$7,t$5;i$k(()=>{e$7=void 0,t$5=void 0;});let a$5=false;const s$e=()=>a$5,l$9=()=>(e$7===void 0&&(e$7=L$3()),e$7),L$2=async n=>{e$7!==n&&(a$5=true,e$7=n,await o$9(n),a$5=false,h$3()&&await C$3({languageAware:true}));},c$8=()=>a$e,m$4=n=>{t$5=n;},h$2=()=>(t$5===void 0&&(t$5=F()),t$5);

  const c$7=["value-changed","click"];let e$6;i$k(()=>{e$6=void 0;});const s$d=t=>c$7.includes(t),l$8=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$6===void 0&&(e$6=U$2()),e$6),f$6=t=>{e$6=t;},a$4=t=>{const n=o$8();return s$d(t)?false:n===true?true:!l$8(t)};
  ...
  const t$4=new WeakMap,n$9=(e,o,r)=>{const s=new MutationObserver(o);t$4.set(e,s),s.observe(e,r);},b$2=e=>{const o=t$4.get(e);o&&(o.disconnect(),t$4.delete(e));};

  const r$6=t=>t.matches(":dir(rtl)")?"rtl":"ltr";

  const s$7=["disabled","title","hidden","role","draggable"],r$5=e=>s$7.includes(e)||e.startsWith("aria")?true:![HTMLElement,Element,Node].some(t=>t.prototype.hasOwnProperty(e));
  ...
  const o$4=t=>{s$6(t)&&e$2(t);},e$2=t=>{if(t._internals?.form){if(n$6(t),!t.name){t._internals?.setFormValue(null);return}t._internals.setFormValue(t.formFormattedValue);}},n$6=async t=>{if(t._internals?.form)if(t.formValidity&&Object.keys(t.formValidity).some(r=>r)){const r=await t.formElementAnchor?.();t._internals.setValidity(t.formValidity,t.formValidityMessage,r);}else t._internals.setValidity({});},i$5=t=>{t._internals?.form?.requestSubmit();},m$3=t=>{t._internals?.form?.reset();},s$6=t=>"formFormattedValue"in t&&"name"in t;

  const t$3=typeof document>"u",o$3=()=>{if(t$3)return a$e;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$e};

  const n$5=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$4 = class r{constructor(s){const t=n$5.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$e,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

  const r$3=new Map,n$4=t=>(r$3.has(t)||r$3.set(t,new r$4(t)),r$3.get(t)),c$4=t=>{try{if(t&&typeof t=="string")return n$4(t)}catch{}return new r$4(r$k)},s$5=t=>{const e=l$9();return e?n$4(e):c$4(o$3())};

  const _$2=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$3=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$5={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$1=i=>{let e;if(!i)return r$k;if(typeof i=="string"&&(e=_$2.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$5[t]||t,o&&(e=c$3.exec(o))||r&&(e=c$3.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$k};

  const r$2={zh_HK:"zh_TW",in:"id"},n$3=t=>{if(!t)return r$k;if(r$2[t])return r$2[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$k?r$k:""};

  const d$3=new Set,m$2=new Set,g$3=new Map,l$4=new Map,u$5=new Map,$$1=(n,t,e)=>{const r=`${n}/${t}`;u$5.set(r,e);},f$4=(n,t)=>{g$3.set(n,t);},A$2=n=>g$3.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$5.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$5.get(e);return r&&!l$4.get(e)&&l$4.set(e,r(t)),l$4.get(e)},M$1=n=>{d$3.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$3.add(n));},L$1=(n,t)=>t!==a$e&&!h$1(n,t),w$2=async n=>{const t=s$5().getLanguage(),e=s$5().getRegion(),r=s$5().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$1(n,s))for(s=p$1(s);L$1(n,s);)s=n$3(s);const I=h$2();if(s===a$e&&!I){f$4(n,null);return}if(!h$1(n,s)){M$1(n);return}try{const o=await B$1(n,s);f$4(n,o);}catch(o){const a=o;m$2.has(a.message)||(m$2.add(a.message),console.error(a.message));}};t$6(n=>{const t=[...g$3.keys()];return Promise.all(t.map(w$2))});
