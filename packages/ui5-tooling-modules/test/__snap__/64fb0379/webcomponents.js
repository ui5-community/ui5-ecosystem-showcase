sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$h={},e$i=c$h.hasOwnProperty,a$f=c$h.toString,o$k=e$i.toString,l$k=o$k.call(Object),i$m=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$k):true)};

  var c$g=Object.create(null),u$f=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$g;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$m(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$m(n)?n:{},r[a]=u$f(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  let t$d;i$k(()=>{t$d=void 0;});const n$h=()=>(t$d===void 0&&(t$d=S$4()),t$d),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$a=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$5(u$9(e),{"sap-ui-webcomponents-theme":e});};

  let _lib="ui5",_package="webcomponents-theming";const s$i="@"+_lib+"/"+_package,S$2=()=>w$5().has(s$i),P$3=async e=>{if(!S$2())return;const t=await m$7(s$i,e);t&&R$3(t,"data-ui5-theme-properties",s$i,e);},E$1=()=>{f$9("data-ui5-theme-properties",s$i);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$i)return;const i=await m$7(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$3()}`,a);});return Promise.all(o)},k$1=async e=>{const t=m$6();if(t)return t;const r=n$q("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$a(e),m$6()},w$4=async e=>{const t=await k$1(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let e$7,t$4;i$k(()=>{e$7=void 0,t$4=void 0;});let a$5=false;const s$e=()=>a$5,l$9=()=>(e$7===void 0&&(e$7=L$3()),e$7),L$2=async n=>{e$7!==n&&(a$5=true,e$7=n,await o$8(n),a$5=false,h$3()&&await C$4({languageAware:true}));},c$8=()=>a$e,m$4=n=>{t$4=n;},h$2=()=>(t$4===void 0&&(t$4=R$5()),t$4);
  ...
  const r$6=new Map;let s$c;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$4=n=>{if(r$6.has(n))return r$6.get(n);const e=new u$5(n);return r$6.set(n,e),e},f$4=async n=>s$c?s$c(n):(await w$2(n),a$4(n)),y$4=n=>{s$c=n;};

  const c$5=["value-changed","click"];let e$6;i$k(()=>{e$6=void 0;});const s$b=t=>c$5.includes(t),l$7=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$6===void 0&&(e$6=F$1()),e$6),f$3=t=>{e$6=t;},a$3=t=>{const n=o$7();return s$b(t)?false:n===true?true:!l$7(t)};
  ...
  const r$4=()=>m$c("CustomStyle.eventProvider",new i$l),n$7="CustomCSSChange",i$5=t=>{r$4().attachEvent(n$7,t);},u$4=t=>r$4().fireEvent(n$7,t),c$3=()=>m$c("CustomStyle.customCSSFor",{});let s$8;i$5(t=>{s$8||C$4({tag:t});});const g$2=(t,e)=>{const o=c$3();o[t]||(o[t]=[]),o[t].push(e),s$8=true;try{u$4(t);}finally{s$8=false;}return C$4({tag:t})},l$4=t=>{const e=c$3();return e[t]?e[t].join(""):""};

  const e$5=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$4=new Map;i$5(t=>{e$4.delete(`${t}_normal`);});const y$3=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$q("OpenUI5Enablement");if(!e$4.has(n)){let l="";s&&(l=e$5(s.getBusyIndicatorStyles()));const a=l$4(o)||"",m=`${e$5(t.styles)} ${a} ${l}`;e$4.set(n,m);}return e$4.get(n)};

  const e$3=new Map;i$5(t=>{e$3.delete(`${t}_normal`);});const s$7=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$3.has(n)){const a=y$3(t),o=new CSSStyleSheet;o.replaceSync(a),e$3.set(n,[o]);}return e$3.get(n)};
