sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$i={},e$j=c$i.hasOwnProperty,a$f=c$i.toString,o$k=e$j.toString,l$h=o$k.call(Object),i$m=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$j.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$h):true)};

  var c$h=Object.create(null),u$h=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?undefined:c$h;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$m(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$m(n)?n:{},r[a]=u$h(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};
  ...
  let e$e;i$k(()=>{e$e=undefined;});const n$m=()=>(e$e===undefined&&(e$e=M$2()),e$e.firstDayOfWeek),i$h=n$r("LegacyDateFormats"),m$d=i$h?a$c.getLegacyDateCalendarCustomizing:()=>[];
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$k=new Set,d$a=new i$l,n$k=new l$g;let t$e,a$a,m$9,i$e;const l$e=async e=>{n$k.add(e),await P$5();},c$d=e=>{d$a.fireEvent("beforeComponentRender",e),s$k.add(e),e._render();},h$5=e=>{n$k.remove(e),s$k.delete(e);},P$5=async()=>{i$e||(i$e=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$d),i$e=null,e(),m$9||(m$9=setTimeout(()=>{m$9=undefined,n$k.isEmpty()&&U$1();},200));});})),await i$e;},y$5=()=>t$e||(t$e=new Promise(e=>{a$a=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$e=undefined,e());});}),t$e),I$4=()=>{const e=$$2().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$9=async()=>{await I$4(),await y$5();},U$1=()=>{n$k.isEmpty()&&a$a&&(a$a(),a$a=undefined,t$e=undefined);},C$3=async e=>{s$k.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$h(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$e(r);}),await f$9();};

  const g$8=typeof document>"u",i$d=(e,t)=>t?`${e}|${t}`:e,l$d=e=>e===undefined?true:b$5(I$5(),parseInt(e))===1,c$c=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$d(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$d(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$d(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$d(e,t)),f$8=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$d(e,t));},R$2=(e,t,r="",s)=>{S$4(t,r)?y$4(e,t,r,s):c$c(e,t,r,s);},m$8=(e,t)=>e===undefined?t:t===undefined?e:`${e} ${t}`;

  const t$d=new i$l,r$g="themeRegistered",n$j=e=>{t$d.attachEvent(r$g,e);},s$j=e=>t$d.fireEvent(r$g,e);

  const l$c=new Map,h$4=new Map,u$a=new Map,T$3=new Set,i$c=new Set,p$6=(e,r,t)=>{h$4.set(`${e}/${r}`,t),T$3.add(e),i$c.add(r),s$j(r);},m$7=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$c.get(g);if(s!==undefined)return s;if(!i$c.has(r)){const $=[...i$c.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$g}. Registered themes are: ${$}`),a$9(e,e$g)}const[n,d]=await Promise.all([a$9(e,r),t?a$9(e,t,true):undefined]),o=m$8(n,d);return o&&l$c.set(g,o),o},a$9=async(e,r,t=false)=>{const s=(t?u$a:h$4).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$3,P$4=e=>i$c.has(e);
  ...
  let t$b;i$k(()=>{t$b=undefined;});const n$h=()=>(t$b===undefined&&(t$b=S$5()),t$b),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$b=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$7(u$9(e),{"sap-ui-webcomponents-theme":e});};

  const s$h="@ui5/webcomponents-theming",S$3=()=>w$5().has(s$h),P$3=async e=>{if(!S$3())return;const t=await m$7(s$h,e);t&&R$2(t,"data-ui5-theme-properties",s$h,e);},E$1=()=>{f$8("data-ui5-theme-properties",s$h);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$h)return;const i=await m$7(a,e,t);i&&R$2(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$6();if(t)return t;const r=n$r("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$b(e),m$6()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$g,t&&t.themeName===e?e:undefined),r$e(e);};
  ...
  let o$c;i$k(()=>{o$c=undefined;});const a$7=()=>(o$c===undefined&&(o$c=b$6()),o$c);

  const i$a=()=>{const t=n$r("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$b();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$7()||t||S$4("data-ui5-font-face")||c$c(a$8,"data-ui5-font-face");},c$b=()=>{S$4("data-ui5-font-face-override")||c$c(n$g,"data-ui5-font-face-override");};
  ...
  const t$a=typeof document>"u",e$a={get userAgent(){return t$a?"":navigator.userAgent},get touch(){return t$a?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$a?false:/(Chrome|CriOS)/.test(e$a.userAgent)},get firefox(){return t$a?false:/Firefox/.test(e$a.userAgent)},get safari(){return t$a?false:!e$a.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$a.userAgent)},get webkit(){return t$a?false:/webkit/.test(e$a.userAgent)},get windows(){return t$a?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$a?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$a?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$a.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$a?false:!e$a.windows&&/Android/.test(e$a.userAgent)},get androidPhone(){return t$a?false:e$a.android&&/(?=android)(?=.*mobile)/i.test(e$a.userAgent)},get ipad(){return t$a?false:/ipad/i.test(e$a.userAgent)||/Macintosh/i.test(e$a.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$a.touch&&!r$d}};let o$b,i$9,r$d;const s$g=()=>{if(t$a||!e$a.windows)return  false;if(o$b===undefined){const n=e$a.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$a=()=>{if(t$a||!e$a.webkit)return  false;if(i$9===undefined){const n=e$a.userAgent.match(/(webkit)[ /]([\w.]+)/);i$9=n?parseFloat(n[1]):0;}return i$9>=537.1},u$8=()=>{if(t$a)return  false;if(r$d===undefined){if(e$a.ipad){r$d=true;return}if(e$a.touch){if(s$g()){r$d=true;return}if(e$a.chrome&&e$a.android){r$d=!/Mobile Safari\/[.0-9]+/.test(e$a.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$a.android&&c$a()&&(n=1),r$d=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$d=e$a.userAgent.indexOf("Touch")!==-1||e$a.android&&!e$a.androidPhone;}},l$b=()=>e$a.touch,h$3=()=>e$a.safari,g$7=()=>e$a.chrome,b$4=()=>e$a.firefox,a$5=()=>(u$8(),(e$a.touch||s$g())&&r$d),d$5=()=>e$a._isPhone(),f$7=()=>t$a?false:!a$5()&&!d$5()||s$g(),m$5=()=>a$5()&&f$7(),w$3=()=>e$a.iOS,P$2=()=>e$a.android||e$a.androidPhone;

  let t$9=false;const i$8=()=>{h$3()&&w$3()&&!t$9&&(document.body.addEventListener("touchstart",()=>{}),t$9=true);};

  let o$a=false,r$c;const p$4=new i$l,h$2=()=>o$a,P$1=e=>{if(!o$a){p$4.attachEvent("boot",e);return}e();},l$a=async()=>{if(r$c!==undefined)return r$c;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$j(b$3);const t=n$r("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$r("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$6(),await I$3(r$b()),t&&t.attachListeners(),i$a(),e$b(),i$8(),n(),o$a=true,p$4.fireEvent("boot");};return r$c=new Promise(e),r$c},b$3=e=>{o$a&&e===r$b()&&I$3(r$b());};

  let t$8;i$k(()=>{t$8=undefined;});const r$b=()=>(t$8===undefined&&(t$8=T$4()),t$8),u$7=async e=>{t$8!==e&&(t$8=e,h$2()&&(await I$3(t$8),await C$3({themeAware:true})));},g$6=()=>e$g,n$f=()=>{const e=r$b();return l$9(e)?!e.startsWith("sap_horizon"):!m$6()?.baseThemeName?.startsWith("sap_horizon")},l$9=e=>s$r.includes(e);
  ...
  let e$8,n$c;i$k(()=>{e$8=undefined,n$c=undefined;});const d$4=()=>(e$8===undefined&&(e$8=L$3()),e$8),s$e=async t=>{e$8!==t&&(e$8=t,await o$9(t),h$2()&&await C$3({languageAware:true}));},m$4=()=>a$e,L$2=t=>{n$c=t;},c$8=()=>(n$c===undefined&&(n$c=F()),n$c);

  const c$7=["value-changed","click"];let e$7;i$k(()=>{e$7=undefined;});const s$d=t=>c$7.includes(t),l$8=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$7===undefined&&(e$7=U$2()),e$7),f$6=t=>{e$7=t;},a$4=t=>{const n=o$8();return s$d(t)?false:n===true?true:!l$8(t)};
