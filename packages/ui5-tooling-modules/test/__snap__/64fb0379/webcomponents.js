sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$j={},e$i=c$j.hasOwnProperty,a$g=c$j.toString,o$j=e$i.toString,l$h=o$j.call(Object),i$n=function(r){var t,n;return !r||a$g.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$j.call(n)===l$h):true)};

  var c$i=Object.create(null),u$f=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$i;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$n(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$n(n)?n:{},r[a]=u$f(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$h=function(n,t){return u$f(true,false,...arguments)};

  const e$g=new Map,s$s=(t,r)=>{e$g.set(t,r);},n$q=t=>e$g.get(t);

  const _$2={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_dark","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$f=_$2.themes.default,s$r=_$2.themes.all,a$f=_$2.languages.default,r$n=_$2.locales.default,l$g=_$2.locales.all;

  const o$i=typeof document>"u",n$p={search(){return o$i?"":window.location.search}},s$q=()=>o$i?"":window.location.href,u$e=()=>n$p.search();

  const s$p=e=>{const t=document.querySelector(`META[name="${e}"]`);return t&&t.getAttribute("content")},o$h=e=>{const t=s$p("sap-allowed-theme-origins")??s$p("sap-allowedThemeOrigins");return t?t.split(",").some(n=>n==="*"||e===n.trim()):false},a$e=(e,t)=>{const n=new URL(e).pathname;return new URL(n,t).toString()},g$e=e=>{let t;try{if(e.startsWith(".")||e.startsWith("/"))t=new URL(e,s$q()).toString();else {const n=new URL(e),r=n.origin;r&&o$h(r)?t=n.toString():t=a$e(n.toString(),s$q());}return t.endsWith("/")||(t=`${t}/`),`${t}UI5/`}catch{}};
  ...
  const e$e=new i$m,t$n="configurationReset",i$l=n=>{e$e.attachEvent(t$n,n);};

  let p$6=false,t$m={animationMode:u$d.Full,theme:e$f,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$4=()=>(o$g(),t$m.animationMode),T$3=()=>(o$g(),t$m.theme),S$5=()=>{if(o$g(),t$m.themeRoot!==void 0){if(!g$e(t$m.themeRoot)){console.warn(`The ${t$m.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$m.themeRoot}},L$6=()=>(o$g(),t$m.language),R$3=()=>(o$g(),t$m.fetchDefaultLanguage),F=()=>(o$g(),t$m.noConflict),U$2=()=>(o$g(),t$m.defaultFontLoading),b$7=()=>(o$g(),t$m.enableDefaultTooltips),D$2=()=>(o$g(),t$m.calendarType),M$3=()=>(o$g(),t$m.formatSettings),i$k=new Map;i$k.set("true",true),i$k.set("false",false);const w$8=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$m=e$h(t$m,e));}},z$1=()=>{const n=new URLSearchParams(u$e());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$d(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$d(r,e,"sap-ui");});},E$3=n=>{const e=n.split("@")[1];return g$e(e)},P$4=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$d=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$k.has(e)&&(e=i$k.get(a)),s==="theme"?(t$m.theme=P$4(s,e),e&&e.includes("@")&&(t$m.themeRoot=E$3(e))):t$m[s]=e;},j=()=>{const n=n$q("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$m=e$h(t$m,e);},o$g=()=>{typeof document>"u"||p$6||(l$f(),p$6=true);},l$f=n=>{w$8(),z$1(),j();};

  let n$o;i$l(()=>{n$o=void 0;});const d$c=()=>(n$o===void 0&&(n$o=C$4()),n$o),m$f=o=>{Object.values(u$d).includes(o)&&(n$o=o);};

  var s$o=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$o||{});

  let n$n;i$l(()=>{n$n=void 0;});const i$j=()=>(n$n===void 0&&(n$n=D$2()),n$n&&n$n in s$o?n$n:s$o.Gregorian);

  let t$l;let a$d = class a{static getLegacyDateCalendarCustomizing(){return t$l===void 0&&(t$l=M$3()),t$l.legacyDateCalendarCustomizing||[]}};s$s("LegacyDateFormats",a$d);

  let e$d;i$l(()=>{e$d=void 0;});const n$m=()=>(e$d===void 0&&(e$d=M$3()),e$d.firstDayOfWeek),i$i=n$q("LegacyDateFormats"),m$e=i$i?a$d.getLegacyDateCalendarCustomizing:()=>[];

  const t$k=new Map,e$c=(n,o)=>{t$k.set(n,o);},c$h=n=>t$k.get(n);
  ...
  const u$c=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$d=()=>typeof document>"u"?null:o$f('meta[name="ui5-shared-resources"]',document.head,u$c),m$d=(t,o)=>{const r=t.split(".");let e=l$d();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$b={version:"2.20.0",major:2,minor:20,patch:0,suffix:"",isNext:false,buildTime:1772704608};

  let s$n,t$j={include:[/^ui5-/],exclude:[]};const o$e=new Map,p$5=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$2()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$n=e;},c$g=()=>s$n,g$c=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$j=e,o$e.clear();},m$c=()=>t$j,i$h=e=>{if(!o$e.has(e)){const n=t$j.include.some(r=>e.match(r))&&!t$j.exclude.some(r=>e.match(r));o$e.set(e,n);}return o$e.get(e)},d$b=e=>{if(i$h(e))return c$g()};

  let i$g,s$m="";const u$b=new Map,r$m=m$d("Runtimes",[]),x$1=()=>{if(i$g===void 0){i$g=r$m.length;const e=e$b;r$m.push({...e,get scopingSuffix(){return c$g()},get registeredTags(){return T$2()},get scopingRules(){return m$c()},alias:s$m,description:`Runtime ${i$g} - ver ${e.version}${""}`});}},I$3=()=>i$g,b$6=(e,m)=>{const o=`${e},${m}`;if(u$b.has(o))return u$b.get(o);const t=r$m[e],n=r$m[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$b.set(o,l),l},$$3=()=>r$m;

  const g$b=m$d("Tags",new Map),d$a=new Set;let i$f=new Map,c$f;const m$b=-1,h$6=e=>{d$a.add(e),g$b.set(e,I$3());},w$7=e=>d$a.has(e),R$2=()=>d$a.size>0,T$2=()=>[...d$a.values()],$$2=e=>{let n=g$b.get(e);n===void 0&&(n=m$b),i$f.has(n)||i$f.set(n,new Set),i$f.get(n).add(e),c$f||(c$f=setTimeout(()=>{y$9(),i$f=new Map,c$f=void 0;},1e3));},y$9=()=>{const e=$$3(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$f.keys()].forEach(s=>{let o,r;s===m$b?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}

"${l.description}" failed to define ${i$f.get(s).size} tag(s) as they were defined by a runtime of ${a} version "${r.description}": ${[...i$f.get(s)].sort().join(", ")}.`,o>0?t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$i=new Set,n$l=e=>{t$i.add(e);},r$l=e=>t$i.has(e);

  const s$l=new Set,d$9=new i$m,n$k=new l$e;let t$h,a$c,m$a,i$e;const l$c=async e=>{n$k.add(e),await P$3();},c$e=e=>{d$9.fireEvent("beforeComponentRender",e),s$l.add(e),e._render();},h$5=e=>{n$k.remove(e),s$l.delete(e);},P$3=async()=>{i$e||(i$e=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$e),i$e=null,e(),m$a||(m$a=setTimeout(()=>{m$a=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$e;},y$8=()=>t$h||(t$h=new Promise(e=>{a$c=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$h=void 0,e());});}),t$h),I$2=()=>{const e=T$2().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$c=async()=>{await I$2(),await y$8();},U$1=()=>{n$k.isEmpty()&&a$c&&(a$c(),a$c=void 0,t$h=void 0);},C$3=async e=>{s$l.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$l(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$c();};

  const g$a=typeof document>"u",i$d=(e,t)=>t?`${e}|${t}`:e,l$b=e=>e===void 0?true:b$6(I$3(),parseInt(e))>=1,c$d=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$d(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$7=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$d(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$b(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$a?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$d(e,t)),f$b=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$d(e,t));},R$1=(e,t,r="",s)=>{S$4(t,r)?y$7(e,t,r,s):c$d(e,t,r,s);},m$9=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$g=new i$m,r$k="themeRegistered",n$j=e=>{t$g.attachEvent(r$k,e);},s$k=e=>t$g.fireEvent(r$k,e);

  const l$a=new Map,T$1=new Map,h$4=new Map,u$a=new Map,a$b=new Set,f$a=(e,r,t,s="root")=>{T$1.set(`${e}/${r}`,t),u$a.set(e,{cssVariablesTarget:s}),a$b.add(r),s$k(r);},L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$a.get(s);if(o!==void 0)return o;if(!a$b.has(r)){const p=[...a$b.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${p}`),c$c(e,e$f)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$9(n,g);return i&&l$a.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$4:T$1).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$8=()=>u$a,w$6=e=>a$b.has(e);

  const r$j=new Set,s$j=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$d=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$j.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$j.add("decode"));return}try{return JSON.parse(a)}catch{r$j.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$j.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$j.has("object")||(console.warn("Malformed theme metadata Object",e),r$j.add("object"));return}return {themeName:t,baseThemeName:a}},m$7=()=>{const e=s$j();if(!e||e==="none")return;const t=o$d(e);if(t)return d$8(t)};

  const t$f=new i$m,d$7="themeLoaded",o$c=e=>{t$f.attachEvent(d$7,e);},n$i=e=>{t$f.detachEvent(d$7,e);},r$i=e=>t$f.fireEvent(d$7,e);
  ...
  let t$e;i$l(()=>{t$e=void 0;});const n$h=()=>(t$e===void 0&&(t$e=S$5()),t$e),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$c=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$6(u$9(e),{"sap-ui-webcomponents-theme":e});};

  const t$d=new Map;let e$a;const n$g=()=>(e$a||(e$a=new CSSStyleSheet),e$a),r$h=(o,s)=>{t$d.set(o,s);const S=Array.from(t$d.values()).join(`
`);n$g().replaceSync(S);};

  let _lib="ui5",_package="webcomponents-theming";const a$a="@"+_lib+"/"+_package,E$2=()=>m$8().has(a$a),U=async e=>{if(!E$2())return;const t=await L$5(a$a,e);t&&R$1(t,"data-ui5-theme-properties",a$a,e);},w$5=()=>{f$b("data-ui5-theme-properties",a$a);},I$1=async(e,t)=>{const o=[...m$8().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$a)return;const i=await L$5(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$h(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$7();if(t)return t;const r=n$q("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$c(e),m$7()},b$5=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U(e):w$5();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$6(e)?e:o||e$f;await I$1(s,r),w$3(o),r$i(e);};

  const d$5=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$f = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$b;i$l(()=>{o$b=void 0;});const a$9=()=>(o$b===void 0&&(o$b=U$2()),o$b);

  const a$8=()=>{const t=n$q("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$9();},f$9=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$9()||t||S$4("data-ui5-font-face")||c$d(n$f,"data-ui5-font-face");};

  var s$i = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

  const r$g=()=>{R$1(s$i,"data-ui5-system-css-vars");};

  var t$c = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

  const s$h=()=>{S$4("data-ui5-scrollbar-styles")||c$d(t$c,"data-ui5-scrollbar-styles");};

  const t$b=typeof document>"u",e$9={get userAgent(){return t$b?"":navigator.userAgent},get touch(){return t$b?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$9.userAgent)},get firefox(){return t$b?false:/Firefox/.test(e$9.userAgent)},get safari(){return t$b?false:!e$9.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$9.userAgent)},get webkit(){return t$b?false:/webkit/.test(e$9.userAgent)},get windows(){return t$b?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$b?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$9.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$b?false:!e$9.windows&&/Android/.test(e$9.userAgent)},get androidPhone(){return t$b?false:e$9.android&&/(?=android)(?=.*mobile)/i.test(e$9.userAgent)},get ipad(){return t$b?false:/ipad/i.test(e$9.userAgent)||/Macintosh/i.test(e$9.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$9.touch&&!r$f}};let o$a,i$b,r$f;const s$g=()=>{if(t$b||!e$9.windows)return  false;if(o$a===void 0){const n=e$9.userAgent.match(/Windows NT (\d+).(\d)/);o$a=n?parseFloat(n[1]):0;}return o$a>=8},c$b=()=>{if(t$b||!e$9.webkit)return  false;if(i$b===void 0){const n=e$9.userAgent.match(/(webkit)[ /]([\w.]+)/);i$b=n?parseFloat(n[1]):0;}return i$b>=537.1},u$8=()=>{if(t$b)return  false;if(r$f===void 0){if(e$9.ipad){r$f=true;return}if(e$9.touch){if(s$g()){r$f=true;return}if(e$9.chrome&&e$9.android){r$f=!/Mobile Safari\/[.0-9]+/.test(e$9.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$9.android&&c$b()&&(n=1),r$f=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$f=e$9.userAgent.indexOf("Touch")!==-1||e$9.android&&!e$9.androidPhone;}},l$9=()=>e$9.touch,h$3=()=>e$9.safari,g$9=()=>e$9.chrome,b$4=()=>e$9.firefox,a$7=()=>(u$8(),(e$9.touch||s$g())&&r$f),d$4=()=>e$9._isPhone(),f$8=()=>t$b?false:!a$7()&&!d$4()||s$g(),m$6=()=>a$7()&&f$8(),w$4=()=>e$9.iOS,P$2=()=>e$9.android||e$9.androidPhone;

  let t$a=false;const i$a=()=>{h$3()&&w$4()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

  let r$e=false,i$9,p$4=false;const m$5=new i$m,O$2=()=>r$e,P$1=t=>{if(!r$e){m$5.attachEvent("boot",t);return}t();},f$7=async()=>{const t=n$q("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$q("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$a=()=>{if(p$4)return;const t=n$q("OpenUI5Support");t&&(p$4=t.attachListeners());},u$7=async()=>{if(i$9!==void 0)return i$9;const t=async e=>{if(x$1(),typeof document>"u"){e();return}n$j(b$3),await f$7(),await d$5(),await b$5(r$d()),c$a(),a$8(),r$g(),s$h(),i$a(),e(),r$e=true,m$5.fireEvent("boot");};return i$9=new Promise(t),i$9},b$3=t=>{if(!r$e)return;const e=r$d(),o=E$1();(t===e||t===o)&&b$5(e);};

  let t$9,n$e;i$l(()=>{t$9=void 0;});const r$d=()=>(t$9===void 0&&(t$9=T$3()),t$9),g$8=async e=>{t$9!==e&&(t$9=e,O$2()&&(await b$5(t$9),await C$3({themeAware:true})));},d$3=()=>e$f,i$8=()=>{const e=r$d();return y$6(e)?!e.startsWith("sap_horizon"):!m$7()?.baseThemeName?.startsWith("sap_horizon")},y$6=e=>s$r.includes(e),E$1=()=>n$e,w$3=e=>{n$e=e;};

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$f=new Map;s$f.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$f.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$f.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$9=(n,e)=>{if(s$f.has(n)){s$f.set(n,{...e,...s$f.get(n)});return}s$f.set(n,e);},r$c=n=>{const e=i$8()?"legacy":"sap_horizon";return s$f.has(n)?s$f.get(n)[e]:n};

  var t$7=(s=>(s["SAP-icons"]="SAP-icons-v4",s.horizon="SAP-icons-v5",s["SAP-icons-TNT"]="tnt",s.BusinessSuiteInAppSymbols="business-suite",s))(t$7||{});const n$d=e=>t$7[e]?t$7[e]:e;

  const i$7=o=>{const t=c$h(r$d());return !o&&t?n$d(t):o?r$c(o):r$c("SAP-icons")};

  const t$6=typeof document>"u",o$9=()=>{if(t$6)return a$f;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$f};

  const e$8=new i$m,n$c="languageChange",t$5=a=>{e$8.attachEvent(n$c,a);},r$b=a=>{e$8.detachEvent(n$c,a);},o$8=a=>e$8.fireEventAsync(n$c,a);

  let e$7,t$4;i$l(()=>{e$7=void 0,t$4=void 0;});let a$6=false;const s$e=()=>a$6,l$8=()=>(e$7===void 0&&(e$7=L$6()),e$7),L$4=async n=>{e$7!==n&&(a$6=true,e$7=n,await o$8(n),a$6=false,O$2()&&await C$3({languageAware:true}));},c$8=()=>a$f,m$4=n=>{t$4=n;},h$2=()=>(t$4===void 0&&(t$4=R$3()),t$4);

  const n$b=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;let r$a = class r{constructor(s){const t=n$b.exec(s.replace(/_/g,"-"));if(t===null)throw new Error(`The given language ${s} does not adhere to BCP-47.`);this.sLocaleId=s,this.sLanguage=t[1]||a$f,this.sScript=t[2]||"",this.sRegion=t[3]||"",this.sVariant=t[4]&&t[4].slice(1)||null,this.sExtension=t[5]&&t[5].slice(1)||null,this.sPrivateUse=t[6]||null,this.sLanguage&&(this.sLanguage=this.sLanguage.toLowerCase()),this.sScript&&(this.sScript=this.sScript.toLowerCase().replace(/^[a-z]/,i=>i.toUpperCase())),this.sRegion&&(this.sRegion=this.sRegion.toUpperCase());}getLanguage(){return this.sLanguage}getScript(){return this.sScript}getRegion(){return this.sRegion}getVariant(){return this.sVariant}getVariantSubtags(){return this.sVariant?this.sVariant.split("-"):[]}getExtension(){return this.sExtension}getExtensionSubtags(){return this.sExtension?this.sExtension.slice(2).split("-"):[]}getPrivateUse(){return this.sPrivateUse}getPrivateUseSubtags(){return this.sPrivateUse?this.sPrivateUse.slice(2).split("-"):[]}hasPrivateUseSubtag(s){return this.getPrivateUseSubtags().indexOf(s)>=0}toString(){const s=[this.sLanguage];return this.sScript&&s.push(this.sScript),this.sRegion&&s.push(this.sRegion),this.sVariant&&s.push(this.sVariant),this.sExtension&&s.push(this.sExtension),this.sPrivateUse&&s.push(this.sPrivateUse),s.join("-")}};

  const r$9=new Map,n$a=t=>(r$9.has(t)||r$9.set(t,new r$a(t)),r$9.get(t)),c$7=t=>{try{if(t&&typeof t=="string")return n$a(t)}catch{}return new r$a(r$n)},s$d=t=>{const e=l$8();return e?n$a(e):c$7(o$9())};

  const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$6=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$6={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$3=i=>{let e;if(!i)return r$n;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$6[t]||t,o&&(e=c$6.exec(o))||r&&(e=c$6.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$n};

  const r$8={zh_HK:"zh_TW",in:"id"},n$9=t=>{if(!t)return r$n;if(r$8[t])return r$8[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$n?r$n:""};

  const d$2=new Set,m$3=new Set,g$7=new Map,l$7=new Map,u$6=new Map,$$1=(n,t,e)=>{const r=`${n}/${t}`;u$6.set(r,e);},f$5=(n,t)=>{g$7.set(n,t);},A$2=n=>g$7.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$6.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$6.get(e);return r&&!l$7.get(e)&&l$7.set(e,r(t)),l$7.get(e)},M$2=n=>{d$2.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$2.add(n));},L$3=(n,t)=>t!==a$f&&!h$1(n,t),w$2=async n=>{const t=s$d().getLanguage(),e=s$d().getRegion(),r=s$d().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$3(n,s))for(s=p$3(s);L$3(n,s);)s=n$9(s);const I=h$2();if(s===a$f&&!I){f$5(n,null);return}if(!h$1(n,s)){M$2(n);return}try{const o=await B$1(n,s);f$5(n,o);}catch(o){const a=o;m$3.has(a.message)||(m$3.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$7.keys()];return Promise.all(t.map(w$2))});
  ...
  const r$7=new Map;let s$c;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$2(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$5=n=>{if(r$7.has(n))return r$7.get(n);const e=new u$5(n);return r$7.set(n,e),e},f$4=async n=>s$c?s$c(n):(await w$2(n),a$5(n)),y$5=n=>{s$c=n;};

  const c$5=["value-changed","click"];let e$6;i$l(()=>{e$6=void 0;});const s$b=t=>c$5.includes(t),l$6=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$6===void 0&&(e$6=F()),e$6),f$3=t=>{e$6=t;},a$4=t=>{const n=o$7();return s$b(t)?false:n===true?true:!l$6(t)};
  ...
  const r$4=[],o$4=t=>r$4.some(s=>t.startsWith(s));

  const t$3=new WeakMap,n$5=(e,o,r)=>{const s=new MutationObserver(o);t$3.set(e,s),s.observe(e,r);},b$1=e=>{const o=t$3.get(e);o&&(o.disconnect(),t$3.delete(e));};
