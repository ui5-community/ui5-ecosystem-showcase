sap.ui.define(['module', 'exports'], (function (module, exports) { 'use strict';
  ...
  var c$k={},e$g=c$k.hasOwnProperty,a$i=c$k.toString,o$j=e$g.toString,l$i=o$j.call(Object),i$k=function(r){var t,n;return !r||a$i.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$g.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$j.call(n)===l$i):true)};

  var c$j=Object.create(null),u$i=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$j;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$k(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$k(n)?n:{},r[a]=u$i(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$f=function(n,t){return u$i(true,false,...arguments)};

  const e$e=new Map,s$r=(t,r)=>{e$e.set(t,r);},n$r=t=>e$e.get(t);

  const _$2={themes:{default:"sap_horizon",all:["sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_horizon","sap_horizon_auto","sap_horizon_dark","sap_horizon_hc_auto","sap_horizon_hcb","sap_horizon_hcw"]},languages:{default:"en"},locales:{default:"en",all:["ar","ar_EG","ar_SA","bg","ca","cnr","cs","da","de","de_AT","de_CH","el","el_CY","en","en_AU","en_GB","en_HK","en_IE","en_IN","en_NZ","en_PG","en_SG","en_ZA","es","es_AR","es_BO","es_CL","es_CO","es_MX","es_PE","es_UY","es_VE","et","fa","fi","fr","fr_BE","fr_CA","fr_CH","fr_LU","he","hi","hr","hu","id","it","it_CH","ja","kk","ko","lt","lv","ms","mk","nb","nl","nl_BE","pl","pt","pt_PT","ro","ru","ru_UA","sk","sl","sr","sr_Latn","sv","th","tr","uk","vi","zh_CN","zh_HK","zh_SG","zh_TW"]}},e$d=_$2.themes.default,s$q=_$2.themes.all,a$h=_$2.languages.default,r$o=_$2.locales.default,n$q=_$2.locales.all;
  ...
  const e$c=new i$j,t$o="configurationReset",i$i=n=>{e$c.attachEvent(t$o,n);};

  const o$i=typeof document>"u",n$p={search(){return o$i?"":window.location.search}},s$p=()=>o$i?"":window.location.href,u$g=()=>n$p.search();

  let g$e=false,t$n={animationMode:u$h.Full,theme:e$d,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true,ignoreUrlParams:false};const y$a=()=>(o$h(),t$n.animationMode),C$7=()=>(o$h(),t$n.theme),T$5=()=>(o$h(),t$n.themeRoot),S$5=()=>(o$h(),t$n.language),U$3=()=>(o$h(),t$n.fetchDefaultLanguage),L$6=()=>(o$h(),t$n.noConflict),F=()=>(o$h(),t$n.defaultFontLoading),b$8=()=>(o$h(),t$n.enableDefaultTooltips),I$3=()=>(o$h(),t$n.ignoreUrlParams),D$3=()=>(o$h(),t$n.calendarType),R$3=()=>(o$h(),t$n.formatSettings),i$h=new Map;i$h.set("true",true),i$h.set("false",false);const M$3=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$n=e$f(t$n,e));}},z$1=()=>{const n=new URLSearchParams(u$g());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||l$h(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&l$h(r,e,"sap-ui");});},E$2=n=>n.split("@")[1],w$8=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,l$h=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$h.has(e)&&(e=i$h.get(a)),s==="theme"?(t$n.theme=w$8(s,e),e&&e.includes("@")&&(t$n.themeRoot=E$2(e))):t$n[s]=e;},j=()=>{const n=n$r("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$n=e$f(t$n,e);},o$h=()=>{typeof document>"u"||g$e||(u$f(),g$e=true);},u$f=n=>{M$3(),t$n.ignoreUrlParams||z$1(),j();};

  let n$o;i$i(()=>{n$o=void 0;});const d$d=()=>(n$o===void 0&&(n$o=y$a()),n$o),m$f=o=>{Object.values(u$h).includes(o)&&(n$o=o);};

  var s$o=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$o||{});

  let n$n;i$i(()=>{n$n=void 0;});const i$g=()=>(n$n===void 0&&(n$n=D$3()),n$n&&n$n in s$o?n$n:s$o.Gregorian);

  let t$m;let a$g = class a{static getLegacyDateCalendarCustomizing(){return t$m===void 0&&(t$m=R$3()),t$m.legacyDateCalendarCustomizing||[]}};s$r("LegacyDateFormats",a$g);

  let e$b;i$i(()=>{e$b=void 0;});const n$m=()=>(e$b===void 0&&(e$b=R$3()),e$b.firstDayOfWeek),i$f=n$r("LegacyDateFormats"),m$e=i$f?a$g.getLegacyDateCalendarCustomizing:()=>[];

  const t$l=new Map,e$a=(n,o)=>{t$l.set(n,o);},c$i=n=>t$l.get(n);
  ...
  const u$e=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$f=()=>typeof document>"u"?null:o$g('meta[name="ui5-shared-resources"]',document.head,u$e),m$d=(t,o)=>{const r=t.split(".");let e=l$f();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$9={version:"2.23.1",major:2,minor:23,patch:1,suffix:"",isNext:false,buildTime:1781204653};

  let s$n,t$k={include:[/./],exclude:[]};const o$f=new Map,p$5=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$2()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$n=e;},c$h=()=>s$n,g$d=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$k=e,o$f.clear();},m$c=()=>t$k,i$e=e=>{if(!o$f.has(e)){const n=t$k.include.some(r=>e.match(r))&&!t$k.exclude.some(r=>e.match(r));o$f.set(e,n);}return o$f.get(e)},d$c=e=>{if(i$e(e))return c$h()};

  let s$m,u$d="";const c$g=new Map,o$e=m$d("Runtimes",[]),d$b=()=>{if(s$m===void 0){s$m=o$e.length;const e=e$9;o$e.push({...e,get scopingSuffix(){return c$h()},get registeredTags(){return T$4()},get scopingRules(){return m$c()},alias:u$d,description:`Runtime ${s$m} - ver ${e.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("webcomponents"), document.baseURI).href});}},h$6=()=>s$m,a$f=(e,t)=>{if(e.isNext||t.isNext)return e.buildTime-t.buildTime;const r=e.major-t.major;if(r)return r;const n=e.minor-t.minor;if(n)return n;const i=e.patch-t.patch;return i||new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,t.suffix)},I$2=(e,t)=>{const r=`${e},${t}`;if(c$g.has(r))return c$g.get(r);const n=o$e[e],i=o$e[t];if(!n||!i)throw new Error("Invalid runtime index supplied");const m=a$f(n,i);return c$g.set(r,m),m},b$7=()=>o$e;

  const g$c=m$d("Tags",new Map),d$a=new Set;let i$d=new Map,c$f;const m$b=-1,h$5=e=>{d$a.add(e),g$c.set(e,h$6());},w$7=e=>d$a.has(e),R$2=()=>d$a.size>0,T$4=()=>[...d$a.values()],$$2=e=>{let n=g$c.get(e);n===void 0&&(n=m$b),i$d.has(n)||i$d.set(n,new Set),i$d.get(n).add(e),c$f||(c$f=setTimeout(()=>{y$9(),i$d=new Map,c$f=void 0;},1e3));},y$9=()=>{const e=b$7(),n=h$6(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$d.keys()].forEach(s=>{let o,r;s===m$b?(o=1,r={description:"Older unknown runtime"}):(o=I$2(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const t$j=new Set,n$l=e=>{t$j.add(e);},r$n=e=>t$j.has(e);

  const i$c=new Set,m$a=new i$j,n$k=new l$g;let t$i,a$e,d$9,s$l;const l$e=async e=>{n$k.add(e),await U$2();},c$e=e=>{i$c.add(e);},f$e=e=>{i$c.delete(e);},u$c=e=>{m$a.fireEvent("beforeComponentRender",e),c$e(e),e._render();},P$2=e=>{n$k.remove(e),f$e(e);},U$2=async()=>{s$l||(s$l=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(u$c),s$l=null,e(),d$9||(d$9=setTimeout(()=>{d$9=void 0,n$k.isEmpty()&&T$3();},200));});})),await s$l;},y$8=()=>t$i||(t$i=new Promise(e=>{a$e=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$i=void 0,e());});}),t$i),C$6=()=>{const e=T$4().map(r=>customElements.whenDefined(r));return Promise.all(e)},w$6=async()=>{await C$6(),await y$8();},T$3=()=>{n$k.isEmpty()&&a$e&&(a$e(),a$e=void 0,t$i=void 0);},b$6=async e=>{i$c.forEach(r=>{const o=r.constructor,E=o.getMetadata().getTag(),p=r$n(o),g=o.getMetadata().isLanguageAware(),v=o.getMetadata().isThemeAware();(!e||e.tag===E||e.rtlAware&&p||e.languageAware&&g||e.themeAware&&v)&&l$e(r);}),await w$6();};

  const g$b=typeof document>"u",i$b=(e,t)=>t?`${e}|${t}`:e,l$d=e=>e===void 0?true:I$2(h$6(),parseInt(e))>=1,c$d=(e,t,r="",s)=>{const d=h$6(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$b(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$7=(e,t,r="",s)=>{const d=h$6(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$b(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$d(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$b?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$b(e,t)),f$d=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$b(e,t));},R$1=(e,t,r="",s)=>{S$4(t,r)?y$7(e,t,r,s):c$d(e,t,r,s);},m$9=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$h=new i$j,r$m="themeRegistered",n$j=e=>{t$h.attachEvent(r$m,e);},s$k=e=>t$h.fireEvent(r$m,e);

  const l$c=new Map,T$2=new Map,h$4=new Map,u$b=new Map,a$d=new Set,f$c=(e,r,t,s="root")=>{T$2.set(`${e}/${r}`,t),u$b.set(e,{cssVariablesTarget:s}),a$d.add(r),s$k(r);},L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$c.get(s);if(o!==void 0)return o;if(!a$d.has(r)){const p=[...a$d.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$d}. Registered themes are: ${p}`),c$c(e,e$d)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$9(n,g);return i&&l$c.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$4:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$8=()=>u$b,w$5=e=>a$d.has(e);

  const r$l=new Set,s$j=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$d=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$l.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$l.add("decode"));return}try{return JSON.parse(a)}catch{r$l.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$l.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$l.has("object")||(console.warn("Malformed theme metadata Object",e),r$l.add("object"));return}return {themeName:t,baseThemeName:a}},m$7=()=>{const e=s$j();if(!e||e==="none")return;const t=o$d(e);if(t)return d$8(t)};

  const t$g=new i$j,d$7="themeLoaded",o$c=e=>{t$g.attachEvent(d$7,e);},n$i=e=>{t$g.detachEvent(d$7,e);},r$k=e=>t$g.fireEvent(d$7,e);
  ...
  const a$c=t=>{const e=document.querySelector(`META[name="${t}"]`);return e&&e.getAttribute("content")},g$a=(t,e=false)=>{const n=a$c("sap-allowed-theme-origins")??a$c("sap-allowedThemeOrigins");return n?e?true:n.split(",").some(r=>r==="*"||t===r.trim()):false},l$b=t=>{let e,n=false;try{if(t.startsWith(".")||t.startsWith("/")&&!t.startsWith("//"))e=new URL(t,s$p()).toString(),n=!0;else {const r=t.startsWith("//")?new URL(t,s$p()):new URL(t),i=r.origin,o=new URL(s$p()).origin;if(n=i===o,i&&g$a(i,n))e=r.toString();else return}return e.endsWith("/")||(e=`${e}/`),`${e}UI5/`}catch{return}};

  let t$f;i$i(()=>{t$f=void 0;});const r$j=()=>(t$f===void 0&&(t$f=T$5()),t$f),f$b=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$i=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$j();if(!n)return;const i=l$b(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$6(f$b(e,i),{"sap-ui-webcomponents-theme":e});};

  const t$e=new Map;let e$8;const n$h=()=>(e$8||(e$8=new CSSStyleSheet),e$8),r$i=(o,s)=>{t$e.set(o,s);const S=Array.from(t$e.values()).join(`
`);n$h().replaceSync(S);};

  let _lib="ui5",_package="webcomponents-theming";const a$b="@"+_lib+"/"+_package,E$1=()=>m$8().has(a$b),U$1=async e=>{if(!E$1())return;const t=await L$5(a$b,e);t&&R$1(t,"data-ui5-theme-properties",a$b,e);},w$4=()=>{f$d("data-ui5-theme-properties",a$b);},I$1=async(e,t)=>{const o=[...m$8().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$b)return;const i=await L$5(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${h$6()}`,s):n==="host"&&r$i(s,i));});return Promise.all(o)},O$2=async e=>{const t=m$7();if(t)return t;const r=n$r("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$j())return await s$i(e),m$7()},b$5=async e=>{const t=await O$2(e);!t||e!==t.themeName?await U$1(e):w$4();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$5(e)?e:o||e$d;await I$1(s,r),B$2(o),r$k(e);};

  const d$5=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

  var n$g = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$b;i$i(()=>{o$b=void 0;});const a$a=()=>(o$b===void 0&&(o$b=F()),o$b);

  const a$9=()=>{const t=n$r("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$a();},f$a=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$a()||t||S$4("data-ui5-font-face")||c$d(n$g,"data-ui5-font-face");};

  var s$h = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

  const r$h=()=>{R$1(s$h,"data-ui5-system-css-vars");};

  var t$d = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

  const s$g=()=>{S$4("data-ui5-scrollbar-styles")||c$d(t$d,"data-ui5-scrollbar-styles");};

  const t$c=typeof document>"u",e$7={get userAgent(){return t$c?"":navigator.userAgent},get touch(){return t$c?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$c?false:/(Chrome|CriOS)/.test(e$7.userAgent)},get firefox(){return t$c?false:/Firefox/.test(e$7.userAgent)},get safari(){return t$c?false:!e$7.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$7.userAgent)},get webkit(){return t$c?false:/webkit/.test(e$7.userAgent)},get windows(){return t$c?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$c?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$c?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$7.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$c?false:!e$7.windows&&/Android/.test(e$7.userAgent)},get androidPhone(){return t$c?false:e$7.android&&/(?=android)(?=.*mobile)/i.test(e$7.userAgent)},get ipad(){return t$c?false:/ipad/i.test(e$7.userAgent)||/Macintosh/i.test(e$7.userAgent)&&"ontouchend"in document},_isPhone(){return u$a(),e$7.touch&&!r$g}};let o$a,i$a,r$g;const s$f=()=>{if(t$c||!e$7.windows)return  false;if(o$a===void 0){const n=e$7.userAgent.match(/Windows NT (\d+).(\d)/);o$a=n?parseFloat(n[1]):0;}return o$a>=8},c$b=()=>{if(t$c||!e$7.webkit)return  false;if(i$a===void 0){const n=e$7.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$a=()=>{if(t$c)return  false;if(r$g===void 0){if(e$7.ipad){r$g=true;return}if(e$7.touch){if(s$f()){r$g=true;return}if(e$7.chrome&&e$7.android){r$g=!/Mobile Safari\/[.0-9]+/.test(e$7.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$7.android&&c$b()&&(n=1),r$g=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$g=e$7.userAgent.indexOf("Touch")!==-1||e$7.android&&!e$7.androidPhone;}},l$a=()=>e$7.touch,h$3=()=>e$7.safari,g$9=()=>e$7.chrome,b$4=()=>e$7.firefox,a$8=()=>(u$a(),(e$7.touch||s$f())&&r$g),d$4=()=>e$7._isPhone(),f$9=()=>t$c?false:!a$8()&&!d$4()||s$f(),m$6=()=>a$8()&&f$9(),w$3=()=>e$7.iOS,P$1=()=>e$7.android||e$7.androidPhone;

  let t$b=false;const i$9=()=>{h$3()&&w$3()&&!t$b&&(document.body.addEventListener("touchstart",()=>{}),t$b=true);};

  let r$f=false,i$8,p$4=false;const m$5=new i$j,w$2=()=>r$f,O$1=t=>{if(!r$f){m$5.attachEvent("boot",t);return}t();},f$8=async()=>{const t=n$r("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$r("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$a=()=>{if(p$4)return;const t=n$r("OpenUI5Support");t&&(p$4=t.attachListeners());},u$9=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(d$b(),typeof document>"u"){e();return}n$j(b$3),await f$8(),await d$5(),await b$5(r$d()),c$a(),a$9(),r$h(),s$g(),i$9(),e(),r$f=true,m$5.fireEvent("boot");};return i$8=new Promise(t),i$8},b$3=t=>{if(!r$f)return;const e=r$d(),o=A$2();(t===e||t===o)&&b$5(e);};

  const g$8=()=>m$d("ConfigChange.eventProvider",new i$j),r$e=()=>m$d("ConfigChange.values",{}),a$7="configChange",t$a=new Set,d$3=(n,e)=>{r$e()[n]=e,t$a.add(n);try{g$8().fireEvent(a$7,{name:n,value:e});}finally{t$a.delete(n);}},C$5=(n,e)=>{g$8().attachEvent(a$7,i=>{i.name===n&&!t$a.has(n)&&e(i.value);});},f$7=n=>r$e()[n];

  let t$9,o$9;i$i(()=>{t$9=void 0;}),C$5("theme",e=>{t$9=e,w$2()&&b$5(t$9).then(()=>b$6({themeAware:true}));});const r$d=()=>(t$9===void 0&&(t$9=f$7("theme")??C$7()),t$9),l$9=async e=>{t$9!==e&&(t$9=e,d$3("theme",e),w$2()&&(await b$5(t$9),await b$6({themeAware:true})));},y$6=()=>e$d,m$4=()=>{const e=r$d();return C$4(e)?!e.startsWith("sap_horizon"):!m$7()?.baseThemeName?.startsWith("sap_horizon")},C$4=e=>s$q.includes(e),A$2=()=>o$9,B$2=e=>{o$9=e;};

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$e=new Map;s$e.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$e.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$e.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$9=(n,e)=>{if(s$e.has(n)){s$e.set(n,{...e,...s$e.get(n)});return}s$e.set(n,e);},r$c=n=>{const e=m$4()?"legacy":"sap_horizon";return s$e.has(n)?s$e.get(n)[e]:n};
  ...
  const i$7=o=>{const t=c$i(r$d());return !o&&t?n$f(t):o?r$c(o):r$c("SAP-icons")};

  const t$6=typeof document>"u",o$8=()=>{if(t$6)return a$h;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$h};

  const e$6=new i$j,n$e="languageChange",t$5=a=>{e$6.attachEvent(n$e,a);},r$b=a=>{e$6.detachEvent(n$e,a);},o$7=a=>e$6.fireEventAsync(n$e,a);

  let n$d,t$4;i$i(()=>{n$d=void 0,t$4=void 0;});let a$6=false;C$5("language",e=>{n$d=e,a$6=true,o$7(e).then(()=>{a$6=false,w$2()&&b$6({languageAware:true});});});const c$8=()=>a$6,L$4=()=>(n$d===void 0&&(n$d=f$7("language")??S$5()),n$d),h$2=async e=>{n$d!==e&&(a$6=true,n$d=e,d$3("language",e),await o$7(e),a$6=false,w$2()&&await b$6({languageAware:true}));},C$3=()=>a$h,p$3=e=>{t$4=e;},D$2=()=>(t$4===void 0&&(t$4=U$3()),t$4);
  ...
  const r$9=new Map,n$b=t=>(r$9.has(t)||r$9.set(t,new r$a(t)),r$9.get(t)),c$7=t=>{try{if(t&&typeof t=="string")return n$b(t)}catch{}return new r$a(r$o)},s$d=t=>{const e=L$4();return e?n$b(e):c$7(o$8())};

  const _$1=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$6=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$6={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$2=i=>{let e;if(!i)return r$o;if(typeof i=="string"&&(e=_$1.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$6[t]||t,o&&(e=c$6.exec(o))||r&&(e=c$6.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$o};

  const r$8={zh_HK:"zh_TW",in:"id"},n$a=t=>{if(!t)return r$o;if(r$8[t])return r$8[t];const L=t.lastIndexOf("_");return L>=0?t.slice(0,L):t!==r$o?r$o:""};

  const d$2=new Set,m$3=new Set,g$7=new Map,l$8=new Map,u$8=new Map,$$1=(n,t,e)=>{const r=`${n}/${t}`;u$8.set(r,e);},f$5=(n,t)=>{g$7.set(n,t);},A$1=n=>g$7.get(n),h$1=(n,t)=>{const e=`${n}/${t}`;return u$8.has(e)},B$1=(n,t)=>{const e=`${n}/${t}`,r=u$8.get(e);return r&&!l$8.get(e)&&l$8.set(e,r(t)),l$8.get(e)},M$2=n=>{d$2.has(n)||(console.warn(`[${n}]: Message bundle assets are not configured. Falling back to English texts.`,` Add \`import "${n}/dist/Assets.js"\` in your bundle and make sure your build tool supports dynamic imports and JSON imports. See section "Assets" in the documentation for more information.`),d$2.add(n));},L$3=(n,t)=>t!==a$h&&!h$1(n,t),w$1=async n=>{const t=s$d().getLanguage(),e=s$d().getRegion(),r=s$d().getVariant();let s=t+(e?`-${e}`:"")+(r?`-${r}`:"");if(L$3(n,s))for(s=p$2(s);L$3(n,s);)s=n$a(s);const I=D$2();if(s===a$h&&!I){f$5(n,null);return}if(!h$1(n,s)){M$2(n);return}try{const o=await B$1(n,s);f$5(n,o);}catch(o){const a=o;m$3.has(a.message)||(m$3.add(a.message),console.error(a.message));}};t$5(n=>{const t=[...g$7.keys()];return Promise.all(t.map(w$1))});

  const g$6=/('')|'([^']+(?:''[^']*)*)(?:'|$)|\{([0-9]+(?:\s*,[^{}]*)?)\}|[{}]/g,i$6=(n,t)=>(t=t||[],n.replace(g$6,(p,s,e,r,o)=>{if(s)return "'";if(e)return e.replace(/''/g,"'");if(r){const a=typeof r=="string"?parseInt(r):r;return String(t[a])}throw new Error(`[i18n]: pattern syntax error at pos ${o}`)}));

  const r$7=new Map;let s$c;let u$7 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$5=n=>{if(r$7.has(n))return r$7.get(n);const e=new u$7(n);return r$7.set(n,e),e},f$4=async n=>s$c?s$c(n):(await w$1(n),a$5(n)),y$5=n=>{s$c=n;};

  const c$5=["value-changed","click"];let e$5;i$i(()=>{e$5=void 0;});const s$b=t=>c$5.includes(t),l$7=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$5===void 0&&(e$5=L$6()),e$5),f$3=t=>{e$5=t;},a$4=t=>{const n=o$6();return s$b(t)?false:n===true?true:!l$7(t)};
  ...
  const T$1="legacy",s$2=new Map,c$2=m$d("SVGIcons.registry",new Map),i$2=m$d("SVGIcons.promises",new Map),l$2="ICON_NOT_FOUND",C$1=(e,t)=>{s$2.set(e,t);},N$1=async e=>{if(!i$2.has(e)){if(!s$2.has(e))throw new Error(`No loader registered for the ${e} icons collection. Probably you forgot to import the "AllIcons.js" module for the respective package.`);const t=s$2.get(e);i$2.set(e,t(e));}return i$2.get(e)},f$1=e=>{Object.keys(e.data).forEach(t=>{const o=e.data[t];y$1(t,{pathData:o.path||o.paths,ltr:o.ltr,viewBox:o.viewBox,accData:o.acc,collection:e.collection,packageName:e.packageName});});},y$1=(e,t)=>{const o=`${t.collection}/${e}`,a={collection:t.collection,packageName:t.packageName,pathData:t.pathData,viewBox:t.viewBox,ltr:t.ltr,accData:t.accData,customTemplate:t.customTemplate};c$2.set(o,a);},u$2=e=>{e.startsWith("sap-icon://")&&(e=e.replace("sap-icon://",""));let t;return [e,t]=e.split("/").reverse(),e=e.replace("icon-",""),t&&(t=n$f(t)),{name:e,collection:t}},D=e=>{const{name:t,collection:o}=u$2(e);return g$1(o,t)},n$2=async e=>{const{name:t,collection:o}=u$2(e);let a=l$2;try{a=await N$1(i$7(o));}catch(r){console.error(r.message);}if(a===l$2)return a;const p=g$1(o,t);return p||(Array.isArray(a)?a.forEach(r=>{f$1(r),c$9(o,{[r.themeFamily||T$1]:r.collection});}):f$1(a),g$1(o,t))},g$1=(e,t)=>{const o=`${i$7(e)}/${t}`;return c$2.get(o)},x$1=async e=>{if(!e)return;let t=D(e);if(t||(t=await n$2(e)),t&&t!==l$2&&t.accData)return t.packageName?(await f$4(t.packageName)).getText(t.accData):t.accData?.defaultText||""};
  ...
  let t$1 = class t{static{this.html=n;}static{this.svg=u;}static{this.unsafeStatic=o$1;}};s$r("LitStatic",t$1);
