sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$j={},e$i=c$j.hasOwnProperty,a$f=c$j.toString,o$j=e$i.toString,l$h=o$j.call(Object),i$n=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$j.call(n)===l$h):true)};
  ...
  let t$l;let a$c = class a{static getLegacyDateCalendarCustomizing(){return t$l===void 0&&(t$l=M$3()),t$l.legacyDateCalendarCustomizing||[]}};s$s("LegacyDateFormats",a$c);

  let e$d;i$l(()=>{e$d=void 0;});const n$m=()=>(e$d===void 0&&(e$d=M$3()),e$d.firstDayOfWeek),i$i=n$q("LegacyDateFormats"),m$d=i$i?a$c.getLegacyDateCalendarCustomizing:()=>[];
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$l=new Set,d$9=new i$m,n$k=new l$e;let t$h,a$b,m$9,i$e;const l$c=async e=>{n$k.add(e),await P$3();},c$e=e=>{d$9.fireEvent("beforeComponentRender",e),s$l.add(e),e._render();},h$5=e=>{n$k.remove(e),s$l.delete(e);},P$3=async()=>{i$e||(i$e=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$e),i$e=null,e(),m$9||(m$9=setTimeout(()=>{m$9=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$e;},y$8=()=>t$h||(t$h=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$h=void 0,e());});}),t$h),I$2=()=>{const e=T$2().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$c=async()=>{await I$2(),await y$8();},U$1=()=>{n$k.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$h=void 0);},C$3=async e=>{s$l.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$l(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$c(r);}),await f$c();};
  ...
  const l$a=new Map,T$1=new Map,h$4=new Map,u$a=new Map,a$a=new Set,f$a=(e,r,t,s="root")=>{T$1.set(`${e}/${r}`,t),u$a.set(e,{cssVariablesTarget:s}),a$a.add(r),s$k(r);},L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$a.get(s);if(o!==void 0)return o;if(!a$a.has(r)){const p=[...a$a.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${p}`),c$c(e,e$f)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$8(n,g);return i&&l$a.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$4:T$1).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$7=()=>u$a,w$6=e=>a$a.has(e);

  const r$j=new Set,s$j=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$d=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$j.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$j.add("decode"));return}try{return JSON.parse(a)}catch{r$j.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$j.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$j.has("object")||(console.warn("Malformed theme metadata Object",e),r$j.add("object"));return}return {themeName:t,baseThemeName:a}},m$6=()=>{const e=s$j();if(!e||e==="none")return;const t=o$d(e);if(t)return d$8(t)};
...
`);n$g().replaceSync(S);};
  ...
  let _lib="ui5",_package="webcomponents-theming";const a$9="@"+_lib+"/"+_package,E$2=()=>m$7().has(a$9),U=async e=>{if(!E$2())return;const t=await L$5(a$9,e);t&&R$1(t,"data-ui5-theme-properties",a$9,e);},w$5=()=>{f$b("data-ui5-theme-properties",a$9);},I$1=async(e,t)=>{const o=[...m$7().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$9)return;const i=await L$5(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$h(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$6();if(t)return t;const r=n$q("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$c(e),m$6()},b$5=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U(e):w$5();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$6(e)?e:o||e$f;await I$1(s,r),w$3(o),r$i(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.33.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$b;i$l(()=>{o$b=void 0;});const a$8=()=>(o$b===void 0&&(o$b=U$2()),o$b);

  const a$7=()=>{const t=n$q("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$9();},f$9=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$8()||t||S$4("data-ui5-font-face")||c$d(n$f,"data-ui5-font-face");};
  ...
  let e$7,t$4;i$l(()=>{e$7=void 0,t$4=void 0;});let a$5=false;const s$e=()=>a$5,l$8=()=>(e$7===void 0&&(e$7=L$6()),e$7),L$4=async n=>{e$7!==n&&(a$5=true,e$7=n,await o$8(n),a$5=false,O$2()&&await C$3({languageAware:true}));},c$8=()=>a$e,m$3=n=>{t$4=n;},h$2=()=>(t$4===void 0&&(t$4=R$3()),t$4);
  ...
  const r$7=new Map;let s$c;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$4=n=>{if(r$7.has(n))return r$7.get(n);const e=new u$5(n);return r$7.set(n,e),e},f$4=async n=>s$c?s$c(n):(await w$2(n),a$4(n)),y$5=n=>{s$c=n;};

  const c$5=["value-changed","click"];let e$6;i$l(()=>{e$6=void 0;});const s$b=t=>c$5.includes(t),l$6=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$6===void 0&&(e$6=F()),e$6),f$3=t=>{e$6=t;},a$3=t=>{const n=o$7();return s$b(t)?false:n===true?true:!l$6(t)};
  ...
  const r$5=()=>m$c("CustomStyle.eventProvider",new i$m),n$6="CustomCSSChange",i$5=t=>{r$5().attachEvent(n$6,t);},u$4=t=>r$5().fireEvent(n$6,t),c$3=()=>m$c("CustomStyle.customCSSFor",{});let s$8;i$5(t=>{s$8||C$3({tag:t});});const g$4=(t,e)=>{const o=c$3();o[t]||(o[t]=[]),o[t].push(e),s$8=true;try{u$4(t);}finally{s$8=false;}return C$3({tag:t})},l$3=t=>{const e=c$3();return e[t]?e[t].join(""):""};
