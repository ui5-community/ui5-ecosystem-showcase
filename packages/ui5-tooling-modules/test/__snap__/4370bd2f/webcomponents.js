sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$h={},e$i=c$h.hasOwnProperty,a$f=c$h.toString,o$k=e$i.toString,l$k=o$k.call(Object),i$l=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$k):true)};

  var c$g=Object.create(null),u$f=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$g;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$l(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$l(n)?n:{},r[a]=u$f(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};
  ...
  const o$j=typeof document>"u",n$p={search(){return o$j?"":window.location.search}},s$q=()=>o$j?"":window.location.href,u$e=()=>n$p.search();
  ...
  const e$e=new i$k,t$m="configurationReset",i$j=n=>{e$e.attachEvent(t$m,n);};

  let p$7=false,t$l={animationMode:u$d.Full,theme:e$f,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true};const C$5=()=>(o$h(),t$l.animationMode),T$3=()=>(o$h(),t$l.theme),S$4=()=>{if(o$h(),t$l.themeRoot!==void 0){if(!g$c(t$l.themeRoot)){console.warn(`The ${t$l.themeRoot} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}return t$l.themeRoot}},L$3=()=>(o$h(),t$l.language),R$5=()=>(o$h(),t$l.fetchDefaultLanguage),F$1=()=>(o$h(),t$l.noConflict),U$2=()=>(o$h(),t$l.defaultFontLoading),D$2=()=>(o$h(),t$l.calendarType),M$2=()=>(o$h(),t$l.formatSettings),i$i=new Map;i$i.set("true",true),i$i.set("false",false);const w$7=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$l=e$h(t$l,e));}},z$1=()=>{const n=new URLSearchParams(u$e());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||g$b(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&g$b(r,e,"sap-ui");});},E$2=n=>{const e=n.split("@")[1];return g$c(e)},P$6=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,g$b=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$i.has(e)&&(e=i$i.get(a)),s==="theme"?(t$l.theme=P$6(s,e),e&&e.includes("@")&&(t$l.themeRoot=E$2(e))):t$l[s]=e;},j=()=>{const n=n$q("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$l=e$h(t$l,e);},o$h=()=>{typeof document>"u"||p$7||(l$i(),p$7=true);},l$i=n=>{w$7(),z$1(),j();};

  let n$o;i$j(()=>{n$o=void 0;});const d$a=()=>(n$o===void 0&&(n$o=C$5()),n$o),m$d=o=>{Object.values(u$d).includes(o)&&(n$o=o);};

  var s$o=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$o||{});

  let n$n;i$j(()=>{n$n=void 0;});const i$h=()=>(n$n===void 0&&(n$n=D$2()),n$n&&n$n in s$o?n$n:s$o.Gregorian);
  ...
  const u$c=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$g=()=>typeof document>"u"?null:o$g('meta[name="ui5-shared-resources"]',document.head,u$c),m$b=(t,o)=>{const r=t.split(".");let e=l$g();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$b={version:"2.15.1",major:2,minor:15,patch:1,suffix:"",isNext:false,buildTime:1761052348};

  let s$n,t$i={include:[/^ui5-/],exclude:[]};const o$f=new Map,l$f=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$4()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$n=e;},c$e=()=>s$n,p$6=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$i=e,o$f.clear();},m$a=()=>t$i,i$f=e=>{if(!o$f.has(e)){const n=t$i.include.some(r=>e.match(r))&&!t$i.exclude.some(r=>e.match(r));o$f.set(e,n);}return o$f.get(e)},g$a=e=>{if(i$f(e))return c$e()};

  let i$e,s$m="";const u$b=new Map,r$j=m$b("Runtimes",[]),x$1=()=>{if(i$e===void 0){i$e=r$j.length;const e=e$b;r$j.push({...e,get scopingSuffix(){return c$e()},get registeredTags(){return T$2()},get scopingRules(){return m$a()},alias:s$m,description:`Runtime ${i$e} - ver ${e.version}${""}`});}},I$3=()=>i$e,b$6=(e,m)=>{const o=`${e},${m}`;if(u$b.has(o))return u$b.get(o);const t=r$j[e],n=r$j[m];if(!t||!n)throw new Error("Invalid runtime index supplied");if(t.isNext||n.isNext)return t.buildTime-n.buildTime;const c=t.major-n.major;if(c)return c;const a=t.minor-n.minor;if(a)return a;const f=t.patch-n.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(t.suffix,n.suffix);return u$b.set(o,l),l},$$3=()=>r$j;

  const g$9=m$b("Tags",new Map),d$9=new Set;let i$d=new Map,c$d;const m$9=-1,h$7=e=>{d$9.add(e),g$9.set(e,I$3());},w$6=e=>d$9.has(e),R$4=()=>d$9.size>0,T$2=()=>[...d$9.values()],$$2=e=>{let n=g$9.get(e);n===void 0&&(n=m$9),i$d.has(n)||i$d.set(n,new Set),i$d.get(n).add(e),c$d||(c$d=setTimeout(()=>{y$7(),i$d=new Map,c$d=void 0;},1e3));},y$7=()=>{const e=$$3(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$d.keys()].forEach(s=>{let o,r;s===m$9?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$l=new Set,d$8=new i$k,n$k=new l$h;let t$g,a$b,m$8,i$c;const l$e=async e=>{n$k.add(e),await P$5();},c$c=e=>{d$8.fireEvent("beforeComponentRender",e),s$l.add(e),e._render();},h$6=e=>{n$k.remove(e),s$l.delete(e);},P$5=async()=>{i$c||(i$c=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$c),i$c=null,e(),m$8||(m$8=setTimeout(()=>{m$8=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$c;},y$6=()=>t$g||(t$g=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$g=void 0,e());});}),t$g),I$2=()=>{const e=T$2().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$a=async()=>{await I$2(),await y$6();},U$1=()=>{n$k.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$g=void 0);},C$4=async e=>{s$l.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$e(r);}),await f$a();};

  const g$8=typeof document>"u",i$b=(e,t)=>t?`${e}|${t}`:e,l$d=e=>e===void 0?true:b$6(I$3(),parseInt(e))===1,c$b=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$b(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$5=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$b(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$d(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$b(e,t)),f$9=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$b(e,t));},R$3=(e,t,r="",s)=>{S$3(t,r)?y$5(e,t,r,s):c$b(e,t,r,s);},m$7=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$f=new i$k,r$h="themeRegistered",n$j=e=>{t$f.attachEvent(r$h,e);},s$k=e=>t$f.fireEvent(r$h,e);

  const l$c=new Map,h$5=new Map,u$a=new Map,T$1=new Set,i$a=new Set,p$5=(e,r,t)=>{h$5.set(`${e}/${r}`,t),T$1.add(e),i$a.add(r),s$k(r);},m$6=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$c.get(g);if(s!==void 0)return s;if(!i$a.has(r)){const $=[...i$a.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$a(e,e$f)}const[n,d]=await Promise.all([a$a(e,r),t?a$a(e,t,true):void 0]),o=m$7(n,d);return o&&l$c.set(g,o),o},a$a=async(e,r,t=false)=>{const s=(t?u$a:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$1,P$4=e=>i$a.has(e);

  const r$g=new Set,s$j=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$e=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$7=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$5=()=>{const e=s$j();if(!e||e==="none")return;const t=o$e(e);if(t)return d$7(t)};

  const t$e=new i$k,d$6="themeLoaded",o$d=e=>{t$e.attachEvent(d$6,e);},n$i=e=>{t$e.detachEvent(d$6,e);},r$f=e=>t$e.fireEvent(d$6,e);
  ...
  let t$d;i$j(()=>{t$d=void 0;});const n$h=()=>(t$d===void 0&&(t$d=S$4()),t$d),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$9=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$5(u$9(e),{"sap-ui-webcomponents-theme":e});};

  let _lib="ui5",_package="webcomponents-theming";const s$i="@"+_lib+"/"+_package,S$2=()=>w$5().has(s$i),P$3=async e=>{if(!S$2())return;const t=await m$6(s$i,e);t&&R$3(t,"data-ui5-theme-properties",s$i,e);},E$1=()=>{f$9("data-ui5-theme-properties",s$i);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$i)return;const i=await m$6(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$3()}`,a);});return Promise.all(o)},k$1=async e=>{const t=m$5();if(t)return t;const r=n$q("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$9(e),m$5()},w$4=async e=>{const t=await k$1(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  let o$c;i$j(()=>{o$c=void 0;});const a$9=()=>(o$c===void 0&&(o$c=U$2()),o$c);

  const a$8=()=>{const t=n$q("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&f$8();},f$8=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$9()||t||S$3("data-ui5-font-face")||c$b(n$g,"data-ui5-font-face");};
  ...
  const i$6=o=>{const t=c$f(r$c());return !o&&t?n$e(t):o?r$b(o):r$b("SAP-icons")};

  const t$6=typeof document>"u",o$9=()=>{if(t$6)return a$e;const a=navigator.languages,n=()=>navigator.language;return a&&a[0]||n()||a$e};

  const e$8=new i$k,n$d="languageChange",t$5=a=>{e$8.attachEvent(n$d,a);},r$a=a=>{e$8.detachEvent(n$d,a);},o$8=a=>e$8.fireEventAsync(n$d,a);

  let e$7,t$4;i$j(()=>{e$7=void 0,t$4=void 0;});let a$5=false;const s$e=()=>a$5,l$9=()=>(e$7===void 0&&(e$7=L$3()),e$7),L$2=async n=>{e$7!==n&&(a$5=true,e$7=n,await o$8(n),a$5=false,h$3()&&await C$4({languageAware:true}));},c$8=()=>a$e,m$3=n=>{t$4=n;},h$2=()=>(t$4===void 0&&(t$4=R$5()),t$4);
  ...
  const r$8=new Map,n$b=t=>(r$8.has(t)||r$8.set(t,new r$9(t)),r$8.get(t)),c$7=t=>{try{if(t&&typeof t=="string")return n$b(t)}catch{}return new r$9(r$k)},s$d=t=>{const e=l$9();return e?n$b(e):c$7(o$9())};

  const _$2=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i,c$6=/(?:^|-)(saptrc|sappsd)(?:-|$)/i,f$6={he:"iw",yi:"ji",nb:"no",sr:"sh"},p$3=i=>{let e;if(!i)return r$k;if(typeof i=="string"&&(e=_$2.exec(i.replace(/_/g,"-")))){let t=e[1].toLowerCase(),n=e[3]?e[3].toUpperCase():void 0;const s=e[2]?e[2].toLowerCase():void 0,r=e[4]?e[4].slice(1):void 0,o=e[6];return t=f$6[t]||t,o&&(e=c$6.exec(o))||r&&(e=c$6.exec(r))?`en_US_${e[1].toLowerCase()}`:(t==="zh"&&!n&&(s==="hans"?n="CN":s==="hant"&&(n="TW")),t+(n?"_"+n+(r?"_"+r.replace("-","_"):""):""))}return r$k};
  ...
  const r$6=new Map;let s$c;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$5(l,i)}};const a$4=n=>{if(r$6.has(n))return r$6.get(n);const e=new u$5(n);return r$6.set(n,e),e},f$4=async n=>s$c?s$c(n):(await w$2(n),a$4(n)),y$4=n=>{s$c=n;};

  const c$5=["value-changed","click"];let e$6;i$j(()=>{e$6=void 0;});const s$b=t=>c$5.includes(t),l$7=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$6===void 0&&(e$6=F$1()),e$6),f$3=t=>{e$6=t;},a$3=t=>{const n=o$7();return s$b(t)?false:n===true?true:!l$7(t)};
  ...
  const s$a=new Map,o$6=new Map,n$9=new Map,c$4=e=>{if(!s$a.has(e)){const a=b$3(e.split("-"));s$a.set(e,a);}return s$a.get(e)},l$5=e=>{if(!o$6.has(e)){const a=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase();o$6.set(e,a);}return o$6.get(e)},p$2=e=>l$5(e),b$3=e=>e.map((a,t)=>t===0?a.toLowerCase():a.charAt(0).toUpperCase()+a.slice(1).toLowerCase()).join(""),C$3=e=>{const a=n$9.get(e);if(a)return a;const t=c$4(e),r=t.charAt(0).toUpperCase()+t.slice(1);return n$9.set(e,r),r};
