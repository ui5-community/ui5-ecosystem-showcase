sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$i={},e$j=c$i.hasOwnProperty,a$e=c$i.toString,o$k=e$j.toString,l$i=o$k.call(Object),i$l=function(r){var t,n;return !r||a$e.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$j.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$i):true)};
  ...
  let e$e;i$j(()=>{e$e=void 0;});const n$m=()=>(e$e===void 0&&(e$e=M$2()),e$e.firstDayOfWeek),i$g=n$r("LegacyDateFormats"),m$c=i$g?a$b.getLegacyDateCalendarCustomizing:()=>[];
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  let t$b;i$j(()=>{t$b=void 0;});const n$h=()=>(t$b===void 0&&(t$b=S$4()),t$b),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$a=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$7(u$9(e),{"sap-ui-webcomponents-theme":e});};

  const s$h="@ui5/webcomponents-theming",S$2=()=>w$5().has(s$h),P$3=async e=>{if(!S$2())return;const t=await m$6(s$h,e);t&&R$3(t,"data-ui5-theme-properties",s$h,e);},E$1=()=>{f$8("data-ui5-theme-properties",s$h);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$h)return;const i=await m$6(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$5();if(t)return t;const r=n$r("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$a(e),m$5()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$g,t&&t.themeName===e?e:void 0),r$e(e);};
  ...
  let o$c;i$j(()=>{o$c=void 0;});const a$7=()=>(o$c===void 0&&(o$c=b$7()),o$c);

  const i$9=()=>{const t=n$r("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$b();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$7()||t||S$3("data-ui5-font-face")||c$c(a$8,"data-ui5-font-face");},c$b=()=>{S$3("data-ui5-font-face-override")||c$c(n$g,"data-ui5-font-face-override");};
  ...
  const t$a=typeof document>"u",e$a={get userAgent(){return t$a?"":navigator.userAgent},get touch(){return t$a?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$a?false:/(Chrome|CriOS)/.test(e$a.userAgent)},get firefox(){return t$a?false:/Firefox/.test(e$a.userAgent)},get safari(){return t$a?false:!e$a.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$a.userAgent)},get webkit(){return t$a?false:/webkit/.test(e$a.userAgent)},get windows(){return t$a?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$a?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$a?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$a.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$a?false:!e$a.windows&&/Android/.test(e$a.userAgent)},get androidPhone(){return t$a?false:e$a.android&&/(?=android)(?=.*mobile)/i.test(e$a.userAgent)},get ipad(){return t$a?false:/ipad/i.test(e$a.userAgent)||/Macintosh/i.test(e$a.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$a.touch&&!r$d}};let o$b,i$8,r$d;const s$g=()=>{if(t$a||!e$a.windows)return  false;if(o$b===void 0){const n=e$a.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$a=()=>{if(t$a||!e$a.webkit)return  false;if(i$8===void 0){const n=e$a.userAgent.match(/(webkit)[ /]([\w.]+)/);i$8=n?parseFloat(n[1]):0;}return i$8>=537.1},u$8=()=>{if(t$a)return  false;if(r$d===void 0){if(e$a.ipad){r$d=true;return}if(e$a.touch){if(s$g()){r$d=true;return}if(e$a.chrome&&e$a.android){r$d=!/Mobile Safari\/[.0-9]+/.test(e$a.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$a.android&&c$a()&&(n=1),r$d=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$d=e$a.userAgent.indexOf("Touch")!==-1||e$a.android&&!e$a.androidPhone;}},l$b=()=>e$a.touch,h$3=()=>e$a.safari,g$7=()=>e$a.chrome,b$5=()=>e$a.firefox,a$5=()=>(u$8(),(e$a.touch||s$g())&&r$d),d$5=()=>e$a._isPhone(),f$7=()=>t$a?false:!a$5()&&!d$5()||s$g(),m$4=()=>a$5()&&f$7(),w$3=()=>e$a.iOS,P$2=()=>e$a.android||e$a.androidPhone;

  let t$9=false;const i$7=()=>{h$3()&&w$3()&&!t$9&&(document.body.addEventListener("touchstart",()=>{}),t$9=true);};

  let o$a=false,r$c;const p$4=new i$k,h$2=()=>o$a,P$1=e=>{if(!o$a){p$4.attachEvent("boot",e);return}e();},l$a=async()=>{if(r$c!==void 0)return r$c;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$j(b$4);const t=n$r("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$r("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$6(),await I$3(r$b()),t&&t.attachListeners(),i$9(),e$b(),i$7(),n(),o$a=true,p$4.fireEvent("boot");};return r$c=new Promise(e),r$c},b$4=e=>{o$a&&e===r$b()&&I$3(r$b());};

  let t$8;i$j(()=>{t$8=void 0;});const r$b=()=>(t$8===void 0&&(t$8=T$4()),t$8),u$7=async e=>{t$8!==e&&(t$8=e,h$2()&&(await I$3(t$8),await C$3({themeAware:true})));},g$6=()=>e$g,n$f=()=>{const e=r$b();return l$9(e)?!e.startsWith("sap_horizon"):!m$5()?.baseThemeName?.startsWith("sap_horizon")},l$9=e=>s$r.includes(e);
  ...
  let e$8,n$c;i$j(()=>{e$8=void 0,n$c=void 0;});const d$4=()=>(e$8===void 0&&(e$8=L$3()),e$8),s$e=async t=>{e$8!==t&&(e$8=t,await o$9(t),h$2()&&await C$3({languageAware:true}));},m$3=()=>a$d,L$2=t=>{n$c=t;},c$8=()=>(n$c===void 0&&(n$c=F()),n$c);

  const c$7=["value-changed","click"];let e$7;i$j(()=>{e$7=void 0;});const s$d=t=>c$7.includes(t),l$8=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$7===void 0&&(e$7=U$2()),e$7),f$6=t=>{e$7=t;},a$4=t=>{const n=o$8();return s$d(t)?false:n===true?true:!l$8(t)};
