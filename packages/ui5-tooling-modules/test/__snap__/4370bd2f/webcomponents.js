sap.ui.define(['module', 'exports'], (function (module, exports) { 'use strict';
  ...
  var c$j={},e$g=c$j.hasOwnProperty,a$h=c$j.toString,o$i=e$g.toString,l$g=o$i.call(Object),i$l=function(r){var t,n;return !r||a$h.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$g.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$i.call(n)===l$g):true)};

  var c$i=Object.create(null),u$f=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$i;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$l(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$l(n)?n:{},r[a]=u$f(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$f=function(n,t){return u$f(true,false,...arguments)};
  ...
  let e$b;i$j(()=>{e$b=void 0;});const n$n=()=>(e$b===void 0&&(e$b=R$3()),e$b.firstDayOfWeek),i$g=n$s("LegacyDateFormats"),m$d=i$g?a$f.getLegacyDateCalendarCustomizing:()=>[];
  ...
  const u$b=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$e=()=>typeof document>"u"?null:o$f('meta[name="ui5-shared-resources"]',document.head,u$b),m$c=(t,o)=>{const r=t.split(".");let e=l$e();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

  const e$9={version:"2.22.0",major:2,minor:22,patch:0,suffix:"",isNext:false,buildTime:1778494735};

  let s$n,t$k={include:[/./],exclude:[]};const o$e=new Map,p$6=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$2()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$n=e;},c$g=()=>s$n,g$d=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$k=e,o$e.clear();},m$b=()=>t$k,i$f=e=>{if(!o$e.has(e)){const n=t$k.include.some(r=>e.match(r))&&!t$k.exclude.some(r=>e.match(r));o$e.set(e,n);}return o$e.get(e)},d$b=e=>{if(i$f(e))return c$g()};

  let i$e,s$m="";const u$a=new Map,n$m=m$c("Runtimes",[]),x$1=()=>{if(i$e===void 0){i$e=n$m.length;const t=e$9;n$m.push({...t,get scopingSuffix(){return c$g()},get registeredTags(){return T$3()},get scopingRules(){return m$b()},alias:s$m,description:`Runtime ${i$e} - ver ${t.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("webcomponents"), document.baseURI).href});}},I$3=()=>i$e,b$6=(t,m)=>{const o=`${t},${m}`;if(u$a.has(o))return u$a.get(o);const e=n$m[t],r=n$m[m];if(!e||!r)throw new Error("Invalid runtime index supplied");if(e.isNext||r.isNext)return e.buildTime-r.buildTime;const c=e.major-r.major;if(c)return c;const a=e.minor-r.minor;if(a)return a;const f=e.patch-r.patch;if(f)return f;const l=new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,r.suffix);return u$a.set(o,l),l},$$3=()=>n$m;

  const g$c=m$c("Tags",new Map),d$a=new Set;let i$d=new Map,c$f;const m$a=-1,h$6=e=>{d$a.add(e),g$c.set(e,I$3());},w$5=e=>d$a.has(e),R$2=()=>d$a.size>0,T$3=()=>[...d$a.values()],$$2=e=>{let n=g$c.get(e);n===void 0&&(n=m$a),i$d.has(n)||i$d.set(n,new Set),i$d.get(n).add(e),c$f||(c$f=setTimeout(()=>{y$9(),i$d=new Map,c$f=void 0;},1e3));},y$9=()=>{const e=$$3(),n=I$3(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
Loading order (versions before 1.1.0 not listed): ${e.map(s=>`
${s.description}`).join("")}`),[...i$d.keys()].forEach(s=>{let o,r;s===m$a?(o=1,r={description:"Older unknown runtime"}):(o=b$6(n,s),r=e[s]);let a;o>0?a="an older":o<0?a="a newer":a="the same",t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$l=new Set,d$9=new i$k,n$k=new l$f;let t$i,a$e,m$9,i$c;const l$d=async e=>{n$k.add(e),await P$3();},c$e=e=>{d$9.fireEvent("beforeComponentRender",e),s$l.add(e),e._render();},h$5=e=>{n$k.remove(e),s$l.delete(e);},P$3=async()=>{i$c||(i$c=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$e),i$c=null,e(),m$9||(m$9=setTimeout(()=>{m$9=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$c;},y$8=()=>t$i||(t$i=new Promise(e=>{a$e=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$i=void 0,e());});}),t$i),I$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$e=async()=>{await I$2(),await y$8();},U$1=()=>{n$k.isEmpty()&&a$e&&(a$e(),a$e=void 0,t$i=void 0);},C$6=async e=>{s$l.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$n(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$d(r);}),await f$e();};

  const g$b=typeof document>"u",i$b=(e,t)=>t?`${e}|${t}`:e,l$c=e=>e===void 0?true:b$6(I$3(),parseInt(e))>=1,c$d=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$b(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$7=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$b(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$c(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$b?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$b(e,t)),f$d=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$b(e,t));},R$1=(e,t,r="",s)=>{S$4(t,r)?y$7(e,t,r,s):c$d(e,t,r,s);},m$8=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$h=new i$k,r$m="themeRegistered",n$j=e=>{t$h.attachEvent(r$m,e);},s$k=e=>t$h.fireEvent(r$m,e);

  const l$b=new Map,T$2=new Map,h$4=new Map,u$9=new Map,a$d=new Set,f$c=(e,r,t,s="root")=>{T$2.set(`${e}/${r}`,t),u$9.set(e,{cssVariablesTarget:s}),a$d.add(r),s$k(r);},L$5=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$b.get(s);if(o!==void 0)return o;if(!a$d.has(r)){const p=[...a$d.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$d}. Registered themes are: ${p}`),c$c(e,e$d)}const[n,g]=await Promise.all([c$c(e,r),t?c$c(e,t,true):void 0]),i=m$8(n,g);return i&&l$b.set(s,i),i},c$c=async(e,r,t=false)=>{const o=(t?h$4:T$2).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$7=()=>u$9,w$4=e=>a$d.has(e);

  const r$l=new Set,s$j=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$d=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$l.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$l.add("decode"));return}try{return JSON.parse(a)}catch{r$l.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$l.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$l.has("object")||(console.warn("Malformed theme metadata Object",e),r$l.add("object"));return}return {themeName:t,baseThemeName:a}},m$6=()=>{const e=s$j();if(!e||e==="none")return;const t=o$d(e);if(t)return d$8(t)};
...
`);n$h().replaceSync(S);};
  ...
  let _lib="ui5",_package="webcomponents-theming";const a$b="@"+_lib+"/"+_package,E$1=()=>m$7().has(a$b),U=async e=>{if(!E$1())return;const t=await L$5(a$b,e);t&&R$1(t,"data-ui5-theme-properties",a$b,e);},w$3=()=>{f$d("data-ui5-theme-properties",a$b);},I$1=async(e,t)=>{const o=[...m$7().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$b)return;const i=await L$5(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${I$3()}`,s):n==="host"&&r$i(s,i));});return Promise.all(o)},O$3=async e=>{const t=m$6();if(t)return t;const r=n$s("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$j())return await s$i(e),m$6()},b$5=async e=>{const t=await O$3(e);!t||e!==t.themeName?await U(e):w$3();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$4(e)?e:o||e$d;await I$1(s,r),B$2(o),r$k(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.35.0/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  const t$c=typeof document>"u",e$7={get userAgent(){return t$c?"":navigator.userAgent},get touch(){return t$c?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$c?false:/(Chrome|CriOS)/.test(e$7.userAgent)},get firefox(){return t$c?false:/Firefox/.test(e$7.userAgent)},get safari(){return t$c?false:!e$7.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$7.userAgent)},get webkit(){return t$c?false:/webkit/.test(e$7.userAgent)},get windows(){return t$c?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$c?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$c?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$7.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$c?false:!e$7.windows&&/Android/.test(e$7.userAgent)},get androidPhone(){return t$c?false:e$7.android&&/(?=android)(?=.*mobile)/i.test(e$7.userAgent)},get ipad(){return t$c?false:/ipad/i.test(e$7.userAgent)||/Macintosh/i.test(e$7.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$7.touch&&!r$g}};let o$a,i$a,r$g;const s$f=()=>{if(t$c||!e$7.windows)return  false;if(o$a===void 0){const n=e$7.userAgent.match(/Windows NT (\d+).(\d)/);o$a=n?parseFloat(n[1]):0;}return o$a>=8},c$b=()=>{if(t$c||!e$7.webkit)return  false;if(i$a===void 0){const n=e$7.userAgent.match(/(webkit)[ /]([\w.]+)/);i$a=n?parseFloat(n[1]):0;}return i$a>=537.1},u$8=()=>{if(t$c)return  false;if(r$g===void 0){if(e$7.ipad){r$g=true;return}if(e$7.touch){if(s$f()){r$g=true;return}if(e$7.chrome&&e$7.android){r$g=!/Mobile Safari\/[.0-9]+/.test(e$7.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$7.android&&c$b()&&(n=1),r$g=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$g=e$7.userAgent.indexOf("Touch")!==-1||e$7.android&&!e$7.androidPhone;}},l$9=()=>e$7.touch,h$3=()=>e$7.safari,g$9=()=>e$7.chrome,b$4=()=>e$7.firefox,a$8=()=>(u$8(),(e$7.touch||s$f())&&r$g),d$4=()=>e$7._isPhone(),f$9=()=>t$c?false:!a$8()&&!d$4()||s$f(),m$5=()=>a$8()&&f$9(),w$2=()=>e$7.iOS,P$2=()=>e$7.android||e$7.androidPhone;

  let t$b=false;const i$9=()=>{h$3()&&w$2()&&!t$b&&(document.body.addEventListener("touchstart",()=>{}),t$b=true);};

  let r$f=false,i$8,p$5=false;const m$4=new i$k,O$2=()=>r$f,P$1=t=>{if(!r$f){m$4.attachEvent("boot",t);return}t();},f$8=async()=>{const t=n$s("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$s("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c$a=()=>{if(p$5)return;const t=n$s("OpenUI5Support");t&&(p$5=t.attachListeners());},u$7=async()=>{if(i$8!==void 0)return i$8;const t=async e=>{if(x$1(),typeof document>"u"){e();return}n$j(b$3),await f$8(),await d$5(),await b$5(r$d()),c$a(),a$9(),r$h(),s$g(),i$9(),e(),r$f=true,m$4.fireEvent("boot");};return i$8=new Promise(t),i$8},b$3=t=>{if(!r$f)return;const e=r$d(),o=A$2();(t===e||t===o)&&b$5(e);};

  const g$8=()=>m$c("ConfigChange.eventProvider",new i$k),r$e=()=>m$c("ConfigChange.values",{}),a$7="configChange",t$a=new Set,d$3=(n,e)=>{r$e()[n]=e,t$a.add(n);try{g$8().fireEvent(a$7,{name:n,value:e});}finally{t$a.delete(n);}},C$5=(n,e)=>{g$8().attachEvent(a$7,i=>{i.name===n&&!t$a.has(n)&&e(i.value);});},f$7=n=>r$e()[n];

  let t$9,o$9;i$j(()=>{t$9=void 0;}),C$5("theme",e=>{t$9=e,O$2()&&b$5(t$9).then(()=>C$6({themeAware:true}));});const r$d=()=>(t$9===void 0&&(t$9=f$7("theme")??C$7()),t$9),l$8=async e=>{t$9!==e&&(t$9=e,d$3("theme",e),O$2()&&(await b$5(t$9),await C$6({themeAware:true})));},y$6=()=>e$d,m$3=()=>{const e=r$d();return C$4(e)?!e.startsWith("sap_horizon"):!m$6()?.baseThemeName?.startsWith("sap_horizon")},C$4=e=>s$q.includes(e),A$2=()=>o$9,B$2=e=>{o$9=e;};

  var t$8=(o=>(o.SAPIconsV4="SAP-icons-v4",o.SAPIconsV5="SAP-icons-v5",o.SAPIconsTNTV2="tnt-v2",o.SAPIconsTNTV3="tnt-v3",o.SAPBSIconsV1="business-suite-v1",o.SAPBSIconsV2="business-suite-v2",o))(t$8||{});const s$e=new Map;s$e.set("SAP-icons",{legacy:"SAP-icons-v4",sap_horizon:"SAP-icons-v5"}),s$e.set("tnt",{legacy:"tnt-v2",sap_horizon:"tnt-v3"}),s$e.set("business-suite",{legacy:"business-suite-v1",sap_horizon:"business-suite-v2"});const c$9=(n,e)=>{if(s$e.has(n)){s$e.set(n,{...e,...s$e.get(n)});return}s$e.set(n,e);},r$c=n=>{const e=m$3()?"legacy":"sap_horizon";return s$e.has(n)?s$e.get(n)[e]:n};
  ...
  const r$7=new Map;let s$c;let u$5 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$6(l,i)}};const a$5=n=>{if(r$7.has(n))return r$7.get(n);const e=new u$5(n);return r$7.set(n,e),e},f$4=async n=>s$c?s$c(n):(await w$1(n),a$5(n)),y$5=n=>{s$c=n;};

  const c$5=["value-changed","click"];let e$5;i$j(()=>{e$5=void 0;});const s$b=t=>c$5.includes(t),l$6=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$5===void 0&&(e$5=F()),e$5),f$3=t=>{e$5=t;},a$4=t=>{const n=o$6();return s$b(t)?false:n===true?true:!l$6(t)};
  ...
  const r$5=()=>m$c("CustomStyle.eventProvider",new i$k),n$7="CustomCSSChange",i$5=t=>{r$5().attachEvent(n$7,t);},u$4=t=>r$5().fireEvent(n$7,t),c$3=()=>m$c("CustomStyle.customCSSFor",{});let s$8;i$5(t=>{s$8||C$6({tag:t});});const g$4=(t,e)=>{const o=c$3();o[t]||(o[t]=[]),o[t].push(e),s$8=true;try{u$4(t);}finally{s$8=false;}return C$6({tag:t})},l$3=t=>{const e=c$3();return e[t]?e[t].join(""):""};

  const e$4=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$3=new Map;i$5(t=>{e$3.delete(`${t}_normal`);});const y$4=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$s("OpenUI5Enablement");if(!e$3.has(n)){let l="";s&&(l=e$4(s.getBusyIndicatorStyles()));const a=l$3(o)||"",m=`${e$4(t.styles)} ${a} ${l}`;e$3.set(n,m);}return e$3.get(n)};
