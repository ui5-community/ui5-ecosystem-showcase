sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$i={},e$i=c$i.hasOwnProperty,a$f=c$i.toString,o$k=e$i.toString,l$k=o$k.call(Object),i$l=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$k):true)};
  ...
  let e$d;i$j(()=>{e$d=void 0;});const n$m=()=>(e$d===void 0&&(e$d=M$2()),e$d.firstDayOfWeek),i$g=n$q("LegacyDateFormats"),m$c=i$g?a$c.getLegacyDateCalendarCustomizing:()=>[];
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$k=new Set,d$9=new i$k,n$k=new l$i;let t$f,a$b,m$8,i$d;const l$f=async e=>{n$k.add(e),await P$5();},c$d=e=>{d$9.fireEvent("beforeComponentRender",e),s$k.add(e),e._render();},h$6=e=>{n$k.remove(e),s$k.delete(e);},P$5=async()=>{i$d||(i$d=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$d),i$d=null,e(),m$8||(m$8=setTimeout(()=>{m$8=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$d;},y$5=()=>t$f||(t$f=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$f=void 0,e());});}),t$f),I$4=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$9=async()=>{await I$4(),await y$5();},U$1=()=>{n$k.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$f=void 0);},C$3=async e=>{s$k.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$f(r);}),await f$9();};

  const g$8=typeof document>"u",i$c=(e,t)=>t?`${e}|${t}`:e,l$e=e=>e===void 0?true:b$6(I$5(),parseInt(e))===1,c$c=(e,t,r="",s)=>{const d=I$5(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$c(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$4=(e,t,r="",s)=>{const d=I$5(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$c(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$e(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$3=(e,t="")=>g$8?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$c(e,t)),f$8=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$c(e,t));},R$3=(e,t,r="",s)=>{S$3(t,r)?y$4(e,t,r,s):c$c(e,t,r,s);},m$7=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$e=new i$k,r$h="themeRegistered",n$j=e=>{t$e.attachEvent(r$h,e);},s$j=e=>t$e.fireEvent(r$h,e);

  const l$d=new Map,h$5=new Map,u$a=new Map,T$2=new Set,i$b=new Set,p$6=(e,r,t)=>{h$5.set(`${e}/${r}`,t),T$2.add(e),i$b.add(r),s$j(r);},m$6=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$d.get(g);if(s!==void 0)return s;if(!i$b.has(r)){const $=[...i$b.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$a(e,e$f)}const[n,d]=await Promise.all([a$a(e,r),t?a$a(e,t,true):void 0]),o=m$7(n,d);return o&&l$d.set(g,o),o},a$a=async(e,r,t=false)=>{const s=(t?u$a:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$2,P$4=e=>i$b.has(e);

  const r$g=new Set,s$i=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$e=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$g.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$g.add("decode"));return}try{return JSON.parse(a)}catch{r$g.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$g.add("parse"));}}},d$8=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$g.has("object")||(console.warn("Malformed theme metadata Object",e),r$g.add("object"));return}return {themeName:t,baseThemeName:a}},m$5=()=>{const e=s$i();if(!e||e==="none")return;const t=o$e(e);if(t)return d$8(t)};

  const t$d=new i$k,d$7="themeLoaded",o$d=e=>{t$d.attachEvent(d$7,e);},n$i=e=>{t$d.detachEvent(d$7,e);},r$f=e=>t$d.fireEvent(d$7,e);
  ...
  let t$c;i$j(()=>{t$c=void 0;});const n$h=()=>(t$c===void 0&&(t$c=S$4()),t$c),u$9=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$a=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$6(u$9(e),{"sap-ui-webcomponents-theme":e});};

  const s$h="@ui5/webcomponents-theming",S$2=()=>w$5().has(s$h),P$3=async e=>{if(!S$2())return;const t=await m$6(s$h,e);t&&R$3(t,"data-ui5-theme-properties",s$h,e);},E$1=()=>{f$8("data-ui5-theme-properties",s$h);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$h)return;const i=await m$6(a,e,t);i&&R$3(i,`data-ui5-component-properties-${I$5()}`,a);});return Promise.all(o)},w$4=async e=>{const t=m$5();if(t)return t;const r=n$q("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$a(e),m$5()},I$3=async e=>{const t=await w$4(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};
  ...
  let o$c;i$j(()=>{o$c=void 0;});const a$8=()=>(o$c===void 0&&(o$c=b$7()),o$c);

  const i$9=()=>{const t=n$q("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&p$5(),c$b();},p$5=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$8()||t||S$3("data-ui5-font-face")||c$c(a$9,"data-ui5-font-face");},c$b=()=>{S$3("data-ui5-font-face-override")||c$c(n$g,"data-ui5-font-face-override");};
  ...
  const t$b=typeof document>"u",e$9={get userAgent(){return t$b?"":navigator.userAgent},get touch(){return t$b?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$9.userAgent)},get firefox(){return t$b?false:/Firefox/.test(e$9.userAgent)},get safari(){return t$b?false:!e$9.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$9.userAgent)},get webkit(){return t$b?false:/webkit/.test(e$9.userAgent)},get windows(){return t$b?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$b?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$9.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$b?false:!e$9.windows&&/Android/.test(e$9.userAgent)},get androidPhone(){return t$b?false:e$9.android&&/(?=android)(?=.*mobile)/i.test(e$9.userAgent)},get ipad(){return t$b?false:/ipad/i.test(e$9.userAgent)||/Macintosh/i.test(e$9.userAgent)&&"ontouchend"in document},_isPhone(){return u$8(),e$9.touch&&!r$e}};let o$b,i$8,r$e;const s$g=()=>{if(t$b||!e$9.windows)return  false;if(o$b===void 0){const n=e$9.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$a=()=>{if(t$b||!e$9.webkit)return  false;if(i$8===void 0){const n=e$9.userAgent.match(/(webkit)[ /]([\w.]+)/);i$8=n?parseFloat(n[1]):0;}return i$8>=537.1},u$8=()=>{if(t$b)return  false;if(r$e===void 0){if(e$9.ipad){r$e=true;return}if(e$9.touch){if(s$g()){r$e=true;return}if(e$9.chrome&&e$9.android){r$e=!/Mobile Safari\/[.0-9]+/.test(e$9.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$9.android&&c$a()&&(n=1),r$e=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$e=e$9.userAgent.indexOf("Touch")!==-1||e$9.android&&!e$9.androidPhone;}},l$c=()=>e$9.touch,h$4=()=>e$9.safari,g$7=()=>e$9.chrome,b$5=()=>e$9.firefox,a$6=()=>(u$8(),(e$9.touch||s$g())&&r$e),d$4=()=>e$9._isPhone(),f$7=()=>t$b?false:!a$6()&&!d$4()||s$g(),m$4=()=>a$6()&&f$7(),w$3=()=>e$9.iOS,P$2=()=>e$9.android||e$9.androidPhone;

  let t$a=false;const i$7=()=>{h$4()&&w$3()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

  let o$a=false,r$d;const p$4=new i$k,h$3=()=>o$a,P$1=e=>{if(!o$a){p$4.attachEvent("boot",e);return}e();},l$b=async()=>{if(r$d!==void 0)return r$d;const e=async n=>{if(x$1(),typeof document>"u"){n();return}n$j(b$4);const t=n$q("OpenUI5Support"),f=t?t.isOpenUI5Detected():false,s=n$q("F6Navigation");t&&await t.init(),s&&!f&&s.init(),await d$5(),await I$3(r$c()),t&&t.attachListeners(),i$9(),e$a(),i$7(),n(),o$a=true,p$4.fireEvent("boot");};return r$d=new Promise(e),r$d},b$4=e=>{o$a&&e===r$c()&&I$3(r$c());};

  let t$9;i$j(()=>{t$9=void 0;});const r$c=()=>(t$9===void 0&&(t$9=T$4()),t$9),u$7=async e=>{t$9!==e&&(t$9=e,h$3()&&(await I$3(t$9),await C$3({themeAware:true})));},g$6=()=>e$f,n$f=()=>{const e=r$c();return l$a(e)?!e.startsWith("sap_horizon"):!m$5()?.baseThemeName?.startsWith("sap_horizon")},l$a=e=>s$r.includes(e);
  ...
  const i$6=o=>{const t=c$g(r$c());return !o&&t?n$e(t):o?r$b(o):r$b("SAP-icons")};

  const e$8=new i$k,n$d="languageChange",t$6=a=>{e$8.attachEvent(n$d,a);},r$a=a=>{e$8.detachEvent(n$d,a);},o$9=a=>e$8.fireEventAsync(n$d,a);

  let e$7,t$5;i$j(()=>{e$7=void 0,t$5=void 0;});let a$5=false;const s$e=()=>a$5,l$9=()=>(e$7===void 0&&(e$7=L$3()),e$7),L$2=async n=>{e$7!==n&&(a$5=true,e$7=n,await o$9(n),a$5=false,h$3()&&await C$3({languageAware:true}));},c$8=()=>a$e,m$3=n=>{t$5=n;},h$2=()=>(t$5===void 0&&(t$5=F()),t$5);

  const c$7=["value-changed","click"];let e$6;i$j(()=>{e$6=void 0;});const s$d=t=>c$7.includes(t),l$8=t=>{const n=o$8();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$8=()=>(e$6===void 0&&(e$6=U$2()),e$6),f$6=t=>{e$6=t;},a$4=t=>{const n=o$8();return s$d(t)?false:n===true?true:!l$8(t)};
  ...
  const r$8=()=>m$b("CustomStyle.eventProvider",new i$k),n$a="CustomCSSChange",i$5=t=>{r$8().attachEvent(n$a,t);},u$6=t=>r$8().fireEvent(n$a,t),c$5=()=>m$b("CustomStyle.customCSSFor",{});let s$a;i$5(t=>{s$a||C$3({tag:t});});const g$4=(t,e)=>{const o=c$5();o[t]||(o[t]=[]),o[t].push(e),s$a=true;try{u$6(t);}finally{s$a=false;}return C$3({tag:t})},l$5=t=>{const e=c$5();return e[t]?e[t].join(""):""};

  const e$5=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$4=new Map;i$5(t=>{e$4.delete(`${t}_normal`);});const y$3=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$q("OpenUI5Enablement");if(!e$4.has(n)){let l="";s&&(l=e$5(s.getBusyIndicatorStyles()));const a=l$5(o)||"",m=`${e$5(t.styles)} ${a} ${l}`;e$4.set(n,m);}return e$4.get(n)};

  const e$3=new Map;i$5(t=>{e$3.delete(`${t}_normal`);});const s$9=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$3.has(n)){const a=y$3(t),o=new CSSStyleSheet;o.replaceSync(a),e$3.set(n,[o]);}return e$3.get(n)};
