sap.ui.define(['module', 'exports'], (function (module, exports) { 'use strict';
  ...
  var c$k={},e$g=c$k.hasOwnProperty,a$i=c$k.toString,o$j=e$g.toString,l$h=o$j.call(Object),i$k=function(r){var t,n;return !r||a$i.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$g.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$j.call(n)===l$h):true)};

  var c$j=Object.create(null),u$h=function(p,m,A,d){var n,t,e,a,o,i,r=arguments[2]||{},f=3,l=arguments.length,s=arguments[0]||false,y=arguments[1]?void 0:c$j;for(typeof r!="object"&&typeof r!="function"&&(r={});f<l;f++)if((o=arguments[f])!=null)for(a in o)n=r[a],e=o[a],!(a==="__proto__"||r===e)&&(s&&e&&(i$k(e)||(t=Array.isArray(e)))?(t?(t=false,i=n&&Array.isArray(n)?n:[]):i=n&&i$k(n)?n:{},r[a]=u$h(s,arguments[1],i,e)):e!==y&&(r[a]=e));return r};

  const e$f=function(n,t){return u$h(true,false,...arguments)};
  ...
  const o$i=typeof document>"u",n$p={search(){return o$i?"":window.location.search}},s$p=()=>o$i?"":window.location.href,u$f=()=>n$p.search();

  let g$e=false,t$n={animationMode:u$g.Full,theme:e$d,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true,ignoreUrlParams:false};const y$a=()=>(o$h(),t$n.animationMode),C$7=()=>(o$h(),t$n.theme),T$5=()=>(o$h(),t$n.themeRoot),S$5=()=>(o$h(),t$n.language),U$3=()=>(o$h(),t$n.fetchDefaultLanguage),L$6=()=>(o$h(),t$n.noConflict),F=()=>(o$h(),t$n.defaultFontLoading),I$3=()=>(o$h(),t$n.ignoreUrlParams),D$3=()=>(o$h(),t$n.calendarType),R$3=()=>(o$h(),t$n.formatSettings),i$h=new Map;i$h.set("true",true),i$h.set("false",false);const M$3=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$n=e$f(t$n,e));}},z$1=()=>{const n=new URLSearchParams(u$f());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||l$g(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&l$g(r,e,"sap-ui");});},E$2=n=>n.split("@")[1],w$8=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,l$g=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$h.has(e)&&(e=i$h.get(a)),s==="theme"?(t$n.theme=w$8(s,e),e&&e.includes("@")&&(t$n.themeRoot=E$2(e))):t$n[s]=e;},j=()=>{const n=n$r("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$n=e$f(t$n,e);},o$h=()=>{typeof document>"u"||g$e||(u$e(),g$e=true);},u$e=n=>{M$3(),t$n.ignoreUrlParams||z$1(),j();};

  let n$o;i$i(()=>{n$o=void 0;});const d$d=()=>(n$o===void 0&&(n$o=y$a()),n$o),m$e=o=>{Object.values(u$g).includes(o)&&(n$o=o);};
  ...
  let e$b;i$i(()=>{e$b=void 0;});const n$m=()=>(e$b===void 0&&(e$b=R$3()),e$b.firstDayOfWeek),i$f=n$r("LegacyDateFormats"),m$d=i$f?a$g.getLegacyDateCalendarCustomizing:()=>[];
...
`);n$h().replaceSync(S);};
  ...
  let _lib="ui5",_package="webcomponents-theming";const a$b="@"+_lib+"/"+_package,E$1=()=>m$7().has(a$b),U$1=async e=>{if(!E$1())return;const t=await L$5(a$b,e);t&&R$1(t,"data-ui5-theme-properties",a$b,e);},w$4=()=>{f$d("data-ui5-theme-properties",a$b);},I$1=async(e,t)=>{const o=[...m$7().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$b)return;const i=await L$5(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${h$6()}`,s):n==="host"&&r$i(s,i));});return Promise.all(o)},O$2=async e=>{const t=m$6();if(t)return t;const r=n$r("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$j())return await s$i(e),m$6()},b$5=async e=>{const t=await O$2(e);!t||e!==t.themeName?await U$1(e):w$4();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$5(e)?e:o||e$d;await I$1(s,r),B$2(o),r$k(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  const c$5=["value-changed","click"];let e$5;i$i(()=>{e$5=void 0;});const s$b=t=>c$5.includes(t),l$6=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$5===void 0&&(e$5=L$6()),e$5),f$3=t=>{e$5=t;},a$4=t=>{const n=o$6();return s$b(t)?false:n===true?true:!l$6(t)};
  ...
  const r$5=()=>m$c("CustomStyle.eventProvider",new i$j),n$7="CustomCSSChange",i$5=t=>{r$5().attachEvent(n$7,t);},u$4=t=>r$5().fireEvent(n$7,t),c$3=()=>m$c("CustomStyle.customCSSFor",{});let s$8;i$5(t=>{s$8||b$6({tag:t});});const g$4=(t,e)=>{const o=c$3();o[t]||(o[t]=[]),o[t].push(e),s$8=true;try{u$4(t);}finally{s$8=false;}return b$6({tag:t})},l$3=t=>{const e=c$3();return e[t]?e[t].join(""):""};

  const e$4=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$3=new Map;i$5(t=>{e$3.delete(`${t}_normal`);});const y$4=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$r("OpenUI5Enablement");if(!e$3.has(n)){let l="";s&&(l=e$4(s.getBusyIndicatorStyles()));const a=l$3(o)||"",m=`${e$4(t.styles)} ${a} ${l}`;e$3.set(n,m);}return e$3.get(n)};
