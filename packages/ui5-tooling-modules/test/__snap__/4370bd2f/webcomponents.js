sap.ui.define(['exports'], (function (exports) { 'use strict';
  ...
  var c$h={},e$i=c$h.hasOwnProperty,a$f=c$h.toString,o$k=e$i.toString,l$j=o$k.call(Object),i$l=function(r){var t,n;return !r||a$f.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$i.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$k.call(n)===l$j):true)};
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  const s$l=new Set,d$8=new i$k,n$k=new l$g;let t$g,a$b,m$8,i$c;const l$d=async e=>{n$k.add(e),await P$5();},c$c=e=>{d$8.fireEvent("beforeComponentRender",e),s$l.add(e),e._render();},h$6=e=>{n$k.remove(e),s$l.delete(e);},P$5=async()=>{i$c||(i$c=new Promise(e=>{window.requestAnimationFrame(()=>{n$k.process(c$c),i$c=null,e(),m$8||(m$8=setTimeout(()=>{m$8=void 0,n$k.isEmpty()&&U$1();},200));});})),await i$c;},y$7=()=>t$g||(t$g=new Promise(e=>{a$b=e,window.requestAnimationFrame(()=>{n$k.isEmpty()&&(t$g=void 0,e());});}),t$g),I$2=()=>{const e=T$2().map(r=>customElements.whenDefined(r));return Promise.all(e)},f$a=async()=>{await I$2(),await y$7();},U$1=()=>{n$k.isEmpty()&&a$b&&(a$b(),a$b=void 0,t$g=void 0);},C$3=async e=>{s$l.forEach(r=>{const o=r.constructor,u=o.getMetadata().getTag(),w=r$i(o),p=o.getMetadata().isLanguageAware(),E=o.getMetadata().isThemeAware();(!e||e.tag===u||e.rtlAware&&w||e.languageAware&&p||e.themeAware&&E)&&l$d(r);}),await f$a();};

  const g$9=typeof document>"u",i$b=(e,t)=>t?`${e}|${t}`:e,l$c=e=>e===void 0?true:b$6(I$3(),parseInt(e))===1,c$b=(e,t,r="",s)=>{const d=I$3(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$b(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},y$6=(e,t,r="",s)=>{const d=I$3(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$b(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$c(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},S$4=(e,t="")=>g$9?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$b(e,t)),f$9=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$b(e,t));},R$2=(e,t,r="",s)=>{S$4(t,r)?y$6(e,t,r,s):c$b(e,t,r,s);},m$7=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

  const t$f=new i$k,r$h="themeRegistered",n$j=e=>{t$f.attachEvent(r$h,e);},s$k=e=>t$f.fireEvent(r$h,e);

  const l$b=new Map,h$5=new Map,u$b=new Map,T$1=new Set,i$a=new Set,p$4=(e,r,t)=>{h$5.set(`${e}/${r}`,t),T$1.add(e),i$a.add(r),s$k(r);},m$6=async(e,r,t)=>{const g=`${e}_${r}_${t||""}`,s=l$b.get(g);if(s!==void 0)return s;if(!i$a.has(r)){const $=[...i$a.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$f}. Registered themes are: ${$}`),a$a(e,e$f)}const[n,d]=await Promise.all([a$a(e,r),t?a$a(e,t,true):void 0]),o=m$7(n,d);return o&&l$b.set(g,o),o},a$a=async(e,r,t=false)=>{const s=(t?u$b:h$5).get(`${e}/${r}`);if(!s){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await s(r);}catch(d){console.error(e,d.message);return}return n},w$5=()=>T$1,P$4=e=>i$a.has(e);
  ...
  let t$d;i$j(()=>{t$d=void 0;});const n$h=()=>(t$d===void 0&&(t$d=S$5()),t$d),u$a=e=>`${n$h()}Base/baseLib/${e}/css_variables.css`,i$9=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o),await d$5(u$a(e),{"sap-ui-webcomponents-theme":e});};

  let _lib="ui5",_package="webcomponents-theming";const s$i="@"+_lib+"/"+_package,S$3=()=>w$5().has(s$i),P$3=async e=>{if(!S$3())return;const t=await m$6(s$i,e);t&&R$2(t,"data-ui5-theme-properties",s$i,e);},E$1=()=>{f$9("data-ui5-theme-properties",s$i);},U=async(e,t)=>{const o=[...w$5()].map(async a=>{if(a===s$i)return;const i=await m$6(a,e,t);i&&R$2(i,`data-ui5-component-properties-${I$3()}`,a);});return Promise.all(o)},k$1=async e=>{const t=m$5();if(t)return t;const r=n$q("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(n$h())return await i$9(e),m$5()},w$4=async e=>{const t=await k$1(e);!t||e!==t.themeName?await P$3(e):E$1();const r=P$4(e)?e:t&&t.baseThemeName;await U(r||e$f,t&&t.themeName===e?e:void 0),r$f(e);};
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.29.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
  ...
  const t$b=typeof document>"u",e$9={get userAgent(){return t$b?"":navigator.userAgent},get touch(){return t$b?false:"ontouchstart"in window||navigator.maxTouchPoints>0},get chrome(){return t$b?false:/(Chrome|CriOS)/.test(e$9.userAgent)},get firefox(){return t$b?false:/Firefox/.test(e$9.userAgent)},get safari(){return t$b?false:!e$9.chrome&&/(Version|PhantomJS)\/(\d+\.\d+).*Safari/.test(e$9.userAgent)},get webkit(){return t$b?false:/webkit/.test(e$9.userAgent)},get windows(){return t$b?false:navigator.platform.indexOf("Win")!==-1},get macOS(){return t$b?false:!!navigator.userAgent.match(/Macintosh|Mac OS X/i)},get iOS(){return t$b?false:!!navigator.platform.match(/iPhone|iPad|iPod/)||!!(e$9.userAgent.match(/Mac/)&&"ontouchend"in document)},get android(){return t$b?false:!e$9.windows&&/Android/.test(e$9.userAgent)},get androidPhone(){return t$b?false:e$9.android&&/(?=android)(?=.*mobile)/i.test(e$9.userAgent)},get ipad(){return t$b?false:/ipad/i.test(e$9.userAgent)||/Macintosh/i.test(e$9.userAgent)&&"ontouchend"in document},_isPhone(){return u$9(),e$9.touch&&!r$e}};let o$b,i$8,r$e;const s$g=()=>{if(t$b||!e$9.windows)return  false;if(o$b===void 0){const n=e$9.userAgent.match(/Windows NT (\d+).(\d)/);o$b=n?parseFloat(n[1]):0;}return o$b>=8},c$a=()=>{if(t$b||!e$9.webkit)return  false;if(i$8===void 0){const n=e$9.userAgent.match(/(webkit)[ /]([\w.]+)/);i$8=n?parseFloat(n[1]):0;}return i$8>=537.1},u$9=()=>{if(t$b)return  false;if(r$e===void 0){if(e$9.ipad){r$e=true;return}if(e$9.touch){if(s$g()){r$e=true;return}if(e$9.chrome&&e$9.android){r$e=!/Mobile Safari\/[.0-9]+/.test(e$9.userAgent);return}let n=window.devicePixelRatio?window.devicePixelRatio:1;e$9.android&&c$a()&&(n=1),r$e=Math.min(window.screen.width/n,window.screen.height/n)>=600;return}r$e=e$9.userAgent.indexOf("Touch")!==-1||e$9.android&&!e$9.androidPhone;}},l$a=()=>e$9.touch,h$4=()=>e$9.safari,g$8=()=>e$9.chrome,b$5=()=>e$9.firefox,a$6=()=>(u$9(),(e$9.touch||s$g())&&r$e),d$3=()=>e$9._isPhone(),f$7=()=>t$b?false:!a$6()&&!d$3()||s$g(),m$4=()=>a$6()&&f$7(),w$3=()=>e$9.iOS,P$2=()=>e$9.android||e$9.androidPhone;

  let t$a=false;const i$7=()=>{h$4()&&w$3()&&!t$a&&(document.body.addEventListener("touchstart",()=>{}),t$a=true);};

  let o$a=false,r$d;const p$3=new i$k,h$3=()=>o$a,P$1=t=>{if(!o$a){p$3.attachEvent("boot",t);return}t();},b$4=async()=>{if(r$d!==void 0)return r$d;const t=async n=>{if(x$1(),typeof document>"u"){n();return}n$j(F);const e=n$q("OpenUI5Support"),f=e?e.isOpenUI5Detected():false,s=n$q("F6Navigation");e&&await e.init(),s&&!f&&s.init(),await d$4(),await w$4(r$c()),e&&e.attachListeners(),a$8(),e$a(),s$h(),i$7(),n(),o$a=true,p$3.fireEvent("boot");};return r$d=new Promise(t),r$d},F=t=>{o$a&&t===r$c()&&w$4(r$c());};

  let t$9;i$j(()=>{t$9=void 0;});const r$c=()=>(t$9===void 0&&(t$9=T$3()),t$9),u$8=async e=>{t$9!==e&&(t$9=e,h$3()&&(await w$4(t$9),await C$3({themeAware:true})));},g$7=()=>e$f,n$f=()=>{const e=r$c();return l$9(e)?!e.startsWith("sap_horizon"):!m$5()?.baseThemeName?.startsWith("sap_horizon")},l$9=e=>s$r.includes(e);
  ...
  let e$7,t$4;i$j(()=>{e$7=void 0,t$4=void 0;});let a$5=false;const s$e=()=>a$5,l$8=()=>(e$7===void 0&&(e$7=L$4()),e$7),L$3=async n=>{e$7!==n&&(a$5=true,e$7=n,await o$8(n),a$5=false,h$3()&&await C$3({languageAware:true}));},c$8=()=>a$e,m$3=n=>{t$4=n;},h$2=()=>(t$4===void 0&&(t$4=R$4()),t$4);
  ...
  const r$6=new Map;let s$c;let u$6 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$5(l,i)}};const a$4=n=>{if(r$6.has(n))return r$6.get(n);const e=new u$6(n);return r$6.set(n,e),e},f$4=async n=>s$c?s$c(n):(await w$2(n),a$4(n)),y$5=n=>{s$c=n;};

  const c$5=["value-changed","click"];let e$6;i$j(()=>{e$6=void 0;});const s$b=t=>c$5.includes(t),l$6=t=>{const n=o$7();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$7=()=>(e$6===void 0&&(e$6=F$1()),e$6),f$3=t=>{e$6=t;},a$3=t=>{const n=o$7();return s$b(t)?false:n===true?true:!l$6(t)};
  ...
  const r$4=()=>m$b("CustomStyle.eventProvider",new i$k),n$7="CustomCSSChange",i$4=t=>{r$4().attachEvent(n$7,t);},u$4=t=>r$4().fireEvent(n$7,t),c$3=()=>m$b("CustomStyle.customCSSFor",{});let s$8;i$4(t=>{s$8||C$3({tag:t});});const g$3=(t,e)=>{const o=c$3();o[t]||(o[t]=[]),o[t].push(e),s$8=true;try{u$4(t);}finally{s$8=false;}return C$3({tag:t})},l$3=t=>{const e=c$3();return e[t]?e[t].join(""):""};

  const e$5=t=>Array.isArray(t)?t.filter(r=>!!r).flat(10).join(" "):t;

  const e$4=new Map;i$4(t=>{e$4.delete(`${t}_normal`);});const y$4=t=>{const o=t.getMetadata().getTag(),n=`${o}_normal`,s=n$q("OpenUI5Enablement");if(!e$4.has(n)){let l="";s&&(l=e$5(s.getBusyIndicatorStyles()));const a=l$3(o)||"",m=`${e$5(t.styles)} ${a} ${l}`;e$4.set(n,m);}return e$4.get(n)};

  const e$3=new Map;i$4(t=>{e$3.delete(`${t}_normal`);});const s$7=t=>{const n=`${t.getMetadata().getTag()}_normal`;if(!e$3.has(n)){const a=y$4(t),o=new CSSStyleSheet;o.replaceSync(a),e$3.set(n,[o]);}return e$3.get(n)};
