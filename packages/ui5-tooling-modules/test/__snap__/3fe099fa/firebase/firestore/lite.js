sap.ui.define(['exports', 'ui5/ecosystem/demo/app/resources/index.esm2017'], (function (exports, index_esm2017) { 'use strict';
	...
	*/
	 ...
	 * limitations under the License.
	 */
	const E = new index_esm2017.index_cjs.Logger("@firebase/firestore");
	...
	function __PRIVATE_logDebug(t, ...e) {
	    if (E.logLevel <= index_esm2017.index_cjs.LogLevel.DEBUG) {
	...
	function __PRIVATE_logError(t, ...e) {
	    if (E.logLevel <= index_esm2017.index_cjs.LogLevel.ERROR) {
	        const r = e.map(__PRIVATE_argToString);
	 ...
	 */ function __PRIVATE_logWarn(t, ...e) {
	    if (E.logLevel <= index_esm2017.index_cjs.LogLevel.WARN) {
	        const r = e.map(__PRIVATE_argToString);
