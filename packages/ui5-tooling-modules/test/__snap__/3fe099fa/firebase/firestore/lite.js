sap.ui.define(['exports', 'ui5/ecosystem/demo/app/resources/index.esm2017'], (function (exports, index_esm2017) { 'use strict';
     ...
     * limitations under the License.
     */
    const f = new index_esm2017.index_cjs.Logger("@firebase/firestore");
    ...
    function __PRIVATE_logDebug(t, ...e) {
        if (f.logLevel <= index_esm2017.index_cjs.LogLevel.DEBUG) {
    ...
    function __PRIVATE_logError(t, ...e) {
        if (f.logLevel <= index_esm2017.index_cjs.LogLevel.ERROR) {
            const r = e.map(__PRIVATE_argToString);
     ...
     */ function __PRIVATE_logWarn(t, ...e) {
        if (f.logLevel <= index_esm2017.index_cjs.LogLevel.WARN) {
            const r = e.map(__PRIVATE_argToString);
    ...
    function __PRIVATE_validateReference(t, e) {
        if ((t = index_esm2017.getModularInstance(t)).firestore !== e) throw new FirestoreError(T, "Provided document reference is from a different Firestore instance.");
        return t;
    }
     ...
     */ (n, e), n);
        ...
        index_esm2017.registerVersion("firestore-lite", "4.7.4", ""), index_esm2017.registerVersion("firestore-lite", "4.7.4", "esm2017");
    }();
