...
module.exports = async function({workspace, dependencies, taskUtil, options}) {
    ...
    const updateIndexHTML = options?.configuration?.updateIndexHTML=== undefined ? true : options.configuration.updateIndexHTML; //TODO default true ok?
    ...
    //const dublicateResources = moveResources && options?.configuration?.dublicateAndMove && Array.isArray(options.configuration.dublicateAndMove) ? options.configuration.dublicateAndMove:["manifest.json"]
