...
sap.ui.define(["sap/ui/test/opaQunit", "sap/ui/test/actions/EnterText", "sap/ui/test/actions/Press", "sap/ui/test/Opa5", "./pages/Main", "./pages/Other"], function (opaTest, EnterText, Press, Opa5) {
	"use strict";
