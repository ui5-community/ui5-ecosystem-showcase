...
**NOTE**: sarting with release 3.0.5, `ui5-task-zipper` will also include the generated standalone app bundle (sap-ui-custom.* files), if it is run after the standard task `generateStandaloneAppBundle`.
